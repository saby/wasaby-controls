...
export enum RpcCommandMethod {
    ...
    /**
     * Имя метода для отбора отмеченных записей
     */
    SHOW_SELECTED = 'ShowMarked',
    /**
    ...
    /**
     * Имя метода для смены корня через хлебные крошки
     */
    MOVE = 'Move',

    /**
     * Имя метода для получения смены корня через кнопку назад
     */
    PREV_DISPLAY = 'PREV_DISPLAY',

    /**
     * Имя метода для получения смены корня через проваливание в узел
     */
    NEXT_DISPLAY = 'NEXT_DISPLAY',
    /**
     * Имя метода для установки нового фильтра
     */
...
export type TRpcCommand =
    ...
    | IAbstractRpcCommand<
      ...
      >
    | IAbstractRpcCommand<
          RpcCommandMethod.CHANGE_FILTER,
          {
              _PageId: string;
    ...
    | IAbstractRpcCommand<
      ...
      >
    | IAbstractRpcCommand<
          RpcCommandMethod.NEXT_DISPLAY,
          {
              _PageId: string;
              View: CrudEntityKey | null;
              Folder: CrudEntityKey | null;
          }
      >
    | IAbstractRpcCommand<
    ...
    | IAbstractRpcCommand<
      ...
      >
    | IAbstractRpcCommand<
          RpcCommandMethod.MOVE,
          {
              _PageId: string;
              Path: SbisRecord | null;
          }
      >
    | IAbstractRpcCommand<
          RpcCommandMethod.SHOW_SELECTED,
          {
              _PageId: string;
          }
      >;
