...
export const nextDisplay = (root: CrudEntityKey | null): IListMobileAction => ({
    type: IListMobileActionType.NEXT_DISPLAY,
    payload: { root },
});

export const prevDisplay = (root: CrudEntityKey | null): IListMobileAction => ({
    type: IListMobileActionType.PREV_DISPLAY,
    payload: { root },
});

export const move = (root: CrudEntityKey | null): IListMobileAction => ({
    type: IListMobileActionType.MOVE,
    payload: { root },
});
