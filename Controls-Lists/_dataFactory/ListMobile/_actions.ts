...
export const keepAlive = (pageId: string): IListMobileAction => ({
    type: IListMobileActionType.KEEP_ALIVE,
    payload: { pageId },
});
...
export const changeUICollectionRoot = (key: CrudEntityKey | null): IListMobileAction => ({
