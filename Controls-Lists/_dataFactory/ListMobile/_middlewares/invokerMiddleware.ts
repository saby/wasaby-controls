...
export const sendRpcCommand = (
    ...
    switch (action.type) {
        case IListMobileActionType.MOVE:
            return sourceController.move(action.payload.root);
        case IListMobileActionType.NEXT_DISPLAY:
            return sourceController.nextDisplay(action.payload.root);
        case IListMobileActionType.PREV_DISPLAY:
            return sourceController.prevDisplay(action.payload.root);
