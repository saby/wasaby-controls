...
export class SourceController extends mixin<ObservableMixin>(ObservableMixin) {
    ...
    private async _dispose(): Promise<void> {
        await this._call({
            ...
            params: {
                ...
                page_id: KeepAliveControllerSingleton.getInstance().disconnect(this._observerId),
            },
        });
    }
    ...
    protected async _initHandleId(): Promise<void> {
        ...
        const response = await this._call({
            ...
            params: {
                ...
                page_id: KeepAliveControllerSingleton.getInstance().connect(this._observerId),
            },
        });
    ...
    async setFilter(filter: TFilter): Promise<void> {
