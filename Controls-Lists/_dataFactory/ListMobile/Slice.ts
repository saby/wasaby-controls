    ...
    implements ISliceWithSelection
{
     ...
     * @function Controls-Lists/_dataFactory/ListMobile/Slice#_initState
     * @param {IListLoadResult} loadResult
     * @param {IListMobileDataFactoryArguments} initConfig
     * @return {IListMobileState}
     * @protected
     */
     ...
     * @function Controls-Lists/_dataFactory/ListMobile/Slice#_createMiddlewareContext
     * @param {IListMobileDataFactoryArguments} initConfig
     * @return {IListMobileMiddlewareContext}
     * @protected
     */
     ...
     * @function Controls-Lists/_dataFactory/ListMobile/Slice#_createMiddlewares
     * @protected
     */
     ...
     * @function Controls-Lists/_dataFactory/ListMobile/Slice#_dispatch
     * @param {IListMobileAction} action
     * @protected
     */
     ...
     * @param {CrudEntityKey} key
     * @param {MarkerDirection} direction
     * @return {void}
     * @public
     */
     ...
     * @return {Promise<TSelectionRecordContent>}
     * @public
     */
