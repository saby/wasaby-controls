 ...
 * @typedef {Map<CrudEntityKey, Array<Controls/gridRender:TColumnKey>>} Controls-Lists/dynamicGrid/TSelectionMap
 */
 ...
 * * columnKey: TColumnKey
 * Возвращает: {@link Controls/display:MultiSelectAccessibility доступность чекбокса для ячейки}
 * @typedef THeaderCellsMultiSelectAccessibilityCallback
 */
export type THeaderCellsMultiSelectAccessibilityCallback = (
    columnKey: TColumnKey
) => (typeof MultiSelectAccessibility)[keyof typeof MultiSelectAccessibility];
...
export interface ICellsMultiSelectAccessibility {
     ...
     * @see cellsMultiSelectAccessibilityCallback
     */
    ...
    /**
     * Видимость множественного выбора ячеек заголовка.
     * @cfg
     * @demo Controls-Lists-demo/timelineGrid/WI/Selected/Index
     * @see headerCellsMultiSelectAccessibilityCallback
     */
    headerCellsMultiSelectVisibility?: TCellsMultiSelectVisibility;
    /**
     * Функция обратного вызова для определения доступности выбора колонки по конкретной ячейке заголовка.
     * @cfg
     * @example
     * <pre class="brush: js">
     * import { MultiSelectAccessibility } from 'Controls/display';
     ...
     *     headerCellsMultiSelectVisibility: 'visible'
