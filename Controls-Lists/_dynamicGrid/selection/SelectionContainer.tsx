    ...
    return (
        <div className="tw-contents" ref={containerRef}>
            <GridSelectionContextProviderMemo
                ...
                headerCellsMultiSelectVisibility={props.headerCellsMultiSelectVisibility}
            ...
            >
                <DragSelectionContextProviderMemo
                    ...
                    headerColumnSelector={props.headerColumnSelector}
                    headerColumnSelectorMask={props.headerColumnSelectorMask}
