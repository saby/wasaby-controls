import { ICellsSelectionModel, IRowSelectionModel, IGridSelectionModel, ISelectionMap } from './types';
...
export function isEqualPlainSelections(
    selection1: ISelectionMap,
    selection2: ISelectionMap
): boolean {
...
export function convertGridSelectionToPlainRecord(selection: IGridSelectionModel): ISelectionMap {
