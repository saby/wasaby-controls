...
class SelectionModel {
    ...
    private _plainSelection: ISelectionMap;
    ...
    getSelection(): ISelectionMap {
        return this._plainSelection;
    }

    isEqualPlainSelections(selection: ISelectionMap): boolean {
    ...
    getBoundingSelectionKeys(itemKey: TItemKey, columnKey: TColumnKey): TSelectionBounds {
        ...
        const plainSelection: ISelectionMap = {};
        let startItemKey;
        let endItemKey;
    ...
    private _changeSelection(oldSelection: ISelectionMap, newSelection: ISelectionMap): void {
    ...
    private _getSelectionDiff(
        oldSelection: ISelectionMap,
        newSelection: ISelectionMap
    ): {
        added: ISelectionMap;
        removed: ISelectionMap;
    } {
        const result = {
            added: {},
            removed: {},
    ...
    static clone(selection: ISelectionMap): ISelectionMap {
        return clone(selection);
    }

    static removeSelections(
        selection: ISelectionMap,
        partialSelection: ISelectionMap
    ): ISelectionMap {
