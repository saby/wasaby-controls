    ...
    const resizerVisibility = React.useMemo(() => {
        ...
        lineVariants.forEach(([direction, edges, perpendicular]) => {
            if (props.resizerVisibility[direction]) {
                ...
                res.classNameMap[
                    direction
                ] = `${BASE_LOGIC_CLASS_NAME} ${BASE_CLASS_NAME} ${BASE_CLASS_NAME}_${direction} ${BASE_CLASS_NAME}_${direction}_${beforeSpacing}_${afterSpacing}`;
            }
        });
        ...
        rectVariants.forEach((direction) => {
            if (props.resizerVisibility[direction]) {
                ...
                res.classNameMap[
                    direction
                ] = `${BASE_LOGIC_CLASS_NAME} ${BASE_CLASS_NAME} ${BASE_CLASS_NAME}_${direction}`;
            }
        });
