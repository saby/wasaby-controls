...
const BASE_LOGIC_CLASS_NAME = 'js-ControlsLists-dynamicGrid__selection__resizer';
...
export function SelectionHighlight(props: ISelectionHighlightProps) {
    ...
    const onResizerMouseDown = useHandler(
        React.useCallback<ISelectionResizerRenderProps['onResizerMouseDown']>(
            (e) => {
                props.preventClickCallback?.(true);
            ...
            [columnKey, props.preventClickCallback]
        )
    );
        ...
        return (
            ...
            >
                <div
                    className={`${
                        !isDragging
                            ? `ControlsLists-dynamicGrid__selection__highlight_right-bottom_bevel ${BASE_LOGIC_CLASS_NAME}`
                            : ''
                    }`}
                ...
                <div
                    className={`${
                        !isDragging
                            ? `ControlsLists-dynamicGrid__selection__highlight_left-top_bevel ${BASE_LOGIC_CLASS_NAME}`
                            : ''
                    }`}
