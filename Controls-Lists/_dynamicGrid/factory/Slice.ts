...
> extends List.slice {
    ...
    protected _initState(
        ...
        const dynamicColumnsGridData = this._generateDynamicColumnsData({
            ...
            dynamicColumnsDataProperty:
                config.dynamicColumnsDataProperty || config.columnsNavigation.sourceConfig.field,
    ...
    protected _loadColumns(direction: Exclude<TNavigationDirection, 'bothways'>): void {
        ...
        const dynamicColumnsDataProperty =
            this.state.dynamicColumnsDataProperty || columnsNavigation.sourceConfig.field;
