...
export default class DynamicGridSlice<TColumnsNavigationPosition = number,
    TColumnsGridData = number> extends List.slice {
    ...
    private _loadColumns(direction: Exclude<TNavigationDirection, 'bothways'>): void {
        ...
        const preparedFilter = {
            ...filter,
            [dynamicColumnsDataProperty]: this._convertDynamicColumnsFilterToRecord(dynamicColumnsFilter),
        };
