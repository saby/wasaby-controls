...
import { IListLoadResult, IListState } from 'Controls/dataFactory';
import { Slice as ListSlice } from 'Controls-DataEnv/currentList';
...
> extends ListSlice {
    ...
    protected _initState(
        ...
        return {
            ...
            headerCellsMultiSelectVisibility: config.headerCellsMultiSelectVisibility,
            headerCellsMultiSelectAccessibilityCallback:
                config.headerCellsMultiSelectAccessibilityCallback,
