...
/**
 * Фабрика данных Таблицы с генерируемыми колонками.
 ...
 * @cfg {Controls-Lists/_dynamicGrid/factory/Slice/DynamicGridSlice} Слайс Таблицы с генерируемыми колонками.
 */
 ...
 * @param {Controls-Lists/_dynamicGrid/factory/IDynamicGridDataFactoryArguments} config Аргументы фабрики данных Таблицы с генерируемыми колонками.
 */
