...
function ConnectedComponentRef(
    ...
    const activeDynamicColumnRef = React.useRef(props.activeDynamicColumn);
    const onActiveDynamicColumnChanged = React.useCallback(
        (newActiveDynamicColumn) => {
            activeDynamicColumnRef.current = newActiveDynamicColumn;
            props.onActiveDynamicColumnChanged?.(newActiveDynamicColumn);
        },
        [props.onActiveDynamicColumnChanged]
    );
    return (
        <DynamicGridComponent
            ...
            activeDynamicColumn={props.activeDynamicColumn || props.activeColumn}
            onActiveDynamicColumnChanged={
                props.onActiveDynamicColumnChanged ? onActiveDynamicColumnChanged : undefined
            }
            innerActiveDynamicColumn={
                props.onActiveDynamicColumnChanged ? activeDynamicColumnRef.current : undefined
            }
            ...
            needRestoreScrollOnColumnsResize={true}
            ...
            headerCellsMultiSelectVisibility={slice.headerCellsMultiSelectVisibility}
            ...
            smoothHorizontalScroll={props.smoothHorizontalScroll}
        />
    );
}
