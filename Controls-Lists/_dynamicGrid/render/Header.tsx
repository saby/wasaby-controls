...
import { getDynamicHeaderCellClass, TColumnDataDensity } from './utils';
...
function shouldHoverSeparatedHeaderCell(quantum: TQuantumType, dataDensity: TColumnDataDensity): boolean {
...
function HeaderDynamicCells(props: IDynamicCellsProps) {
    ...
    const hoverBackgroundStyle = shouldHoverSeparatedHeaderCell(quantum, dataDensity) ? 'unaccented' : null;
