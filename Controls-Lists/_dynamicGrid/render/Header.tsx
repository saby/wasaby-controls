...
import { IRange, Quantum, TAvailableQuantums } from '../interfaces/IEventRenderProps';
...
function getHeaderCellHoverClass(
    ...
    if (shouldHoverSeparatedHeaderCell(quantum, dataDensity, range, availableQuantums)) {
        return null;
    }
