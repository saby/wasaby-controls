...
export const DISABLE_HOVER_STYLES_FOR_EDITABLE_DYNAMIC_CELLS_WRAPPER =
    'controls-GridReact_singleCellEditable_disableHoverStyles';
...
export const JS_START_FIXED_SELECTOR = '.js-controls-GridColumnScroll__cell_fixedStart';
