...
import { DYNAMIC_GRID_CELL_BASE_CLASS_NAME, DYNAMIC_GRID_CELL_FIXED_STICKIED_Z_INDEX } from '../constants';
        ...
        patchColumnProps(
            ...
            (superProps) => {
                return {
                    ...
                    multiSelectFixedZIndex: DYNAMIC_GRID_CELL_FIXED_STICKIED_Z_INDEX,
                };
            },
            'defaultClassName'
        );
