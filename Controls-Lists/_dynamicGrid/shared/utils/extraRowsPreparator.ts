 ...
 */
import { ICellProps, IFooterConfig, IBaseColumnConfig, TColumnWidth } from 'Controls/gridRender';
...
/*
 * Подготавливает колонки строки Header, Footer
 */
export function prepareExtraRowColumns(
    ...
    if (!extraRowDynamicColumn && !extraRowStaticColumns) {
        return null;
    }
