 ...
 * @typedef {Function} Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/TEventMouseEventCallback
 */
 ...
 * @interface Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/IEventRenderProps
 * @public
 */
 ...
 * @typedef {String} Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/TEventRenderViewMode
...
/**
 * Интерфейс параметров рендеринга события, возвращаемых из {@link Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/ICellProps коллбека}
 * @interface Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/ICustomEventRenderProps
 * @public
 */
export interface ICustomEventRenderProps {
    /**
     * Режим рендеринга события
     * @cfg {Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/TEventRenderViewMode.typedef}
     */
    viewMode: TEventRenderViewMode;
}

/**
 * Коллбек, возвращающий {@link Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/ICustomEventRenderProps параметры для рендеринга события}.
 * Функция принимает Record события.
 * @typedef {String} Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/TGetEventRenderPropsCallback
 */
export type TGetEventRenderPropsCallback = (item: Model) => ICustomEventRenderProps;

/**
 * Интерфейс свойств компонента "Таймлайн таблица"
 * @interface Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/ITimelineComponentOptions
 * @public
 */
export interface IBaseTimelineGridComponentProps {
    /**
     * Компонент для рендера событий.
     * Принимает в себя компонент, в который будут отданы свойства интерфейса {@link Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/IEventRenderProps}
     */
    eventRender?: React.ReactElement<IEventRenderProps>;
    /**
     * Функция обратного вызова для получения параметров для рендеринга события.
     * @cfg {Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/TGetEventRenderPropsCallback.typedef}
     */
     ...
     * @cfg {Controls-Lists/_dynamicGrid/interfaces/IDynamicGridComponent/TEventMouseEventCallback.typedef}
     */
