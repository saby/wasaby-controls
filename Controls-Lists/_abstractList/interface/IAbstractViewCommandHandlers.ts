...
export interface IAbstractViewCommandHandlers {
    ...
    onItemKeyDownBackSpace: TViewKeyDownEventHandler;
    ...
    onViewKeyDownBackSpace: TViewKeyDownEventHandler;
    ...
    onViewTriggerVisibilityChanged: (position: 'bottom' | 'top', visibilityState: boolean) => void;
}
