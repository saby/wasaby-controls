...
type TEventSaturation = 'max' | 'mid' | 'min';

/**
 * Размер кванта для формирования сетки в "Таймлайн таблице".
 * @typedef {String} Controls-Lists/_timelineGrid/utils/Quantum
 * @variant hour час
 * @variant day день
 * @variant month месяц
 */
 ...
 * В качестве ключей принимает строковые названия размера квантов из {Controls-Lists/_timelineGrid/utils/Quantum.typedef Controls-Lists/timelineGrid:Quantum}
 * Строковые значения задаются в пикселях.
 * @typedef {Record<Controls-Lists/_timelineGrid/utils/Quantum.typedef, string>} Controls-Lists/_timelineGrid/utils/TDynamicColumnMinWidths
 */
