...
export function findStrictRange(params) {
    ...
    const startIndex = dynamicColumnsGridData.findIndex((d) => d.getTime() === startDate.getTime());
    const endIndex = dynamicColumnsGridData.findIndex((d) => d.getTime() === endDate.getTime());
