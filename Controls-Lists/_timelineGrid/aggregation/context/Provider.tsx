/**
 * Предоставляет провайдер контекста дополнительной колонки
 */
...
/**
 * Провайдер контекста дополнительной колонки
 * @param  columnRender Шаблон колонки
 * @param range Отображаемый период
 * @param isShown Видимость дополнительной колонки
 * @param children
 * @param dynamicColumnsGridData Данные для построения динамической сетки
 */
function Provider({
    columnRender,
    range,
