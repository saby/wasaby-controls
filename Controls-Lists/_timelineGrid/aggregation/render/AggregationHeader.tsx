 ...
 *
 * Предоставляет компонент для отображения шаблона заголовка дополнительной колонки
 * Контент заголовка содержит выпадающий список режимов отображения данных в колонке
 * @class Controls-Lists/_timelineGrid/aggregation/render/AggregationHeader
 * @category component
 * @private
 */
...
/**
 * Компонент заголовка дополнительной колонки
 */
...
/**
 * Компонент заголовка дополнительной колонки. Получает данные из контекста
 */
