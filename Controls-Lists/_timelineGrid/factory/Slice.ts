...
> extends DynamicGridFactory.slice<TColumnsNavigationPosition, TColumnsGridData> {
    ...
    protected _initState(
        ...
        return {
            ...
            ...super._initState(loadResult, { ...config, loadRange }),
            range: config.range,
    ...
    setRange(newRange: IRange): void {
        ...
        const range = { start: newRange.start, end: endDate, needScroll: newRange.needScroll };
        ...
        this.setState({ range, loadRange: range });
    }
