...
import type { ITimelineColumnsFilter, ITimelineGridDataFactoryArguments } from './ITimelineGridFactory';
import {
...
function loadData(
    ...
    const dynamicColumnsFilter: ITimelineColumnsFilter = prepareDynamicColumnsFilter(columnsNavigation);
    const filter = {
