...
type TimelineLayerComponent = React.ReactElement<ITimelineLayerComponentProps<IArrow>>;
...
export interface ITimelineGridConnectedComponentProps extends IDynamicGridConnectedComponentProps {
    ...
    /**
     * Калбэк, который вызывается после ресайза события, но до сохранения данных
     * @param params
     */
