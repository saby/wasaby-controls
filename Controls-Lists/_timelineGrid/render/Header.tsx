...
import { IHeaderConfig, ICellProps } from 'Controls/gridRender';
...
import { HOURS_IN_DAY, MONTHS_IN_YEAR } from 'Controls-Lists/_timelineGrid/constants';
...
function HeaderDateComponent(props: {
    ...
    const content = quantum !== Quantum.Second && isQuantumLessThanDay(quantum) ? (
