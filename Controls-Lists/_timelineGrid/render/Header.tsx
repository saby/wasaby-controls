...
import { HolidayConnectedComponent, useWeekendDate } from 'Controls-Lists/_timelineGrid/render/Holidays';
...
function HeaderDateComponent(props: {
    ...
    const fontColorStyle = isWeekend && quantum !== Quantum.Month ? 'danger' : 'secondary';
    return (
        <>
            <div
                className={
