...
interface IHolidaySliceConnectedComponentProps extends IHolidayConnectedComponentProps {
    storeId: string;
}
...
export function HolidaySliceConnectedComponent(props: IHolidaySliceConnectedComponentProps) {
    ...
    return (
        <HolidaysContext.Provider value={holidaysContextValue}>
            <HolidayConnectedComponent {...props} />
