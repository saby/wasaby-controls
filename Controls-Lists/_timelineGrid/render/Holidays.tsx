 ...
 * @variant DateType.WorkDay Рабочий день
 * @variant DateType.Weekend Конец недели
 * @variant DateType.Holiday Праздничный день
 * @variant DateType.PreHoliday Предпраздничный день
 */
