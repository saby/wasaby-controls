...
export function getTodayRange(currentRange: IRange): IRange {
...
export default function GoToTodayButton(props: IProps) {
    ...
    return (
        <div className={CLASS_NAME} data-qa="Controls-Lists_timelineGrid__GoToTodayButton" onClick={onClick} title={rk('Текущий период')}>
            {currentDate}
        </div>
    );
}
