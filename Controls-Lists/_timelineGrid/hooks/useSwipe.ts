...
import { staticWorkspaceSizeType } from 'Controls-Lists/_timelineGrid/interface/ITimelineGridConnectedComponentProps';
 ...
 * @param initialStaticWorkspaceSize Инициализирующее состояние ширины статических колонок.
 */
export function useSwipe(
    ...
    const [staticWorkspaceSize, setStaticWorkspaceSize] = React.useState<staticWorkspaceSizeType>(
        initialStaticWorkspaceSize || 'default'
    );
