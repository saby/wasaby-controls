...
/**
 * Конфигурация компонента “Выбор периода”.
...
/**
 * Контрол “Выбор периода”, обеспечивающий переключение периода в
 * “Таймлайн таблице” и отображающий кнопки горизонтальной прокрутки.
 * Работает с данными через слайс, предоставляемый фабрикой {@link Controls-Lists/timelineGrid:TimelineGridFactory}.
 * @param props {Controls-Lists/_timelineGrid/RangeSelectorConnectedComponent/IProps} Конфигурация компонента.
 * @example
 * Ниже приведён пример встраивания контрола временнного периода в заголовок статичной колонки таймлайн таблицы
 * <pre class="brush: js">
