...
function getArrowClickHandler(slice: TimelineGridSlice): (direction:  'backward' | 'forward') => void {
    return (direction) => {
...
export default function RangeSelectorConnectedComponent(props: IProps) {
    ...
    return (
        <div className={'tw-flex tw-items-center tw-justify-between tw-h-full tw-w-full'}>
            ...
            <div className={'tw-flex tw-items-baseline ControlsLists-timelineGrid__RangeSelectorComponent_buttons-gap'}>
