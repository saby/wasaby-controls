...
function getDateTriangleComponent(
    ...
    if (rightOffset) {
        ...
        return (
            <StickyBlock
                style={wrapperStyle}
                className="ControlsLists-dateLine__wrapper ControlsLists-dateLine__variables"
            >
                <div>
...
function getDateLineComponent(
    ...
    if (rightOffset) {
        ...
        return (
            <div
                style={wrapperStyle}
                className="ControlsLists-dateLine__wrapper tw-relative ControlsLists-dateLine__variables"
            >
...
function ConnectedComponentRef(
    ...
    }, [slice.state.collection, slice.staticColumns]);
    ...
    }, [quantum, eventsSaturation, dynamicColumnsGridData, slice.visibleRange]);
...
function prepareStaticColumns(
    ...
    return staticColumns.map((staticColumn) => {
        ...
        preparedStaticColumn.width = `${staticColumnsWidth}px - var(--outer_padding, 0px)`;
...
function goToInternalRange(slice: TimelineGridSlice, targetDate: Date, quantums: IQuantum[]): void {
    ...
    switch (quantum) {
        ...
        case Quantum.Day:
            ...
            if (rangeSize < daysInTwoWeeks || (days && days.weekRangeAvailable === false)) {
                if (lessThanDay) {
