...
import { THoverMode } from 'Controls-Lists/dynamicGrid';
...
function getDateTriangleComponent(
    ...
    const spacing =
        spaceSize === null ? '0px' : `(var(--offset_${spaceSize}) - var(--border-thickness))`;
    if (rightOffset) {
        const lineStyle = {
            right: `calc((${columnWidth}px + ${spacing}) * ${rightOffset}
 ...
 * </pre>
 * @demo Controls-Lists-demo/timelineGrid/WI/Base/Index
 * @param {Controls-Lists/_timelineGrid/interface/ITimelineGridConnectedComponentProps} props Конфигурация компонента
 */
function ConnectedComponentRef(
    ...
    const onHeaderClick = React.useCallback(
        (event: React.MouseEvent) => {
            ...
            goToInternalRange(slice, date, props.availableQuantums);
        },
        [slice, props.availableQuantums]
    );
                ...
                >
                    ...
                    >
                        <DynamicGridComponent
                            ...
                            availableQuantums={props.availableQuantums}
