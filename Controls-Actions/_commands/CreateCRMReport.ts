...
const reportTypeToConfigMap: Record<TReportType, string> = {
    PurchaseFunnel: 'CRMClientsList/Reports/purchaseFunnel:Config',
    DynamicOfActivities: 'CRMClientsList/Reports/activitiesDynamic:Config',
    PaymentsAndShipments: 'CRMClientsList/Reports/paymentAndShipment:Config',
    ManagerLeads: 'CRMClientsList/Reports/managerLeads:Config',
    ProcessingOfScheduled: 'CRMClientsList/Reports/processingPlanned:Config',
    ProcessingOfLeads: 'CRMClientsList/Reports/processingLeads:Config',
    LeadsDynamic: 'CRMClientsList/Reports/leadsDynamic:Config',
    SalesSources: 'CRMClientsList/Reports/salesSources:Config',
    ProcessingTask: 'CRMClientsList/Reports/processingTasks:Config',
    TaskDynamic: 'CRMClientsList/Reports/tasksDynamic:Config',
    ProcessingSpeedLeads: 'CRMClientsList/Reports/processingSpeedLeads:Config',
    ProcessingSpeedTasks: 'CRMClientsList/Reports/processingSpeedTasks:Config',
    OverdueLeads: 'CRMClientsList/Reports/overdueLeads:Config',
    OverdueTasks: 'CRMClientsList/Reports/overdueTasks:Config',
    LeadsInProgress: 'CRMClientsList/Reports/leadsInProgress:Config',
    ABCAnalysis:
                    ...
                    openDialog({
                        ...
                        eventHandlers: {
                            onResult: (items: RecordSet) => {
                                ...
                                reportFilters.РегламентИдентификатор = items.getCount() === 1 ? items.at(0).get('Идентификатор') : null;
