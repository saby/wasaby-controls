...
const actions: IActionConfig[] = [
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateTaskFactoryConfig',
            },
        ],
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateExpenseReportFactoryConfig',
            },
        ],
    ...
    },
    {
        ...
        info: {
            title: `${translate('Отправить письмо контрагенту в')} ${
                controller.currentLocaleConfig.ecosystem.name
            }`,
            category: translate('Документооборот и EDI', 'Виджет'),
            icon: 'icon-Mail',
        },
    ...
    {
        type: 'createPowerOfAttorney',
        info: {
            title: translate('Создать доверенность'),
            category: translate('Документооборот и EDI', 'Виджет'),
            icon: 'icon-Handshake',
        },
        commandName: 'Controls-Actions/commands:CreatePowerOfAttorney',
        rights: ['Доверенности', 'UB attorney'],
    },
    {
    ...
    },
    {
        type: 'upload',
        info: {
            title: translate('Загрузить'),
            category: translate('Документооборот и EDI', 'Виджет'),
            icon: 'icon-Attach',
        },
        commandName: 'Controls-Actions/commands:Upload',
        commandOptions: {},
        propTypes: [
            {
                name: 'item',
                type: 'object',
                editorTemplateName: 'Controls-Actions/commands:UploadChooserEditor',
                dataFactory: 'Controls-Actions/commands:UploadDataFactoryConfig',
            },
        ],
        //rights: [],
    },
    {
        type: 'openMonitoringDialog',
        info: {
            title: translate('Поставить документ на контроль'),
            category: translate('Документооборот и EDI', 'Виджет'),
            icon: 'icon-Show',
        },
        commandName: 'Controls-Actions/commands:OpenMonitoringDialog',
    },
    {
        type: 'selling',
        info: {
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateOutflowFactoryConfig',
            },
        ],
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateBillFactoryConfig',
            },
        ],
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateOrderFactoryConfig',
            },
        ],
        rights: ['Наряды'],
    },
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateClientFactoryConfig',
            },
        ],
        rights: ['Контрагенты'],
    },
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateEventFactoryConfig',
            },
            {
                name: 'planedEvent',
                type: 'boolean',
        ...
        propTypes: [
            {
                ...
                dataFactory: 'Controls-Actions/commands:CreateLeadFactoryConfig',
            },
        ],
        rights: ['leads'],
    },
    ...
    },
    {
        ...
        info: {
            title: `${translate('Открыть чат')} "${translate('Поддержка')} ${
                controller.currentLocaleConfig.ecosystem.name
            }"`,
    ...
    },
    {
        type: 'openFeedback',
        info: {
            title: translate('Обратная связь'),
            category: translate('Контакт-центр'),
            icon: 'icon-Lenta',
        },
        commandName: 'Controls-Actions/commands:OpenFeedback',
        propTypes: [
            {
                name: 'widget',
                type: 'object',
                editorTemplateName: 'Controls-Actions/commands:WidgetEditor',
                validators: ['Controls/validate:isRequired'],
            },
        ],
    },
    ...
    {
        type: 'createAddAgreement',
        info: {
            title: translate('Создать доп. соглашение'),
            category: translate('Кадровый ЭДО'),
            icon: 'icon-Checkreport',
        },
        commandName: 'Controls-Actions/commands:CreateCEDWDoc',
        commandOptions: { docType: 'CadresAgreement' },
        propTypes: [
            {
                name: 'regulation',
                type: 'string',
    ...
    {
        type: 'createEmployeeMiniCard',
        info: {
            title: translate('Создать пользователя'),
            category: translate('Аккаунт и расширения', 'Виджет'),
            icon: 'icon-Workers',
        },
        commandName: 'Controls-Actions/commands:CreateEmployeeMiniCard',
        rights: ['Сотрудники'],
    },
    {
    ...
    },
    {
        ...
        info: {
            title: translate('Исходящий платеж'),
            category: translate('Отчетность и бухгалтерия', 'Виджет'),
            icon: 'icon-Purchases',
        },
        commandName: 'Controls-Actions/commands:CreateOutgoingPayment',
        commandOptions: { docType: 'ИсходящийПлатеж', id: 'cca3f238-4166-11e3-905f-005056b70b39' },
        rights: ['Исходящие счета'],
    },
    {
        type: 'transport',
        info: {
            title: translate('Транспорт'),
            category: translate('Управление транспортом'),
            icon: 'icon-Truck',
        },
        commandName: 'Controls-Actions/commands:Transport',
        commandOptions: {},
        propTypes: [
            {
                name: 'item',
                type: 'object',
                dataFactory: 'Controls-Actions/commands:TransportFactoryConfig',
                editorTemplateName: 'Controls-Actions/commands:TransportEditor',
            },
        ],
        rights: [
            {
    ...
    },
    {
        ...
        commandName: 'Controls-Actions/commands:CreateDoc',
        commandOptions: {},
        propTypes: [
            {
                name: 'item',
                type: 'object',
                dataFactory: 'Controls-Actions/commands:CreateDocFactoryConfig',
                editorTemplateName: 'Controls-Actions/commands:DocEditor',
            },
        ],
        rights: [
            {
    ...
    },
    {
        ...
        info: {
            title: translate('Бронь'),
            category: translate('Отель'),
        },
        commandName: 'Controls-Actions/commands:CreateHotelEntity',
        commandOptions: {
            entityType: 'bookingDoc',
        },
        rights: ['Hotel Settings', 'Hotel Booking'],
    },
    {
        type: 'createHotelCategory',
        info: {
            title: translate('Категория номера'),
            category: translate('Отель'),
        },
        commandName: 'Controls-Actions/commands:CreateHotelEntity',
        commandOptions: {
            entityType: 'categoryRoom',
        },
        rights: ['Hotel Settings'],
    },
    {
        type: 'createHotelRoom',
        info: {
            title: translate('Номер'),
            category: translate('Отель'),
        },
        commandName: 'Controls-Actions/commands:CreateHotelEntity',
        commandOptions: {
    ...
    {
        type: 'createHotelRate',
        info: {
            title: translate('Тариф'),
            category: translate('Отель'),
        },
        commandName: 'Controls-Actions/commands:CreateHotelEntity',
        commandOptions: {
