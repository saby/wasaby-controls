...
const actions: IActionConfig[] = [
    ...
    },
    {
        ...
        commandName: 'Controls-Actions/commands:CreateSalary2NDFL',
        rights: [
            {
    ...
    },
    {
        ...
        commandOptions: {
            referenceType: 'SalaryRegisterNDFL',
        },
        rights: [
            {
                zone: 'Справки сотрудникам',
    ...
    },
    {
        ...
        commandName: 'Controls-Actions/commands:CreateSalaryReference',
        commandOptions: {
            referenceType: 'SalarySZVMExperience',
        },
        rights: [
            {
                zone: 'Справки сотрудникам',
    ...
    },
    {
        ...
        commandName: 'Controls-Actions/commands:CreateSTDR',
        rights: [
            {
                zone: 'Справки сотрудникам',
                requiredLevel: 'update',
    ...
    },
    {
        ...
        commandName: 'Controls-Actions/commands:CreateMVDReference',
        commandOptions: {
            docType: 'СправкиДляСотрудников',
            docSubType: 'УВЕДОЗАКТРУДДОГИНГР',
        },
        rights: [
            {
                zone: 'Справки сотрудникам',
    ...
    },
    {
        ...
        commandOptions: {
            docType: 'СправкиДляСотрудников',
            docSubType: 'УВЕДОРАСТРУДДОГИНГР',
        },
        rights: [
            {
                zone: 'Справки сотрудникам',
