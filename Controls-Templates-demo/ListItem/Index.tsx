...
export default class Index extends React.Component {
    ...
    render(): JSX.Element {
        return (
            <div ref={ this.props.forwardedRef } className={'controlsDemo__wrapper controlsDemo__maxWidth800'}>
                <ListItem
                    {...this._commonItemsProps}
                    markerVisible={true}
                    caption={
                        'ListItem принимает в качестве caption строку, или ReactNode.'
                    }
                />
                <ListItem
                    {...this._commonItemsProps}
                ...
                <ListItem
                    ...
                    captionFontSize={'xl'}
                    caption={
                        <div>А еще можно выравнивать, и стилизовать текст</div>
                    }
                />
            </div>
        );
