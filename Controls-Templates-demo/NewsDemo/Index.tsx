                ...
                <div className={'controlsDemo__wrapper controlsDemo__flexRow '}>
                    <HorizontalItem
                        ...
                        caption={
                            <div>
                                ...
                                >
                                    Хорошее отношение к работе, старание и
                                    упорство
                                </span>
                                <span
                                    className={
                        ...
                        header={
                            ...
                            >
                                <span
                                    className={
                                        'controls-fontsize-xs controls-text-unaccented'
                                    }
                                >
                                    Уваров С. Правление
                                </span>
                    ...
                    <VerticalItem
                        ...
                        description={
                            <div>
                                <span>
                                    Текст новости с коллажом, размещенном в
                                    области описания
                                </span>
                                <div
                                    className={
                                ...
                                >
                                    <img
                                        className={
                                            'Controls-Templates-demo__news_collage-photo'
                                        }
                    ...
                    <HorizontalItem
                        ...
                        header={
                            ...
                            >
                                ...
                                >
                                    Длинное название группы, опубликовавшей эту
                                    новость
                                </span>
                                <span
                                    className={
