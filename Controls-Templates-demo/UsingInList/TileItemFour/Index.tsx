...
import { MENU_BUTTON_KEY, TItemActionShowType } from 'Controls/itemActions';
...
function Demo(props: TInternalProps, ref: React.ForwardedRef<HTMLDivElement>): React.ReactElement {
    // Скрываем принудительно кнопку меню
    const itemActionVisibilityCallback = React.useCallback((action: IItemAction, item: Model) => {
