    ...
    render(): JSX.Element {
        return (
            <div className={'controlsDemo__wrapper controlsDemo__flexColumn'}>
                ...
                <div
                    className={
                        'Application-maison controlsDemo__wrapper controlsDemo__flexRow'
                    }
                >
                    <div
                        className={'Controls-Templates-demo_certificate_group'}
                    >
                        <BackgroundItem
                            cursor={'pointer'}
                            className={
                                'Controls-Templates-demo_certificate first'
                            }
                            imageSrc={Images.MILI}
                            imageClass={
                                'Controls-Templates-demo_certificate_image'
                            }
                            overlayDirection={'to-top'}
                            caption={'Сертификат на 1000'}
                            captionClass={
                                'Controls-Templates-demo_certificate_caption'
                            }
                        ...
                        <BackgroundItem
                            cursor={'pointer'}
                            className={
                                'Controls-Templates-demo_certificate second shifted'
                            }
                            imageSrc={Images.MILI}
                            imageClass={
                                'Controls-Templates-demo_certificate_image'
                        ...
                        <BackgroundItem
                            cursor={'pointer'}
                            className={
                                'Controls-Templates-demo_certificate third shifted'
                            }
                            imageSrc={Images.MILI}
                            imageClass={
                                'Controls-Templates-demo_certificate_image'
                ...
                <div className={'controlsDemo__wrapper controlsDemo__flexRow'}>
                    <BackgroundItem
                        ...
                        imageSrc={Images.KLUKVA}
                        overlayDirection={'to-top'}
                        caption={
                            <div
                                className={
                                    'ws-flexbox ws-flex-column ws-align-items-center'
                                }
                            >
