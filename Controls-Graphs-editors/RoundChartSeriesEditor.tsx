...
/**
 * Редактор измерений круговой диаграммы
 */
const RoundChartSeriesEditor = React.memo((props: IRoundChartSeriesEditorProps) => {
    const {
        connectedPropName,
...
RoundChartSeriesEditor.displayName = 'Controls-Graphs-editors/SeriesEditor:SeriesEditor';
