...
export const TButtonStyleType = StringType.id('Controls/meta:TFontColorStyleType')
    ...
    .editor(createEditorLoader('Controls-Buttons-editors/StyleEditor:StyleEditor', getDataToRender));
...
export const IButtonStyleType = ObjectType.id('Controls/meta:IButtonStyleType')
    ...
    .editor(createEditorLoader('Controls-Buttons-editors/StyleObjectEditor:StyleObjectEditor', getDataToRender));
