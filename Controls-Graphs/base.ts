...
export { default as IValueProperty } from './_base/interfaces/IValueProperty';
...
export { default as IId } from './_base/interfaces/IId';
export { default as IColorProperty } from './_base/interfaces/IColorProperty';
