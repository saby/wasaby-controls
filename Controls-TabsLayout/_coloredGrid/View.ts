...
/**
 * Табличная обертка над {@link /docs/js/Controls-TabsLayout/colored/View Controls-TabsLayout/colored:View}
 * @remark
 * Предназначена для упрощения взаимодействия с Controls-TabsLayout/colored:View в раскладках списка и его окружения:
 * <ol>
 *     <li>{@link /docs/js/Layout/browsers/Browser/ Layout/browsers/Browser}.</li>
 *     <li>{@link /docs/js/Layout/Selector/Browser/ Layout/Selector/Browser}.</li>
 * </ol>
 *
...
export default class View extends Control<IColoredTabsGridOptions> {
    ...
    protected _children: {
        coloredGrid: ColoredTabsGrid;
    };

    updateItem(item: Model): void {
        this._children.coloredGrid.updateItem(item);
    }
}
