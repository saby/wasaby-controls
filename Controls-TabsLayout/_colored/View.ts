 ...
 * Демо пример можно посмотреть {@link TabsLayout/coloredGrid:View тут}.
 *
 * @class TabsLayout/_colored/View
 * @extends UI/Base:Control
 * @control
 * @public
 * @mixes Controls/interface:ISingleSelectable
 * @implements TabsLayout/_colored/IColoredOptions
 * @demo Engine-demo/TabsLayout/colored/BaseView/Default/Index
 *
 */
