            ...
            {props.items.map((item, index) => {
                ...
                return (
                    <div
                        ...
                        data-qa="ColoredTabsHorizontal__item-container"
                        style={{
                            left: `${position}px`,
                    ...
                    >
                        ...
                        <div
                            className={`ColoredTabsHorizontal__content ${
                                index === props.items.length - 1
                                    ? 'ColoredTabsHorizontal__content__lastItem'
                                    : ''
                            } controls-ColoredTabs__border-${item.backgroundStyle}`}
                            data-qa={'ColoredTabs__item-content'}
                        >
                            <ScrollContainer
                            ...
                            >
                                <item.itemTemplate className="controls-ColoredTabs__custom-content" />
                            </ScrollContainer>
                        </div>
                    </div>
                );
