 ...
 * {@link https://wi.sbis.ru/docs/js/Controls-TabsLayout/colored/IColoredOptions/options/headTemplate headTemplate}.
 * Пример использования смотрите {@link https://wi.sbis.ru/docs/js/Controls-TabsLayout/colored/IColoredOptions/options/headTemplate здесь}.
 ...
 * {@link https://wi.sbis.ru/docs/js/Controls-TabsLayout/colored/IColoredOptions/typedefs/ItemTab headTemplate}, заданный на item'е, имеет приоритет выше.
