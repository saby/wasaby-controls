...
export interface IColoredOptions {
    ...
    headTemplate?: React.Component | React.FunctionComponent | TemplateFunction;
...
export interface IItemTab {
    key: string;
    title?: string;
    itemTemplate?: React.Component | React.FunctionComponent | TemplateFunction;
    headTemplate?: React.Component | React.FunctionComponent | TemplateFunction;
...
/**
 * @typedef {Object} Controls-TabsLayout/_colored/IColoredOptions/ItemTab
 * @variant key Ключ, уникально идентифицирующий элемент коллекции.
 * @variant title Заголовок вкладки.
 * @variant backgroundStyle Стиль {@link /docs/js/Controls/interface/IFontColorStyle/options/fontColorStyle/ цвета} вкладки.
 ...
 * {@link /docs/js/Controls-TabsLayout/colored/IColoredOptions/options/headTemplate headTemplate}.
 * Пример использования смотрите {@link /docs/js/Controls-TabsLayout/colored/IColoredOptions/options/headTemplate здесь}.
 * @variant headTemplateOptions Опции для заголовка вкладки.
 */

/**
 * @name Controls-TabsLayout/_colored/IColoredOptions#items
 * @cfg {Array.<Controls-TabsLayout/_colored/IColoredOptions/ItemTab.typedef>} Массив элементов.
 * @example
 ...
 * {@link /docs/js/Controls-TabsLayout/colored/IColoredOptions/typedefs/ItemTab headTemplate}, заданный на item'е, имеет приоритет выше.
