 ...
 * Применяется с шаблоном TabsLayout/colored:HeadCounter для
...
/**
 * @name TabsLayout/_colored/IColoredOptions#items
 * @cfg {Array.<ItemTab>} Массив элементов.
 * @example
 * TabsLayout.colored:View/BaseView с четырьмя вкладками:
 * <pre>
 ...
 */
/**
 * @name TabsLayout/_colored/IColoredOptions#headerContentTemplate
 * @cfg {content|string} Контент располагающийся слева от вкладок.
 * @demo Engine-demo/TabsLayout/colored/BaseView/HeaderContentTemplate/Index
 * @example
 * <pre>
 *   <TabsLayout.colored:View
 *       class="controlsDemo__height500"
...
/**
 * @name TabsLayout/_colored/IColoredOptions#backgroundFill
...
/**
 * @name TabsLayout/_colored/IColoredOptions#propStorageId
 * @cfg {String} Уникальный идентификатор, по которому будут сохраняться текущая выбранная вкладка.
 */

/**
 * @name TabsLayout/_colored/IColoredOptions#headTemplate
...
/**
 * @name TabsLayout/_colored/IColoredOptions/typedefs/ItemTab#headTemplate
...
/**
 * @name TabsLayout/_colored/IColoredOptions#maxHeaderWidth
