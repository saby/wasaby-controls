 ...
 * @property {String} [item.buttonIcon] Определяет иконку для кнопки вкладки.
 * @property {Function(MouseEvent)} [item.buttonClickHandler] Обработчик нажатия на кнопку.
 * @property {String} [item.icon] Определяет иконку для вкладки.
 * @property {String} [item.iconStyle] Определяет стиль отображения иконки.
 *
 */

/**
 * @name Controls-TabsLayout/_verticalTabs/IVerticalTabs#items
 * @cfg {RecordSet.<Controls-TabsLayout/verticalTabs:IVerticalTabs.Item.typedef>} Рекордсет с конфигурацией вкладок.
