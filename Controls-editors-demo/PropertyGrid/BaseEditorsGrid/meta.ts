...
const BaseEditorsAttrsDefaults: ObjectMetaProperties<IBaseEditorsOptions> = {
    ...group('Время', {
...
const BaseEditorsAttrsRequired: ObjectMetaProperties<IBaseEditorsOptions> = Object.keys(
    ...
    {} as ObjectMetaProperties<IBaseEditorsOptions>
);

// Делаем все атрибуты меты опциональными
const BaseEditorsAttrsOptional: ObjectMetaProperties<IBaseEditorsOptions> = Object.keys(
