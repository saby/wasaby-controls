...
export default forwardRef(
    (_: unknown, ref: LegacyRef<HTMLDivElement>): ReactElement => {
        ...
        const actionClickHandler = useCallback((_: Event, item: Model<{keys: string[]}>) => {
            helper.open({
                        templateOptions: {
        ...
        return (
            <div className="tw-flex tw-justify-center"
                 ref={ref}
            >
                <div className="tw-flex tw-justify-baseline controls-cursor_pointer Controls-Colors-demo_border
