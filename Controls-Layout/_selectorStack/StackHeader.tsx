        ...
        return (
            <div
                ...
                className={`controls-Layout-SelectorStack__header 
                    ${!checkboxVisible ? 'controls-padding_left-xl' : ''} 
                    controls-padding_right-m`}
            >
                {checkboxVisible && <MultiSelectorCheckbox storeId={tabConfig.storeId} />}
                {tabConfig.caption && (
                    <Title
                        className={'ws-ellipsis controls-margin_left-3xs'}
                ...
                <div
                    className={
                        'controls-Layout-SelectorStack__header__rightTemplate controls-margin_left-m'
                    }
                >
                    {checkboxVisible && !!listSlice.state.selectedKeys.length && (
