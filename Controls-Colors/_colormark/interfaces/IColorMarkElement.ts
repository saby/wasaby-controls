 ...
 * @public
 */
export interface IColorMarkElement extends ITooltip, IPartialSelected {
    /**
    ...
    editable?: boolean;
    /**
     * @name Controls-Colors/_colormark/interfaces/IColorMarkElement#editableStyle
    ...
    /**
     * @name Controls-Colors/_colormark/interfaces/IColorMarkElement#disabled
     * @cfg {Boolean} Возможность выбирать и редактировать.
     * @demo Controls-Colors-demo/Panel/ColormarkOpener/Index
     * @remark Запретим возможность выбора и редактирования четвёртой записи в списке.
     */
    disabled?: boolean;
}
