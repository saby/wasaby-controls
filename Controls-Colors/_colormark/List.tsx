        ...
        <EditingContext.Provider value={isEditing}>
            ...
            >
                <ItemsView
                    ...
                    itemActionsClass={'Colormark__List_itemActionsPosition Colormark__List_itemActionsPosition' +
                                      (props.isAdaptive ? '_adaptive' : '_default')}
...
function EditorTemplate({
    ...
    const inputValueChangeHandler = useCallback((_, value) => item.set('caption', value), []);
    return (
        <EditingTemplate
            {...editingTemplateProps}
            ...
            editorTemplate={useCallback(() => {
                ...
                return (
                    ...
                    >
                        <div
                            className={
                                'Colormark__List_editorTemplate_wrapper tw-flex tw-items-center' +
                ...
                <>
                    ...
                    <span
                        className={
                            ...
                            (isExcluded || (isEditing && !editingTemplateProps.item.isEditing())
                                ? 'readonly'
                                : 'default')
                        }
...
function EditingTemplateList({ contentTemplateProps, palette, excludedKeys, excludable }) {
...
function ItemTemplateList({ itemTemplateProps, palette, excludedKeys, excludable }) {
