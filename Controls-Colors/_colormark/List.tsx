...
export default memo((props: IListOptions): ReactElement => {
    ...
    const checkboxClickHandler = useCallback((key: unknown) => {
        ...
        <EditingContext.Provider value={isEditing}>
            ...
            >
                <ItemsView
                    ...
                    multiSelectTemplate={(multiSelectTemplateContentProps: object) => {
                        if (multiSelectTemplateContentProps.item.contents.get('disabled')) {
                            return null;
                        }
                        let value = false;
                        if (multiSelectTemplateContentProps.item.isSelected()) {
                            if (
                                multiSelectTemplateContentProps.item.contents.get('partialSelected')
                            ) {
                                value = null;
                            } else {
                                value = true;
                        ...
                        return (
                            <MultiSelectTemplate
                                {...multiSelectTemplateContentProps}
                                value={value}
                            />
                        );
                    }}
