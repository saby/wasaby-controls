    ...
    const openSelector = React.useCallback(() => {
        ...
        stickyOpener.open({
            ...
            templateOptions: {
                ...
                multiSelect: true,
                adding: false,
                isAdaptive: props.isAdaptive || detection.isMobilePlatform,
            },
    ...
    return (
        ...
        >
            ...
            <div className="ColormarkFilter__Editor-itemsView tw-flex tw-flex-wrap tw-w-full">
                ...
                {excluded.length && props.items?.length ? (
...
/**
 * @name Controls-Colors/colormarkFilter:Editor#items
...
/**
 * @name Controls-Colors/colormarkFilter:Editor#palette
