...
export const ITimeLimitOptionsType = ObjectType.id(
    'Controls-Input-meta/dateRangeConnected:ILabelOptionsType'
)
    .attributes({
        limit: ObjectType.title(translate('Лимит'))
            ...
            .editor('Controls-editors/properties:LimitTimeEditor',
