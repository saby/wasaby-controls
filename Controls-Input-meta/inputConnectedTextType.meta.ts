import { ArrayType, BooleanType, extended, group, WidgetType } from 'Meta/types';
import {
    FieldTypes,
...
const supportedTypes = [FieldTypes.Text, FieldTypes.String, FieldTypes.Email, FieldTypes.Link];
