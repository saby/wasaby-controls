...
import {
    ...
    TCheckboxGroupVariantsType,
    TCheckboxOrientationType,
...
const CheckboxGroupConnectedTypeMeta = WidgetType.id('Controls-Input/CheckboxGroupConnected')
    ...
    .icon('icon-Check2')
    .properties<ICheckBoxGroupProps>({
        name: INameOptionsType.order(0)
            .editorProps({ fieldType: [FieldTypes.Flags, FieldTypes.Array] })
            .required(),
        ...TCheckboxOrientationType.properties(),
        ...ILabelOptionsType.properties(),
        ...group(null, {
            ...TCheckboxGroupVariantsType.properties(),
        }),
        ...group('', {
