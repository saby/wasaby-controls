...
const id = 'Controls-Input/decoratorConnectedDesignTime:Number';

/**
 * Мета-описание типа редактора {@link Controls-Input/decoratorConnectedDesignTime:Number Number}
 */
