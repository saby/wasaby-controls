            ...
            <div className="tw-flex">
                ...
                >
                    <ScrollContainer
                        ...
                        className={'tw-w-full controlsDemo__height500'}
                    >
                        <TimelineGridConnectedComponent
                            ...
                            limitRangeIfFits={true}
                            dynamicColumnMaxWidths={dynamicColumnMaxWidths}
                            getEventRenderProps={getEventRenderProps}
                            hoverMode={'cell'}
                            columnsSpacing={'null'}
                            shouldStretchGridContainer={true}
                            timeMarkerLineStyle={{ height: 250 }}
