...
import { updateWorkIntersections } from 'Controls-Lists-demo/timelineGrid/Sources/generateEventsData';
import { default as generateDynamicColumnsData } from 'Controls-Lists-demo/timelineGrid/Sources/generateDynamicColumnsData';
import {
    STAFF,
    STAFF_STRUCTURE,
} from 'Controls-Lists-demo/timelineGrid/Integration/Sources/Data/Data';
import generateEvents from 'Controls-Lists-demo/timelineGrid/Integration/TimelineLayers/generateEvents';
...
export default class ExtMemory extends Memory {
    ...
    query(query: Query): Promise<DataSet> {
        ...
        STAFF.forEach((item) => {
            ...
            const eventsData = generateEvents(result.getAdapter(), columnsFilter, item.key);
