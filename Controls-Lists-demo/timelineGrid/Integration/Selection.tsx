...
import ExtMemory from './Sources/Data/ExtMemory';
import DemoStaticColumnComponent from './Sources/Components/StaticColumnComponent';
import DemoDynamicColumnComponent from './Sources/Components/DynamicColumnComponent';
    ...
    return {
        ...
        getCellProps: (item: Model, date: Date) => {
            return {
                ...
                topLeftBorderRadius: 's',
                topRightBorderRadius: 's',
                bottomRightBorderRadius: 's',
                bottomLeftBorderRadius: 's',
                borderStyle: 'cadetBlue',
