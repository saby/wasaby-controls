...
import { isWeekend, shiftDate } from 'Controls-Lists-demo/timelineGrid/WI/Base/utils/common';
...
export default function generateHolidaysCalendar(startDate: Date) {
...
export function generateMetaData(resultRecordSet: RecordSet, query: Query) {
