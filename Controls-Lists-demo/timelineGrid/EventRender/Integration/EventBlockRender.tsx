...
function EventBlock(
    ...
    return (
        ...
        <>
            <div className="Controls-lists-demo__TimelineGrid_EventRender_title">{props.title}</div>
            <div
                className={
            ...
            <TimelineDataContext.Provider value={timelineDataContextValue}>
                <div className="tw-flex">
                    ...
                    <div className="controls-padding_left-s controls-padding_right-s">
                        ...
                        <EventBlock {...baseConfig} valign={'start'} title={'valign=start'} />
                        <EventBlock {...baseConfig} valign={'baseline'} title={'valign=baseline'} />
                        <EventBlock {...baseConfig} valign={'center'} title={'valign=center'} />
                        <EventBlock {...baseConfig} valign={'end'} title={'valign=end'} />
                    </div>
                    ...
                    <div className="controls-padding_left-s controls-padding_right-s">
                        ...
                        <EventBlock
                            {...baseConfig}
                            leftBevel={'bottom'}
                            title={'leftBevel=bottom'}
                        />
                        <EventBlock
                            {...baseConfig}
                            rightBevel={'bottom'}
                            title={'rightBevel=bottom'}
                        />
