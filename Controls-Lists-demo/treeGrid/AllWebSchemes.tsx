        ...
        <div ref={ref}>
            <div className="tw-flex tw-justify-between">
                ...
                >
                    ...
                    {/*@ts-ignore*/}
                    <View
                        storeId={STORE_ID_OLD_LIST}
                        data-qa="Controls-Lists-demo_treeGrid_AllWebSchemes__old"
                    />
                </div>
                <div
                    style={{
                ...
                >
                    ...
                    {/*@ts-ignore*/}
                    <View
                        storeId={STORE_ID_OLD_LIST_WITH_COLLECTION}
                        data-qa="Controls-Lists-demo_treeGrid_AllWebSchemes__old-with-collection"
                    />
                </div>
                <div
                    style={{
                ...
                >
                    ...
                    <Component
                        ...
                        data-qa="Controls-Lists-demo_treeGrid_AllWebSchemes__new"
                    />
                </div>
            </div>
            ...
            <div className="tw-flex tw-justify-between">
                ...
                >
                    ...
                    <View
                        ...
                        data-qa="Controls-Lists-demo_treeGrid_AllWebSchemes__old-without-slice"
                    />
                </div>
                <div
                    style={{
