...
import { Component, ITreeGridComponentAPI } from 'Controls-Lists/treeGrid';
...
const Simple = React.memo(
    React.forwardRef(function Simple(
        ...
        const treeGridRef = React.useRef<ITreeGridComponentAPI>();

        return (
            <div ref={ref} className="controls-padding-m">
                <Component storeId={STORE_ID} ref={treeGridRef} />
            </div>
        );
    })
);
