...
import { IDataConfig } from 'Controls-Lists/dataFactory';
                ...
                <>
                    ...
                    <DemoBlock title="TreeGrid [connected]">
                        <ScrollContainer className="ControlsListsDemo-maxHeight-200">
                            <Component
                                ...
                                onItemClick={(item) => {
                                    const key = loadSync<
                                        typeof import('Controls/listsCommonLogic')
                                    >('Controls/listsCommonLogic').UILogic.Common.getKey(item);
                                    addToLog(`onItemClick(${key})`);
                                }}
                            />
                        </ScrollContainer>
                    </DemoBlock>
                    <DemoBlock title="log">
                        <div>
                            ...
                            <div
                                className="tw-overflow-y-auto ControlsListsDemo-maxHeight-200"
                                data-qa={'Controls-Lists-demo_treeGrid_ActualDevelopmentState__log'}
                            >
