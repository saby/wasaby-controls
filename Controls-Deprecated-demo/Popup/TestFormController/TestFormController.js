/**
 */
define('Controls-Deprecated-demo/Popup/TestFormController/TestFormController', [
   'Lib/Control/CompoundControl/CompoundControl',
   'wml!Controls-Deprecated-demo/Popup/TestFormController/TestFormController',
   'Types/source',
   'Controls-Deprecated-demo/Popup/TestFormController/FormController'
      ...
      init: function () {
         ...
         ListView1.subscribe('onItemClick', function (event, id, data) {
            myDialogAction_1.execute({
               ...
               template: 'Controls-Deprecated-demo/Popup/TestFormController/FormController',
               dialogOptions: {
