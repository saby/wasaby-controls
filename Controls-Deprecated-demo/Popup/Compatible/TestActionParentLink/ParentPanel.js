define('Controls-Deprecated-demo/Popup/Compatible/TestActionParentLink/ParentPanel', [
   'Lib/Control/CompoundControl/CompoundControl',
   'wml!Controls-Deprecated-demo/Popup/Compatible/TestActionParentLink/ParentPanel'
            ...
            requirejs(['SBIS3.CONTROLS/Action/OpenDialog'], function (OpenDialog) {
               if (!self._action) {
                  self._action = new OpenDialog({
                     mode: 'floatArea',
                     template: 'Controls-Deprecated-demo/Popup/Compatible/TestActionParentLink/ChildPanel'
                  });
               }
