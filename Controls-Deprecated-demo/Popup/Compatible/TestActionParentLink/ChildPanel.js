define('Controls-Deprecated-demo/Popup/Compatible/TestActionParentLink/ChildPanel', [
   'Lib/Control/CompoundControl/CompoundControl',
   'wml!Controls-Deprecated-demo/Popup/Compatible/TestActionParentLink/ChildPanel',
   'Env/Env'
   ...
   var ChildPanel = CompoundControl.extend({
      ...
      _runChildLinkTest: function (resultContainer) {
         var parentButtonContainer = document.querySelector('.startActionButton'),
            parentButton = parentButtonContainer.wsControl,
            childButton = this.getChildControlByName('actionLinkChildButton'),
            hasChildLink =
               parentButton.getChildControlByName('actionLinkChildButton') === childButton;
