define('Controls-Deprecated-demo/Popup/Compatible/TestStack', [
   'Lib/Control/CompoundControl/CompoundControl',
   'wml!Controls-Deprecated-demo/Popup/Compatible/TestStack'
   ...
   var TestStack = CompoundControl.extend({
      ...
      init: function () {
         ...
         this._onAfterVisibilityChange = this._onAfterVisibilityChange.bind(this);

         compoundArea.subscribe('onAfterVisibilityChange', this._onAfterVisibilityChange);
      ...
      destroy: function () {
         var compoundArea = this.getParent();
         compoundArea.unsubscribe('onAfterVisibilityChange', this._onAfterVisibilityChange);
