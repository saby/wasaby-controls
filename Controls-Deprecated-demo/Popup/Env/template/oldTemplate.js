 ...
 */
define('Controls-Deprecated-demo/Popup/Env/template/oldTemplate', [
   'Lib/Control/CompoundControl/CompoundControl',
   'wml!Controls-Deprecated-demo/Popup/Env/template/oldTemplate'
], function (CompoundControl, template) {
   var oldTemplate = CompoundControl.extend({
      _dotTplFn: template,
      init: function () {
