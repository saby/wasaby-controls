define('Controls-Deprecated-demo/Popup/resources/SimpleListEditDialog', [
   // Подключаем базовый класс для наследования диалога редактирования
   'SBIS3.CONTROLS/FormController',
   'wml!Controls-Deprecated-demo/Popup/resources/SimpleListEditDialog/SimpleListEditDialog',
   'Types/source',
   ...
   moduleClass._styles = [
      'Controls-Deprecated-demo/Popup/resources/SimpleListEditDialog/SimpleListEditDialog'
   ];
