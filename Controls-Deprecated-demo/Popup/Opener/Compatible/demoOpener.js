define('Controls-Deprecated-demo/Popup/Opener/Compatible/demoOpener', [
   'UI/Base',
   'tmpl!Controls-Deprecated-demo/Popup/Opener/Compatible/demoOpener',
   'require',
   'Types/source'
   ...
   var TestOpener = Base.Control.extend({
      ...
      _beforeMount: function () {
         this._verticalItems = [{ title: 'top' }, { title: 'bottom' }];
         this._sideItems = [{ title: 'left' }, { title: 'right' }];
            ...
            CompatiblePopup.load().addCallback(function () {
               ...
               requirejs(['SBIS3.CONTROLS/Action/List/OpenEditDialog'], function (OpenDialog) {
                  self._action = new OpenDialog({
                     template: 'Controls-Deprecated-demo/Popup/Opener/Compatible/resources/demoOldPanel',
                     mode: 'floatArea'
                  });
         ...
         requirejs(['Lib/Control/LayerCompatible/LayerCompatible'], function (CompatiblePopup) {
            CompatiblePopup.load().addCallback(function () {
               ...
               requirejs(['SBIS3.CONTROLS/Action/List/OpenEditDialog'], function (OpenDialog) {
                  self._action = new OpenDialog({
                     mode: 'floatArea',
                     template: 'Controls-Deprecated-demo/Popup/Opener/Compatible/resources/dimensionOldPanel'
                  });
                  var dialogOptions = {
                     handlers: self.setHandlers(self),
                     border: self._border,
   ...
   TestOpener._styles = ['Controls-Deprecated-demo/Popup/Opener/Compatible/demoOpener'];
