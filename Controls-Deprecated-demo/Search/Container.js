 ...
 */
define('Controls-Deprecated-demo/Search/Container', [
   'UI/Base',
   'wml!Controls-Deprecated-demo/Search/Container',
   'Types/source',
   ...
   SearchContainer._styles = ['Controls-Deprecated-demo/Search/Container'];
