...
import { ISelectedStyleOptionsType } from './_interface/ISelectedStyleOptionsType';
import { IAlignOptionsType } from './_interface/IAlignOptionsType';
...
const TabsType = WidgetType.id('Controls-Containers/Tabs')
    ...
    .components(['9a751d1b-b5fc-4240-8673-f7e4c98b6176'])
    .description(
    ...
    .properties<Required<Omit<ITabsProps, '.style' | keyof IComponentProps>>>({
        ...group('Tabs', '', {
        ...
        ...group('Properties', '', {
            ...ISelectedStyleOptionsType.properties(),
            ...IAlignOptionsType.properties(),
        }),
    })
    .appendStyles({
