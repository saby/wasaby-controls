        ...
        <div className="tw-flex ws-flex-column ws-align-items-center" data-qa="controlsDemo_capture">
            <div data-qa="controlsDemo_Buttons__capture"
                ...
                <div className="controls-margin_right-m">
                    <Button caption="Аннулирование" fontColorStyle="secondary" data-qa="Controls-demo_BeautifulButtons__secondary"/>
                </div>
                <div>
                    <Button caption="Аннулирование" fontColorStyle="unaccented" data-qa="Controls-demo_BeautifulButtons__unaccented"/>
                </div>
            </div>
        </div>
    </div>;
