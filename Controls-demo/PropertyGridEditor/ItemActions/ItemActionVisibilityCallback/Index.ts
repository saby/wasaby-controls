...
import * as template from 'wml!Controls-demo/PropertyGridEditor/ItemActions/ItemActionVisibilityCallback/Index';
...
export default class Demo extends Control<IControlOptions> {
    ...
    protected _itemActions: IItemAction[] = [
        {
            ...
            handler: (item) => {
                return this._openConfirmation(
                    `Edit clicked at ${item.getId()}`
                );
            },
        },
        {
        ...
        },
        {
            ...
            handler: (item) => {
                return this._openConfirmation(
                    `First editor clicked at ${item.getId()}`
                );
            },
        },
    ];
    ...
    protected _itemActionVisibilityCallback(
        ...
        return itemAction.title === 'itemAction для первого редактора'
            ? key === 'number'
            : true;
    }
