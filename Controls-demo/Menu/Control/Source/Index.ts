...
class Source extends Control {
    ...
    private _selectorTemplate: IStackPopupOptions;
    ...
    protected _beforeMount(): void {
        ...
        this._selectorTemplate = {
            template: 'Controls-demo/Menu/Control/Source/resources/StackTemplate',
            templateOptions: {
                items: this._itemsMore,
            },
        };
    }
    ...
    _moreButtonClick(): void {
        loadAsync('Controls/lookup').then(({ showSelector }) => {
            showSelector(this, this._selectorTemplate, this._options.multiSelect);
        });
    }
}
