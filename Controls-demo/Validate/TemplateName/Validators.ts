...
function isCustomTemplate(args: IArgs): IValidator | boolean {
    ...
    if (typeof result !== 'boolean') {
        return {
            templateName: 'wml!Controls-demo/Validate/TemplateName/resources/TemplateName',
        };
    }
    return result;
}
...
function isCustomTemplateOptions(args: IArgs): IValidator | boolean {
    ...
    if (typeof result !== 'boolean') {
        return {
            templateName: 'wml!Controls-demo/Validate/TemplateName/resources/TemplateOptions',
            templateOptions: {
