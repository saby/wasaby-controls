...
export default class Source extends HierarchicalMemory {
    _moduleName: string = 'Controls-demo/treeGridNew/ReloadItem/Source';
    ...
    query(query?: Query): Promise<DataSet> {
        let parents: number[] = (query.getWhere() as { parent: number[] }).parent;
