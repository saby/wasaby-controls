...
import ExpanderIconEmptyNode from 'Controls-demo/treeGridNew/Expander/ExpanderIcon/EmptyNode/Index';
import ExpanderIconHiddenNode from 'Controls-demo/treeGridNew/Expander/ExpanderIcon/HiddenNode/Index';
import ExpanderIcon from 'Controls-demo/treeGridNew/Expander/ExpanderIcon/Index';
import ExpanderIconNode from 'Controls-demo/treeGridNew/Expander/ExpanderIcon/Node/Index';
import ExpanderIconNone from 'Controls-demo/treeGridNew/Expander/ExpanderIcon/None/Index';
...
export default class extends Control {
    ...
    static getLoadConfig(): Record<string, IDataConfig<IListDataFactoryArguments>> {
        return {
            ...ExpanderIconEmptyNode.getLoadConfig(),
            ...ExpanderIconHiddenNode.getLoadConfig(),
            ...ExpanderIcon.getLoadConfig(),
