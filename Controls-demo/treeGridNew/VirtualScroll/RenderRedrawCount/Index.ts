...
export default class RenderRedrawDemo extends Control {
    ...
    protected _beforeMount(): void {
        ...
        this._debouncedRedrawCounters = debounce(
            this._redrawCounters,
            COUNTERS_REQUERY_DELAY
        );
    }
        ...
        const counters = model
            ...
            .map((item, index): IRedrawCounter => {
                const oldColumnCount =
                    this._counters[viewName][index] &&
                    this._counters[viewName][index].columnCount;
        ...
        if (
            ...
            this._counters = {
                gridView:
                    viewName === 'gridView'
                        ? counters
                        : this._counters.gridView,
                treeGridView:
                    viewName === 'treeGridView'
                        ? counters
                        : this._counters.treeGridView,
            };
        }
    }
