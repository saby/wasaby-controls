...
export default class extends Control {
    ...
    private _bindCallbacks(): void {
        this._nodeFooterVisibilityCallback =
            this._getNodeFooterVisibilityCallback(
                this._isNodeFooterVisible
            ).bind(this);
        this._itemActionVisibilityCallback =
            this._getItemActionsVisibilityCallback(
                this._isItemActionVisible
            ).bind(this);
    }

    private _getNodeFooterVisibilityCallback(
        visible: boolean
    ): (contents?: Model) => boolean {
    ...
    private _getItemActionsVisibilityCallback(
        visible: boolean
    ): TItemActionVisibilityCallback {
        const returningTrue = (
            action: IItemAction,
