...
import { ItemsView as ListView, ItemTemplate as ListItemTemplate } from 'Controls/list';
import { ItemsView as GridView, ItemTemplate as GridItemTemplate } from 'Controls/grid';
import { ItemsView as TreeGridView, ItemTemplate as TreeGridItemTemplate } from 'Controls/treeGrid';
import { ItemsView as TreeView, ItemTemplate as TreeItemTemplate } from 'Controls/tree';
import { ItemsView as TileView, ItemTemplate as TileItemTemplate } from 'Controls/tile';
import { ItemsView as ColumnsView, ItemTemplate as ColumnsItemTemplate } from 'Controls/columns';
...
let MODE_INDEX = 0;
export default React.forwardRef(function MarkerClassName(props, ref): JSX.Element {
