...
// импорт, чтобы указанный в свойстве записи шаблон отрендерился
import 'wml!Controls-demo/list_new/ColumnsView/TemplateProperty/ItemTemplate';
...
function getData(): IData[] {
    return generateData<IData>({
        ...
        beforeCreateItemCallback: (item) => {
            ...
            item.itemTemplate =
                'wml!Controls-demo/list_new/ColumnsView/TemplateProperty/ItemTemplate';
        },
    });
}
