...
export default class RenderDemo extends Control {
    ...
    protected _dragEnterMaster(
        _: SyntheticEvent,
        entity: ItemsEntity
    ): boolean {
        return cInstance.instanceOfModule(
            entity,
            'Controls/dragnDrop:ListItems'
        );
    }
    ...
    protected _dragEndMaster(
        ...
        if (entity.getOptions().detail) {
            ...
            this._children.masterList
                .moveItems(selection, target.getKey(), position)
                .then(() => {
