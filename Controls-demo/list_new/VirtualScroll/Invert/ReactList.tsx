...
import type { INavigationOptionValue, INavigationPositionSourceConfig } from 'Controls/interface';
    ...
    return (
        <div ref={ref} className="controlsDemo__wrapper controlsDemo_fixedWidth500">
            ...
            <ScrollContainer
                ...
                data-qa={'Controls-demo_list_new_VirtualScroll_Invert__scroll-react'}
            >
                <List
                    storeId="VirtualScrollInvert"
                    name="list"
                    virtualScrollConfig={virtualScrollConfig}
                    data-qa={'Controls-demo_list_new_VirtualScroll_Invert__list-react'}
                />
            </ScrollContainer>
        </div>
    );
