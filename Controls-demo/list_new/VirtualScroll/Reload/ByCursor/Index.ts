...
class Demo extends Control<IProps> {
    ...
    protected _changePosition(_: Event, correction: number): void {
        const slice = this._options._dataOptionsValue.VirtualScrollReloadByCursor;
    ...
    protected _slowDownSource(): void {
        const source = this._options._dataOptionsValue.VirtualScrollReloadByCursor.source;
