...
export default forwardRef(function ButtonsMode(_, ref: LegacyRef<HTMLDivElement>) {
    return (
        <div className="tw-flex controlsDemo_widthFit" ref={ref} data-qa={'controlsDemo_capture'}>
            <div className="tw-flex tw-flex-col controlsDemo__wrapper__padding-left controlsDemo__wrapper__horizontal">
                <div className="controls-text-label">scrollOrientation = horizontal</div>
                <div className="controlsDemo_fixedWidth300">
                    ...
                    <Container
                        ...
                        data-qa={'Controls-demo_Scroll_ButtonsSize__horizontal'}
                    >
            ...
            <div className="tw-flex tw-flex-col controlsDemo__wrapper__padding-left">
                <div className="controls-text-label">scrollOrientation = vertical</div>
                <div className="controlsDemo_fixedWidth300">
                    <div className="controls-text-label">buttonsSize = m</div>
                    <Container
                        className="controlsDemo__height300"
                        ...
                        data-qa={'Controls-demo_Scroll_ButtonsSize__vertical'}
                    >
