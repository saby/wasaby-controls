...
import { BooleanType, NumberType, ObjectMeta, ObjectType, StringType } from 'Meta/types';
import { EditorsProvider, getAttributeTitle, ObjectTypeEditor, useParentTypes, } from 'Controls-editors/object-type';
import { BooleanEditor, NumberEditor, ObjectEditor, StringEditor, } from 'Controls-editors/properties';
