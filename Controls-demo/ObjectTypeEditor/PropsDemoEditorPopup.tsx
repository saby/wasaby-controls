...
export function PropsDemoEditorPopup({ metaType, dataQA, control }: PropsDemoEditorPopupProps) {
    ...
    return (
        <div>
            <div className="PropsDemoEditor__Content">
                <div>
                    <button ref={btnOpenerRef} onClick={openEditorHandler} data-qa={dataQA + '-button'}>
