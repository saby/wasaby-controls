...
function getListData(): {
    ...
    return [
        ...
        },
        {
            ...
            position:
                'Ведущий проектировщик пользовательских интерфейсов (3 категории)',
            phone: '1018',
            likes: 2,
            department: null,
            count: null,
        },
        {
            ...
            position:
                'Проектировщик пользовательских интерфейсов (2+ категории)',
            phone: '2514',
            likes: 2,
            department: null,
            count: null,
        ...
        },
        {
            ...
            likes: null,
            department:
                'Тюмень/ Расширенный набор контролов (Компоненты фреймворка)',
            count: 0,
        },
    ];
}

function getFlatData(): { key: number; title: string }[] {
    return [
        {
            key: 1,
            title: 'Элемент 1',
...
function getPanelDataWithLongCaption(): {
    id: string;
    '@parent': boolean;
    icon?: string;
    title: string;
