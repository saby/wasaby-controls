    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className="controlsDemo__flex ws-flex-column ws-align-items-center"
                    data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same"
                >
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <Button
                            ...
                            caption="Кнопка"
                            buttonStyle="primary"
                            data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same-primary"
                        />
                    </div>
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <Button
                            ...
                            caption="Кнопка"
                            buttonStyle="secondary"
                            data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same-secondary"
                        />
                    </div>
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <Button
                            ...
                            caption="Кнопка"
                            buttonStyle="success"
                            data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same-success"
                        />
                    </div>
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <Button
                            ...
                            caption="Кнопка"
                            buttonStyle="danger"
                            data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same-danger"
                        />
                    </div>
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <Button
                            ...
                            caption="Кнопка"
                            buttonStyle="warning"
                            data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same-warning"
                        />
                    </div>
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <Button
                            ...
                            caption="Кнопка"
                            buttonStyle="info"
                            data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same-info"
                        />
                    </div>
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <Button
                            ...
                            caption="Кнопка"
                            buttonStyle="unaccented"
                            data-qa="controlsDemo-ButtonStyle__ViewModeFilled-same-unaccented"
                        />
                    </div>
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m" />
                    <div className="controls-inlineheight-l controls-margin_bottom-m controls-margin_right-m" />
