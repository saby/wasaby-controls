...
export default forwardRef(function ButtonStyle(props, ref: LegacyRef<HTMLDivElement>) {
    ...
    return <div
        ref={ref}
        {...attrs}
        className={`controlsDemo__wrapper controlsDemo__flex ws-justify-content-center ${props.className ? props.className : (
            attrs.className ? attrs.className : ''
        )}`}
    >
        <div className="controlsDemo__flex ws-justify-content-center ws-align-items-center"
            ...
            <div className="controlsDemo__flex ws-flex-column ws-align-items-center">
                {
                    buttonStyles.map((buttonStyle) => {
                        return <div
                            ...
                            <span className="controls-text-label controlsDemo_fixedWidth100">{buttonStyle}</span>
                        </div>;
                    })
                }
            </div>
