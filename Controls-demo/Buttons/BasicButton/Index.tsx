    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="primary" buttonSize={'4xl'}>
                    ...
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="secondary" buttonSize={'4xl'}>
                            <span className="controls-demo_button-wrapper tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-full">
                                <span className="controls-BaseButton__text controls-fontsize-m controls-fontweight-bold">
                                    Заголовок
                                </span>
                    ...
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="success" buttonSize={'4xl'}>
                            <span className="controls-demo_button-wrapper tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-full">
                                <span className="controls-BaseButton__text controls-fontsize-m controls-fontweight-bold">
                                    Заголовок
                                </span>
                    ...
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="danger" buttonSize={'4xl'}>
                            <span className="controls-demo_button-wrapper tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-full">
                                <span className="controls-BaseButton__text controls-fontsize-m controls-fontweight-bold">
                                    Заголовок
                                </span>
                    ...
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="warning" buttonSize={'4xl'}>
                            <span className="controls-demo_button-wrapper tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-full">
                                <span className="controls-BaseButton__text controls-fontsize-m controls-fontweight-bold">
                                    Заголовок
                                </span>
                    ...
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="info" buttonSize={'4xl'}>
                            <span className="controls-demo_button-wrapper tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-full">
                                <span className="controls-BaseButton__text controls-fontsize-m controls-fontweight-bold">
                                    Заголовок
                                </span>
                    ...
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m" />
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="default" buttonSize={'4xl'}>
                            <span className="controls-demo_button-wrapper tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-full">
                                <span className="controls-BaseButton__text controls-fontsize-m controls-fontweight-bold">
                                    Заголовок
                                </span>
                    ...
                    <div className="controls-inlineheight-5xl controls-margin_bottom-m controls-margin_right-m controlsDemo__flex ws-align-items-center">
                        <BasicButton viewMode="outlined" buttonStyle="pale" buttonSize={'4xl'}>
                            <span className="controls-demo_button-wrapper tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-full">
                                <span className="controls-BaseButton__text controls-fontsize-m controls-fontweight-bold">
                                    Заголовок
                                </span>
