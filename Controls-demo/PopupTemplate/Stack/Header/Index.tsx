...
import { StackOpener, Confirmation } from 'Controls/popup';
...
export default forwardRef(function SlidingStackTemplateDemo(
    ...
    const applyButtonClickCallback = () => {
        Confirmation.openPopup({
            message: 'Клик на кнопку подтверждения',
            type: 'ok',
        });
    };
        ...
        <div ref={ref} className="tw-flex tw-flex-col tw-items-center">
            <div className="tw-flex tw-flex-col controls-margin_bottom-2xl">
                <Checkbox
                    ...
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__closeButtonVisible'}
                />
                <Checkbox
                    caption="counterValue (счётчик)"
                    value={counterValueVisible}
                    onValueChanged={handleChangeCounterValueVisible}
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__counterValue'}
                />
                <Checkbox
                    ...
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__imageContentTemplate'}
                />
                <Checkbox
                    ...
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__headerContentTemplate'}
                />
                <Checkbox
                    caption="headingCaption (стандартный заголовок)"
                    value={headingCaptionVisible}
                    onValueChanged={handleChangeHeadingCaptionVisible}
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__headingCaption'}
                />
                <Checkbox
                    ...
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__toolbarContentTemplate'}
                />
                <Checkbox
                    caption="applyButtonVisible (кнопка подтверждения)"
                    value={applyButtonVisible}
                    onValueChanged={handleChangeApplyButtonVisible}
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__applyButtonVisible'}
                />
                <Checkbox
                    ...
                    data-qa={'Controls-demo_PopupTemplate_Stack_Header__applyButtonCallback'}
                />
            </div>
            <div>
                <Button
