...
export default class extends Control<IControlOptions> {
    ...
    protected _activateRouteWithOnBeforeOpenCallbackPath(): void {
        const route = getRouteWithOnBeforeOpenCallbackPath();
        this._activate(route);
    }

    protected _activateColoredRoute(): void {
        const route = getRouteWithDifferentStyles();
        this._activate(route);
    }
