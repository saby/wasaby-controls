define('Controls-demo/Input/DateTime/DateTime', [
   ...
   var ModuleClass = Base.Control.extend({
      ...
      _getExtendedTimeFormatValue: function () {
         if (this._extendedTimeFormatValue) {
            return this._extendedTimeFormatValue.toLocaleString('ru-RU');
         }
         return null;
      },
      ...
      _masks: [
         {
            ...
            masks: ['DD.MM.YYYY', 'DD.MM.YY', 'DD.MM', 'YYYY', 'HH:mm', 'HH:mm:ss', 'HH:mm:ss:SSS']
         },
         {
