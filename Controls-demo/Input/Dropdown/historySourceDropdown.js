define('Controls-demo/Input/Dropdown/historySourceDropdown', [
...
], function (history, defferedLib, collection, entity, source, historyStore) {
   'use strict';
   ...
   function createMemory() {
      if (!historyStore.Store.getLocal('TEST_HISTORY_ID_DROPDOWN')['pinned'].getCount()) {
         historyStore.Store.togglePin('TEST_HISTORY_ID_DROPDOWN', 1);
         historyStore.Store.togglePin('TEST_HISTORY_ID_DROPDOWN', 2);
      }
