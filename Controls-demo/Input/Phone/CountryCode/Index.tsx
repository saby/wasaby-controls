    ...
    return (
        ...
        >
            <div
                ...
                data-qa="Controls-demo_Input_Phone_CountryCode__cell-empty"
            >
            ...
            <div
                className="controlsDemo__cell"
                data-qa="Controls-demo_Input_Phone_CountryCode__cell-us"
            >
            ...
            <div
                className="controlsDemo__cell"
                data-qa="Controls-demo_Input_Phone_CountryCode__cell-kz"
            >
                <div className="controls-text-label">countryCode = KZ</div>
                <Phone
                    className="ControlsDemo-PhoneInput_phoneField"
                    data-qa="Controls-demo_Input_Phone_CountryCode_kz"
                    countryCode="KZ"
                    flagVisible={true}
                    onlyMobile={true}
                />
