...
import { lookupOptions, initialContractorConfig, changedContractorConfig } from 'Controls-demo/Lookup/MultipleInputNew/resources/Data';
...
export default class extends Control {
    ...
    protected _selectedKeysChanged(event: SyntheticEvent, value: object): void {
        ...
        this._lookupOptions[1] = this._selectedKeys.company.length ? changedContractorConfig : initialContractorConfig;
    }
