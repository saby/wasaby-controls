...
import { _companies, _departmentsDataLong, _equipment, } from 'Controls-demo/Lookup/DemoHelpers/DataCatalog';
...
export default class extends Control {
    ...
    protected _selectedKeyWithComment: string[] = ['Иванова Зинаида Михайловна, ИП'];
    protected _selectedKeyWithItemMultiline: string[] = ['Иванова Зинаида Михайловна , ИП 2'];
    ...
    protected _selectedKeysReadOnly: string[] = ['Иванова Зинаида Михайловна, ИП'];
    ...
    protected _updateInfoMultiSelectLazy(): void {
        ...
        const selectedKeysCount = lookupMultiSelectLazy._getSelectedItemsCount(options);
        ...
        if (contentTemplateOptions && contentTemplateOptions.items) {
            contentTemplateOptions.items = factory(contentTemplateOptions.items)
                .sort((firstItem: Model, secondItem: Model) => {
                    return firstItem.get('title').localeCompare(secondItem.get('title'));
                })
