...
export default class extends Control {
    ...
    protected _displayMode: TimeIntervalDisplayMode =
        TimeIntervalDisplayMode.Numeric;
    ...
    protected _displayedUnitsNumberChangeHandler(
        e: SyntheticEvent,
        key: number
    ): void {
    ...
    protected _displayedUnitsChangeHandler(
        e: SyntheticEvent,
        key: number
    ): void {
