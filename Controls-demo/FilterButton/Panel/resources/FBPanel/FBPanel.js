/**
 */
define('Controls-demo/FilterButton/Panel/resources/FBPanel/FBPanel', [
   // Устанавливаем имя, по которому демо-компонент будет доступен в других компонентах
   ...
   var moduleClass = CompoundControl.extend({
      ...
      init: function () {
         ...
         // Обязательная конструкция - вызов функции init у родительского класса
         moduleClass.superclass.init.call(this);
      }
   });
   moduleClass._styles = [
      'Controls-demo/FilterButton/Panel/resources/FBPanel/FBPanel'
   ];
