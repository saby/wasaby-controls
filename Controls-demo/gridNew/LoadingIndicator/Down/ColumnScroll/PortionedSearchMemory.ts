...
export default class PositionSourceMemory extends Memory {
    ...
    protected _moduleName: string = 'Controls-demo/gridNew/LoadingIndicator/Down/ColumnScroll/PortionedSearchMemory';
            ...
            const result = this._prepareQueryResult(
                {
                    items,
                    meta: {
                        total: isPosition ? { before: false, after: true } : true,
                    },
                },
                null
            );
