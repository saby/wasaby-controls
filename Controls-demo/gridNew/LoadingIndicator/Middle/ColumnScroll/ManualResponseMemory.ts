...
export default class ManualResponseMemory extends Memory {
    protected _moduleName: string = 'Controls-demo/gridNew/LoadingIndicator/Middle/ColumnScroll/ManualResponseMemory';
