...
import { ManualResponseMemory } from 'Controls-demo/gridNew/LoadingIndicator/Middle/ColumnScroll/ManualResponceMemory';
...
export default class extends Control {
    ...
    protected _beforeMount(): void {
        this._viewSource = new ManualResponseMemory({
            keyProperty: 'key',
            deferResponse: true,
