...
import { IColumn, IColumnConfig, IHeaderCell, IHeaderConfig } from 'Controls/grid';
...
export const Countries = {
    ...
    getColumns: (count?: number): IColumnConfig[] => {
        return [
    ...
    getColumnsWithFixedWidths: (count?: number): IColumnConfig[] => {
        return (
            [
                {
                    displayProperty: 'number',
    ...
    getColumnsWithFixedLargeWidths: (count?: number): IColumnConfig[] => {
        return (
            [
                {
                    displayProperty: 'number',
    ...
    getLongHeader: (textOverflow): IHeaderConfig[] => {
        return [
            {
                caption: '#',
            },
