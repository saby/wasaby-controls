...
import * as Template from 'wml!Controls-demo/gridNew/Grouped/RightTemplate/WithoutSeparator/TextVisibleFalse/TextVisibleFalse';
...
export default class extends Control {
    ...
    static getLoadConfig(): Record<string, IDataConfig<IListDataFactoryArguments>> {
        return {
            RightTemplateWithoutSeparatorTextVisibleFalse: {
