...
import {IColumn, IItemAddOptions, IItemEditOptions, TBeforeBeginEditEventResult,} from 'Controls/grid';
...
export default class extends Control {
    ...
    protected _beforeMount(): void {
        this._columns = Countries.getColumnsWithFixedWidths().map((column, index) => {
            ...
            column.template = index < 3 ? editingCellText : editingCellNumber;
            return column;
        });
