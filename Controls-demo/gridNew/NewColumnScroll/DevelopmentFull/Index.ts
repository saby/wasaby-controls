...
import * as Template from 'wml!Controls-demo/gridNew/NewColumnScroll/DevelopmentFull/DevelopmentFull';
import * as NewColumnTemplate from 'wml!Controls-demo/gridNew/NewColumnScroll/DevelopmentFull/NewColumnTemplate';
import * as PopulationColumn from 'wml!Controls-demo/gridNew/NewColumnScroll/DevelopmentFull/PopulationColumn';
...
export default class extends Control {
    ...
    protected _virtualColumnScrollConfig: object = null;
    protected _pageSizeInputValue: number = 0;
    ...
    protected _dragStart(_: SyntheticEvent, draggedKeys: number[]): unknown {
    ...
    protected _updateVirtualPageSize(e: Event, val: number): void {
        if (val === null) {
            this._virtualColumnScrollConfig = null;
        } else if (
            !this._virtualColumnScrollConfig ||
            val !== this._virtualColumnScrollConfig.pageSize
        ) {
            this._virtualColumnScrollConfig = {
                ...this._virtualColumnScrollConfig,
                pageSize: this._pageSizeInputValue,
            };
        }
    }
    ...
    protected _toggleColumnScrollStartPosition(e: Event, value: string): void {
