...
export default class extends Control {
    ...
    private _gridShowed: boolean = true;
    ...
    protected _toggleNewColumnScroll(): void {
        this._newColumnScroll = !this._newColumnScroll;
        this._gridShowed = false;
    }
