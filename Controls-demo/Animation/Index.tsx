    ...
    return (
        ...
        >
            <div>
                ...
                <div
                    className={
                        'controls-padding-s controls-fontsize-s controls-text-label'
                    }
                >
    ...
    render(): JSX.Element {
        return (
            <div className={'controlsDemo__wrapper'}>
                <Container
                    ref={this._animationRef}
                    animationTemplate={animationTemplate}
                >
                    <div className={'controlsDemo__flexRow'}>
                        <div
                            className={
                                'controlsDemo__wrapper controlsDemo_fixedWidth300'
                            }
                        >
                            <List
                                ref={this._list1ref}
                        ...
                        <div
                            className={
                                'controlsDemo__wrapper ws-flex-column ws-flexbox'
                            }
                        >
                            <button
