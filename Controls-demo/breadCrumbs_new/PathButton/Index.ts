...
import { data, dataWithoutHierarchy } from 'Controls-demo/breadCrumbs_new/PathButton/Data';
...
export default class Index extends Control {
    ...
    protected _sourceWithoutHierarchy: HierarchicalMemory;
    ...
    protected _beforeMount(): void {
        ...
        this._sourceWithoutHierarchy = new HierarchicalMemory({
            data: dataWithoutHierarchy,
            keyProperty: 'id',
            parentProperty: 'parent',
            filter: () => {
                return true;
