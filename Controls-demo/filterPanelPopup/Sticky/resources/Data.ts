...
export const inputConfig = {
    ...
    caption: 'Отдел',
    editorTemplateName: 'Controls/filterPanelExtEditors:InputEditor',
    resetValue: '',
    value: 'Отдел',
    textValue: '',
    viewMode: 'extended',
...
const companyEditorData = [
    { id: 'Samsung', title: 'Very very long caption for Samsung', counter: 1 },
    { id: 'Apple', title: 'Apple', counter: 2 },
    { id: 'Xiaomi', title: 'Xiaomi', counter: 1 },
    { id: 'Huawei', title: 'Huawei', counter: 3 },
];
...
companyEditorWithoutExpander.editorOptions.showEditArrow = 'counter';
companyEditorWithoutExpander.editorOptions.additionalTextProperty = true;
...
companyEditorWithoutCaption.editorOptions.selectorTemplate = {
    templateName:
        'Controls-demo/filterPanel/resources/MultiSelectStackTemplate/StackTemplate',
    templateOptions: {
...
export const typeEditor = {
    ...
    editorOptions: {
        ...
        extendedCaption: 'Тип',
        selectorTemplate: {
            templateName: 'Engine-demo/Controls-widgets/StoreId/SelectorStack',
            templateOptions: {
