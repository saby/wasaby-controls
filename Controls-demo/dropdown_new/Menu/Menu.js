define('Controls-demo/dropdown_new/Menu/Menu', [
   ...
   var ModuleClass = Base.Control.extend({
      ...
      _beforeMount: function () {
         ...
         this._historySource = new HistoryOld.Source({
            historySource: new HistoryOld.Service({
               pinned: true,
               frequent: true,
