...
import controlTemplate = require('wml!Controls-demo/dropdown_new/Input/Scroll/ScrollbarVisible/Index');
...
export default class extends Control<IControlOptions> {
    ...
    static _styles: string[] = ['Controls-demo/dropdown_new/Input/Scroll/Index'];
}
