...
import * as controlTemplate from 'wml!Controls-demo/dropdown_new/Input/MultiSelect/PinnedItems/Bold/Index';
...
export default class extends Control<IControlOptions> {
    ...
    static _styles: string[] = ['Controls-demo/dropdown_new/Input/MultiSelect/PinnedItems/Index'];
}
