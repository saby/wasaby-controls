        ...
        <div ref={ref} className="controlsDemo__wrapper controlsDemo__flexRow">
            <div className="controlsDemo__ml2">
                <DropdownButton
                    ...
                    caption="Создать"
                    footerContentTemplate="Controls-demo/dropdown_new/Button/MenuMode/FooterContentTemplate/Index:FooterContentTemplate"
...
export function FooterContentTemplate() {
    return (
