...
const hierarchyFilters: IFilterItem[] = [
    {
        ...
        itemTemplate:
            'Controls-demo/Filter_new/resources/Editors/HierarchyLookup',
        editorOptions: {
            ...
            selectorTemplate: {
                templateName:
                    'Controls-demo/Filter_new/resources/TreeStack/TreeStackTemplate',
                templateOptions: {
...
const defaultItems: IFilterItem[] = [
    ...
    },
    {
        ...
        additionalTemplate:
            'wml!Controls-demo/Filter_new/resources/Editors/Additional/Link',
        visibility: false,
        editorOptions: {
            caption: 'Подписанные',
        },
    ...
    },
    {
        ...
        itemTemplate: 'wml!Controls-demo/Filter_new/resources/Editors/Dropdown',
        additionalTemplate:
            'Controls-demo/Filter_new/resources/Editors/Additional/Dropdown',
        visibility: false,
        editorOptions: {
