...
import {PreviewerPersonsImages} from 'Controls-demo/Previewer/image/images';
...
export default class extends Control {
    ...
    protected _greenFilledImage: string = '';

    protected _beforeMount(): void {
        this._greenFilledImage = PreviewerPersonsImages.GreenFilled;
