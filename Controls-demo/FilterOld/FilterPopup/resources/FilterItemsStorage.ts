...
const hierarchyFilters: IFilterItem[] = [
    {
        ...
        itemTemplate: 'Controls-demo/FilterOld/FilterPopup/resources/Editors/HierarchyLookup',
        editorOptions: {
...
const defaultItems: IFilterItem[] = [
    {
        ...
        value: null,
        type: 'dateRange',
        itemTemplate: 'wml!Controls-demo/FilterOld/FilterPopup/resources/Editors/DateRange',
        editorOptions: {
