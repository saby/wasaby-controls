...
const recentData = {
    ...
    d: [
        ...
        [
            '2',
            JSON.stringify(getChangedHistoryItems(2), new Serializer().serialize),
            'TEST_HISTORY_ID_3',
        ],
        [
            '3',
        ...
        [
            '10',
            JSON.stringify(getChangedHistoryItems(1), new Serializer().serialize),
            'TEST_HISTORY_ID_10',
        ],
    ],
    s: [
