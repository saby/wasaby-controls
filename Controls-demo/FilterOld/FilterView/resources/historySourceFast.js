define('Controls-demo/FilterOld/FilterView/resources/historySourceFast', [
   'Controls/historyOld',
   'Types/deferred',
   'Types/collection',
   'Types/entity',
...
], function (history, defferedLib, collection, entity, source, Images) {
   'use strict';
   ...
   var items = [
      ...
      { id: '2', title: 'My department' },
      {
         ...
         itemTpl: 'wml!Controls-demo/FilterOld/FilterView/resources/itemTemplatePhoto'
      },
      {
         id: '4',
