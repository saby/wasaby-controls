...
import controlTemplate = require('wml!Controls-demo/Suggest_new/Input/MinSearchLength/MinSearchLength');
import suggestTemplate = require('wml!Controls-demo/Suggest_new/Input/MinSearchLength/resources/SuggestTemplate');
