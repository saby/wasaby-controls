...
export function getData(): IData[] {
    return [
        ...
        createItem({
            key: '2626c5cb-a665-4426-b3a6-9bdqw9f0123ac',
            number: '...08111',
            date: new Date(2025, 4, 8),
        }),
        createItem({
            key: '28147c2c-12c4-432f-865d-5adqw46612318',
            number: '...08111',
            date: new Date(2025, 4, 8),
        }),
        createItem({
            key: '72fb6caa-4211-4a67-aa29-62dqwe491230e',
            number: '...08111',
            date: new Date(2025, 4, 8),
        }),
        createItem({
            key: 'cf9fdffb-5cc1-4fd3-b8ca-44dqw37b12371',
            number: '...08111',
            date: new Date(2023, 1, 20),
        }),
        createItem({
            key: '51be641a-80bb-46cf-bb93-23dqwa3b1233a',
            number: '...08111',
            date: new Date(2023, 1, 20),
        }),
        createItem({
            key: 'a79d162c-e415-4559-999a-74dqw2e312338',
            number: '...08123',
            date: new Date(2023, 1, 20),
            icons: ['icon-Payment'],
        }),
        createItem({
            key: '129360bd-63bb-46a5-8643-46dqwc0812373',
            number: '...08123',
            date: new Date(2023, 1, 18),
        }),
        createItem({
            key: '323ee9ac-c0eb-4fe6-b845-1fdqw29d12328',
            number: '...08123',
            date: new Date(2023, 1, 18),
            icons: ['icon-Shipment', 'icon-Payment'],
        }),
        createItem({
            key: 'f905f322-61e8-4879-9c57-57dqw7a1123df',
            number: '...08123',
            date: new Date(2023, 1, 5),
            icons: [],
        }),
        createItem({
            key: 'aa241a98-c8f9-4105-ae49-6fdqwe0512313',
            number: '...08123',
            date: new Date(2023, 1, 5),
            icons: ['icon-Shipment', 'icon-Payment', 'icon-WaitingSignature'],
        }),
        createItem({
            key: '3c6bfac0-f4a0-415b-ad6c-20dqwfc11234a',
            number: '...08123',
            date: new Date(2023, 1, 5),
            icons: [],
        }),
        createItem({
            key: 'dca1e8c6-072b-44b1-9db3-55dqw3a2123a5',
            number: '...09005',
            date: new Date(2023, 1, 5),
            icons: ['icon-Shipment', 'icon-Payment', 'icon-WaitingSignature'],
        }),
        createItem({
            key: 'e76a8ec1-f233-4e17-b6e8-ecdqwd07123c8',
            number: '...09007',
            date: new Date(2023, 1, 5),
            icons: [],
        }),
        createItem({
            key: '88bef0bd-ca4e-4644-8e6f-7ddqw62e12350',
            number: '...09008',
            date: new Date(2023, 1, 5),
            icons: ['icon-Shipment', 'icon-Payment'],
        }),
        createItem({
            key: 'f4a56757-60db-45c3-8f88-82dqwe2512348',
            number: '...09011',
            date: new Date(2022, 10, 8),
            icons: ['icon-Shipment'],
        }),
        createItem({
            key: '82fafc21-33f6-4d6d-bccb-14dqw1b61231e',
            number: '...09011',
            date: new Date(2022, 10, 8),
            icons: ['icon-Shipment'],
        }),
        createItem({
            key: '0f651f7a-d339-4fe1-b717-c6dqw21912383',
            number: '...09011',
            date: new Date(2022, 10, 8),
            icons: [],
        }),
        createItem({
            key: 'aa23a187-5e62-48b3-938f-4ddqw2961232f',
            number: '...09013',
            date: new Date(2022, 10, 8),
            icons: ['icon-Shipment', 'icon-Payment', 'icon-WaitingSignature'],
        }),
        createItem({
            key: '3558e829-0949-43a2-ba78-56dqw15d123ac',
            number: '...09013',
            date: new Date(2022, 10, 8),
            icons: [],
        }),
        createItem({
            key: 'f10492d0-523b-4e22-b293-42dqw4d01231c',
            number: '...09013',
            date: new Date(2022, 10, 8),
            icons: [],
        }),
        createItem({
            key: 'dfd94570-be4d-484d-a019-8ddqw375123e8',
            number: '...09567',
            date: new Date(2022, 10, 8),
            icons: [],
        }),
        createItem({
            key: 'cbcbbb1a-a6df-493c-a84d-b6dqwb7512317',
            number: '...09567',
            date: new Date(2022, 10, 8),
            icons: ['icon-Shipment', 'icon-Payment'],
        }),
        createItem({
            key: '65f385c2-266a-414b-a75a-09dqwd4412355',
            number: '...09567',
            date: new Date(2022, 10, 8),
            icons: ['icon-Payment'],
        }),
        createItem({
            key: '3cb3c4ed-5a3d-4289-a7d4-cfdqwea012378',
            number: '...09567',
            date: new Date(2022, 10, 4),
            icons: [],
        }),
        createItem({
            key: '5da256d6-8a4b-424f-b749-c9dqwe78123d7',
            number: '...09567',
            date: new Date(2022, 10, 4),
            icons: [],
        }),
        createItem({
            key: '4245d7d2-b4c7-4118-8632-42dqwb0012308',
            number: '...09567',
            date: new Date(2022, 10, 4),
            icons: [],
        }),
        createItem({
            key: 'eaee6472-dc2c-4a3a-b6e7-78dqw82712352',
            number: '...09567',
            date: new Date(2022, 10, 4),
            icons: ['icon-Shipment', 'icon-WaitingSignature'],
        }),
        createItem({
            key: '9c29d033-d925-425b-8aba-00dqw8081237d',
            number: '...09567',
            date: new Date(2022, 10, 4),
            icons: [],
        }),
        createItem({
            key: '1d0a9a65-749c-465a-bc0e-efdqw99412301',
            number: '...09777',
            date: new Date(2022, 10, 4),
            icons: [],
        }),
        createItem({
            key: 'e1031ba3-4797-4680-a76c-bcdqw0de123bc',
            number: '...09777',
            date: new Date(2022, 10, 4),
            icons: ['icon-Shipment', 'icon-Payment', 'icon-WaitingSignature'],
        }),
        createItem({
            key: 'b35bf0a8-6917-4a7f-8b68-14dqw4aa123b9',
            number: '...09777',
            date: new Date(2022, 10, 4),
            icons: [],
        }),
...
export function getItemsWithMetaData() {
    return new RecordSet({
        keyProperty: KEY_PROPERTY,
        rawData: getData(),
