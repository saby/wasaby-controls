...
function Editor(props: IEditorProps): React.ReactElement {
    ...
    const ColumnsCountTumbler = useTumbler('columnsCount', [5, 10, 15, 20, 25, 30, 40, 50, 90, 180]);
    ...
    const MultiSelectVisibilityTumbler = useTumbler('multiSelectVisibility', ['visible', 'hidden', 'onhover']);
