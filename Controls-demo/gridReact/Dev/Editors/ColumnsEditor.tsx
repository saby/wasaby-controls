    ...
    return (
        <div className={'ws-flexbox ws-flex-wrap'}>
            ...
            <BaseSelector header={'backgroundStyle'}>
                <ColorStyleSelector
                    value={cellProps.backgroundStyle}
                    onChange={(backgroundStyle) => {
                        return updateCellProps({ backgroundStyle });
                    }}
                />
            </BaseSelector>
...
function ColumnEditor(props: IColumnEditorProps): React.ReactElement {
    ...
    return (
        <div className={'controls__block-layout-item controls-padding-xs'}>
            <BaseEditor header={`Column Editor ${props.column.displayProperty}`} level={3}>
                <CellPropsEditor cellProps={cellProps} onChange={updateCellProps} />
            </BaseEditor>
        </div>
    );
}
