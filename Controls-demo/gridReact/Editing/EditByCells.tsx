...
export default React.forwardRef((props: IProps, ref: React.ForwardedRef<HTMLDivElement>) => {
    ...
    return (
        <div ref={ref}>
            ...
            >
                <option hidden defaultValue={null} label={'select mode'} />
            ...
            >
                <option hidden defaultValue={null} label={'select inputBackgroundVisibility'} />
            ...
            >
                <option hidden defaultValue={null} label={'select inputBorderVisibility'} />
