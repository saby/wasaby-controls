...
export default React.forwardRef(
    (
        ...
        const [borderVisibility, setBorderVisibility] =
            React.useState<TBorderVisibility>(propBorderVisibility);
        const [borderStyle, setBorderStyle] = React.useState<TBorderStyle>(propBorderStyle);
        const [borderMode, setBorderMode] = React.useState<'cell' | 'row'>(propsBorderMode);
