...
function getColumns(columnScroll?: boolean): IColumnConfig[] {
    return [
        {
            key: 'key',
            displayProperty: 'key',
...
export default React.forwardRef(function StickyCallbackDemo(
    ...
    const columnScroll = URL.getQueryParam('columnScroll') !== 'false';
    const columns = React.useMemo(() => {
        return getColumns(columnScroll);
    }, [columnScroll]);
