    ...
    return (
        <div className='tw-flex tw-justify-center'>
            <div className='tw-flex tw-flex-col' style={{width: '400px'}}>
                ...
                <Button caption='Открыть информационное окно' onClick={openDefaultConfirmation}/>
                <Label caption='type="ok" markerStyle="danger"'/>
                <Button caption='Открыть информационное окно' onClick={openDangerConfirmation}/>
                <Label caption='Кастомное значение buttons, markerStyle="success"'/>
                <Button caption='Открыть информационное окно' onClick={openCustomButtonsConfirmation}/>
            </div>
        </div>
    );
}