...
class Index extends Control<IControlOptions> {
    ...
    protected _openSlidingPanelHandler(
        event: Event,
        ...
        this._dialogOpener.open({
            ...
            slidingPanelOptions: {
                minHeight: this._heightListActivated
                    ? undefined
                    : this._minHeight,
                maxHeight: this._heightListActivated
                    ? undefined
                    : this._maxHeight,
                position: this._position[0],
                heightList: this._heightListActivated
                    ? this._heightList
                    : undefined,
