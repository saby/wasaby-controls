...
function Index(props, ref) {
    ...
    const getSlidingPositionReadOnly = () => {
        ...
        return (
            isMobileReadOnly ||
            (popupType !== 'Sliding' && !adaptiveMode.device.isPhone()) ||
            (!allowAdaptive && adaptiveMode.device.isPhone())
        );
    };
    ...
    const openPopup = useCallback(() => {
        ...
        if (popupType === 'Sliding') {
            ...
            config.slidingPanelOptions.autoHeight = true;
        ...
        >
            <div className="controlsDemo__flexColumn">
                ...
                <Checkbox
                    ...
                    readOnly={!adaptiveMode.device.isPhone()}
                ...
                <Checkbox
                    ...
                    customEvents={['onValueChanged']}
                    readOnly={!allowAdaptive || !adaptiveMode.device.isPhone()}
