...
export default function ConfirmationDemo() {
    ...
    return (
        <div className="tw-flex tw-justify-center">
            <div className="tw-flex tw-flex-col" style={{ width: '350px' }}>
                <Label caption='backgroundStyle="success"' />
                <Label caption='icon="icon-Successful"' />
                <Button caption="Открыть нотификационное окно" onClick={openSuccessNotification} />
                <Label caption='backgroundStyle="danger"' />
                <Label caption='icon="icon-Alert"' />
