        ...
        const data = [
            {
                id: 0,
                authorPhoto:
                    cConstants.resourceRoot +
                    'Controls-demo/resources/images/mili.png',
                author: '"Мили"',
                date: 'сегодня 15:00',
                title: 'Бизнес-ланч',
                ...
                photo:
                    cConstants.resourceRoot +
                    'Controls-demo/resources/images/menu.jpg',
                isNew: true,
            },
            {
                id: 1,
                authorPhoto:
                    cConstants.resourceRoot +
                    'Controls-demo/resources/images/development.png',
                author: 'Чиркова В.',
            ...
            },
            {
                ...
                authorPhoto:
                    cConstants.resourceRoot +
                    'Controls-demo/resources/images/golubev.png',
                author: 'Голубев А.',
                orgName: 'HL/HA',
                date: 'сегодня 11:08',
                ...
                banner:
                    cConstants.resourceRoot +
                    'Controls-demo/resources/images/banner.jpg',
                isNew: false,
            },
            {
                id: 6,
                authorPhoto:
                    cConstants.resourceRoot +
                    'Controls-demo/resources/images/sbis.png',
                author: 'Гребенкина А.',
