define('Controls-demo/explorerNew/Search', [
   ...
   'Router/router',
   'Controls/explorer'
], function (Base, template, MemorySource, source, router) {
   'use strict';
   var ModuleClass = Base.Control.extend({
      ...
      _beforeMount: function (options) {
         ...
         var url = options.Router.url.getUrl();
         this._feature1188089336 = !!router.MaskResolver.calculateUrlParams(
             'feature1188089336=:feature1188089336',
             url
         ).feature1188089336;
      }
   });

   ModuleClass._styles = ['Controls-demo/explorerNew/Search', 'DemoStand/Controls-demo'];
