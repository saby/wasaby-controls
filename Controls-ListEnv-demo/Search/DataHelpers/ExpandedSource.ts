...
import { default as memoryFilter } from 'Controls-ListEnv-demo/Search/DataHelpers/memoryFilter';
...
export default class ExpandedSource extends HierarchicalMemory {
    protected _moduleName: string =  'Controls-ListEnv-demo/Search/DataHelpers/ExpandedSource';
