...
const MasterTemplate = React.forwardRef(function (_props, ref) {
    return <FilterPanel storeId="rating" filterNames={filterNames} ref={ref} />;
});
    ...
    return {
        rating: {
            ...
            dataFactoryArguments: {
                ...
                countFilterValue: 'year',
                countFilterLinkedNames: ['task'],
                countFilterUserPeriods: userPeriods,
            },
        },
    };
};
