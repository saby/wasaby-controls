...
import * as controlTemplate from 'wml!Controls-ListEnv-demo/ExtSearch/Navigation/Index';
...
export default class extends Control {
    ...
    protected _suggestNavigation: object = {
        source: 'page',
        view: 'page',
        sourceConfig: {
            pageSize: 3,
        ...
        this._filterDescription = [
            {
                ...
                editorOptions: {
                    ...
                    suggestNavigation: this._suggestNavigation,
