        ...
        return {
            filterView: {
                ...
                dataFactoryArguments: {
                    ...
                    historyId: 'DetailPanelExtendedItemsViewMode__myHistoryId',
                    filterDescription: [
                        dateConfig,
                        dropdownConfig,
                        textConfig,
                        ...
                        // Этот код нужен, чтобы выбранные фильтры не сохранялись в историю фильтров
                        // т.к. сервис истории не работает на демо стендах
                        return { ...filterItem, doNotSaveToHistory: true };
                    }),
                    historyItems: [],
                },
            },
