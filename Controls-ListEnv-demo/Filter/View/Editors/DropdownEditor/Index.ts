...
export const dropdownSingleSelectConfig = {
    caption: 'Страна',
    name: 'singleCountry',
    value: 'USA',
    resetValue: null,
...
export const dropdownBasicEmptyTextConfig = {
    caption: 'Страна',
    name: 'singleCountryEmptyText',
    value: null,
    resetValue: null,
    textValue: '',
    editorTemplateName: 'Controls/filterPanelEditors:Dropdown',
...
const dropdownMultiSelectEmptyKeyConfig = {
    caption: 'Страны с пустыми значениями',
    name: 'countryEmptyKey',
    value: [],
    resetValue: [],
    emptyKey: [null, 'USA'],
    textValue: '',
    ...
    editorOptions: {
        ...
        multiSelect: true,
        extendedCaption: 'Страны с пустыми значениями',
        displayProperty: 'title',
        keyProperty: 'id',
    },
} as IFilterItem;
...
const dropdownCityFrequentConfig = {
    ...
    editorOptions: {
        items: new RecordSet({
            rawData: [
                { id: 0, title: 'Москва', region: 77 },
                { id: 1, title: 'Санкт-Петербург', region: 78 },
                { id: 2, title: 'Ярославль', region: 76 },
            ],
            keyProperty: 'id',
        }),
        itemTemplate: 'Controls-ListEnv-demo/Filter/View/Editors/DropdownEditor/ItemTpl',
        itemTemplateOptions: {
            withRegion: true,
        },
        frequentItemKey: 2,
