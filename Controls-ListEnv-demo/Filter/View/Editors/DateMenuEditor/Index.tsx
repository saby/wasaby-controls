...
export const dateMenuConfig = {
    ...
    editorOptions: {
        closeButtonVisibility: 'hidden',
        excludedPeriods: ['allPeriod', 'yesterday', 'week', 'quarter'],
...
const dateMenuModeDatesConfig = {
    ...
    descriptionToValueConverter:
        'Controls-ListEnv-demo/Filter/View/Editors/DateMenuEditor/DescriptionToValueConverter',
    editorOptions: {
        closeButtonVisibility: 'hidden',
        _date: _currentDate, // только для тестов, чтобы замокать текущий день
        periodType: 'last',
