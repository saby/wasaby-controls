define('Controls-ListEnv-demo/Filter/NotConnectedView/RichDemo/resources/historySourceFast', [
   ...
   'Types/source',
   'Env/Env'
], function (history, defferedLib, collection, entity, source, Env) {
   'use strict';
   ...
   var items = [
      ...
      { id: '2', title: 'My department' },
      {
         ...
         photo: Env.constants.resourceRoot +
             'Controls-ListEnv-demo/Filter/NotConnectedView/RichDemo/resources/dogadkin.png',
         itemTpl: 'wml!Controls-ListEnv-demo/Filter/NotConnectedView/RichDemo/resources/itemTemplatePhoto'
      },
      {
         id: '4',
