...
const _currentDate = new Date(2022, 0, 7);
...
export const dateMenuConfig = {
    ...
    editorOptions: {
        ...
        // мокаем дату для тестов
        _date: _currentDate,
        excludedPeriods: ['yesterday', 'week', 'month', 'quarter'],
        userPeriods: [
            {
                key: 'LastYear',
...
export const cities = [
    ...
    { id: 'Kursk', title: 'Kursk' },
    { id: 'Mariupol', title: 'Mariupol' },
    { id: 'Rybinsk', title: 'Rybinsk' },
    { id: 'Lugansk', title: 'Lugansk ' },
    { id: 'Tver', title: 'Tver ' },
];
...
export const lookupBasicConfigWithEmptyText = {
    name: 'lookupCityEmptyKey',
    editorTemplateName: 'Controls/filterPanelEditors:Lookup',
    resetValue: 'All',
    value: 'All',
    emptyText: 'Выберите город',
    emptyKey: 'All',
    textValue: 'Выберите город',
    viewMode: 'basic',
    editorOptions: {
        source: new Memory({
            keyProperty: 'id',
