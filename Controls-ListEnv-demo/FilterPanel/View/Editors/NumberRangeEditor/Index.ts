...
import * as template from 'wml!Controls-ListEnv-demo/FilterPanel/View/Editors/NumberRangeEditor/Index';
...
export const numberRangeConfig = {
    ...
    editorOptions: {
        ...
        afterEditorTemplate:
            'wml!Controls-ListEnv-demo/FilterPanel/View/Editors/NumberRangeEditor/AfterEditorTemplate',
    },
} as IFilterItem;
