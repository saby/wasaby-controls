 ...
 */
define('Controls-ListEnv-demo/SuggestSearch/resources/kbLayoutRevert', [], function () {
   'use strict';
   ...
   return /** @lends SBIS3.CONTROLS/Utils/KbLayoutRevert/KbLayoutRevertUtil.prototype SBIS3.CONTROLS/Utils/KbLayoutRevert/KbLayoutRevertUtil */ {
      ...
      process: function (text, layoutId) {
         ...
         var directionByWorld = this._figureConversionDirectionByWorlds(text, innerLayoutId),
