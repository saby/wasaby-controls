...
function AdditionalTextTemplate(props: IItemTemplateOptions): JSX.Element | null {
    ...
    return minRangeType ? (
        <div>
            ...
            <div className="tw-inline-flex" onClick={(event) => event.stopPropagation()}>
                <EnumEditor
...
export default function DateRangeEditorItemTemplate(props: IItemTemplateOptions): JSX.Element {
    ...
    const isArbitrarySelected = item?.item?.get('value') === 'arbitrary' && item?.isSelected();
