...
class Index extends Control<IControlOptions> {
    ...
    protected _beforeMount(
        ...
        const params = MaskResolver.calculateUrlParams(
            'app/:app?activate=:activate',
            options.Router.url.getUrl()
        );
        const sourceUrl = params.app;
        ...
        this._hasLoadConfig = !!demoModule.getLoadConfig;
    ...
    protected _onReloadStarted() {
        if (this._hasLoadConfig) {
            getDataToRender(this._options.Router.url.getUrl()).then((loadResult) => {
