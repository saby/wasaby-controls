...
import { IColumnsEditorValue } from 'Controls-Lists-editors/_columnsEditor/components/MainPopup/HeaderContentTemplate';

/**
 * Компонент - opener окна настройки колонок
 * @public
 */
export class Opener extends Component {
    ...
    async open(props: IOpenColumnsEditorProps) {
        ...
        return this._dialog.open({
            ...
            eventHandlers: {
                onResult: (result: IColumnsEditorValue) => {
