...
function ColumnsListPopupRender(props: IColumnsListPopupRender) {
    ...
    const itemClick = React.useCallback(
        ...
        [header, columns, onClose, allColumns, allHeader, onItemClick, onItemClickParams]
    );
    return (
        <div>
            {listData.length > 0 ? (
                <Stack
                    headingCaption={rk('Значение колонки')}
                        ...
                        >
                            ...
                            >
                                <ItemsView
                                    ...
                                    data-qa={
                                        'Controls-Lists-editors_columnsEditor_ColumnsListPopupRender__items'
                                    }
                                />
                            </div>
                        </div>
