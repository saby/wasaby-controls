...
import { IColumnsEditorValue } from 'Controls-Lists-editors/_columnsEditor/components/HeaderContentTemplate';
...
export const getContextDataConfig = (
    ...
    const installationParams: IColumnsEditorValue = params.widgetMetaType.getDefaultValue();
    return {
        templateOptions: {
            frames: {
                mainFrame: {
                        ...
                        frame: new JsonmlFrameFacade([
                            ...
                            [
                                params.widget,
                                {
                                    id: 'widget',
                                    ...params.widgetProps,
                                    editingColumns: validateColumnsConfig([
                                        ...installationParams.columns,
                                    ]),
                                    editingHeaders: validateHeaderConfig([
                                        ...installationParams.header,
                                    ]),
                                    allColumns: params.allColumns,
                                    allHeader: params.allHeader,
                                    draggable: false,
