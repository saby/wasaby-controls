...
export { default as RenderWrapper } from 'Controls-Lists-editors/_columnsEditor/components/MainPopup/RenderWrapper';
export {
...
export { IColumnsEditorValue } from 'Controls-Lists-editors/_columnsEditor/components/MainPopup/HeaderContentTemplate';
