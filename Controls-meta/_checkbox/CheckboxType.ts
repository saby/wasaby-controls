...
export const CheckboxType = WidgetType.id('Controls/meta:Checkbox')
    ...
    .attributes<ICheckboxOptions>({
        ...
        ...group(rk('Внешний вид'), {
            ...
            horizontalPadding: StringType.title(
                rk('Горизонтальный внутренний отступ')
            )
        ...
        resetValue: IBooleanNullType.description(
            rk('Предустановленное значение')
        ).optional(),
        onClick: FunctionType.optional(),
        onKeyUp: FunctionType.optional(),

        '[Controls/_interface/IViewMode]': null,
    });
