import { BooleanType, ObjectType, StringType, UnionType } from 'Meta/types';
...
export const IMenuPopupOptionsType = ObjectType.id(
    ...
    headerContentTemplate: UnionType.of([TemplateFunctionType, StringType]).optional(),
    footerContentTemplate: UnionType.of([TemplateFunctionType, StringType]).optional(),
