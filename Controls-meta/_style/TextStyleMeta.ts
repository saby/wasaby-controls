...
const MAX_HEADER_PIXEL_SIZE = 60;
const MAX_TEXT_PIXEL_SIZE = 36;

export const TextStyleMeta = ObjectType.id('TextStyleMeta').properties({
    fontFamily: FontFamilyType,
    fontSize: FontSizeType.editorProps({ maxPixelValue: MAX_TEXT_PIXEL_SIZE }),
    textAlign: TextAlignType,
    lineHeight: LineHeightType,
    textTransform: TextTransformType,
    ...DecoratorType.properties(),
});

export const HeaderStyleMeta = ObjectType.id('HeaderStyleMeta').properties({
    fontFamily: FontFamilyType,
    fontSize: FontSizeType.editorProps({ maxPixelValue: MAX_HEADER_PIXEL_SIZE }),
    textAlign: TextAlignType,
    lineHeight: LineHeightType,
    textTransform: TextTransformType,
    ...DecoratorType.properties(),
...
export const BaseTextStyleMeta = ObjectType.id('BaseTextStyleMeta').properties({
    fontFamily: FontFamilyType,
    fontSize: FontSizeType.editorProps({ maxPixelValue: MAX_TEXT_PIXEL_SIZE }),
});
