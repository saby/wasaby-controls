...
import { BooleanType, ObjectType, StringType, NullType } from 'Types/meta';
...
export const IMenuBaseOptionsType = ObjectType.id(
    ...
    displayProperty: StringType.description(
        rk('Устанавливает имя поля элемента, значение которого будет отображено.')
    ),
    selectedAllText: NullType,
