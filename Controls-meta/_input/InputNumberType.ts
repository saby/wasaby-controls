...
export const InputNumberType = WidgetType.id(
    ...
    ...group('', {
        ...
        onlyPositive: INumberInputOptionsType
            .attributes()
            .onlyPositive
            .defaultValue(true)
            .order(1),
        useGrouping: INumberInputOptionsType
            .attributes()
            .useGrouping
            .defaultValue(true)
            .order(2),
        integersLength: INumberInputOptionsType
            .attributes()
            .integersLength
            .order(3),
        precision: INumberInputOptionsType
            .attributes()
            .precision
            .order(4),
        placeholder: INumberInputOptionsType
            .attributes()
            .placeholder
            .defaultValue(rk('1 2345.67'))
            .order(5),
    }),
    ...group(rk('Стиль'), {
        contrastBackground: INumberInputOptionsType
            .attributes()
            .contrastBackground
            .defaultValue(false)
            .order(6),
