...
export const InputPhoneType = WidgetType.id('Controls/meta:InputPhoneType')
    ...
    .attributes<IPhoneOptions>({
        ...group('', {
            ...
            onlyMobile: IPhoneOptionsType.attributes().onlyMobile.order(2),
            placeholder: IPhoneOptionsType.attributes()
                .placeholder.order(3)
                .defaultValue('8 (800) 123-45-67'),
        }),
        ...group(' ', {
            contrastBackground: IPhoneOptionsType.attributes().contrastBackground.order(4),
