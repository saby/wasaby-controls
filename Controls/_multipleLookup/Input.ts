 ...
 * Полезные ссылки:
 * * {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/input-elements/directory/multi/ руководство разработчика}
 *
 *
...
export default class Input extends Control<IInputOptions> {
    ...
    protected _itemsChanged(event: SyntheticEvent, lookupName: string, items: RecordSet): void {
        if (this._options.items !== undefined) {
            ...
            this._notify('itemsChanged', [items, lookupName]);
        }
    }
 ...
 * @name Controls/_multipleLookup/Input#selectedKeysChanged
