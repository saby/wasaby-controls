 ...
 * @includes Decorator Controls/_markup/Decorator
 * @includes Converter Controls/_markup/Markup/Converter
 * @library
 * @public
 */

export { default as Decorator, IOptions } from './_markup/Decorator';
...
import EMOJI_REGEX from './_markup/Markup/resources/emojiRegex';
...
export { default as modifyJsonRecursively } from './_markup/Markup/resources/modifyJsonRecursively';
