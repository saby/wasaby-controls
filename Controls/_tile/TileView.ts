...
import { IContextTileMenuConfig } from 'Controls/_tile/interface/IContextTileMenuConfig';

const AVAILABLE_ITEM_PADDINGS = ['null', 'default', '3xs', '2xs', 'xs', 's', 'm'];

type TActionMenuViewMode = 'menu' | 'preview';

export interface ITileAspectOptions extends IAbstractListStateParts.ITileState {
    imageFit: TImageFit;
...
export default class TileView extends ListView {
    ...
    getActionsMenuConfig(
        ...
        menuConfig: IContextTileMenuConfig,
