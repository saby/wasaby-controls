...
export default interface IItemTemplateOptions extends IBaseItemTemplateOptions {
    ...
    /**
     * Опция, позволяющая установить автоматическую подстройку высоты плитки в случае, когда элементы с разными шаблонами необходимо выровнять по высоте, а блок, автоматически растягивающий плитку не построился.
     * Единственное значение: auto
     * @cfg {String}
     * @demo Controls-demo/tileNew/DifferentItemTemplates/MixedTemplates/Index
     */
    height?: 'auto';
}
