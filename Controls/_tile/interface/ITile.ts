 ...
 * Если опция {@link Controls/tile:ItemTemplate#staticHeight staticHeight} не установлена в значение "true", опция tileHeight задает минимальную высоту, а дальше плитка пропорционально растягивается от ширины (см. {@link Controls/tile:View#tileWidth tileWidth} и {@link Controls/_treeTile/interface/ITreeTile#folderWidth folderWidth}).
 *
 * @example
 ...
 * @cfg {Number} Ширина элементов, отображаемых в виде плитки.
 * @default 250
 ...
 * Влияние опции на отрисовку шаблона плитки зависит от опции {@link Controls/_tile/interface/ITile#tileMode tileMode}:
 ...
 * Если ширина установлена на самом шаблоне плитки в опцию {@link Controls/tile:ItemTemplate#width width}, то tileWidth не учитывается.
 * @example
 ...
 * @cfg {String} Название свойства на элементе, которое содержит числовое значение минимальной ширины плитки.
