...
export function getItemActionsTemplate(
    ...
    return React.forwardRef(
        (
            ...
            const iconStyle =
                props.iconStyle ??
                (props.itemType === 'rich' ? 'default' : undefined);
            ...
            return (
                <HoverActionsTemplate
                    ...
                    actionPadding={
                        props.actionPadding || itemActionsProps.actionPadding
                    }
...
export function ItemActionsResolverComponent(
    ...
    if (shouldDisplayHoverActions) {
        const itemActionsClass = item.getItemActionsClasses(
            props.itemType,
...
export function ItemActionsControl(props: ITileItemProps): React.ReactElement {
    ...
    const actionStyle =
        !props.titleStyle || props.titleStyle === 'light'
            ? 'tileLight'
            : 'tileDark';
    // @see Controls/_baseList/Render/ForReact.tsx#L79
    const controlContent = !detection.isMobilePlatform ? (
