...
export function getImageSize(
    ...
    if (imageFit === IMAGE_FIT.COVER && imageWidth && imageHeight) {
        ...
        if (
            imageDeltaW > tileDeltaW &&
            imageDeltaW < tileDeltaW * DEFAULT_SCALE_COEFFICIENT
        ) {
...
export function getItemSize(
    ...
    if (tileMode === 'dynamic' && imageWrapper) {
        ...
        imageWrapper.style.height =
            imageWrapperRect.height * zoomCoefficient + 'px';
    }
