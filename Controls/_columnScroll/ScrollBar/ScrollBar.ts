...
export default class ScrollBar extends Control<IScrollBarOptions> {
    ...
    setSizes(params: {
        ...
        if (
            typeof params.contentSize !== 'undefined' &&
        ...
        if (
            typeof params.scrollWidth !== 'undefined' &&
    ...
    _isArrowActive(direction: 'left' | 'right'): boolean {
        return (
            ...
            this._isArrowsMode() &&
            this._position !==
                (direction === 'left' ? 0 : this._maxScrollPosition)
        );
    }
    ...
    protected _onArrowClick(e: Event, direction: 'left' | 'right'): void {
        ...
        const newScrollPosition =
            this._position +
            (direction === 'left' ? -this._scrollWidth : this._scrollWidth);
    ...
    private _updateScrollPosition(scrollPosition: number): void {
        const newScrollPosition = roundInRange(scrollPosition, [
            0,
