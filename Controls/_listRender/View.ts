...
export default class View extends Control<IViewOptions> {
    ...
    protected _beforeUpdate(options: IViewOptions): void {
        ...
        if (
            ...
            ((options.itemActions || options.itemActionsProperty) &&
                collectionRecreated) ||
    ...
    protected _isVisibleItemActions(itemActionsMenuId: number): boolean {
        return (
            !itemActionsMenuId ||
            this._options.itemActionsVisibility === 'visible'
        );
    }
    ...
    private _resolveItemContainer(
        ...
        return isMenuClick
            ...
            : Array.prototype.filter.call(
                  container.querySelector('.controls-ListView__itemV')
                      .parentNode.children,
                  (elem: HTMLElement) => {
                      return elem.className.includes(
    ...
    private _openItemActionsMenu(
         ...
         */
        this._targetItem = clickEvent.target.closest(
            '.controls-ListView__itemV'
        );
