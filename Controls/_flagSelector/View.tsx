...
import { IAreaCodeData, AREA_PHONE_CODES, getAreaPhoneCode } from './Utils';
...
export default React.forwardRef(function View(props: IFlagSelectorProps, ref) {
    ...
    const [selectedLocaleData, setSelectedLocaleData] = React.useState<IAreaCodeData>(() => {
        return getAreaPhoneCode(props.value);
    });
    ...
    React.useEffect(() => {
        const selectedFlag = getAreaPhoneCode(props.value, selectedItem);
