...
export default React.forwardRef(function itemCounterTemplate(
    props: IItemTemplateProps, ref
) {
    return (
        <ItemTemplate
            ref={ref}
            ...
            contentTemplate={(
                contentTemplateProps: IContentTemplateOptions
            ) => {
                return (
                    <>
