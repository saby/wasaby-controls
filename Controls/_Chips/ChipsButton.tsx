...
/**
 * @name Controls/Chips:Button#onValueChanged
 * @cfg {Function} Функция-обработчик изменения значения в контроле
 */

/**
 * @name Controls/Chips:Button#onClick
 * @cfg {Function} Функция-обработчик события клика
 */
