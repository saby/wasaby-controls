...
export default React.forwardRef(function ChipsButton(
    ...
    let className =
        ...
        ` controls-Button-inlineheight-${inlineHeight} controls-button_size-${inlineHeight} controls-button_padding-${inlineHeight} controls-button_fontsize-${fontSize}` +
        ...
        >
            <span
                className={
                    ...
                    ` tw-items-${props.isCustomCaptionTemplate ? 'center' : 'baseline'}` +
