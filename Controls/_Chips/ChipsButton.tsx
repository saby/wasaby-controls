...
export default React.forwardRef(function ChipsButton(
    ...
    let className =
        ...
        ` controls-Button-inlineheight-${inlineHeight} controls-fontsize-${fontSize} controls-ButtonGroup__button ${getButtonClass()}`;
    if (props.className) {
        ...
        >
            <span
                className={
                    ...
                    ` controls-Button__wrapper_inline-height_${inlineHeight}` +
                ...
                {props.iconTemplate ? (
                    <props.iconTemplate
                        className={
                            ...
                            ` tw-self-center controls-icon_style-${getIconStyle()}`
                        }
                        {...iconOptions}
                    />
                ) : props.icon ? (
                    <Icon
                        className="controls-Button__icon controls-BaseButton__icon tw-self-center"
                        tabIndex={-1}
                        icon={props.icon}
                        iconSize={iconSize}
