 ...
 * @remark
 * По умолчанию при видимой кнопке разворота узла в первую ячейку подвала, итогов, и шапки таблицы добавляется отступ, позволяющий отобразить содержимое на одоной вертикаоьной линии.
