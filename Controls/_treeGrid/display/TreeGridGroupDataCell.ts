...
import { ITreeRowComponentProps } from 'Controls/_treeGrid/renderReact/CellRenderWithExpander';
import { GroupDataCellRender } from 'Controls/_treeGrid/renderReact/GroupCellContent';
...
>(TreeGridDataCell, GroupMixin) {
    ...
    getContentClasses(): string {
        ...
        if (this._$column?.groupNodeConfig?.padding) {
            classes += ' controls-padding_top-' + this._$column.groupNodeConfig.padding.top;
            classes += ' controls-padding_bottom-' + this._$column.groupNodeConfig.padding.bottom;
        }
