...
import { TreeGridGroupDataCell, TreeGridGroupDataRow } from 'Controls/treeGridDisplay';
import { IColumn as ITreeGridColumn } from 'Controls/_treeGrid/interface/IColumn';
import { IHierarchyGroupDataCellComponentProps } from 'Controls/_treeGrid/cleanRender/cell/HierarchyGroupDataCellComponent';
...
export function getHierarchyGroupCellComponentProps(
    ...
    const cellConfig: ITreeGridColumn = cell.getColumnConfig();
    ...
    const renderProps: IGroupCellComponentProps = {
        ...
        hoverBackgroundStyle:
            getCellPropsResult.hoverBackgroundStyle !== undefined
                ? getCellPropsResult.hoverBackgroundStyle
                : 'default',
    ...
    if (cellConfig.groupNodeConfig) {
        ...
        Object.keys(cellConfig.groupNodeConfig).forEach((key) => {
            if (key === 'padding') {
                ...
                renderProps[key as keyof IGroupCellComponentProps] = cellConfig.groupNodeConfig[key];
            }
        });
