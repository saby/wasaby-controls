 ...
 * @interface Controls/_treeGrid/renderReact/ContentRenderWithExpander/ITreeRowProps
 * @public
 */
export interface ITreeRowProps extends IRowProps, IExpanderProps {}

/**
 * Функция, возвращающая {@link Controls/_treeGrid/renderReact/ContentRenderWithExpander/ITreeRowProps свойства строки дерева с колонками}
 * @typedef Controls/_treeGrid/renderReact/ContentRenderWithExpander/TGetTreeRowPropsCallback
 */
...
export default function ContentRenderWithExpander(props: IProps) {
