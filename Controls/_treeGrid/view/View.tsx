...
import { TreeGridCellComponent } from 'Controls/_treeGrid/cell/DataCellComponent';
...
export function getRowComponent(
    ...
    rowProps.isGroupChild =
        item['[Controls/treeGrid:TreeGridDataRow]'] && item?.getParent?.().isGroupNode?.();
