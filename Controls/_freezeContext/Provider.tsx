...
export interface IFreezeContextProvider extends TInternalProps {
    isFreeze: boolean;
}
 ...
 */
export const Context = createContext(null as unknown as IFreezeContextProvider);

export default function ContextProvider(props: IFreezeContextProvider) {
