...
const ANIMATIONS_DATA = {
    slideRight: {
        preAnimationInClasses:
            'controls-MonthSlider-Slider__slideLeftRight-left',
        preAnimationOutClasses:
...
export default class Slider extends Control<IControlOptions> {
    ...
    private _prepareAnimation(itemData: object): void {
        ...
        item.transitionClasses =
            ANIMATIONS_DATA[this._inAnimation].preAnimationInClasses;
        ...
        item.transitionClasses =
            ANIMATIONS_DATA[this._outAnimation].preAnimationOutClasses;
    }
    ...
    private _animate(): void {
        ...
        month.transitionClasses =
            ANIMATIONS_DATA[this._inAnimation].animationInClasses;
        ...
        month.transitionClasses =
            ANIMATIONS_DATA[this._outAnimation].animationOutClasses;
    }
