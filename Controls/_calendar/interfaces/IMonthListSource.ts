...
export interface ISource extends ICrud {
    getInitialData?: (position: Date) => Promise<RecordSet>;
}

export interface IHolidaysGetter {
    getHolidays: (startValue: Date, endValue: Date) => Promise<RecordSet>;
}
...
export interface IMonthListSourceOptions {
    ...
    order?: string;
    filter?: {};
    holidaysGetter?: IHolidaysGetter;
}
/* Eng
