...
export default class MonthView extends React.Component<IControlOptions> {
    ...
    protected _dayClickHandler(
        ...
        if (
            ...
            this.props.onItemclick(event, item, event, extData);
        }
    }
    ...
    protected _mouseEnterHandler(
        ...
        if (
            isCurrentMonth ||
            (this.props.mode === 'extended' && this._isDayAvailable(item))
        ) {
    ...
    render(): React.ReactElement {
        ...
        return (
            <div
                ...
                data-qa={attrs['data-qa'] || 'controls-MonthViewVDOM'}
