...
export default class MonthSlider extends Control<IControlOptions> {
    ...
    protected _updateArrowButtonVisible(
        ...
        this._prevArrowButtonVisible =
            firstDate < normalizedDate || firstDate === null;
        this._nextArrowButtonVisible =
            lastDate > normalizedDate || lastDate === null;
    }
    ...
    private _setMonth(
        ...
        this._animation =
            month < this._month
                ? Slider.ANIMATIONS.slideRight
                : Slider.ANIMATIONS.slideLeft;
        this._month = month;
    ...
    private _getHomeVisible(
        ...
        const canBeDisplayed = DateUtil.hitsDisplayedRanges(
            currentDate,
            displayedRanges
        );
