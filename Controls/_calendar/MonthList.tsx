        ...
        IDisplayedRanges
{
    ...
    constructor(props: IMonthListOptions) {
        ...
        const normalizedPosition = this._normalizeDate(position, props.viewMode, props.amountOfCustomItems);
    ...
    private _updateSource(props: IMonthListOptions, oldProps?: IMonthListOptions): boolean {
        if (
            ...
            let normalizedPosition = this._normalizeDate(position, props.viewMode, this.props.amountOfCustomItems);
