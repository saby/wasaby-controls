        ...
        IDisplayedRanges
{
    ...
    componentDidMount() {
        ...
        if (this._extData && this.props.source && !this.props.source.getInitialData) {
    ...
    private _updateItemTemplate(props: IMonthListOptions): void {
        ...
        this._itemTemplate =
            props.viewMode === VIEW_MODE.year ? props.yearTemplate : props.monthTemplate;
    }
    ...
    private _normalizeDate(date: Date, viewMode?: VIEW_MODE): Date {
        return (viewMode || this.props.viewMode) === VIEW_MODE.year
            ...
            if (entry.data) {
                ...
                if (boundingClientRect.top - rootBounds.top <= 0) {
                    ...
                    if (boundingClientRect.bottom - rootBounds.top >= SCALE_ROUNDING_ERROR_FIX) {
                        ...
                        if (this.props.viewMode === VIEW_MODE.year) {
    ...
    private _updateDisplayedItems(entry: IntersectionObserverSyntheticEntry): void {
        ...
        if (!this.props.source || !entry.data) {
            return;
        }
    ...
    private _canScroll(date: Date): boolean {
        ...
        if (this.props.viewMode === VIEW_MODE.year && date.getMonth() !== 0) {
            return true;
        }
            ...
            <error.Container forwardedRef={this._refCallback} viewConfig={this._errorViewConfig}>
                ...
                >
                    <ScrollContainer
                        ...
                        attachLoadTopTriggerToNull={this.props.attachLoadTopTriggerToNull}
                        attachLoadDownTriggerToNull={this.props.attachLoadDownTriggerToNull}
