...
import type { TFilter } from 'Controls-DataEnv/_interface/IFilter';
import { IPopupOptions } from 'Controls/_popup/interface/IPopup';
import { TSelectionType } from 'Controls-DataEnv/newLists/_listTypes/TSelectionRecordContent';
...
export interface ISuggestOptions
    ...
    onChoose?: (eventName: string, params: unknown[]) => void;
...
class Suggest extends Control<ISuggestOptions> {
    ...
    _showInputBorderBySuggestPopupWidth: boolean = false;
    _children: {
        input: Text;
    };
    ...
    _isInputWiderThanSuggest(): boolean {
