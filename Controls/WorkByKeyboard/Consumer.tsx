...
export default React.forwardRef(function ContextConsumer(
    props: IContextConsumerOptions,
    _
) {
    const context = React.useContext<IWorkByKeyboardContext>(
        WorkByKeyboardContext
    );
    React.useEffect(() => {
