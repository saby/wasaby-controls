...
function StickyGroupWrapper({ offsetTop = 0, ...props }) {
    ...
    return (
        <StickyGroup
            ...
            removedBlockInGroupCallback={
                groupContext.removedBlockInGroupCallback
            }
            ...
            groupChangeFixedPositionCallback={
                groupContext.groupChangeFixedPositionCallback
            }
...
export default StickyGroupWrapper;
