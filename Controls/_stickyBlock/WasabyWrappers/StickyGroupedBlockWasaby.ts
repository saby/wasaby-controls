 ...
 * @cfg {String} Позволяет задать стиль фона на контрол, когда он будет в зафиксированном состоянии.
 * @remark Для того чтобы выш фон отработал корректно, чтоит определить класс "controls-background-..."
 */
