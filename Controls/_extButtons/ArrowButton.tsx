...
export default React.forwardRef(function ArrowButton(
    ...
    return (
        <Button
            ...
            {...attrs}
            attrs={attrs}
            className={`controls-ArrowButton ${viewMode === 'stretched' ? `controls-ArrowButton_stretched-${direction}` : `controls-ArrowButton_${direction}`} ${attrs.className || props.className}`}
            viewMode={viewMode}
