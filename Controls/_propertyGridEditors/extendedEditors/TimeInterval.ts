...
import TimeIntervalTemplate = require('wml!Controls/_propertyGridEditors/extendedEditors/TimeInterval');
 ...
 * @class Controls/_propertyGridEditors/extendedEditors/TimeIntervalEditor
...
class TimeIntervalEditor extends Control<ITimeIntervalEditorOptions> implements IEditor {
    ...
    protected _handleInputCompleted(event: SyntheticEvent, value: Date): void {
        this._notify(
            ...
            [this._getStringValueConverter(this._options.mask).getStringByValue(value)],
            { bubbling: true }
        );
    }
