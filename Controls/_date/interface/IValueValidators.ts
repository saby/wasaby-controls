...
/**
 * @name Controls/_date/interface/IValueValidators#disableValidators
 * @cfg {Boolean} Отключает вызов переданных через опцию валидаторов.
 *
 * @remark
 * Не отключает нативные валидаторы полей ввода дат. Например, если пользователь введет '00.00.0000', все равно
 * вызовется ошибка валидации.
 */
