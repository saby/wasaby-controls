...
import getPopupClassName from 'Controls/_date/Utils/getPopupClassName';
...
export default class BaseSelector<IProps = IBaseSelectorOptions> extends React.Component<IProps> {
    ...
    constructor(props) {
        ...
        this.getArrowButtonReadOnly = this.getArrowButtonReadOnly.bind(this);
    ...
    getArrowButtonReadOnly(direction: 'left' | 'right'): boolean {
        return this._ref.current.getArrowButtonReadOnly(direction);
    }
    ...
    protected _getBasePopupOptions(value: { Date }) {
        ...
        return {
            ...
            className: getPopupClassName(this.props, this.context.theme),
    ...
    protected _mouseEnterHandler(): void {
        if (this.props.datePopupType && this.props.datePopupType !== 'datePicker') {
            let libName;
