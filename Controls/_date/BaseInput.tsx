...
export default class BaseInput<T extends IDateBaseOptions> extends React.Component<T> {
    ...
    protected _inputCompletedHandler(
        ...
        if (typeof event === 'string') {
            textValue = value;
            wsEvent = new SyntheticEvent('inputCompleted', {
                type: 'inputCompleted',
            });
        }
    ...
    private _onSelectionStartChanged(_, position: number): void {
        ...
        this.setSelectionPosition(selectionPosition);
    }

    setSelectionPosition(position: number): void {
