...
export default class LinkView extends React.Component<ILinkView> {
    ...
    UNSAFE_componentWillUpdate(props: ILinkView): void {
    ...
    private _updateProps(props: ILinkView): void {
        this._resetButtonVisible = this._getResetButtonVisible(props);
        this._caption = this._getCaption(props);
        this._fontColorStyle = this._getFontColorStyle(props.fontColorStyle, this.context?.readOnly);
    }
    ...
    render() {
        if (!this._fontColorStyle) {
            this._fontColorStyle = this._getFontColorStyle(this.props.fontColorStyle, this.context.readOnly);
        }
