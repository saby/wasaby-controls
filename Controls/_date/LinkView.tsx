...
export default class LinkView extends React.Component<ILinkView> {
    ...
    private _getFontColorStyle(
        ...
        if (readOnly) {
            if (
                newFontColorStyle === 'filterPanelItem' ||
                newFontColorStyle === 'filterItem'
            ) {
    ...
    render() {
        return (
            <div
                ...
                {...this.props.attrs}
                className={`controls-DateLinkView controls_shortDatePicker_theme-${this.props.theme} ${this.props.className} ${this.props.attrs?.className}`}
            >
                {!this.props.readOnly ? (
                    <Button
                        ...
                        className={`controls-DateLinkView__button-value controls-DateLinkView__value_fontWeight-${this.props.fontWeight}`}
                        caption={this._caption}
                        viewMode="link"
                        fontColorStyle={this._fontColorStyle}
                        fontSize={this.props.fontSize}
                        tootltip={this.props.tooltip}
                    ...
                    <span
                        ...
                        className={
                            ...
                            `controls-fontsize-${this.props.fontSize} ` +
                            `${
