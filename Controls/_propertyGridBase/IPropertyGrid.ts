...
import { IEditingPropertyGrid } from 'Controls/_propertyGridBase/interface/IEditingPropertyGrid';
import {
...
export interface IPropertyGridOptions
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#editingObject
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#typeDescription
     * @cfg {Controls/_propertyGridBase/IProperty[]} Конфигурация свойств в PropertyGrid.
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#groupTemplate
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#groupProperty
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#collapsedGroups
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#nodeProperty
    ...
    nodeProperty?: string;
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#parentProperty
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#keyProperty
     * @cfg {String} Имя свойства, содержащего информацию об идентификаторе текущей строки.
     */
    keyProperty?: string;
    render?: Control<IPropertyGridOptions>;
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#itemActions
     ...
     * @name Controls/_propertyGridBase/IPropertyGrid#itemActionVisibilityCallback
     * @function
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#multiSelectAccessibilityProperty
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#multiSelectVisibility
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#multiSelectPosition
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#multiSelectTemplate
     * @cfg {TemplateFunction|String} Пользовательский шаблон множественного выбора.
     */
    multiSelectTemplate?: Function;
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#captionFontColorStyle
     * @cfg {String} Цвет текста заголовков редакторов.
     * @variant unaccented
     * @variant label
     * @default label
     * @remark Значение fontColorStyle, заданное в {{Controls/_propertyGridBase/IProperty#captionOptions опциях заголовка редактора}} имеет больший приоритет.
     * @demo Controls-demo/PropertyGridNew/CaptionOptions/Index
     */
    captionFontColorStyle: 'label' | 'unaccented';
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#captionFontSize
     * @cfg {Controls/_interface/IFontSize/TFontSize.typedef} Размер шрифта заголовков редакторов.
     * @default m
     * @remark Значение fontSize, заданное в {{Controls/_propertyGridBase/IProperty#captionOptions опциях заголовка редактора}} имеет больший приоритет.
     * @demo Controls-demo/PropertyGridNew/CaptionOptions/Index
     */
    captionFontSize: TFontSize;
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#captionFontWeight
     * @cfg {Controls/_interface/IFontWeight/TFontWeight.typedef} Начертание шрифта заголовков редакторов.
     * @variant default
     * @variant normal
     * @variant bold
     * @default default
     * @remark Значение fontWeight, заданное в {{Controls/_propertyGridBase/IProperty#captionOptions опциях заголовка редактора}} имеет больший приоритет.
     * @demo Controls-demo/PropertyGridNew/CaptionOptions/Index
     */
    captionFontWeight: TFontWeight;
    captionPosition?: TCaptionPosition;
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#contextMenuConfig
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#toggledEditors
    ...
    toggledEditors?: TKey[];
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#jumpingLabel
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#limit
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#propStorageId
     * @cfg {String} Уникальный идентификатор контрола, по которому будет сохраняться набор свернутых узлов в хранилище данных.
     */
    propStorageId?: string;

    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#expanderVisibility
     * @cfg {String} Режим отображения кнопки разворота узла родительского элемента редакторов.
     * @default hidden
     * @remark
     * С помощью этой опции включается функционал сворачивания/разворачивания родительских элементов.
     */
    expanderVisibility?: string;

    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#expandedItems
     * @cfg {Array<TKey>} Идентификаторы развернутых узлов в иерархической структуре PropertyGrid
     */
    expandedItems?: TKey[];
}
...
/**
 * @name Controls/_propertyGridBase/IPropertyGrid#captionPosition
...
/**
 * @event Controls/_propertyGridBase/IPropertyGrid#itemClick Происходит при клике на элемент.
 * @param {UI/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Controls/_propertyGridBase/PropertyGridCollectionItem} item Элемент, по которому произвели клик.
 * @param {Object} originalEvent Дескриптор исходного события.
 */

/**
 * @event Controls/_propertyGridBase/IPropertyGrid#editingObjectChanged Происходит при изменении объекта, свойства которого являются значениями для редакторов.
 * @param {UI/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Object | Types/entity:Model} editingObject Объект, с обновленными значениями для редакторов.
 */

/**
 * @event Controls/_propertyGridBase/IPropertyGrid#typeDescriptionChanged Происходит при изменении конфигурации свойств в PropertyGrid.
 * @param {UI/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Controls/_propertyGridBase/IProperty[]} typeDescription конфигурация свойств в PropertyGrid.
 * @see typeDescription
 */

/**
 * @event Controls/_propertyGridBase/IPropertyGrid#toggledEditorsChanged Происходит при скрытии или показе редакторов.
 * @param {UI/Events:SyntheticEvent} eventObject Дескриптор события.
...
/**
 * @event Controls/_propertyGridBase/IPropertyGrid#validateFinished Происходит при завершении валидации редактора.
 * @param {UI/Events:SyntheticEvent} eventObject Дескриптор события.
 ...
 *
 * @interface Controls/_propertyGridBase/IPropertyGrid
 * @public
 * @author Герасимов А.М.
 */
export interface IPropertyGrid {
    readonly '[Controls/_propertyGridBase/IPropertyGrid]': boolean;
}
