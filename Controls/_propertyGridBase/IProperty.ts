...
export default interface IProperty {
     ...
     * @remark
     * Редактору в опции propertyValue приходит текущее значение свойства из {@link Controls/propertyGrid:PropertyGrid#editingObject}
     ...
     * @variant number Числовой тип, редактор по умолчанию - {@link Controls/propertyGridEditors:Number}
     * @variant boolean Логический тип, редактор по умолчанию - {@link Controls/propertyGridEditors:Boolean}
     * @variant string Строковой тип, редактор по умолчанию - {@link Controls/propertyGridEditors:String}
     * @variant text Строковой тип, отличается от типа string редактором - {@link Controls/propertyGridEditors:Text}
     * @variant enum Перечисляемый тип, редактор по умолчанию - {@link Controls/propertyGridEditors:Enum}
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#validateTemplateName
     ...
     * @param {Controls/_propertyGridBase/IProperty[]} items свойства в PropertyGrid
     */

    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#validators
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#captionValidators
    ...
    /**
     * @name Controls/_propertyGridBase/IPropertyGrid#isEditable
    ...
    /**
     * @cfg {Controls/_propertyGridBase/IPropertyGrid/TCaptionPosition.typedef} Определяет расположение заголовка редактора.
     ...
     * @see Controls/_propertyGridBase/IPropertyGrid#captionPosition
     */
