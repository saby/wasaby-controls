    ...
    protected _beforeMount(): void {
        ...
        if (serverSidePopup) {
            if (!constants.isServerSide) {
                ...
                if (typeof serverSidePopup.position.top === 'number') {
                    serverSidePopupConfig.top = serverSidePopup.position.top;
                }
                if (typeof serverSidePopup.position.left === 'number') {
                    serverSidePopupConfig.left = serverSidePopup.position.left;
                }
