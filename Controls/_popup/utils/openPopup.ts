 ...
 * @param openCallback
 */
export function startLoadersIfNecessary(config: IBaseOpenerOptions, openCallback: Function): void {
        ...
        const openPopup = () => {
            ...
            const showDialog = (
                ...
                if (cancelablePromise.isCanceled() === false) {
                    startLoadersIfNecessary(popupConfig, () => {
                        BaseOpener.showDialog(templateModule, popupConfig, controllerModule).then(
                            (popupId: string) => {
            ...
            const openByConfig = (popupCfg: IBaseOpenerOptions, controllerModuleName: string) => {
                ...
                if (tplModule && contrModule) {
                    ...
                    BaseOpener.requireModules(popupCfg, controllerModuleName)
