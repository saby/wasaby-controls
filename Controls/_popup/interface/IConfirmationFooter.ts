...
export interface IConfirmationButton {
    caption: string;
    // @ts-ignore Если будет не any то не сможем на лету посчитать возвращаемое значение для openPopup
    value: any;
    viewMode?: string;
    buttonStyle?: string;
...
/**
 * Интерфейс для опций футера информационного окна.
 ...
 * позиционирующихся в нижней части информационного окна.
 * @example
 * <pre>
 ...
 *      },
 *      {
 *          caption: 'Собрать без конвертации',
 *          viewMode: 'link',
