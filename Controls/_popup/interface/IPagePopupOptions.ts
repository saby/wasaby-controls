 ...
 * @cfg {String} Идентификатор страницы, указанный в {@link /doc/platform/developmentapl/interface-development/application-configuration/create-page/new-page/ конфигурации страницы}
 */
