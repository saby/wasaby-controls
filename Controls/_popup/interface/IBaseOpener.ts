...
/**
 * @name Controls/_popup/interface/IBaseOpener#destroy
 * @description Разрушает экземпляр класса.
 * @function
 */

/**
 * @name Controls/_popup/interface/IBaseOpener#getPopupId
 * @description Возвращает идентификатор открытого окна. В случае если окно не открыто вернет null.
 * @returns {String|null} Идентификатор открытого окна.
 * @function
 */
 ...
 * @returns {Promise<String>} Возвращает промис, который содержит в себе идентификатор окна
 * @example
