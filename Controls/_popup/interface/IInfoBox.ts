 ...
 */
import { IBackgroundStyleOptions, IComponentProps } from 'Controls/interface';
import { IEventHandlersOptions, ILoadConfigOptions } from 'Controls/popup';
...
export interface IInfoBoxOptions<T = any>
     ...
     * @cfg {String} Сторона таргета, относительно которой будет позиционироваться всплывающая подсказка.
    ...
    alignment?: string;
    /**
     * @name Controls/_popup/interface/IInfoBoxOptions#borderStyle
     ...
     * @cfg {String} Определяет, какое событие будет инициировать открытие и закрытие всплывающей подсказки.
    ...
    templateOptions?: T;
    /**
     * @name Controls/_popup/interface/IInfoBoxOptions#closeButtonVisible
    ...
    /**
     * @name Controls/_popup/interface/IInfoBoxOptions#horizontalPadding
     * @cfg {String} Задает отступ контента по горизонтали
     * @variant m
     * @variant null
     * @default m
     * @demo Controls-demo/Popup/InfoBox/doc/VerticalPadding/Index
     */
    ...
    /**
     * @name Controls/_popup/interface/IInfoBoxOptions#verticalPadding
     * @cfg {String|null} Определяет наличие вертикальных отступов внутри шаблона
     * @variant xs Вертикальные отступы размера xs
     * @variant null Вертикальные отступы отсутствуют
     * @default xs
     * @remark Данная опция предназначена только для шаблона, открывающегося с помощью InfoboxTarget, так как базовый шаблон Controls.popupTemplate:InfoBox не имеет вертикальных отступов.
     * @demo Controls-demo/Popup/InfoBox/doc/VerticalPadding/Index
     */
}
 ...
 * @property {String} trigger Определяет, какое событие будет инициировать открытие и закрытие всплывающей подсказки.
 * @property {String} targetSide Сторона таргета, относительно которой будет позиционироваться всплывающая подсказка.
...
/**
 * @name Controls/_popup/interface/IInfoBoxOptions#openInfoBox
...
/**
 * @name Controls/_popup/interface/IInfoBoxOptions#closeInfoBox
