...
import { IEdgeOffsetOptions } from './IEdgeOffset';
...
/**
 * Интерфейс для опций {@link https://n.sbis.ru/article/14b8c2f4-296b-44ea-8110-2bcf4fc8c7b6 диалоговых окон}.
 * @public
 ...
 * @description Свойства объекта, передаваемого в опцию offset.
...
/**
 * @name Controls/_popup/interface/IDialogOpener#isCentered
 * @cfg {Boolean} Определяет, будет ли окно отображаться по центру экрана на ПК с поддержкой тача.
 * @remark Из-за особенностей работы виртуальной клавиатуры нельзя корректно посчитать позицию окна
 * полсе ее открытия.
 * @default true
 * @deprecated Опция устарела и больше не поддерживается.
 */
