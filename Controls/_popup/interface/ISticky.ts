...
export interface IStickyPopupOptions extends IBasePopupOptions, IBackgroundStyleOptions, IAdaptivePopupOptions {
...
/**
 * @typedef {Object} TActionOnScroll
 ...
 * @property {TActionOnScroll} actionOnScroll Реакция прилипающего блока на скролл родительской области.
 ...
 * @cfg {TActionOnScroll} Определяет реакцию прилипающего блока на скролл родительской области.
 * @default none
