...
/**
 * Интерфейс для опций {@link https://n.sbis.ru/article/d09d217d-f080-4a81-9790-a4c279d8fa8e нотификационных окон}.
 * @public
 ...
 * @description Конфигурация нотификационного окна.
 * @property {Boolean} autofocus Установится ли фокус на шаблон попапа после его открытия.
 * @property {String} className Имена классов, которые будут применены к корневому узлу окна уведомления.
 ...
 * @remark
 * При наличии нескольких попапов с включенной опцией, они будут отображаться в порядке появления.
 * @default false
 */
