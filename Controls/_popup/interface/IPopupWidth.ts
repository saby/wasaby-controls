...
/**
 * Интерфейс, который используется для установки ширин в буквенном или числовом варианте.
 *
 ...
 * @default Ширина окна устанавливается по размерам содержимомого.
 */
