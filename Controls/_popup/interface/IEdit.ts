 ...
 * @interface Controls/_popup/interface/IEditOpener
 * @public
 */
 ...
 * <a href="/materials/DemoStand/app/Controls-demo%2FPopup%2FEdit%2FOpener">Demo-example</a>
 ...
 * @param {Object} meta Данные, которые определяют откуда диалог получит редактируемую запись. В объект можно передать свойства {@link /docs/js/Controls/form/Controller/options/entityKey/ entityKey} и {@link /docs/js/Controls/form/Controller/options/record/ record}.
 ...
 * @param {String} formControllerEvent Действие над записью, которое выполняется через formController: чтение записи("read"), обновление существующей записи("update"), начало обновления существующей записи("updatestarted"), неудачное обновление существующей записи("updateFailed"), создание новой записи ("create"), начало удаления записи ("deleteStarted") или удаление записи ("delete").
 * @param {Object} record Редактируемая запись.
 ...
 * @variant stack Отображение диалога в {@link https://n.sbis.ru/article/558ad4e6-866f-43a6-8093-af46125111ca стековом окне}. Для открытия диалога редактирования используйте класс {@link Controls/popup:Stack}.
 * @variant dialog Отображение диалога в {@link https://n.sbis.ru/article/14b8c2f4-296b-44ea-8110-2bcf4fc8c7b6 диалоговом окне}. Для открытия диалога редактирования используйте класс {@link Controls/popup:Dialog}.
 * @variant sticky Отображение диалога в {@link /doc/platform/developmentapl/interface-development/controls/openers/sticky/ прилипающем окне}. Для открытия диалога редактирования используйте класс {@link Controls/popup:Sticky}.
 */
/*
 * @name Controls/_popup/interface/IEditOpener#mode
