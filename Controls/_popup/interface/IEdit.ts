 ...
 * @variant sticky Отображение диалога в {@link https://n.sbis.ru/article/7c32a8ae-6e9b-4859-b9d3-7e7237663a6e прилипающем окне}. Для открытия диалога редактирования используйте класс {@link Controls/popup:Sticky}.
 */
/*
 * @name Controls/_popup/interface/IEditOpener#mode
