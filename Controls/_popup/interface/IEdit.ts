 ...
 * @param {Object} meta Данные, которые определяют откуда диалог получит редактируемую запись. В объект можно передать свойства entityKey и record, политика обработки которых описана {@link /doc/platform/developmentapl/interface-development/controls/list/actions/editing-dialog/#step22 здесь}.
