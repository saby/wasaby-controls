 ...
 * @class Controls/_popup/Edit
 * @remark
 * Полезные ссылки:
 * <ul>
 *     <li>{@link /materials/DemoStand/app/Controls-demo%2FPopup%2FEdit%2FOpener демо-пример}</li>
 *     <li>{@link /doc/platform/developmentapl/interface-development/controls/list/actions/editing-dialog/#step4 руководство разработчика}</li>
