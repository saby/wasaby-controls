 ...
 * @class Controls/_popup/Notification
 * @remark
 * Полезные ссылки:
 * <ul>
 *     <li>{@link /materials/DemoStand/app/Controls-demo%2FPopup%2FNotification%2FIndex демо-пример}</li>
...
export default class Notification extends BaseOpener<IControlOptions> {
    ...
    /**
     * Статический метод для открытия нотификационного окна.
     ...
     * @static
     * @remark
     * Дополнительный пример работы со статическим методом доступен {@link https://n.sbis.ru/article/d09d217d-f080-4a81-9790-a4c279d8fa8e#toc_c6ddeb64-6973-49a1-989d-519cae7b6909 здесь}.
