...
export default class Opener extends Component<IPortalOpener> {
    ...
    open(props: IPortalOpener = {}): Promise<string> {
        ...
        return this._opener
            .open({
                ...
                templateOptions: this._getContentProps(props.contentProps || props.templateOptions),
    ...
    private _getContentProps(contentProps: object) {
        return {
