...
import { IComponentProps, ICaptionOptions } from 'Controls/interface';

interface IMisspellContainerOptions extends TInternalProps, IComponentProps, ICaptionOptions {
