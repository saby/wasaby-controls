...
import { ICaptionOptions, IComponentProps, IHeightOptions } from 'Controls/interface';
import { ISearchInputOptions } from '../Search';
import SearchButtonTemplate from './searchButton';

interface ISearchButtonTemplateOptions extends TInternalProps, IComponentProps, ICaptionOptions {
...
export default React.forwardRef(function SearchButtonLeftTemplate(
    ...
    return (
        <div
            className={`controls_search_theme-${theme} controls-Search__buttons controls-Search__buttons-leftTemplate`}
            ref={ref}
        >
