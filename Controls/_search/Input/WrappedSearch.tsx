 ...
 *
 * Классы для задания ширины строки поиска:
 * * controls-Search-inlineWidth-s Маленькая ширина строки поиска.
 * * controls-Search-inlineWidth-l Большая ширина строки поиска.
 * * controls-Search-inlineWidth-xl Очень большая ширина строки поиска.
 *
...
export default class WrappedSearch<IProps = ISearchInputOptions> extends React.Component<IProps> {
    ...
    activate(...args: Parameters<Search['activate']>): ReturnType<Search['activate']> {
        ...
        return this._ref.current?.activate(...args);
    }
