...
export interface ISearchInputOptions extends IBaseOptions, ITextOptions {
...
class Search extends Base<ISearchInputOptions> {
    ...
    protected _renderStyle(): string {
        ...
        if (
            ...
            this._options._dataOptionsValue?.contrastBackground
        ) {
    ...
    protected _initProperties(): void {
        ...
        this._rightFieldWrapper.scope.isVisibleReset =
            _private.isVisibleResetButton.bind(this);
        this._rightFieldWrapper.scope.getIconSize =
            _private.getIconSize.bind(this);

        this._leftFieldWrapper.template = leftTemplate;
        this._leftFieldWrapper.scope.getIconSize =
            _private.getIconSize.bind(this);
    }
 ...
 * * WML
 * <pre>
 *     <Controls.SuggestSearch on:searchClick="_searchClick()" bind:value="_value">
 *        ...
