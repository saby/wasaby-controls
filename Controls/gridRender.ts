...
/**
 * Библиотека компонентов, необходимых для рендера {@link /doc/platform/developmentapl/interface-development/controls/list/grid/ таблицы}.
 * @library
...
export { default as IEmptyTemplate } from 'Controls/_gridRender/interface/EmptyTemplate';

export {
    IColumnDataDecoratorProps,
    IGridColumnDataDecoratorProps,
} from 'Controls/_gridRender/cell/interface/IColumnDataDecoratorProps';

export {
    IEditableGrid,
    IBeforeBeginEditEventResultOptions,
    IEditableGridOptions,
    IGridEditingConfig,
    IItemAddOptions,
    IItemEditOptions,
    TAddPosition,
    TEditingMode,
    TSequentialEditingMode,
...
} from 'Controls/_gridRender/interface/IEditableGrid';

export {
    default as SortingButton,
    ISortButtonProps,
    IArrowProps as TSortingButtonArrowProps,
    TOnSortingClick,
    TAlign as TSortingButtonAlign,
    TOverflow as TSortingButtonOverflow,
    TWhiteSpace,
} from 'Controls/_gridRender/components/SortButton';
...
export * as CheckboxClassUtils from 'Controls/_gridRender/cell/utils/Classes/CheckboxClasses';
...
export * as CursorUtils from 'Controls/_gridRender/cell/utils/Props/Cursor';
...
export {
    ...
    TColumnKey,
} from 'Controls/_gridRender/cell/interface/IBaseColumnConfig';
export { ICellProps } from 'Controls/_gridRender/cell/interface/ICellProps';
export {
    default as GridView,
    propsAreEqual as gridViewPropsAreEqual,
    getRowComponent,
} from 'Controls/_gridRender/View';
export { IGridViewProps, IEditArrowGridProps } from 'Controls/_gridRender/interface/IView';
...
export {
    ...
    TPercents,
    TFractures,
} from 'Controls/_gridRender/cell/interface/IColumnConfig';
export { IHeaderConfig } from 'Controls/_gridRender/cell/interface/IHeaderConfig';
...
export {
    ...
    IListData,
    TWatchedData,
} from 'Controls/_gridRender/hooks/useListData';
...
export { default as LadderWrapper, ILadderWrapperProps } from 'Controls/_gridRender/ladder/Wrapper';
...
export {
    ...
    validate,
    TemplateNameType,
} from 'Controls/_gridRender/utils/compatibleValidator';
