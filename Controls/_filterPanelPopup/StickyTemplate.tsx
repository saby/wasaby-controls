...
export default forwardRef(function FilterPanelPopupStickyTemplate(
    ...
    return (
        <Dialog
            ...
            className={`controls-FilterPanelPopup controls-FilterPanelPopup-${orientation} controls_filterPanelPopup_theme-${theme} controls_filterPanel_theme-${theme} controls_filterPopup_theme-${theme} ${className} ${
                props.className
            } ${!isAdaptive ? 'controls-FilterPanelPopup-' + orientation + '_paddingTop' : ''}`}
