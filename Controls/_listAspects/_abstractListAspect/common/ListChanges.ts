...
const SET_SELECTED_COUNT: TSelectionChanges['name'] = 'SET_SELECTED_COUNT';
...
export const ListChangeNameEnum = {
    ...
    CHANGE_KEY_PROPERTY: 'CHANGE_KEY_PROPERTY',
...
export type IListChange =
    ...
    /* Изменить keyProperty */
    | {
          name: typeof ListChangeNameEnum.CHANGE_KEY_PROPERTY;
          args: {
              keyProperty: string;
          };
      }
