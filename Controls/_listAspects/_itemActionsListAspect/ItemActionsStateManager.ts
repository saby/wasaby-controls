 ...
 * @param actions
 */
function isValidSliceItemActions(actions: IAction[]): boolean {
        ...
        for (const change of changes) {
            switch (change.name) {
                case ItemActionsChangeName:
                    ...
                    nextState.itemActions = change.args.itemActions;
                    nextState.itemActionsProperty = change.args.itemActionsProperty;
                    nextState.itemActionVisibilityCallback =
                        change.args.itemActionVisibilityCallback;
                    break;
                ...
                case ListChangeNameEnum.REPLACE_ITEMS:
                    if (
                        nextState.itemActions?.length &&
                        isValidSliceItemActions(state.itemActions)
                    ) {
