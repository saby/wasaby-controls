...
export const SetHasMoreChangeName = 'SET_HAS_MORE';
export type TSetHasMoreChangeName = typeof SetHasMoreChangeName;
...
export interface IHasMoreChange {
    name: TSetHasMoreChangeName;
    args: {
