...
class Base extends React.Component<IMasterDetail, IMasterDetailState> {
    ...
    constructor(props = {} as IMasterDetail) {
        ...
        this.state = {
            ...
            masterBackgroundFeature: Feature?.get?.(['master_background'])[0],
            ...initMaxSizes,
        };
            ...
            >
                {this.props.masterVisibility !== 'hidden' ? (
                    <div
                        ...
                        ${
                            this.state.masterBackgroundFeature
                                ? 'controls-MasterDetail__master-template_light-mode'
                                : ''
                        }
                      `}
                        ...
                        {this.state.masterFixed ? (
                            ...
                            >
                                <div
                                    style={{
                                        display: 'contents',
                                        maxHeight: this.state.masterMaxHeight,
                                    }}
                                >
                                    <ScrollContainer
                                        ...
                                        attrs={{
                                            style: `maxHeight: ${this.state.masterMaxHeight}`,
                                        }}
                                    >
                ...
                {this.state.canResizing && !isMasterWidthEqualAuto(this.props.masterWidth) ? (
                    ...
                    >
                        <ResizingLine
                            ...
                            controls-MasterDetail_resizing-line_position-${this.props.masterPosition}
                        `}
...
export default React.forwardRef((props: Omit<IMasterDetail, 'forwardedRef'>, ref) => {
    ...
    return <Base {...props} isAdaptive={props.isAdaptive ?? isAdaptive} forwardedRef={ref} />;
});
