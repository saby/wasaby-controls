...
import { IntersectionObserverContainer, IntersectionObserverSyntheticEntry } from 'Controls/scroll';
...
const buildMarginStyle = (top: string = '0px', bottom: string = '0px'): string => {
...
function DataPinContainer(props: IProps, ref): JSX.Element {
     ...
     */
    const onIntersect = React.useCallback((entry: IntersectionObserverSyntheticEntry) => {
