...
import { IStickyPopupOptions, IStickyPosition, Opener as PopupOpener } from 'Controls/popup';
 ...
 * @implements Controls/dropdown:IBasePopupDropdown
...
class ComboBox extends BaseDropdown<IComboboxOptions, IComboboxState> {
    ...
    constructor(props: IComboboxOptions, context) {
        super(props);
        ...
        this._controller = new Controller(this._getControllerOptions(props, context));
        this.state = {
            ...this.state,
    ...
    componentDidUpdate(prevProps: IComboboxOptions): void {
        ...
        this._controller.update(this._getControllerOptions(this.props, this.context));
    ...
    _getControllerOptions(options: IComboboxOptions, context): object {
        ...
        return {
            ...
            ...{
                ...
                readOnly: this.state.readOnly ?? options.readOnly,
            },
        };
    }
    ...
    _setCountItems(items: RecordSet<Model>): void {
        ...
        if (
            countItems &&
            (this.props.emptyText || (this.props.selectedItems && this._countItems === undefined))
        ) {
            countItems += 1;
        }
    ...
    _onSingleItemHandler(result: Model[]): void {
    ...
    openMenu(popupOptions?: IStickyPopupOptions): void {
        this._openMenu(popupOptions).then((result) => {
            if (result) {
                this._onSingleItemHandler(result);
            }
        });
    }
        ...
        return (
            <>
                ...
                >
                    ...
                    {props.tagStyle ? (
                        <TagTemplate
                            className={`controls-ComboBox_tag_padding-right-${horizontalPadding}`}
