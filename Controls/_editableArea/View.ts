 ...
 *
 * Полезные ссылки:
 * * {@link https://git.sbis.ru/saby/wasaby-controls/-/blob/rc-24.6100/Controls-default-theme/variables/_editableArea.less переменные тем оформления}
 *
...
interface IViewControlOptions extends IViewOptions, IControlOptions {
    onBeforeEndEdit?: (editingObject: Record, commit: boolean) => Promise<unknown> | string;
    onBeforeBeginEdit?: (options: object, isAdd: boolean) => Promise<unknown> | string;
