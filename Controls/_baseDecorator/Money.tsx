 ...
 *
 * @public
 * @demo Controls-demo/Decorator/Money/Base/Index
 * @demo Controls-demo/Decorator/Money/Hovered/Index
 *
 */

export default React.memo(React.forwardRef(function Money(props: IMoneyOptions, ref): React.ReactElement {
    ...
    const fractionFontSize = props.fractionFontSize || calculateFractionFontSize(fontSize);
    ...
    const currencyClass = calculateCurrencyClass(currencySize, props.currencyStyle || fontColorStyle, fontWeight);
                    ...
                    <>
                        <span className={integerClass}>
                            {props.highlightedValue !== null && props.highlightedValue !== undefined
                                ? (
                                    <Highlight value={formattedNumber.integer}
                                               highlightedValue={String(props.highlightedValue)}
                                    />
                                  )
                        ...
                        {isDisplayFraction && abbreviationType !== 'long' ? (
                            <span className={fractionClass}>
                                ...
                                props.highlightedValue !== undefined
                                    ? (
                                        <Highlight value={formattedNumber.fraction}
                                                   highlightedValue={String(props.highlightedValue)}
                                        />
                                      )
                                    : formattedNumber.fraction}
 ...
 * @typedef {String|Number|Null} Controls/_baseDecorator/IMoney/TValue
 */

/**
 * Тип данных для аббревиатуры (сокращения) суммы
 * @typedef {String} Controls/_baseDecorator/IMoney/TAbbreviationType
 ...
 * @typedef {String} Controls/_baseDecorator/IMoney/TCurrency
 ...
 * @typedef {String} Controls/_baseDecorator/IMoney/TCurrencyPosition
 ...
 * @typedef {String} Controls/_baseDecorator/IMoney/TCurrencySize
 * @variant inherit
 * @variant xs
 * @variant s
 * @variant m
...
/**
 * @name Controls/_baseDecorator/IMoney#currencyStyle
 * @cfg {String} Стиль для отображаемой валюты. По умолчанию принимает значение опции fontColorStyle.
 * @variant primary
 * @variant secondary
 * @variant success
 * @variant warning
 ...
 * @variant default
 * @variant contrast
 * @demo Controls-demo/Decorator/Money/CurrencyStyle/Index
 */

/**
 * Тип данных для подчеркивания
 * @typedef {String} Controls/_baseDecorator/IMoney/TUnderline
 ...
 * @typedef {String} Controls/_baseDecorator/IMoney/TPrecision
 * @variant 0
 * @variant 2
 */
...
/**
 * @name Controls/_baseDecorator/IMoney#fractionFontSize
 * @cfg {Controls/interface:IFontSize/TFontSize.typedef} Определяет размер копеек.
 */
