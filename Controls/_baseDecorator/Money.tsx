...
export default React.memo(
    React.forwardRef(function Money(props: IMoneyOptions, ref): React.ReactElement {
        ...
        const currencyClass = calculateCurrencyClass(
            currencySize,
            props.currencyStyle || fontColorStyle,
            fontWeight
        );
 ...
 * @default none
 *
 * @remark Дробная часть будет всегда обрезаться.
 *
 ...
 * @demo Controls-demo/Decorator/Money/FontColorStyleCustom/Index
 */
 ...
 * @cfg {Controls/interface:TFontSize} Определяет размер копеек.
 */
