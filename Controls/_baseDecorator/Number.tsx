...
export default React.memo(function Number(props: INumberOptions): React.ReactElement {
    ...
    const prepareTitle = () => {
        if (title !== formattedNumber) {
            ...
            if (Math.round(textWidth) > Math.round(containerWidth)) {
    ...
    return (
        ...
        >
            {props.highlightedValue !== null && props.highlightedValue !== undefined ? (
                <Highlight value={formattedNumber} highlightedValue={props.highlightedValue} />
            ) : (
                formattedNumber
            )}
        </span>
 ...
 * @demo Controls-demo/Decorator/Number/Tooltip/Index
 */
 ...
 * @demo Controls-demo/Decorator/Number/FontColorStyleCustom/Index
 */
