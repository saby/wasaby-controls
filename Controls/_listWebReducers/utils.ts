...
import { SnapshotName, _private, _private_TErrorQueryConfig } from 'Controls-DataEnv/list';
...
const { getConfigAfterLoadError } = _private;
...
export async function getStateAfterLoadError<TState extends IListState = IListState>(
    ...
    loadError: Error,
    queryConfig: _private_TErrorQueryConfig
): Promise<TState> {
