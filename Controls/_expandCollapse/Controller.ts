...
export class Controller {
    ...
    constructor(options: IOptions) {
        ...
        this.setExpandedItems(
            options.expandedItems ? [...options.expandedItems] : []
        );
        this.setCollapsedItems(
            options.collapsedItems ? [...options.collapsedItems] : []
        );
    }
    ...
    onCollectionRemove(removedItems: TreeItem[]): IResult {
        ...
        if (
            this._model &&
            (this._options.expandedItems?.length ||
                this._options.collapsedItems?.length)
        ) {
    ...
    private _applyState(
        ...
        const intersection = ArraySimpleValuesUtil.getIntersection(
            expandedItems,
            collapsedItems
        );
