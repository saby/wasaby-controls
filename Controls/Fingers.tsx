...
export default class Fingers extends React.Component<IProps> {
    ...
    private _calcWrapperClassName(
        props: IFingerProps,
        isSelected: boolean
    ): string {
        let wrapperClassName =
            'Controls-Fingers__item Controls-Fingers__item-shadow';
        if (isSelected) {
    ...
    render() {
        ...
        const style: React.CSSProperties =
            this.props.attrs.style || this.props.styleProp || {};
    ...
    private static _resolveRoundBorder(
        alignment: TFingerAlignment
    ): IRoundBorder {
        const rounded = '2xl';
        const angular = 'null';
