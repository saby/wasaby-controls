...
export interface ISeparatorOptions extends IComponentProps, TInternalProps {
...
export default React.forwardRef(function Separator(
    ...
    const separatorStyle = React.useMemo<string>(() => {
        return props.style || props.separatorStyle || 'secondary';
    }, [props.style, props.separatorStyle]);
    ...
    return (
        <div
            ...
            ref={props.$wasabyRef}
            className={`controls-HeaderSeparator ${attrs.className} ${props.className || ''}`}
        >
