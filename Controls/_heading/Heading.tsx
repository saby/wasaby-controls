 ...
 *
 */
export default React.forwardRef(function Header(props: IHeadingOptions, ref): React.ReactElement {
    const {
        fontSize = 'l',
        textTransform = 'none',
        fontWeight = 'default',
    ...
    const headerClass =
        ...
        (fontWeight === 'normal' ? '' : ` ${getHeaderFontSizeClass(fontSize)}`) +
    ...
    return (
        <span
            {...attrs}
            data-qa={props.dataQa || attrs['data-qa']}
