...
import TreeGridSpaceRow from '../TreeGridSpaceRow';
import TreeGridGroupDataRow from '../TreeGridGroupDataRow';
    ...
    protected _sortItems(items: T[], options: ISortOptions<S, T>): number[] {
        ...
        const createSpaceItem = (
            ...
            return options.spaceItemFactory(group, {
                key: `space-collection-item-${position}-group-${groupId}`,
...
Object.assign(GroupNodeBlocks.prototype, {
    '[Controls/_treeGridDisplay/itemsStrategy/GroupNodeBlocks]': true,
