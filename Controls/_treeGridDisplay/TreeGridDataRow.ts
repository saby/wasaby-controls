...
import { ITreeItemOptions, TreeItem } from 'Controls/baseTreeDisplay';
    ...
    implements IDisplaySearchValue, IGroupNode
{
    ...
    setMultiSelectVisibility(multiSelectVisibility: string): boolean {
        ...
        return this._setMultiSelectVisibility(isChangedMultiSelectVisibility, hasCheckboxCell);
    }
    ...
    getRowComponentProps(
        ...
        const rowProps: IRowComponentProps = this._rowProps || {};
        return {
            ...
            ['data-qa']: rowProps?.dataQa || this.listElementName,
        };
    }
