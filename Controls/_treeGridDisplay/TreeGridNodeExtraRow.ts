...
import { IColumn, TColspanCallbackResult, TColumns } from 'Controls/gridDisplay';
import { INavigationViewConfig } from 'Controls/_interface/INavigation';
...
export default abstract class TreeGridNodeExtraRow extends TreeGridDataRow<null> {
    ...
    getViewConfig(): INavigationViewConfig | null {
        return this.getOwner?.()?.getNavigation?.()?.viewConfig ?? null;
    }
