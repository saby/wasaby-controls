 ...
 * Валидация запускается при смене value или при потере фокуса.
 * @remark
 ...
 * Важно! Подписываться на событие нужно именно на InputContainer. При подписке на событие в поле вода, событие будет срабатывать дважды.
 * @example
 * <pre>
