 ...
 * По умолчанию значение не задано, группы строятся без блоков.
 * @name Controls/interface/IGroupedList#groupViewMode
 * @cfg {Controls/_display/interface/ICollection/TGroupViewMode}
 * @demo Controls-demo/list_new/Grouped/GroupViewMode/blocks/Index В следующем примере группировка отображается в виде блоков.
 * @demo Controls-demo/list_new/Grouped/GroupViewMode/titledBlocks/Index В следующем примере группировка отображается в виде блоков, включающих заголовок группы.
 */
/**
