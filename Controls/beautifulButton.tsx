 ...
 */
export default forwardRef(function BeautifulButton(
    props: IButtonProps,
    ref
    ...
    let className = 'controls-button-beautiful ' + props.className;
    if (detection.isIE || (detection.chrome && detection.chromeVersion <= 110)) {
        className += ' controls-button-beautiful_old-browser';
    }
    return (
        <ButtonTemplate
            {...attrs}
...
/**
 * @name Controls/beautifulButton#fontColorStyle
 * @cfg {Controls/interface/TFontColorStyle.typedef}
 * @demo Controls-demo/BeautifulButtons/FontColorStyle/Index
 */

/**
 * @name Controls/beautifulButton#fontSize
 * @cfg {Controls/_interface/IFontSize/TFontSize.typedef}
 * @demo Controls-demo/BeautifulButtons/FontSize/Index
 */
