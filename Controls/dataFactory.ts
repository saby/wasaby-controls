...
export const ListWebActions = {
    ...
    complexUpdate,
    source,
    items: ListActionCreators.items,
    operationsPanel: ListActionCreators.operationsPanel,
    selection: ListActionCreators.selection,
    search: ListActionCreators.search,
    root: ListActionCreators.root,
    marker: ListActionCreators.marker,
};
