 ...
 * @library
 * @includes Slice Controls-DataEnv/newLists/_currentList/CurrentListSlice/CurrentListSlice
 * @includes ListSlice Controls-DataEnv/newLists/_list/ListSlice/ListSlice
 * @includes IListState Controls-DataEnv/newLists/_list/interface/IListState/IListState
 * @public
 */
...
} from './_dataFactory/interface/IListDataFactoryCompatible';
export { default as CompatibleList, CompatibleListSlice } from './_dataFactory/CompatibleList';
