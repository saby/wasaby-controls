...
import {
    default as ColumnsCollection,
    IColumnsOptions as IColumnsCollectionOptions,
} from 'Controls/_columns/display/Collection';
...
export { ColumnsCollection, IColumnsCollectionOptions };
