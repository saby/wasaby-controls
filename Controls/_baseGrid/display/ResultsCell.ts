...
class ResultsCell extends Cell<null, ResultsRow> {
    ...
    getWrapperClasses(backgroundColorStyle: string, templateHighlightOnHover: boolean): string {
        ...
        if (this._$resultsVerticalPadding) {
            wrapperClasses += ' controls-Grid__row-cell_withRowSeparator_size-null';
            wrapperClasses += ' controls-Grid__row-cell_default_style-default_min_height';
        }
    ...
    _getWrapperPaddingClasses(): string {
        ...
        let classes = '';
        if (this._$resultsVerticalPadding) {
            classes += this._getVerticalPaddingClasses();
        }
    ...
    getWrapperStyles(): string {
        ...
        if (this._$owner.isFullGridSupport() && !this.getColspanParams()) {
    ...
    getCellComponentProps(rowProps: IRowComponentProps): ICellComponentProps {
        ...
        const startColspanIndex = this._$column?.startColumn
            ...
            : superProps.startColspanIndex;
        const endColspanIndex = this._$column?.endColumn
            ? this._$column.endColumn + multiSelectOffset
            : superProps.endColspanIndex;

        superProps.className +=
            ' controls-GridReact__results-cell' +
            `controls-GridReact__results-cell_${this._$resultsPosition}`;
