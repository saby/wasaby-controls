...
export interface IHeaderCell extends IControlOptions, IRowspanParams, IColspanParams {
    ...
    caption?: string;
    /**
     * @cfg {Controls/_baseGrid/display/interface/IColumn/TOverflow.typedef} Поведение текста, если он не умещается в ячейке.
    ...
    /**
     * @cfg {Controls/_baseGrid/display/interface/IColumn/TCellHorizontalAlign.typedef} Выравнивание содержимого ячейки по горизонтали.
    ...
    /**
     * @cfg {Controls/_baseGrid/display/interface/IColumn/TCellVerticalAlign.typedef} Выравнивание содержимого ячейки по вертикали.
