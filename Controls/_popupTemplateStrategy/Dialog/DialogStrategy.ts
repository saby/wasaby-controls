...
import { Controller as ManagerController, IDialogPopupOptions, IPopupPosition, IPopupSizes } from 'Controls/popup';
...
export class DialogStrategy {
    ...
    private _validateCoordinate(
        ...
        const outsideBottomBorderValue = position.top + height - windowData.height - (windowData.top || 0);
