...
import type RootSeparatorItem from '../RootSeparatorItem';
    ...
    implements IItemsStrategy<S, T>
{
    ...
    /**
     * Возвращает количество записей проекции с разделителем записей из корня
     */
    get count(): number {
    ...
    /**
     * Возвращает записи проекции с разделителем записей из корня
     */
    get items(): T[] {
    ...
    /**
     * Возвращает запись по индексу из проекции с разделителем записей из корня
     * @param index
     */
    at(index: number): T {
        const itemsOrder = this._getItemsOrder();
