...
export const MODULE_NAME = 'Controls/baseTreeDisplay:PseudoParentCollectionItem';
...
export default class CollectionItem<T extends Model = Model> extends TreeItem<T> {
    ...
    readonly listInstanceName: string = 'controls-BaseTree';
...
Object.assign(CollectionItem.prototype, {
    '[Controls/baseTreeDisplay:PseudoParentCollectionItem]': true,
