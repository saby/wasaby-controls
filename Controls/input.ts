...
export { ISelection as IBaseSelection, ISelectionOptions } from 'Controls/_input/interface/ISelection';
...
export {
    CarriagePositionWhenFocus as __CarriagePositionWhenFocus
} from 'Controls/_input/FixBugs/CarriagePositionWhenFocus';
