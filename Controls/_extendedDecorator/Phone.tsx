...
export interface IPhoneOptions extends IComponentProps {
    /**
     * @name Controls/_extendedDecorator/Phone#value
     * @cfg {String} Декорируемый телефонный номер.
     * @default ''
...
export default React.memo(function Phone(props: IPhoneOptions): React.ReactElement {
    const formattedPhone: string = formatPhone(
