 ...
 */
import { toString, Formatter, FormatBuilder } from 'Controls/baseDecorator';
import { FORMAT_MASK_CHARS, REPLACER, phoneMask } from './phoneMask';


/**
 * Утилита для преобразования номера телефона.
 * @function
 * @param phone {String | null} Форматируемое значение
 * @param onlyMobile {Boolean} Определяет необходимость отображения мобильного номера телефона
 *
 * @example
 * <pre  class="brush: js">
