...
const DESIGN_FEATURE_NAME = 'new-button-shadow';
...
function Button(props: IBasicButtonProps, ref: Ref<HTMLElement>) {
    ...
    if (
        props.viewMode === 'outlined' &&
        (props.buttonStyle === 'default' || props.buttonStyle === 'pale') &&
        Feature.get([DESIGN_FEATURE_NAME])?.[0]
    ) {
        className += ' controls-BaseButton_new_shadow-style';
    }
