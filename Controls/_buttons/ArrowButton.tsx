...
import { wasabyAttrsToReactDom, clearEvent, createElement } from 'UICore/Jsx';
import Button from './Button';
import Arrow, {
    TArrowButtonDirection,
} from 'Controls/_buttons/ArrowButton/Arrow';
...
export default React.forwardRef(function ArrowButton(
    ...
    const getButton = (): React.ReactElement => {
        return createElement(
            ...
            {
                ...attrs,
                class: `controls-ArrowButton controls-ArrowButton_${direction} ${attrs.className || props.className}`,
            },
            {
