 ...
 * @variant outlined-same В виде обычной кнопки c бледной обводкой.
 * @variant filled В виде обычной кнопки c заливкой.
 * @variant filled-same В виде обычной кнопки с бледной заливкой.
 ...
 * @demo Controls-demo/Buttons/FilledSame/Index
 * @remark Важно!
 * При использовании бледных кнопок необходимо самостоятельно подгрузить css-файл стилей. Сделать это можно следующим образом:
 ...
 *    viewMode="link"/>
 * </pre>
 * Кнопка в режиме отображения "squared".
 * <pre class="brush: html; highlight: [4]">
 * <!-- WML -->
 * <Controls.buttons:Button
 *    icon="icon-Yes"
