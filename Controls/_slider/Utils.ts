...
export default {
    ...
    getTooltipPosition(
        ...
        const tooltipWidth =
            Math.floor(getFontWidth(String(tooltipValue), 'l')) +
            2 * baseTooltipPadding;
        const tooltipPercentWidth =
            (tooltipWidth / rangeLength) * maxPercentValue;
        const leftParcentCoords =
            tooltipParcentPosition - tooltipPercentWidth / 2;
        const rightParcentCoords =
            tooltipParcentPosition + tooltipPercentWidth / 2;
        let adjustment;
