...
const getVariables = (): Record<string, string> => {
    return {
        ...
        '--hover_background-color': '#E7E8EC',
        '--active_background-color': '#E1E2E7',
        '--readonly_text-color': '#B5B5B5',
        '--pale_border-color': '#DFE2E7',
        '--readonly_border-color': '#D9D9D9',
        '--pale_color': '#E7E9E9',
        '--pale_hover_color': '#DFE2E7',
...
function ContrastWrapper(props: IComponentPropsWithReadonly, ref): React.ReactElement {
