...
const getDerivedStateFromProps = (options: IZenWrapperOptions): object => {
...
function ZenWrapper(props: IZenWrapperOptions, _): React.ReactElement {
    ...
    const className =
        ...
        ` controls-ZenWrapper_complementary${
            !props.complementaryColor ? '-empty' : ''
        }` +
