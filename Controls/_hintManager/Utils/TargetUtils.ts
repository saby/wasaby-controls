 ...
 * @function
 * @name Controls/_hintManager/Utils/TargetUtils#getTargetById
 ...
 * @function
 * @name Controls/_hintManager/Utils/TargetUtils#getElementsArrayByText
 ...
 * @function
 * @name Controls/_hintManager/Utils/TargetUtils#getElementInnerText
 ...
 * @function
 * @name Controls/_hintManager/Utils/TargetUtils#isProperTargetSize
 ...
 * @function
 * @name Controls/_hintManager/Utils/TargetUtils#_getSelectorFromTargetId
 * @param {String} targetId Идентификатор целевого элемента маршрута подсказок.
 * @return {String}
 * @private
 */
