...
import GridColumnResizer from 'Controls/_gridDisplay/ColumnResizer';
...
export {
    TColumns,
    IColumn,
    IColumn as ICompatibleColumnConfig,
    IColspanParams,
    ICellPadding,
...
export {
    THeader,
    IHeaderCell,
    IHeaderCell as ICompatibleHeaderConfig,
} from 'Controls/_gridDisplay/interface/IHeaderCell';
export {
    IFooterColumn,
    IFooterColumn as ICompatibleFooterConfig,
} from 'Controls/_gridDisplay/interface/IFooterColumn';
export {
    IGridControl,
    IGridLadderProps,
...
} from 'Controls/_gridDisplay/interface/IGridControl';
