...
export default React.forwardRef(function MenuConfigResolver(props: IMenuControl, ref): JSX.Element {
    ...
    }, [props.menuConfigs, props.selectedKeys]);
    ...
    }, [props.menuConfigs, props.excludedKeys]);

    const updateApplyButton = React.useCallback(
        (newSelectedKeys = [], newExcludedKeys = []) => {
        ...
        [
            props.applyButtonVisibility,
            props.multiSelect,
            selectedKeysState,
            excludedKeysState,
            menuConfigs,
            props.onApplyButtonVisibleChanged,
        ]
    );
