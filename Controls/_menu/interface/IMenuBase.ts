...
/**
 * @name Controls/_menu/interface/IMenuBase#multiSelect
...
/**
 * @name Controls/_menu/interface/IMenuBase#selectedAllText
 * @cfg {String} Добавляет пустой элемент в список с заданным текстом.
...
/**
 * @name Controls/_menu/interface/IMenuBase#selectedAllKey
