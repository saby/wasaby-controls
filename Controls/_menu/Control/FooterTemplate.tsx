        ...
        return (
            <>
                ...
                {props.footerContentTemplate ? (
                    <div className="tw-flex tw-items-center tw-flex-0 controls-padding_bottom-s">
                        <FooterCustomContentTemplate {...props} />
                    </div>
                ) : null}
            </>
        );
...
interface IMenuFooterContentProps extends IExpanderButtonProps, IShowMoreRightTemplateProps {
    ...
    return (
        <div
            className={`controls-Menu__footer ${
                props.showMoreRightTemplate ? 'controls-Menu__footer-minHeight' : null
            }`}
    ...
    return (
        <div
            className={`controls-Menu__additional
                                 controls-Menu__footer-additional_padding-top_${
                                     props.expanded ? 'm' : 'xs'
                                 }
        ...
        >
            <Async templateName="Controls/ShowMoreButton" templateOptions={moreButtonOptions} />
        </div>
    );
}
