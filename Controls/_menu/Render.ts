...
import { isHistorySeparatorVisible, getIconPadding } from 'Controls/_menu/Render/getClassList';
...
class MenuRender extends Control<IMenuRenderOptions> {
    ...
    protected _beforeMount(options: IMenuRenderOptions): void {
        this._iconPadding = getIconPadding(options.sourceController?.getItems(), options);
