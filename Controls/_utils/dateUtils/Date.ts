 ...
 * @param {Date | undefined} date1 первая дата.
 * @param {Date | undefined} date2 вторая дата.
 * @returns {boolean}
 */
export function isDatesEqual(date1: Date | undefined, date2: Date | undefined): boolean {
    return (
        date1 === date2 ||
 ...
 * @return {Boolean}
 */
export function isStartOfMonth(date: Date | undefined): boolean {
 ...
 * @return {Boolean}
 */
export function isEndOfMonth(date: Date | undefined): boolean {
...
export function getAmountOfMonths(startValue: Date, endValue: Date): number {
    if (!startValue || !endValue) {
        return 0;
    }
    let months = (endValue.getFullYear() - startValue.getFullYear()) * 12;
    months -= startValue.getMonth();
    months += endValue.getMonth();
    return months;
}
