...
import type { IHeaderCell, IColumn } from 'Controls/grid';

export type ICompositeViewMode = 'tile' | 'table';
...
export interface ICompositeViewConfig extends ITreeTileCollectionOptions, IItemActionsOptions {
    ...
    /**
     * @cfg {String} Режим отображения узлов в составном списке. Должен совпадать с leavesViewMode.
     * @variant tile - В виде плитки
     * @variant table - В виде табличного представления
     */
    nodesViewMode: ICompositeViewMode;
    /**
     * @cfg {String} Режим отображения листьев в составном списке. Должен совпадать с nodesViewMode.
     * @variant tile - В виде плитки
     * @variant table - В виде табличного представления
     */
    leavesViewMode: ICompositeViewMode;
...
> extends Tree<S, T> {
    ...
    getCompositeNodesViewMode(): ICompositeViewMode {
        return this._$compositeViewConfig.nodesViewMode || 'tile';
    }

    getCompositeLeavesViewMode(): ICompositeViewMode {
