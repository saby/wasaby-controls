...
import type { TSelectionModelStatus } from 'Controls/abstractSelectionAspect';
        ...
        IVirtualCollectionItem
{
    ...
    getWrapperClasses(
        ...
        const groupViewMode = this.getGroupViewMode();
        if (groupViewMode && groupViewMode !== 'default') {
            wrapperClasses += ' controls-List__item_grouped_in_block';
        }
