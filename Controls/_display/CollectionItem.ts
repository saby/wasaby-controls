...
import type { TSelectionModelStatus } from 'Controls/listAspects';
import type { THighlightedValues } from 'Controls/listAspects';
        ...
        if (itemPadding.top !== 'null' || itemPadding.bottom !== 'null') {
            ...
            if (classes.indexOf(ITEMACTIONS_POSITION_CLASSES.topRight) !== -1) {
                ...
                if (this.getRowSeparatorSize() && this._$isBottomSeparatorEnabled) {
                    result.push(` controls-ListView__rowSeparator_bottom_size-${this.getRowSeparatorSize()}`);
                }
            }
        }
