...
export default class CollectionEnumerator<T>
    extends mixin<DestroyableMixin, OptionsToPropertyMixin, IndexedEnumeratorMixin<any>>(
        DestroyableMixin,
    ...
    implements IEnumerator<T>
{
    ...
    constructor(options?: object) {
        ...
        if (!(this._$filterMap instanceof Array)) {
            throw new TypeError(
                this._moduleName + '::constructor(): filter map should be instance of an Array'
            );
        }
        if (!(this._$sortMap instanceof Array)) {
            throw new TypeError(
                this._moduleName + '::constructor(): sort map should be instance of an Array'
            );
        }
    }
    ...
    protected _setCurrentByPosition(): void {
        this._current =
            this._position > -1 ? this.items[this.getSourceByInternal(this._position)] : undefined;
    }
