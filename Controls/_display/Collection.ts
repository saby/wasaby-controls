    ...
    implements ICollection<S, T>, IEnumerable<T>, IList<T>
{
    ...
    protected _getInvertItemsOrderSort(): SortFunction<S, T> {
        return (leftItem, rightItem) => {
            if (this._$order && this._$order !== 'default') {
    ...
    setOrder(order?: TItemsOrder): void {
        this._notify('onInvertSortStarted');
        this._$order = order;
        ...
        // TODO: ### скорее всего надо как-то по-другому
        this._reBuild(true);
        this.nextVersion();
    }
