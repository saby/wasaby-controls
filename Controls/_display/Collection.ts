...
import {ICollection, ISourceCollection, IItemPadding, TLogError} from './interface/ICollection';
    ...
    implements ICollection<S, T>, IEnumerable<T>, IList<T>
{
    ...
    getFixedBackgroundStyle(): TBackgroundStyle {
        return this._$fixedBackgroundStyle;
    }
