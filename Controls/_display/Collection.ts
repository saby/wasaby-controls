...
import type { TSelectionModel } from 'Controls/listAspects';
import type { THighlightedFieldsMap } from 'Controls/listAspects';
...
import { TItemActionsMap } from 'Controls/listAspects';
    ...
    implements ICollection<S, T>, IEnumerable<T>, IList<T>
{
    ...
    updateInteractorStateProps(interactorStateProps: IInteractorStateProps) {
        if (
