...
interface IInteractorStateProps {
    ...
    implements ICollection<S, T>, IEnumerable<T>, IList<T>
{
    ...
    updateInteractorStateProps(interactorStateProps: IInteractorStateProps) {
        if (this.interactorStateProps.itemActionsMap !== interactorStateProps.itemActionsMap) {
    ...
    setWasMobileExpanderDisplayed(): void {
        if (this._$isThinInteractor) this._$wasMobileExpanderDisplayed = true;
    }
