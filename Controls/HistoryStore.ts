...
interface IHistoryLoadConfig {
     ...
     */
    pinned: number | null;
    // Количество недавно выбранных для клиента
    // По умолчанию - null
    client: number | null;
}
...
interface IHistoryStoreData {
    ...
    // Последние выбранные для клиента
    client: RecordSet<IHistoryItem> | null;
}
...
interface IHistoryStore {
    ...
    togglePin(historyId: THistoryId, id: CrudEntityKey): Promise<void>;
