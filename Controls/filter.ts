...
const { getFilterByFilterDescription, getDatesByFilterItem, DESCRIPTION_CONVERTER_DELETE_VALUE } =
    FilterCalculator;
const {
...
export {
    ...
    TPeriod,
    TPeriodType,
} from 'Controls/_filter/interface/IPeriodsConfig';
const HistoryUtils = {
...
export {
    TAppliedFrom,
    default as IFilterItemInternal,
} from './_filter/interface/IFilterItemInternal';
export {
