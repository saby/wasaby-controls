...
import type { Rpc } from 'Types/source';
...
import type { ISelection, TKey, TViewMode } from 'Controls-DataEnv/interface';
import type { IListAction } from 'Controls/actions';
import type { TColumns, THeader } from 'Controls/grid';
import type { IHasMoreStorage } from 'Controls/baseTree';
import type { IAbstractListSliceState } from '../../AbstractList/AbstractListSlice';
import type { TCollectionType } from '../../AbstractList/_interface/IAbstractListSliceTypes';
 ...
 * @cfg {Boolean} Определяет, поддерживает ли метод, который вызывается для получения данных, параметр фильтрации {@link https://wi.sbis.ru/doc/platform/developmentapl/service-development/service-contract/logic/list/list-iterator/#selection selection}.
 */
...
/**
 * @name Controls/_dataFactory/List/_interface/IListState#searchInputFocused
 * @cfg {Boolean} Определяет, будет ли установлен фокус в строке поиска
 * @default false
 * @variant true фокус установлен
 * @variant false фокус не установлен
 */

/**
 * @name Controls/_dataFactory/List/_interface/IListState#singleExpand
...
/**
 * @name Controls/_dataFactory/List/_interface/IListState#itemsOrder
 * @cfg {Controls/interface/TItemsOrder} Определяет, будет ли отображение списка инвертировано
 */
export interface IListState
    extends IAbstractListSliceState,
        ISourceOptions,
        ISelectFieldsOptions,
        IHierarchySearchOptions,
        IHierarchyOptions,
    ...
    errorController: import('Controls/error').ErrorController;
