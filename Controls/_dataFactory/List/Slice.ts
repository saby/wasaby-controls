...
import { isStateHierarchy } from './utils';
...
> {
    ...
    private _propsForMigrationToDispatcher: _private_TMiddlewaresPropsForMigrationToDispatcher;

    private _subscribeOnFilter: boolean;

    protected _cachedItemsChanges: TItemsChange[] = [];
