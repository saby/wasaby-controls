...
import { TAbstractMiddleware, TAbstractMiddlewareCreator } from './TAbstractMiddleware';
...
> = (
    middlewareCreator?: TAbstractMiddlewareCreator<TAction, TMiddlewareContext, TMiddleware>
