import { FirstItemKeySymbol } from 'Controls/listAspects';

import type { Collection as ICollection } from 'Controls/display';
import type { IAction, TItemActionsMap, IItemActionsState } from 'Controls/listAspects';
 ...
 * @param state
 */
export function getActionsForItem(item: Model, state: IItemActionsState): IAction[] {
    let actions: IAction[];
