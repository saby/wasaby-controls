...
import type { IListState as INewListState } from 'Controls-DataEnv/list';
 ...
 * @public
 */
export type IAbstractListSliceState = INewListState &
    IMarkerState &
    IPathState &
    IItemsState &
    IHierarchySelectionState &
...
/**
 * @interface Controls/_dataFactory/AbstractList/_interface/IAbstractListSliceState#itemsOrder
