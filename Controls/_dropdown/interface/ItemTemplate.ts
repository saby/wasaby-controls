...
import { IItemTemplateOptions as IMenuItemTemplateOptions } from 'Controls/menu';
 ...
 * @mixes Controls/menu:ItemTemplate
 * @public
 * @example
...
export default interface IItemTemplateOptions extends IMenuItemTemplateOptions {
    /**
