 ...
 * Может использоваться для настройки опций menuPopupComponent'a, для этого необходимо задать templateOptions
 * @example
 * Настройка хлебных крошек и фильтра для справочника в меню (menuPopupComponent = Controls-Layout/selectorSticky:Template)
 * <pre class="brush: js">
 * <!-- TSX -->
