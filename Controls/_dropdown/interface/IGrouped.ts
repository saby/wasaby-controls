...
export interface IGroupedOptions {
     ...
     * @cfg {Function} Шаблон отображения заголовка группы. Визуальное представление группировки можно изменять путём настройки шаблона группировки {@link Controls/dropdown:GroupTemplate}.
     * @markdown
     * @remark
