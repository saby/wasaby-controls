...
export default class Controller {
    ...
    getSelectedItems(): Model[] {
        ...
        } else if (!this._options.source || this._options.buildByItems) {
    ...
    update(newOptions: IDropdownControllerOptions): Promise<RecordSet | void> | void {
        ...
        if (newOptions.selectedItems && newOptions.selectedItems !== oldOptions.selectedItems) {
            this.setSelectedItems(newOptions.selectedItems);
        } else if (
            (!newOptions.source || newOptions.buildByItems) &&
            newOptions.items &&
    ...
    private _resolveLoadedItems(
        ...
        if (!options.items && options.dataLoadCallback && !isHistorySource(this._source)) {
