...
export default function getDropdownControllerOptions(
    ...
    return {
        ...
        footerBackgroundStyle: options.menuFooterBackgroundStyle,
        ...
        expandedItems: options.menuExpandedItems,
        expanderPosition: options.expanderPosition,
        ...
        menuPopupComponent:
            options.menuPopupComponent ||
            // TODO поправить прикладников, удалить
            (options.menuMode === 'selector' ? 'Controls/selectorSticky:Template' : undefined),
        ...
        breadCrumbsVisibility: options.menuBreadCrumbsVisibility,
