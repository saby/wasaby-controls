 ...
 * @example
 * <pre class="brush: js">
 * import {Selector, inputDefaultContentTemplate as DropdownContentTemplate} from 'Controls/dropdown';
 *
 * <Selector
 ...
 * />
 *
 * function MyContentTemplate(props) {
 *     return <DropdownContentTemplate {...props} iconStyle="danger"/>;
 * }
 * </pre>
        ...
        <div
            ...
            className={`controls-Dropdown__wrapper ${
                ...
                inlineHeight
                    ...
                    : 'controls-Dropdown__wrapper-height-default'
            } ${className || ''}`}
        >
            <div
                tabIndex={0}
                className={`controls-Dropdown__content-wrapper controls-Dropdown__content-wrapper-height-${
