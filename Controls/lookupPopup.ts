...
import ListContainer = require('wml!Controls/_lookupPopup/List/WrappedContainer');
import listMemorySourceFilter = require('Controls/_lookupPopup/List/Utils/memorySourceFilter');

export { default as Controller, ILookupPopupControllerOptions } from './_lookupPopup/Controller';
...
export { default as initState } from './_lookupPopup/CompatibleSlice/initState';
