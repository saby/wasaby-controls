...
function BeforeItemsContentComponent(
    ...
    const stickyProperty = props.collection.getGridColumnsConfig()[0].stickyProperty;
    const additionalStickyColumnsCount =
        stickyProperty instanceof Array ? stickyProperty.length : +!!stickyProperty;
    return (
        <BeforeItemsContent
            part={props.part}
            ...
            columnsCount={
                props.collection.getGridColumnsConfig().length + additionalStickyColumnsCount
            }
            columnScrollViewMode={props.collection.getColumnScrollViewMode() || 'scrollbar'}
            stickyColumnsCount={
                props.collection.getStickyColumnsCount() + additionalStickyColumnsCount
            }
