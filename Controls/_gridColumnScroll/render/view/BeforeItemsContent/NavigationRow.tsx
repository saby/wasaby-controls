...
const NavigationRowRender = React.memo(function InnerNavigationRow(
    ...
    return (
        <StickyGroup mode="stackable" position="topBottom" shadowVisibility="hidden">
            <div className="tw-contents" data-qa={QA_SELECTORS.NAVIGATION_ROW}>
                ...
                <StickyGroupedBlock
                    ...
                    className={
                        ...
                        props.SELECTORS.SCROLLABLE_ELEMENT
                    }
                    attrs={{
...
export default function NavigationRow(props: INavigationRowProps) {
    ...
    return (
        <>
            <NavigationRowRender {...props} SELECTORS={ctx.SELECTORS} />
            {!props.needShowEmptyTemplate && (
                <StickyGroup mode="stackable" position="topBottom" shadowVisibility="visible">
                    <div
                        className="tw-contents"
                        data-qa="controls-GridColumnScroll_NavigationRow_shadow"
                    >
                        <StickyGroupedBlock
                            attrs={{ style: { gridColumn: '1 / -1' } }}
                            className={`${ctx.SELECTORS.FIXED_ELEMENT} ${ctx.SELECTORS.STRETCHED_TO_VIEWPORT_ELEMENT}`}
                            mode="stackable"
                            fixedZIndex={5}
                            position="topBottom"
