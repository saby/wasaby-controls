...
export default React.memo(
    React.forwardRef(function MobileViewColumnScroll(
        ...
        const {
            onResizeCallback: synchronizePartsOnResizeCallback,
            ...
            hasStickyHeader: props.collection.hasHeader(true) && props.collection.isStickyHeader(),
            hasStickyTopResults:
                ...
                {props.fakeRequired === 'startFixed' || props.fakeRequired === 'both' ? (
                    ...
                    >
                        <ResolvedViewComponent
                            {...props}
                            className={''}
                            _$fakeGridTemplateColumns={fakeGridStartTemplateColumns}
                ...
                {props.fakeRequired === 'endFixed' || props.fakeRequired === 'both' ? (
                    ...
                    >
                        <ResolvedViewComponent
                            {...props}
                            className={''}
                            _$fakeGridTemplateColumns={fakeGridEndTemplateColumns}
                            /* eslint-disable-next-line @typescript-eslint/ban-ts-comment */
                            /* @ts-ignore */
                            cCountEnd={cCountEnd}
                            itemsContainerReadyCallback={undefined}
