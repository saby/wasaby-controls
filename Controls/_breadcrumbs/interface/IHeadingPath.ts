...
export interface IHeadingPath extends IBreadCrumbsOptions {
    ...
    /**
     * @name Controls/_breadcrumbs/interface/IHeadingPath#pathButtonKeyProperty
     * @cfg {String} Имя поля записи содержащее её ключ.
     */
    pathButtonKeyProperty?: string;

    /**
     * @name Controls/_breadcrumbs/interface/IHeadingPath#pathButtonNodeProperty
     * @cfg {String} Имя поля записи содержащее её тип (узел, скрытый узел, лист).
     */
    pathButtonNodeProperty?: string;

    /**
     * @name Controls/_breadcrumbs/interface/IHeadingPath#pathButtonParentProperty
     * @cfg {String} Имя поля записи содержащее идентификатор родительского узла.
     */
    pathButtonParentProperty?: string;

    /**
     * @name Controls/_breadcrumbs/interface/IHeadingPath#pathButtonDisplayProperty
    ...
    /**
     * @name Controls/_breadcrumbs/interface/IHeadingPath#backButtonBeforeCaptionTemplate
