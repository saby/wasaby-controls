 ...
 */
class MultilinePath
    extends Control<IMultilinePathOptions, IReceivedState>
    implements IFontSize
{
    ...
    protected _beforeMount(
        ...
        if (!options.containerWidth) {
            Logger.warn(
                'Опция containerWidth не задана. Контрол может работать некорректно',
                this
            );
    ...
    private _calculateBreadCrumbsToDraw(
        ...
        const firstContainerData =
            BreadCrumbsUtil.calculateItemsWithShrinkingLast(
                items,
                options,
                this._width,
                getTextWidth
