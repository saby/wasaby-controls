...
class BreadCrumbsPath extends Control<IHeadingPath, IReceivedState> {
    ...
    protected _isPhone: boolean = getAdaptiveModeForLoaders().device.isPhone();
    ...
    private _calculateBreadCrumbsToDraw(
        ...
        let width = options.containerWidth - SIZES.ARROW_WIDTH - SIZES.HOME_BUTTON_WIDTH;
    ...
    private _updateBreadCrumbsClasses(
        ...
        if (options.withoutBreadcrumbs) {
            this._backButtonClass =
                'controls-BreadCrumbsPath__unrestrictedWidth controls-BreadCrumbsPath-min_width_default';
            return;
        }
        ...
        if (this._crumbsWidth > this._backButtonWidth) {
            ...
            this._backButtonClass = `controls-BreadCrumbsPath__unrestrictedWidth controls-BreadCrumbsPath-min_width_${this._getPathButtonHeight()}`;
        }
    }
