...
export function NavigationMenuHeader(props: INavigationMenuHeaderProps) {
    const { goToRootCallback, caption = 'На главную', readOnly = false, hierarchy = false } = props;
    return (
        <div
            className={`controls-breadcrumbsPathButton__menu_header-wrapper controls-breadcrumbsPathButton__menu_header-margin-left${
