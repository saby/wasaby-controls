...
export function ReactSearchBreadcrumbsTreeGridView(
    ...
    const colspanBreadCrumbs = getColspanBreadcrumbs({
        breadCrumbsMode: props.breadCrumbsMode,
        columnScroll: props.columnScroll,
        isColumnScrollVisible: props.isColumnScrollVisible,
    });
    const {
        breadCrumbsMode: prevBreadCrumbsMode,
        containerWidth: prevContainerWidth,
        colspanBreadCrumbs: prevColspanBreadCrumbs,
    } = usePreviousProps({
        breadCrumbsMode: props.breadCrumbsMode,
    ...
    if (prevColspanBreadCrumbs === undefined) {
    ...
    // update
    React.useEffect(() => {
        if (prevColspanBreadCrumbs === colspanBreadCrumbs) {
            collection.setColspanBreadcrumbs(colspanBreadCrumbs);
        }

        if (prevBreadCrumbsMode !== props.breadCrumbsMode) {
            collection.setBreadCrumbsMode(props.breadCrumbsMode);
        }
        if (prevContainerWidth !== props.containerWidth) {
            collection.setContainerWidth(props.containerWidth);
        }
    }, [
        collection,
        props.breadCrumbsMode,
        prevBreadCrumbsMode,
        props.containerWidth,
        prevContainerWidth,
        colspanBreadCrumbs,
        prevColspanBreadCrumbs,
    ]);
