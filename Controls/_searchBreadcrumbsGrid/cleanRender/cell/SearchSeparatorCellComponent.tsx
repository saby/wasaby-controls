...
function getBackgroundClasses({
    ...
    backgroundColorStyle: ISearchSeparatorCellComponentProps['backgroundColorStyle'];
    ...
    if (!isSticky && backgroundColorStyle && backgroundColorStyle !== 'none') {
        classes += BackgroundClassUtils.getBackgroundColorStyleClasses(backgroundColorStyle);
    }
