...
export default function withPopupManagerActions<T extends IApplicationProps = IApplicationProps>(
    ...
    return class extends Component<T> {
        ...
        protected _touchStartPage(event: Event): void {
            if (detection.isMobilePlatform) {
                Controller.getController()?.mouseDownHandler(event);
            }
        }
        ...
        render() {
            return (
                /*<EventSubscriber
                    onOpenInfoBox={withWasabyEventObject(this._openInfoBoxHandler.bind(this))}
                    onServiceError={withWasabyEventObject(this._openDialogHandler.bind(this))}
                    onCloseInfoBox={withWasabyEventObject(this._closeInfoBoxHandler.bind(this))}
                    onForceCloseInfoBox={this._forceCloseInfoBoxHandler.bind(this)}
                    onOpenPreviewer={withWasabyEventObject(this._openPreviewerHandler.bind(this))}
                    onCancelPreviewer={withWasabyEventObject(
                        this._cancelPreviewerHandler.bind(this)
                    )}
                    onIsPreviewerOpened={withWasabyEventObject(
                        this._isPreviewerOpenedHandler.bind(this)
                    )}
                    onClosePreviewer={withWasabyEventObject(this._closePreviewerHandler.bind(this))}
                    onPageScrolled={this._popupEventHandler.bind(this, 'pageScrolled')}
                    onWorkspaceResize={this._workspaceResizeHandler.bind(this)}
                    onResize={this._resizePage.bind(this)}
                >*/
                <WrappedComponent
                    {...this.props}
