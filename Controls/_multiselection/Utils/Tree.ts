...
import { TSelectionCountMode, ISelectionObject as ISelection } from 'Controls/interface';
import { MultiSelectAccessibility, ISourceDataStrategy } from 'Controls/display';

import { IFlatGetCountParams, IHasMoreUtil } from 'Controls/_multiselection/Utils/Flat';
import { TKeys } from 'Controls/_multiselection/interface';
import { ICanBeSelectedParams as IFlatCanBeSelectedParams } from './Flat';
...
export interface ITreeGetCountParams extends IFlatGetCountParams, ICollectionParams {
...
export interface ICanBeSelectedParams extends IFlatCanBeSelectedParams, IIsNodeParams {
    rootKey: CrudEntityKey;
    selectionType: ISelectionType;
    recursiveSelection: boolean;
}
