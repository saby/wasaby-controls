 ...
 * Получаются на основании ISelectorsProps, обогащают пользовательские селекторы GUID'ом и добавляют
 ...
 * @param {ISelectorsProps} propsSelectors Селекторы из опций.
 ...
 * @param {ISelectorsProps} propsSelectors Селекторы из опций.
 * @return Required<ISelectorsProps>
 * @private
 */
