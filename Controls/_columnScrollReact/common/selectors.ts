...
export const DEFAULT_SELECTORS = {
    ...
    NOT_DRAG_SCROLLABLE:
        `${prefix}_notDragScrollable` as `${typeof prefix}_notDragScrollable`,
    FIXED_TO_LEFT_EDGE_ELEMENT:
        `${prefix}_offsetForFixed` as `${typeof prefix}_offsetForFixed`,
    HIDE_ALL_FIXED_ELEMENTS:
        `${prefix}_hideFixedElements` as `${typeof prefix}_hideFixedElements`,
};
...
function _getPropsSelectors(
    propsSelectors: ISelectorsProps
): Required<ISelectorsProps> {
    return {
        FIXED_ELEMENT:
            propsSelectors.FIXED_ELEMENT || DEFAULT_SELECTORS.FIXED_ELEMENT,
        NOT_DRAG_SCROLLABLE:
            propsSelectors.NOT_DRAG_SCROLLABLE ||
            DEFAULT_SELECTORS.NOT_DRAG_SCROLLABLE,
        ROOT_TRANSFORMED_ELEMENT:
            propsSelectors.ROOT_TRANSFORMED_ELEMENT ||
            DEFAULT_SELECTORS.ROOT_TRANSFORMED_ELEMENT,
    };
}
