 ...
 */
import { PrivateContextUserSymbol } from 'Controls/_columnScrollReact/context/ColumnScrollContext';
 ...
 * @typedef {String} Controls/_columnScrollReact/common/types/TAutoScrollAnimation.typedef
 ...
 */
export type TAutoScrollAnimation = 'none' | 'all' | 'smooth';
...
export interface IScrollIntoViewActionParams {
