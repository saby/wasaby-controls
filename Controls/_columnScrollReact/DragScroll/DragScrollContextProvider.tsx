...
export function DragScrollContextProvider(
    ...
    const startDragScroll = React.useCallback(
        (e: React.MouseEvent | React.TouchEvent) => {
            if (canDragScrollByOptions(props.isDragScrollEnabled) && !scrollContext.isMobile) {
    ...
    const moveDragScroll = React.useCallback((e: React.MouseEvent | React.TouchEvent) => {
        ...
        if (newPosition !== null) {
            scrollContextRef.current.setPosition(newPosition, undefined, PrivateContextUserSymbol);
        }
    }, []);
