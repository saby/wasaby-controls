...
const NOT_DRAG_SCROLL_PLATFORM_SELECTORS = [
    // В идеале было бы организовать импорт селектора, но он поставляется библиотекой 'Controls/input'
    // (RENDER_JS_SELECTOR) и такой импорт приводит статической зависимости от полей ввода и всего, что они притягивают
    'js-controls-Render',
