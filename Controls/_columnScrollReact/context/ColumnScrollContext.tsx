...
export interface IColumnScrollContext
    ...
    /**
     * @cfg {Controls/_columnScrollReact/common/types/TAutoScrollAnimation.typedef} Анимация автоподскрола при завершении скроллирования.
     */
    ...
    scrollIntoView: (
        ...
        params?: IScrollIntoViewActionParams
    ) => void;
