...
export type TUpdateSizesState = IColumnScrollWidths &
    ...
    TStateWithEdgesTriggersState & {
        ...
        previousAppliedPosition: number | null;
...
export function updateSizes<TState extends TUpdateSizesState>(
    ...
    if (hasAllSizes(newSizes)) {
        ...
        if (!hasAllSizes(currentSizes)) {
            ...
            if (
                currentSizes.contentWidth !== 0 &&
                newPosition !== 0 &&
                newSizes.contentWidth > currentSizes.contentWidth &&
                newPosition === currentSizes.contentWidth - newSizes.viewPortWidth
            ) {
                newPosition = newSizes.contentWidth - newSizes.viewPortWidth;
            }
        }
