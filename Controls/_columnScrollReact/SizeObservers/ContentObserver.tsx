    ...
    return (
        <>
            {React.cloneElement(props.fixedDiv, {
                ref: fixedDivRef,
                children: (
                    <ObservableDivComponent
                        onResize={setFixedWidth}
                        dataQA={QA_SELECTORS.FIXED_CONTENT_PART_OBSERVER}
                    />
                ),
            })}
            {React.cloneElement(props.scrollableDiv, {
                ...
                children: (
                    <ObservableDivComponent
                        onResize={setScrollableWidth}
                        dataQA={QA_SELECTORS.SCROLLABLE_CONTENT_PART_OBSERVER}
                    />
                ),
            })}
        </>
