...
export default React.forwardRef(function CutButton(props: ICutButton, ref) {
    ...
    const className = `controls_spoiler_theme-${theme} controls_toggle_theme-${theme}` +
        ` controls-background-${props.backgroundStyle}` +
        ` controls-CutButton__container_background-${props.backgroundStyle}` +
        ` controls-CutButton__container controls-CutButton__container_${
            props.expanded ? 'extended' : 'notExtended'
        }_size-${iconSize}` +
