...
class BaseCut<TOptions extends ICutOptions = ICutOptions>
 extends Control<TOptions> implements IBackgroundStyle, IExpandable {
    ...
    protected _buttonStateChanged: boolean = false;
    ...
    protected _afterRender(oldOptions?: ICutOptions) {
        if (this._buttonStateChanged) {
            ...
            this._buttonStateChanged = false;
        }
    }
