...
const _private = {
    ...
    getItemsSizes(
        ...
        visibleKeys.forEach((key) => {
         ...
         const visibleItemsSizes = DOMUtil.getElementsWidth(itemsMark, 'controls-Toolbar__item', true);
         const readonlyItemsSizes = DOMUtil.getElementsWidth(itemsMark, 'controls-Toolbar__item_readOnly', true);
         return visibleItemsSizes.concat(readonlyItemsSizes);
    },
