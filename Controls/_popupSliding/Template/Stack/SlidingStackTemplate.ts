...
export default class SlidingPanel extends Control<ISlidingPanelTemplateOptions> {
    ...
    protected _isActionContentTemplateVisible(): void {
        // todo Нужно найти решение, чтобы при показе клавиатуры, происходила перерисовка
        return this._options.actionContentTemplate; // && !isKeyboardVisible();
    }
