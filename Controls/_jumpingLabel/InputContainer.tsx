...
class InputContainer extends Base<IReactInputContainerOptions> {
    constructor(props: IReactInputContainerOptions) {
        super(props);
        this._valueChangedHandler = this._valueChangedHandler.bind(this);
    }
    ...
    private _valueChangedHandler(inputValue: unknown): void {
        this.setState({
    ...
    render(): React.ReactNode {
        ...
        const mainProps = {
            ...
            onValueChanged: this._valueChangedHandler,
        };
        ...
        return (
            ...
            >
               ...
               ${this.state._showFromAbove ? '' : 'ws-invisible'}`}
                    ...
                    {Children.isWasabyTemplate ? (
                        <Children {...contentProps} {...mainProps} />
                    ) : (
                        React.cloneElement(Children, reactProps)
                    )}
                </div>
            </div>
        );
