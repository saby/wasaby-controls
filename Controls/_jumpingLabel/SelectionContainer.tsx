    ...
    implements ISingleSelectable, IMultiSelectable
{
    ...
    render(): React.ReactNode {
        ...
        const mainProps = {
            ...
            onSelectedKeyChanged: this._selectedChangedHandler.bind(this),
            onSelectedKeysChanged: this._selectedChangedHandler.bind(this),
               ...
               ${this.state._showFromAbove ? '' : 'ws-invisible'}`}
                ...
                </div>
                {
                    this.props.content.isWasabyTemplate ? <this.props.content {...contentProps} {...mainProps}/> :
                                           React.cloneElement(this.props.content, {...contentProps, ...mainProps})
                }
            </div>
        );
    }
