...
import DndController from '../_listDragNDrop/Controller';
import FlatStrategy from '../_listDragNDrop/strategies/Flat';
import TreeStrategy from '../_listDragNDrop/strategies/Tree';
import { IDraggableCollection, IDraggableItem } from '../_listDragNDrop/interface';
...
async function startDragNDrop(
    ...
    const {
        viewModelState: { collection, viewMode, parentProperty },
    } = props;
