...
import RootSeparatorItem, { IOptions as IRootSeparatorOptions } from './RootSeparatorItem';
...
> extends Tree<S, T> {
    ...
    createRootSeparator(options: IRootSeparatorOptions<S>): RootSeparatorItem<S> {
