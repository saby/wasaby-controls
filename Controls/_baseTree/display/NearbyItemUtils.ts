 ...
 */
export function getTreeNearbyItem<
...
>(
    ...
    const parent =
        (item && item.getParent && item.getParent()) || collectionRoot;
    let hasItem = true;
    ...
    while (hasItem && !sameParent) {
        ...
        sameParent =
            nearbyItem && isTreeItem
                ...
                : false;
        current =
            hasItem && (!isTreeItem || sameParent) ? nearbyItem : undefined;
    }
