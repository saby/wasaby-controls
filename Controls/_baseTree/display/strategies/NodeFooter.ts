...
export function shouldDisplayNodeFooterTemplate(
    ...
    return (
        ...
        extraItemVisibilityCallback(item.getContents())
    );
}
...
> extends ExtraNodeItem {
    ...
    protected _getSortItemsOptions(): ISortOptions {
        return {
            ...
            hasNodeFooterViewConfig: !!(
                this._options.display as Tree
            ).getNodeFooterTemplate(),
        };
    }
    ...
    protected _insertExtraItemIndex(params: IInsertExtraItemIndexParams): void {
        ...
        const currentNodeIndex = itemsOrder.indexOf(
            sourceNodeIndex + countExtraItems
        );
        ...
        itemsOrder.splice(
            currentNodeIndex + countChildren + 1,
            0,
            extraItemIndex
        );
    }
