...
> implements IItemsStrategy<S, T>
{
    ...
    protected _getSortItemsOptions(): ISortOptions<S, T> {
        return {
            ...
            extraItemVisibilityCallback:
                this._options.extraItemVisibilityCallback,
        };
    }
    ...
    protected abstract _insertExtraItemIndex(
        params: IInsertExtraItemIndexParams
    ): void;

    protected abstract _shouldAddExtraItem(
        item: T,
        options: ISortOptions<S, T>
    ): boolean;

    protected _getNodesWithExtraItem(
        items: T[],
        options: ISortOptions<S, T>
    ): T[] {
    ...
    protected _updateParentInExtraItems(
        items: TreeItem[],
        extraItems: TreeItem[]
    ): void {
