...
function getExpanderProps<TItem extends TreeItem = TreeItem>(
    ...
    return {
        ...
        withoutExpanderPadding: item.getWithoutExpanderPadding(props.withoutExpanderPadding),
...
function getExpanderClassName(props: IExpanderProps): string {
    ...
    if (expanderPosition === 'default') {
        ...
        expanderClasses += ' tw-inline-flex tw-justify-center tw-items-center tw-flex-shrink-0';
    } else {
