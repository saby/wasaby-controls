...
import { TChildrenLoadMode } from 'Controls/baseTreeDisplay';
...
import { TExpanderIconViewMode } from 'Controls/baseTree';
...
export interface IOptions
    extends IHierarchyOptions,
        ...
        IFilterOptions,
        IExpandedItemsOptions,
        Partial<TOldBaseTreeControlCompatibility> {
    ...
    expanderIconStyle?: TExpanderIconStyle | string;
 ...
 * @remark
 * По умолчанию при видимой {@link Controls/_treeGrid/TreeGrid#expanderVisibility кнопке разворота узла} в первую ячейку итогов таблицы добавляется отступ, позволяющий отобразить содержимое на одной вертикальной линии.
