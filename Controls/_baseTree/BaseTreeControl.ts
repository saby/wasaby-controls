...
import { TreeSiblingStrategy } from './display/dataStrategies/TreeSiblingStrategy';
...
> extends BaseControl<TOptions> {
    ...
    protected _loadMore(direction: Direction): void | Promise<RecordSet | void> {
        ...
        const lastExpandedNodeKey = this._getLastExpandedNodeKey(direction, lastRootItem);
