 ...
 * @remark
 * Полезные ссылки:
 * * {@link https://git.sbis.ru/saby/wasaby-controls/-/blob/rc-24.6100/Controls-default-theme/variables/_tabs.less переменные тем оформления}
 *
 ...
 * <ul>
 *     <li>{@link /docs/js/Controls/tabs/IIconCounterTabTemplate/ Controls/tabs:IconCounterTabTemplate} - иконка и счетчик</li>
 *     <li>{@link /docs/js/Controls/tabs/IIconTextSelectedTabTemplate/ Controls/tabs:IconTextSelectedTabTemplate} - сменный шаблон, где текст будет отображаться у активной вкладки</li>
 *     <li>{@link /docs/js/Controls/tabs/ITextCounterTabTemplate/ Controls/tabs:TextCounterTabTemplate} - текст и счетчик</li>
 * </ul>
 *
 * @example
