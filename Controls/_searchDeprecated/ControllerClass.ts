    ...
    private _updateFilterAndLoad(
        ...
        const executeLoad = () => {
            ...
            if (this._searchInProgress) {
                ...
                // Чтобы при поиске не уходила мультинавигация
                // На уровне слайса это уже решено
                if (
                    !this._options.deepReload &&
                    this._sourceController.getNavigation()?.sourceConfig?.multiNavigation
                ) {
                    paginationConfig = {
                        ...this._sourceController.getNavigation()?.sourceConfig,
                ...
                return this._sourceController
                    .load(
                        ...
                        undefined,
                        filter,
                        this._options.addItemsAfterSearch,
                        paginationConfig
                    )
                    .catch((error) => {
