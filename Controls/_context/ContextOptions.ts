...
import IBrowserSlice from 'Controls/_context/interface/IBrowserSlice';
import { TConfigLoadResult } from '../_dataLoader/Loader';
...
export interface IContextValue extends IContextOptionsValue {
    ...
    [storeId: string]: IBrowserSlice | unknown;
}
