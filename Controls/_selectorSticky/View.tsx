...
export default forwardRef(function SelectorStickyView(props: ISelectorViewOptions, _) {
    ...
    const itemPadding = useMemo(() => {
        return {
            ...
            right: !props.headerContentVisible
                ? 'l'
                : props.multiSelect && !props.allowAdaptive
                ? 'm'
                : 's',
        } as IPadding;
    }, [
        ...
        <>
            ...
            >
                ...
                <ControlFooterTemplate
                    ...
                    className="controls-padding_left-2xs controls-padding_right-2xs"
                />
            </ScrollContainer>
        </>
    );
...
function getLeftPadding(props: ISelectorViewOptions, isSearch?: boolean, isRoot?: boolean): string {
    ...
    let leftSpacing =
        isSearch && props.viewMode !== 'table'
            ? '2xl'
            : props.expanderPosition === 'custom'
            ? '2xl'
