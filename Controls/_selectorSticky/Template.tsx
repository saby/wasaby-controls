            ...
            bodyContentTemplate={
                ...
                >
                    ...
                    <SelectorView
                        ...
                        stickyFooter={stickyFooter}
                        className="controls-padding_left-2xs controls-padding_right-2xs tw-box-border"
                        isAdaptive={isAdaptive}
                        allowAdaptive={allowAdaptive}
                        adaptiveMenuIsSwiped={props.adaptiveMenuIsSwiped}
...
function BreadcrumbsPath({ allowAdaptive }: { allowAdaptive: boolean }): ReactElement {
    ...
    if (selectorContext?.state.breadCrumbsItems?.length) {
        return (
            <div className="tw-flex tw-items-center controls-margin_left-m controls-margin_right-2xs controls-inlineheight-xl controls-margin_bottom-xs">
                <BreadcrumbsPath
                    storeId={SELECTOR_STORE_ID}
