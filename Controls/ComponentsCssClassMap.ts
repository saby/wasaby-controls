...
export const MENU_CLASS = 'controls-menu';

export const STACK_TEMPLATE_CLASS = 'controls-Stack__content-wrapper';
...
export const EXCEPTION_POPUP_LIST = [STACK_TEMPLATE_CLASS, 'controls-ConfirmationTemplate'];
...
// Подстроки селекторов списочных элементов, для которых разрешена привязка подсказок к первому элементу списка.
