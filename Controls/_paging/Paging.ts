 ...
 *
 * @remark
 * Данный контрол также входит в состав списка. Подробнее читайте в {@link /doc/platform/developmentapl/interface-development/controls/list/navigation/visual-mode/data-pagination/ статье}.
 * Полезные ссылки:
 * * {@link https://git.sbis.ru/saby/wasaby-controls/-/blob/rc-24.6100/Controls-default-theme/variables/_paging.less переменные тем оформления}
 *
