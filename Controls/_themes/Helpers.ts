...
const colorTemplate = {
    color: [
        ...
        { name: 'hover_border-color', S: 1.06, L: 1.09 },
...
const additionalColors = {
    ...
    '--unaccented_color': [
        ...
        { name: '--pale_color', S: 1.5, L: 1.25 }, // FIXME коэффициенты
        { name: '--pale_hover_color', S: 1.6, L: 1.16 }, // FIXME коэффициенты
        { name: '--pale_active_color', S: 1.92, L: 1.32 }, // FIXME коэффициенты
