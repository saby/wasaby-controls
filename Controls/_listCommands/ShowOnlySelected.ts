...
export default class ShowOnlySelected implements ICommand<ICommandOptions> {
    ...
    private _hasSelectedParent(itemKey: TKey): boolean {
        ...
        let item = items.getRecordById(itemKey);

        if (
            typeof item === 'undefined' ||
            typeof parentProperty === 'undefined' ||
            typeof root === 'undefined'
        ) {
            return false;
        }

        let currentParentKey = item.get(parentProperty);
        ...
        do {
            ...
            item = items.getRecordById(currentParentKey);
