 ...
 */
import type { IFilterItemBase, IFilterDescriptionItem } from 'Controls-DataEnv/interface';
...
type TKey = boolean | string | number | null;
 ...
 * @public
 * @deprecated Используйте {@link Controls-DataEnv/interface:IFilterDescriptionItem}
 */
