...
export type TPeriod = 'allPeriod' | 'today' | 'yesterday' | 'week' | 'month' | 'quarter' | 'year';
...
export interface IPeriodsConfig {
     ...
     *      />
     * </pre>
     * Пример отключения пункта "Весь период" для {@link Controls/filterPanelEditors:DateMenu редактора фильтра}
     * <pre class="brush: js">
     *      const filterDescription = [{
     *            name: 'period'
     *            value: null,
