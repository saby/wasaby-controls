...
import { getFilterItemProperty, isFrequentDateRangeItem } from 'Controls/_filter/FilterDescription';
...
function getFilterByValue(
    ...
    } else if (isDropdownType(filterItem) && loadItemsForPopup && editorOptions.historyId) {
