...
class FilterView extends Control<IFilterViewOptions, IFilterReceivedState> implements IFilterView {
    ...
    protected openDetailPanel(name?: string): Promise<void> {
                ...
                () => {
                    this._loadItemsTemplates(this._configs, this._source).then(() => {
                        ...
                        const popupOptions: IStickyPopupOptions = {
                            template:
                                this._options.panelTemplateName ||
                        ...
                        const isOneItem = popupConfig.length === 1;
                         ...
                         */
                            ...
                            popupOptions.className +=
                                ...
                                (isOneItem ? 'withoutHeader' : 'withHeader');
                        } else {
                            popupOptions.className =
    ...
    private _openDetailPanelFromSimple(result: IResultPopup): void {
        ...
        factory(result.selectedKeys).each((sKey, index: string) => {
            if (sKey) {
                ...
                item.value = this._getValue(sKey, index);
            }
        });
        ...
        this._open(this._popupSource, popupOptions);
    }
