...
import { IListStateParts } from 'Controls-DataEnv/list';
...
/**
 * Возвращает объект, содержащий фильтр для последующего сохранения его в параметры url.
 * @param {IFilterItem[]} filterDescription Массив элементов фильтра
...
function applyFilterCounter(
    ...
    }: Partial<IListStateParts.IFilterPanelState>
): IFilterItem[] {
