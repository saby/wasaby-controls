...
export interface IFilterItem {
    ...
    resetValue?: unknown;
    /**
     * Текстовое представление фильтра. Используется для отображения выбранных фильтров рядом с контролом {@link Controls-ListEnv/filter:View}.
     * Так же используется для отображения в истории фильтров (см. опцию {@link Controls-ListEnv/filter:View#historyId})
     ...
     * @remark Независимо от значения опции, текстовое представление фильтра используется для отображения истории фильтров (см. опцию {@link Controls-ListEnv/filter:View#historyId}).
     * @default true
     */
     ...
     * <ul>
     *     <li>Изменении фильтра через {@link Controls-ListEnv/filterPanel:View панель фильтров}</li>
     *     <li>Изменение фильтров на {@link Controls-ListEnv/filter:View окне фильтров}. Функция будет вызываться только для фильтров, которые редактируются на окне фильтра.</li>
     *     <li>Применение фильтров на {@link Controls-ListEnv/filter:View окне фильтров} (после нажатия на кноку "Отобрать")</li>
