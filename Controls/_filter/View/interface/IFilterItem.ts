...
export interface IFilterItem {
     ...
     * При установке "dateMenu" рядом с кнопкой фильтров будет построен редактор {@link Controls/filterPanelEditors:DateMenu}. В поле editorTemplateName необходимо задать редактор Controls/filterPanelEditors:DateMenu
