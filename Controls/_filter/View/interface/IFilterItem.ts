...
type TDescriptionToValueConverter = (item: IFilterItem) => object;
...
export interface IEditorOptions {
     ...
     * @demo Controls-demo/Filter_new/FilterView/Frequent/Hierarchy/Index
     * @see parentProperty
     */
    nodeProperty?: string;
    /**
     ...
     * @demo Controls-demo/Filter_new/FastFilterCaption/FastFilterCaption
     */
...
export interface IFilterItem {
    ...
    resetValue?: unknown;
    /**
     * Текстовое представление фильтра. Используется для отображения выбранных фильтров рядом с контролом {@link Controls-widgets/filter:View}.
     * Так же используется для отображения в истории фильтров (см. опцию {@link Controls-widgets/filter:View#historyId})
     ...
     * @remark Независимо от значения опции, текстовое представление фильтра используется для отображения истории фильтров (см. опцию {@link Controls-widgets/filter:View#historyId}).
     * @default true
     */
     ...
     * @variant Controls/filterPanelExtEditors:NumberRangeEditor редактор {@link Controls/filterPanelExtEditors:NumberRangeEditor диапазона чисел}
     ...
     * @variant Controls/filterPanelExtEditors:TumblerEditor редактор перечисляемого типа в виде {@link Controls/filterPanelExtEditors:TumblerEditor переключателя}
     ...
     * <ul>
     *     <li>Изменении фильтра через {@link Controls-widgets/filterPanel:Widget панель фильтров}</li>
     *     <li>Изменение фильтров на {@link Controls-widgets/filter:View окне фильтров}. Функция будет вызываться только для фильтров, которые редактируются на окне фильтра.</li>
     *     <li>Применение фильтров на {@link Controls-widgets/filter:View окне фильтров} (после нажатия на кноку "Отобрать")</li>
     ...
     * </pre>
     */
    filterChangedCallback?: Function | string;
     ...
     * </pre>
     */
    filterVisibilityCallback?: Function | string;
    /**
     ...
     * @example
     * <pre class="brush: js; highlight: [13-18]">
     ...
     *         descriptionToValueConverter: ({value}: IFilterItem) => {
     *             return {
     *                 ДатаНачала: value[0],
     *                 ДатаКонца: value[1]
     *             }
     ...
     *   ];
     * </pre>
     * Будет сформирован фильтр следующего вида:
     * <pre class="brush: js;">
     *   {
     ...
     * </pre>
     */
    descriptionToValueConverter?: string | TDescriptionToValueConverter;
    /**
