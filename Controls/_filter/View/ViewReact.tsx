...
function DetailPanelTarget(props: IFilterViewProps): React.ReactElement {
...
function FilterButtonText(props: IFilterViewProps): React.ReactElement {
    const openDetailPanel = useCallback(() => {
        props.openDetailPanel();
    }, [props.openDetailPanel]);
    if (props.filterText) {
            ...
            return (
                <>
                    ...
                    {isResetButtonVisible && !props.readOnly ? (
                        <ResetButton
                            reset={(event) => {
                                props.resetFrequentItem(event, dateRangeItem);
                            }}
                        />
                    ) : null}
                </>
...
const forwardedComponent = React.forwardRef(function FilterViewReact(
    ...
    return (
        ...
        >
            {props.showFilterText ? (
                <ContentTemplate {...props} alignmentClass={alignmentClass} alignment={alignment} />
            ) : null}
            {isButtonVisible ? (
                <div
                    tabIndex={0}
