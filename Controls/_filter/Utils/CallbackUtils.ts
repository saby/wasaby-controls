...
function isCallbackLoaded(cb: string | Function): boolean {
    return cb === undefined || cb === null || (typeof cb === 'string' && isLoaded(cb)) || typeof cb === 'function';
}
...
function callCallback<T>(
    ...
    if (func) {
        ...
        return func(object.clonePlain(item, {processCloneable: false}), updatedFilter, changedFilters, filterSource);
    }
}
