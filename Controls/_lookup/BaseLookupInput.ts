...
import { IBaseOptions, IFieldTemplate, IPaddingOptions, ITextOptions, IValueOptions, } from 'Controls/input';
import { IBackgroundStyleOptions, IContrastBackgroundOptions, ISelectorDialogOptions, } from 'Controls/interface';
...
export default abstract class BaseLookupInput extends BaseLookup<ILookupInputOptions> {
    ...
    showSelector(popupOptions?: IStackPopupOptions): boolean {
        ...
        const searchStarted = inputValue?.length >= this._options.minSearchLength;
        return showSelector(
            this,
            popupOptions,
