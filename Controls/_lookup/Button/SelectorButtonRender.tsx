...
function InnerItemTemplate(outerProps, props): JSX.Element {
    const innerClassName = !props.readOnly ? 'controls-SelectorButton_selectedItem' : '';
        ...
        return props.readOnly ? (
            ...
            <Button
                className={`controls-Selectorbutton_link${
                    props.fontColorStyle === 'filterPanelItem'
                        ? ' controls-Selectorbutton_link-filterPanelItem-style'
                        : ''
                }`}
                viewMode="link"
    ...
    return (
        <div
            ...
            className={`controls_lookup_theme-${props.theme} ${props.className}
                        ...
                        }${props.readOnly ? ' controls-Selectorbutton__readOnly' : ''}
