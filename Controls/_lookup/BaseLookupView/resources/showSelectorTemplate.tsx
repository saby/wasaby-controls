...
function ShowSelectorTemplate(
    props: IShowSelectorTemplateOptions
): JSX.Element {
    return (
        <Icon icon="Controls-icons/common:icon-Burger"
              ...
              className={`controls-Lookup__showSelector
                         ...
                         controls-Lookup__showSelector_horizontalPadding-${ props.horizontalPadding ? props.horizontalPadding : 'xs' }`}
