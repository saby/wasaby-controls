...
class InputRenderLookup extends Text {
    ...
    constructor(props) {
        ...
        // удаляем лишний сallback, так как он уже навешивается на input.Render
        delete this._useEvent.onKeyDown;
    }
    ...
    protected _getCommentMinWidth(): object {
        return this.props.comment ? { minWidth: `${this.props.comment?.length || 0}ch` } : {};
    }
    ...
    protected _getContent(contentProps = {}) {
        ...
        return this._getReadOnly() &&
            ...
            ? getContent(this._field.template, {
                  ...
                  style: {
                      width: this.props.inputWidth + 'px',
                      ...this._getCommentMinWidth(),
                  },
              })
            : null;
