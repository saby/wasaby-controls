...
export interface ILookupOptions extends ILookupBaseControllerOptions, IControlOptions {
    ...
    selectorTemplate?: TemplateFunction;
...
> {
    ...
    protected _beforeUpdate(newOptions: ILookupOptions): Promise<SelectedItems> | void | boolean {
        ...
        if (this._selectorOpened && this._isSelectorTemplateOptionsChanged(newOptions)) {
            this.showSelector(
    ...
    protected _isSelectorTemplateOptionsChanged(newOptions): boolean {
        return (
            !isEqual(
                newOptions.selectorTemplate?.popupOptions,
