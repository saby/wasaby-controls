...
import { default as itemTemplate, CrossTemplate } from 'Controls/_lookup/SelectedCollection/ItemTemplate';
    ...
    if (
        ...
        return (
            <span
                ref={infoBoxRef}
                style={infoBoxStyle}
                className={`controls-SelectedCollection__InfoBox ${
                    props.counterClassName
                }
                            ${
...
export function SelectedCollectionRenderWithoutHooks(
    ...
    const inlineHeightClass = `${
        props.inlineHeight
            ? 'controls-SelectedCollection__collection_lineheight-' +
              props.inlineHeight
            : ''
    }`;
