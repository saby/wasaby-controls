...
import { ICounterTemplateOptions } from './CounterTemplate';
import { clsx } from 'clsx';
import { TSelectionType } from 'Controls/interface';

export interface ISelectedCollectionOptions
    extends TInternalProps,
        Pick<ICounterTemplateOptions, 'counterVisibility'> {
    theme?: string;
    itemsLayout?: string;
...
function Counter(props: ISelectedCollectionOptions): ReactElement | null {
    const {
        maxVisibleItems,
        readOnly,
        itemsLayout,
    ...
    if (props.counterVisibility === 'hiddenCompletely') {
        return null;
    }
    const className = clsx('controls-SelectedCollection__InfoBox', {
        'controls-SelectedCollection__counter-singleLine': props.counterAlignment === 'right',
    ...
    if (
        ...
        return (
            <span ref={infoBoxRef} style={infoBoxStyle} className={className} onClick={onClick}>
...
export function SelectedCollectionRenderWithoutHooks(
    ...
    const className = clsx(
        'controls-SelectedCollection__collection',
        props.collectionClass,
        `controls-SelectedCollection__collection_${
        ...
        }_fontSize-${props.fontSize || 'm'}`,
        {
            ...
            'controls-focused-item_background': props.highlightedOnFocus,
            'controls-SelectedCollection__collection-singleSelect': props.visibleItems.length === 1,
        }
    );
