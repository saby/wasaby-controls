 ...
 *
 * Принимает аргумент item: {@link Types/entity:Model} и возвращает {@link Controls/gridReact:IRowProps}
 * @typedef {Function} Controls/_gridReact/row/interface/TGetRowPropsCallback
 */
 ...
 * @interface Controls/_gridReact/row/interface/IMultiSelectProps
 * @public
 */
