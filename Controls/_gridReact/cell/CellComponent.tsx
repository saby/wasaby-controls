...
/*
 * Метод для рассчета вертикальных паддингов
 */
 ...
 */
export function getHorizontalPaddingsClassName(
...
export function getClassName({
    ...
    className += getVerticalPaddingsClassName(paddingTop, paddingBottom);
    className += getHorizontalPaddingsClassName(paddingLeft, paddingRight);
