...
import { IColumnSeparatorSizeConfig } from 'Controls/grid';
 ...
 * Принимает item: {@link Types/entity:Item} и должна возвращать {@link Controls/gridReact:ICellProps}
 * @typedef {Function} Controls/gridReact:TGetCellPropsCallback
 */
...
export interface IBorderRadiusProps {
     ...
     */
    topLeftBorderRadius?: TRoundBorderSize;
    /**
     * Радиус скругления правого верхнего угла ячейки
     */
    topRightBorderRadius?: TRoundBorderSize;
    /**
     * Радиус скругления правого нижнего угла ячейки
     */
    bottomRightBorderRadius?: TRoundBorderSize;
    /**
     * Радиус скругления левого нижнего угла ячейки
     */
    bottomLeftBorderRadius?: TRoundBorderSize;
}
 ...
 * @interface Controls/_gridReact/cell/interface/IColumnConfig
 * @public
 */
...
export interface ICellComponentProps
    ...
    displayType?: 'block' | 'inline-block' | 'flex' | 'inline-flex' | 'contents' | 'hidden';
