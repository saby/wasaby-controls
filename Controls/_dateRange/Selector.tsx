...
import { IFontSizeOptions, IFontWeightOptions } from 'Controls/interface';
 ...
 * * {@link /doc/platform/developmentapl/interface-development/controls/input-elements/date-time/input/ руководство разработчика}
 *
...
export default class Selector extends BaseSelector<IRangeSelectorProps> {
    ...
    constructor(props: IRangeSelectorProps) {
        ...
        this._rangeChangedHandler = this._rangeChangedHandler.bind(this);
    }
    ...
    protected _getPopupOptions() {
        ...
        if (
            this.context.isAdaptive &&
            (orientationType === 'landscape-primary' || orientationType === 'landscape-secondary')
        ) {
            baseOption.className = 'controls-popupSliding__horizontalMode__withDatePicker';
        }
        return baseOption;
    }
    ...
    render() {
        return (
            <LinkView
                ...
                onRangeChanged={this._rangeChangedHandler}
                onLinkClick={this.openPopup}
                onMouseEnter={this._mouseEnterHandler}
                onMouseLeave={this._mouseLeaveHandler}
                className={`controls-DateRangeSelector controls-DateRangeSelector__view ${
                    this.props.className || this.props.attrs?.className
                }`}
            />
        );
    }
