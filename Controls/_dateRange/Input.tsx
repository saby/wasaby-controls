...
export interface IDateRangeInputOptions
    ...
    onStartValueChanged?: (e: SyntheticEvent, startValue: Date, displayValue?: string) => void;
    onEndValueChanged?: (e: SyntheticEvent, endValue: Date, displayValue?: string) => void;
}
...
export default class Input extends React.Component<IDateRangeInputOptions> {
    ...
    private _startValueChangedCallback(startValue: Date): void {
        ...
        if (this.props.onStartValueChanged) {
            this.props.onStartValueChanged(event, startValue, this._startInputDisplayValue);
        }
    }
    ...
    private _endValueChangedCallback(endValue: Date): void {
        ...
        if (this.props.onEndValueChanged) {
            this.props.onEndValueChanged(event, endValue, this._endInputDisplayValue);
        }
    }
    ...
    private _startValueChangedHandler(_: Event, value: Date, displayValue: string): void {
        this._startInputDisplayValue = displayValue;
        this._rangeModel.startValue = value;
    }

    private _endValueChangedHandler(_: Event, value: Date, displayValue: string): void {
