 ...
 * Полезные ссылки:
 * <ul>
 *     <li>{@link /materials/DemoStand/app/Controls-demo%2FdateRange%2FInput%2FIndex демо-пример}</li>
 ...
 *     <li>{@link https://git.sbis.ru/saby/wasaby-controls/-/blob/rc-24.6100/Controls-default-theme/variables/_dateRange.less переменные тем оформления}</li>
 * </ul>
 *
...
export default class Input extends React.Component<IDateRangeInputOptions> {
    ...
    openPopup(): void {
        ...
        let className = `controls_popupTemplate_theme-${this.context.theme} `;
    ...
    private _validateAfterInput(fieldName: string): void {
        ...
        // Будем обновлять другое поле сами.
        // Если установлена опция validateByFocusOut true, будем валидировать поле на afterUpdate, когда значение
    ...
    protected _onTouchStartHandler(event: TouchEvent): void {
        if (detection.isMobileSafari && TouchKeyboardHelper.isKeyboardVisible(false)) {
            ...
            >
                <div className="controls-Input-DateRange__inputs">
                    <BaseInput
                        ...
                        onTouchStart={this._onTouchStartHandler}
                        customEvents={[
                            'onMouseDown',
                            'onInputControl',
                            'onInputCompleted',
