...
interface ISelectorConsumerReactProps extends IComponentProps {
...
export default class SelectorConsumerReact extends React.Component<ISelectorConsumerReactProps> {
    ...
    componentDidMount(): void {
        const { setShiftPeriod, setGetArrowButtonReadOnly } = this.context;
        setShiftPeriod(() => {
            return this._ref.current.shiftPeriod;
        });
        setGetArrowButtonReadOnly(() => {
            return this._ref.current.getArrowButtonReadOnly;
        });
    }
    openPopup(): void {
