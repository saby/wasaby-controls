 ...
 */
function getArrayDifference(arrayOne: any[], arrayTwo: any[]): IDifferenceArrays {
    return {
...
function getIntersection(firstCollection: unknown[], secondCollection: unknown[]): unknown[] {
