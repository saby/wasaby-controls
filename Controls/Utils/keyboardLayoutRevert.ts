...
const KeyboardLayoutRevert = {
    ...
    process(text: string): string {
        ...
        const directionByWorld = this._figureConversionDirectionByWorlds(text, innerLayoutId);
        const layoutObj = this._getLayoutObject(innerLayoutId, true);
        let layoutMap = directionByWorld.direction === 1 ? layoutObj.straight : layoutObj.reverse;
        let result = '';
