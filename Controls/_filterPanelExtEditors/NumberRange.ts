...
class NumberRangeEditor
    extends Control<INumberRangeOptions>
    implements INumberRange
{
    ...
    protected _handleMinValueChanged(
        event: SyntheticEvent,
        value: number
    ): void {
        if (value <= this._maxValue || !this._maxValue) {
            this._minValue = value;
            this._processPropertyValueChanged(event, [
                this._minValue,
                this._maxValue,
            ]);
        }
    ...
    protected _handleMaxValueChanged(
        event: SyntheticEvent,
        value: number
    ): void {
    ...
    protected _getExtendedValue(): object {
        ...
        return {
            value,
            textValue: !this._isValueEmpty(value)
                ? this._getTextValue(value)
                : '',
        };
    }
    ...
    private _processPropertyValueChanged(
        event: SyntheticEvent,
        value: number[]
    ): void {
