...
import { IMenuPopupOptions, IMenuControlOptions } from 'Controls/menu';
...
export interface IToolBarItem {
    ...
    buttonStyle?: string;
    /**
     * @name Controls/_toolbar/IToolBarItem#subMenuTemplate
     * @cfg {String} Шаблон подменю, которое откроется у этого элемента. Шаблон будет обернут в {@link Controls/popupTemplate:Sticky}
     */
    subMenuTemplate?;
    /**
     * @name Controls/_toolbar/IToolBarItem#subMenuTemplateOptions
     * @cfg {IMenuPopupOptions} Опции, которые будут переданы в шаблон {@link subMenuTemplate}.
     */
    subMenuTemplateOptions?: IMenuPopupOptions;
    /**
     * @name Controls/_toolbar/IToolBarItem#menuOptions
     * @cfg {Controls/menu:IMenuPopupOptions} Дополнительные параметры которые будет переданы в выпадающее меню тулбара
     */
    menuOptions?: IMenuPopupOptions;
    /**
     * @name Controls/_toolbar/IToolBarItem#counter
     * @cfg {Number} Значение счётчика. В горизонтальном тулбаре счётчик не отображается.
     * @demo Controls-demo/Toolbar/Counter/Index
     */
    counter?: number;
    /**
     * @name Controls/_toolbar/IToolBarItem#counterStyle
     * @cfg {String} Стиль отображения счетчики. См. {@link Controls/buttons:IButton#buttonStyle подробнее}.
     * @default info
     * @demo Controls-demo/Toolbar/Counter/Index
     */
    counterStyle?: string;
    /**
     * @name Controls/_toolbar/IToolBarItem#className
     * @cfg {String} Класс, который навесится на элемент тулбара.
     */
    className?: string;
}
