    ...
    protected _resultHandler(action: string, data: Model, nativeEvent: SyntheticEvent): void {
        if (action === 'itemClick' || action === 'rightTemplateClick' || action === 'applyClick') {
            ...
            if (this.props[wasabyActionEnvironment]) {
                this.props[wasabyActionEnvironment](nativeEvent, item, nativeEvent._nativeEvent);
            }
            if (this.props[reactActionEnvironment]) {
                this.props[reactActionEnvironment](nativeEvent, item, nativeEvent._nativeEvent);
            }
