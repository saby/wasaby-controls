...
import { Button, IButtonOptions, IViewMode, TButtonStyle } from 'Controls/buttons';
...
export default class View extends React.Component<IToolbarOptions, IToolbarState> {
    ...
    render(): React.ReactElement {
        ...
        return (
            <div ref={this.props.forwardedRef} {...attrs} className={attrsClassName} data-qa={this.props['data-qa']}>
                <div
