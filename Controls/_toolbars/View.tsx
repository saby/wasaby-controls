...
export default class View extends React.Component<IToolbarOptions, IToolbarState> {
    ...
    protected _resultHandler(
        ...
        if (action === 'itemClick' || action === 'rightTemplateClick' || action === 'applyClick') {
            ...
            if (this.props[wasabyActionEnvironment]) {
                this.props[wasabyActionEnvironment](mainEvent, item, mainEvent._nativeEvent);
            }
            if (this.props[reactActionEnvironment]) {
                this.props[reactActionEnvironment](mainEvent, item, mainEvent._nativeEvent);
            }
             ...
             */
            if (this._sticky?.isOpened() && (isCloseOnItemClick || mainEvent?.result === true)) {
                this._sticky.close();
            }
        }
    }
    ...
    protected _createItemTemplate(item: Model, index: number): TemplateFunction {
        ...
        if (typeof ItemTemplate === 'string') {
            return <Async key={index} templateName={ItemTemplate} templateOptions={itemTemplateOptions} />;
        }
