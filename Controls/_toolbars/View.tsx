...
export default class View extends React.Component<IToolbarOptions, IToolbarState> {
    ...
    protected _loadMenuDependiesPromise: Promise<unknown> = null;
    ...
    protected _loadDependencies(): Promise<unknown> {
        try {
            ...
            if (!this._loadMenuDependiesPromise) {
                this._loadMenuDependiesPromise = Promise.all([
                    import('Controls/menu'),
                    this._preloadMenuTemplates()
                ]);
            }
            return this._loadMenuDependiesPromise;
        } catch (e) {
