...
import { Button, IButtonOptions, IViewMode } from 'Controls/buttons';
...
export default class View extends React.Component<IToolbarOptions, IToolbarState> {
    ...
    protected _createItemTemplate(item: Model, index: number): TemplateFunction {
        ...
        const attrsForItemTemplate = {
            'data-name':
                item.get(this.props.keyProperty) || item.get(this.state.items.getKeyProperty()),
            'data-qa':
                item.get(this.props.keyProperty) || item.get(this.state.items.getKeyProperty()),
                ...
                >
                    ...
                    {this.state.needShowMenu && (
                        <Button
                            ...
                            iconStyle={this.props.translucent ? 'contrast' : 'secondary'}
