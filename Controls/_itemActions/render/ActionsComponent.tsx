...
function getActionClassName(props: IActionComponentProps): string {
    ...
    if (!props.action.isMenu) {
        className +=
            ` controls-itemActionsV__action_padding_${props.actionPadding || 'xs'}` +
            ` controls-padding_left-${props.actionPadding || 'xs'}` +
            ` controls-padding_right-${props.actionPadding || 'xs'}`;
    }
    ...
    return (
        ...
        >
            <ButtonTemplate
                ...
                className={
                    action.viewMode === 'closeButton' ? 'controls-itemAction__closeButton' : ''
                }
            />
        </div>
    );
 ...
 * @class Controls/_itemActions/render/ActionsComponent
 * @public
 */

/**
 * Массив конфигов для операций над записью.
 * @name Controls/_itemActions/render/ActionsComponent#actions
 ...
 * @name Controls/_itemActions/render/ActionsComponent#actionStyle
 ...
 * @name Controls/_itemActions/render/ActionsComponent#actionPadding
 * @cfg {String}
 */
 ...
 * @name Controls/_itemActions/render/ActionsComponent#iconStyle
 * @cfg {TIconStyle}
 */
