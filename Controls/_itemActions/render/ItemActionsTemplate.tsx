...
import ActionsComponent, { IBaseActionProps } from 'Controls/_itemActions/render/ActionsComponent';
...
import { MENU_BUTTON_KEY } from '../constants';
...
function getClassName(props: IItemActionsTemplateProps): string {
    ...
    if (props.isSwiped && props.itemActionsPosition === 'outside') {
    ...
    const actions = React.useMemo(() => {
        if (props.menuActionVisibility === 'hidden' || shouldDisplayEditableButtons) {
            ...
            if (shouldDisplayEditableButtons) {
                ...
                const iconUrl = `${constants.resourceRoot}Controls/_itemActions/icons.svg`;
                newActions.push({
