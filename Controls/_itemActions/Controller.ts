...
export class Controller {
    ...
    private _updateActionsOnItem(item: IItemActionsItem, actionsObject: IItemActionsObject): boolean {
        ...
        const isOutsideAndMaster = this._collection.getStyle() === 'master' && this._itemActionsPosition === 'outside';
