...
/**
 * Адаптивное размещение действий по свайпу - горизонтальное или вертикальное
 * @typedef TActionAlignment
...
/**
 * Стиль оформления кнопки-галки в форме редактирования по месту
 * @typedef TApplyButtonStyle
 * @variant accent По умолчанию
 * @variant unaccent Неакцентное оформление
 */
