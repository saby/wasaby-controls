...
/**
 * @typedef {String} Controls/_itemActions/interface/IItemActionsTemplateConfig/TActionAlignment.typedef
...
export interface IItemActionsTemplateConfig {
     ...
     * @cfg {Controls/_interface/IActions/TItemActionsPosition.typedef}
     */
    /*
     * @cfg {Controls/_interface/IActions/TItemActionsPosition.typedef} Actions position relative to record
     */
     ...
     * @cfg {Controls/_itemActions/interface/IItemActionsTemplateConfig/TActionAlignment.typedef}
     */
    /*
     * @cfg {Controls/_itemActions/interface/IItemActionsTemplateConfig/TActionAlignment.typedef} Alignment of actions inside actions panel
     */
