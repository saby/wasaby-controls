...
/**
 * @typedef {String} Controls/itemActions/TActionAlignment.typedef
...
export interface IItemActionsTemplateConfig {
     ...
     * @cfg {Controls/interface/TItemActionsPosition.typedef}
     */
    /*
     * @cfg {Controls/interface/TItemActionsPosition.typedef} Actions position relative to record
     */
