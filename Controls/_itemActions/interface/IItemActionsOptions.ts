...
export interface IItemActionsOptions {
     ...
     * @cfg {Controls/_interface/IActions/TItemActionsPosition.typedef} Позиционирование панели {@link /doc/platform/developmentapl/interface-development/controls/list/actions/item-actions/position/ опций записи}.
     * @remark
