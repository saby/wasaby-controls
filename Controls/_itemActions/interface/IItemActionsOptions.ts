...
export interface IItemActionsOptions {
     ...
     * @see Controls/_baseList/resources/utils/MoveHelpers/canMoveToDirection утилита, позволяющая определить, можно ли переместить запись вверх/вниз с учётом иерархии
