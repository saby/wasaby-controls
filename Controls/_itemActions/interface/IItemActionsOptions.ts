...
export interface IItemActionsOptions {
     ...
     * @cfg {Controls/interface/TItemActionsPosition.typedef} Позиционирование панели {@link /doc/platform/developmentapl/interface-development/controls/list/actions/item-actions/position/ опций записи}.
     * @remark
