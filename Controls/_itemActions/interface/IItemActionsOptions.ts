...
export interface IItemActionsOptions {
     ...
     * @see Controls/_listCommands/utils/MoveHelpers/canMoveToDirection утилита, позволяющая определить, можно ли переместить запись вверх/вниз с учётом иерархии
