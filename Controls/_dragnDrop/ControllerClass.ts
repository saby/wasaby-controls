...
class ControllerClass {
    ...
    updateDraggingTemplate(
        ...
        this._dialogOpener.open({
            ...
            top:
                draggingTemplateOptions.position.y + draggingTemplateOptions.draggingTemplateOffset,
            left:
                draggingTemplateOptions.position.x + draggingTemplateOptions.draggingTemplateOffset,
