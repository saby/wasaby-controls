...
export default class InputContainer extends Control<IInputControllerOptions> {
    ...
    private _historyStoreLoad: Promise<unknown> = null;
    ...
    protected _select(event: SyntheticEvent, item: Model): Promise<void> | void {
        ...
        if (this._options.historyId) {
            return this._getHistoryStore().then((historyStore) => {
                historyStore.push(this._options.historyId, newItem.getKey());
                this._historyStoreLoad = null;
                return historyStore;
            });
        }
    }
