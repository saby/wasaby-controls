 ...
 * @includes IEdgeOffset Controls/_popup/interface/IEdgeOffset
 * @includes registerServerSidePopup Controls/_popup/utils/registerServerSidePopup
 * @includes Controller Controls/_popup/Popup/Controller
 * @public
 */
...
export { default as EditContainer } from './_popup/WasabyOpeners/WrappedContainer';
