...
import type { TFontWeight, TFontColorStyle, TFontSize } from 'Controls/interface';
import type {
...
import { IItemActionsHandler, TMarkerPosition } from 'Controls/baseList';
 ...
 * @variant grab курсор для элементов, которые можно захватить.
 * @variant text курсор для элементов, внутри которых можно выделить текст.
 * @author Колесов В.А.
 */
export type TCursor = 'pointer' | 'auto' | 'default' | 'grab' | 'text';
...
export interface IBorderProps {
     ...
     * @cfg
     */
    borderVisibility?: TVisibility | string;
 ...
 * @author Колесов В.А.
 */
export interface IActionsProps<GenericActionsPosition = void> {
    /**
     * Набор операций
     * @cfg
     */
     ...
     * @cfg
     */
    actionsPosition?: GenericActionsPosition | TItemActionsPosition;
...
export interface IImageProps {
     ...
     * @cfg
     * @remark
     * * Строка - одно изображение в подходящем формате для атрибута src элемента <img>.
...
export interface IStickyProps {
    ...
    // Опция, позволяющая стики-заголовку установить специальный цвет в зафиксированном состоянии
