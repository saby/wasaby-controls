...
/**
 * @typedef {String} Controls/interface/TLineBrake
...
export interface IMarkerProps {
    ...
    /**
     * @cfg {string} Позволяет отключить видимость маркера для отдельной записи списка.
     */
    marker?: boolean;
}
...
export interface ICaptionProps {
    ...
    /**
     * @cfg {string} Перенос строк заголовка
     */
 ...
 * @typedef {String} Controls/interface/TListTriggerPosition
 * @variant top Сверху
 * @variant bottom Снизу
 */
