...
import type { StickyVerticalPosition, StickyMode, StickyHorizontalPosition } from 'Controls/stickyBlock';
 ...
 * @variant onhover Отбоажается при наведении на элемент.
 * @author Колесов В.А.
 */
...
export interface IActionsProps {
    ...
    /**
     * @cfg {Controls/interface/TItemActionsPosition.typedef} Позиция операций
     */
