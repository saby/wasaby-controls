 ...
 * @description Допустимые значения для опции {@link Controls/interface/IFontColorStyle/Property/fontColorStyle fontColorStyle}.
 * @variant primary
 * @variant secondary
 * @variant success
 * @variant warning
...
export interface IFontColorStyleOptions {
     ...
     * @cfg {Controls/_interface/IFontColorStyle/TFontColorStyle} Стиль цвета текста контрола.
