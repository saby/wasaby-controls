...
/**
 * @description Допустимые значения для параметра {@link Controls/interface:INavigationViewConfig#digitRenderCallback digitRenderCallback}.
 * @typedef {(index: number) => {}} Controls/_interface/INavigation/TDigitRenderCallback
 */
