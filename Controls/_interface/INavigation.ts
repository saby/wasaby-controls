...
import { TPositionField } from 'Controls-DataEnv/listTypes';
/*
...
/**
 * @typedef {Function} Controls/_interface/INavigation/TDigitRenderCallback
 * @description Тип для функции обратного вызова, которая принимает в аргумент номер страницы и возвращает эмодзи.
 * Используется для {@link Controls/interface:INavigationViewConfig Конфигурации визуального представления навигации}.
...
/**
 * @typedef {Map<Types/source:ICrud#CrudEntityKey, Controls/_interface/INavigation/IBaseSourceConfig.typedef>} Controls/_interface/INavigation/IMultiBaseSourceConfig
 * @description
 ...
 * значение - {@link конфигурация Controls/_interface/INavigation/IBaseSourceConfig.typedef} навигации для источника данных
 *
