...
/**
 * Интерфейс пропсов списочных контролов с возможностью настройки отображения элементов.
 * @public
 */
export interface IItemTemplateListProps {
    /**
    ...
    /**
     * Объект с опциями для шаблона элемента списка.
     * @cfg
     * @remark
