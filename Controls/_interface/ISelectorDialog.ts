 ...
 *    searchParam="title"
 *    keyProperty="id">
 *    <ws:selectorTemplate templateName="Controls-Layout/selectorStack:Template"
 ...
 *          shoes: {
 *              prefetchConfig: {
 *                  configLoader: 'MyModule/myLib:ConfigLoader'
 *              },
 *              contentConfig: {
 *                  workspaceConfig: {
 *                      templateName: 'MyModule/myLib:SelectorList'
 *                  }
 *              },
 *              addButtonConfig: {
 *                  menuConfigGetter: 'MyModule/myLib:AddButtonConfig',
 *                  activateHandler: 'MyModule/myLib:AddButtonActivateHandler'
 *              }
 *          }
 *       }
 *    };
 ...
 * Для получения списка записей нужно сохранить записи на состояние в {@link /docs/js/Controls/dropdown/Selector/options/dataLoadCallback/?v=22.1100 dataLoadCallback}.
 *
 * @example
 ...
 * @property {String} templateName Шаблон панели выбора элементов. Для построения стандартной раскладки передайте {@link Controls-Layout/selectorStack:Template Controls-Layout/selectorStack:Template}.
 * В редких случаях, когда стандартная раскладка не подходит, можно задать свой компонент.
 * @property {Object | Controls/selector:ISelectFactoryArguments} templateOptions Параметры шаблона всплывающего окна. Опции стандартной раскладки можно посмотреть {@link Controls-Layout/selectorStack:Template тут}.
