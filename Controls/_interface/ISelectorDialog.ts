 ...
 * @property {Function} templateName Шаблон панели выбора элементов. Для отображения нового окна выбора опцию нужно задать как {@link Controls-Layout/selectorStack:Template Controls-Layout/selectorStack:Template}.
 * @property {Object | Controls/selector:ISelectFactoryArguments} templateOptions Параметры шаблона всплывающего окна. Для настройки нового окна выбора опцию нужно задать в формате {@link Controls.selector:ISelectFactoryArguments}.
