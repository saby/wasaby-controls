...
import { IItemAction, TIconSize, TIconStyle, TKey, TVisibility } from 'Controls/interface';
import { IActionWithCommand } from 'Controls/actions';
 ...
 */
export type TActionViewMode = Extract<IViewMode, 'link' | 'filled'>;
export type TItemActionViewMode = TActionViewMode;
 ...
 */
export type TItemActionHandler = (
    item: Model,
...
export type TActionShowType = TItemActionShowType;
 ...
 * @variant custom Произвольная позиция отображения. Задаётся через шаблон {@link Controls/interface:IItemTemplateListProps itemTemplate}.
 */
 ...
 * @variant m Средняя.
 */
export type TItemActionsSize = TIconSize; // 's' | 'm'
...
export interface IAction
     ...
     * @cfg {String} Identifier of the action.
     */
    id?: string;
     ...
     */
    showType?: TItemActionShowType | number; // TODO IActionBaseConfig['showType']
    ...
    /**
     * @cfg {Controls/interface:TActionViewMode} Режим отображения кнопки операции над записью.
     * @variant link В виде гиперссылки с возможностью отображения иконки.
     ...
     */
    displayMode?: TActionDisplayMode | string;
