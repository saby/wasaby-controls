...
export default interface ISearchBreadcrumbsOptions {
     ...
     * @default open
     * @demo Controls-demo/Search/SearchNavigationMode/Expand/Index
     * @demo Controls-demo/Search/SearchNavigationMode/Open/Index
     * @demo Controls-demo/Search/SearchNavigationMode/Readonly/Index
     */
