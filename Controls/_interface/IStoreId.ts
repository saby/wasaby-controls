 ...
 * </pre>
 * @see /doc/platform/developmentapl/interface-development/controls/new-data-store/create-context/ Реализация собственного слайса в контексте данных
 * @see /doc/platform/developmentapl/interface-development/controls/new-data-store/list-slice/ Слайс для работы со списочными компонентами
