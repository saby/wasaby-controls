 ...
 * <Controls-ListEnv.searchConnected:Input storeId='tasks'/>
 * <Controls.explorer:View storeId='tasks'/>
 * </pre>
 * @see /doc/platform/developmentapl/interface-development/context-data/new-data-store/create-context/ Реализация собственного слайса в контексте данных
 * @see /doc/platform/developmentapl/interface-development/context-data/new-data-store/list-slice/ Слайс для работы со списочными компонентами
 * @see Controls/dataFactory:IListDataFactoryArguments Интерфейс аргументов фабрики списка.
 */
