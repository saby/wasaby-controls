 ...
 * @variant all В меню отметки ПМО добавляется пункт "Показать отмеченные", если есть отмеченные чекбоксами записи.
 * @variant selected В меню отметки ПМО добавляется пункт "Показать все". Если есть отмеченные чекбоксами записи, так же добавляется пункт "Показать отмеченные"
