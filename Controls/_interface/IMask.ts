...
export interface IMaskOptions {
    /**
     * @name Controls/_interfaces/IMask#mask
    ...
    mask?: string;
    /**
     * @name Controls/_interfaces/IMask#replacer
    ...
    replacer?: string;
    /**
     * @name Controls/_interfaces/IMask#formatMaskChars
 ...
 * @interface Controls/_interfaces/IMask
 * @public
 */
