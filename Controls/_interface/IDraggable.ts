...
/**
 * @event customdragStart Происходит при начале перемещения элемента.
...
/**
 * @event customdragEnd Происходит при завершении перемещения элемента в списке.
...
/**
 * @event dragEnter Происходит при перемещении элемента из другого контрола.
...
/**
 * @event changeDragTarget Происходит перед изменением позиции, в которую будет перемещен элемент.
