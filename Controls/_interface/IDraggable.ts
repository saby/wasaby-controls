 ...
 * @param {Controls/listDragNDrop:TPosition} position Положение перемещения.
 * @example
 ...
 * @param {Controls/listDragNDrop:TPosition} position Position to move.
 * @see customdragStart
 */
 ...
 * @param {Controls/listDragNDrop:TPosition} position Позиция перемещения.
 * @returns {Boolean}
