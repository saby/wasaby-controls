...
export default interface ISuggest {
     ...
     * @demo Controls-demo/Suggest_new/Input/SuggestTemplate/SuggestTemplate
     * @editor function
     * @example
     ...
     * @demo Controls-demo/Suggest_new/Input/EmptyTemplate/EmptyTemplate
     * @example
     * <!-- emptyTemplate.wml -->
     * <pre class="brush: html">
     ...
     * @demo Controls-ListEnv-demo/SuggestSearch/FooterTemplate/FooterTemplate
     * @example
     * <pre class="brush: html">
     * <!-- myFooter.wml -->
     ...
     * необходимо использовать стандартный шаблон подвала {@link Controls/suggestPopup:FooterTemplate}
     */
    ...
    /**
     * @name Controls/_interface/ISuggest#suggestWidth
     * @cfg {String} Устанавливает ширину автодополнения
     * @remark Ширина задаётся в пикселях
     * @example
