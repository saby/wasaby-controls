import { IPadding } from 'Controls/_interface/IItemPadding';
...
export interface IItemsContainerPaddingOptions {
 ...
 * @cfg {Controls/_interface/IItemPadding/IPadding} Конфигурация внешних отступов
 * @example
