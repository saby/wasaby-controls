...
export interface IDateRangeValidatorsOptions {
    ...
    startValidationStatus: TValidationStatus;
    endValidationStatus: TValidationStatus;
}
...
/**
 * @name Controls/_interface/IDateRangeValidators#startValidationStatus
 * @cfg {Controls/interface:IValidationStatus} Статус поля ввода начала периода.
 */

/**
 * @name Controls/_interface/IDateRangeValidators#endValidationStatus
 * @cfg {Controls/interface:IValidationStatus} Статус поля ввода начала периода.
 */
