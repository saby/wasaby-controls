...
import { IHierarchySearchOptions } from 'Controls/searchDeprecated';
import { IMarkerListOptions } from 'Controls/marker';
import type { IShadowsOptions } from 'Controls/_scroll/Container/Interface/IShadows';
import { IFilterItem, IPrefetchOptions } from 'Controls/filter';
import { NewSourceController as SourceController } from 'Controls/dataSource';
import { ControllerClass as FilterControllerClass } from 'Controls/filterOld';
...
import type { TSearchNavigationMode } from 'Controls-DataEnv/listTypes';
...
export interface IListConfigurationBase
...
export interface IListConfiguration
    extends IListConfigurationBase,
        Omit<ITreeControlOptions, keyof IListConfigurationBase> {}
...
export interface IBrowserOptions
    extends IListConfiguration,
        ...
        IFilterChanged,
        INavigation {
    listsOptions: (IListConfiguration & { id: string })[];
 ...
 * - когда на странице используются контролы поиска/фильтра, которые связаны со списком с помощью опции storeId. (подробнее: {@link /doc/platform/developmentapl/interface-development/context-data/new-data-store/ новый механизм работы с данными})
 *
 * Не используйте, если:
 ...
 * </Controls.browser:Browser>
 * </pre>
 * @see {@link /doc/platform/developmentapl/interface-development/context-data/new-data-store/ Управление данными для страниц и окон}
 */

/**
 * @name Controls/_browser/interface/IBrowser#historyItems
 * @cfg {Array.<Controls/filter:IFilterItem>>} Заменяет набор последних примененных фильтров из истории.
 * @remark
