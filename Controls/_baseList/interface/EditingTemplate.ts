...
/**
 * Допустимые значения для опции {@link inputBackgroundVisibility}
 * @typedef TInputBackgroundVisibility.
 ...
 */
export type TInputBackgroundVisibility = 'visible' | 'onhover' | 'hidden';

/**
 * Допустимые значения для опции {@link inputBorderVisibility}.
 * @typedef TInputBorderVisibility
 * @variant partial Только нижняя граница поля ввода.
 * @variant hidden Границы поля ввода скрыты.
 */
export type TInputBorderVisibility = 'partial' | 'hidden';
...
export default interface IEditingTemplateOptions {
     ...
     * @cfg {Controls/_list/interface/EditingTemplate/TInputBackgroundVisibility.typedef} Режим подсветки полей ввода в режиме просмотра.
     * @default onhover
     */
     ...
     * @cfg {Controls/_list/interface/EditingTemplate/TInputBorderVisibility.typedef} Видимость границ полей ввода в режиме просмотра.
     * @default hidden
     */
