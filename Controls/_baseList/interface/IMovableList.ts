 ...
 * @interface Controls/_baseList/interface/IListActionAdditionalConfig
...
export interface IMovableList {
     ...
     * @param {Types/source:LOCAL_MOVE_POSITION} position
     ...
     * @param {String} viewCommandName Название команды для выполнения действия с RecordSet. По умолчанию Controls/viewCommands:Move
     * Чтобы скрыть или показать кнопку перемещения, можно возпользоваться утилитой {@link Controls/_listCommands/helpers/moveHelpers/MoveHelpers#canMoveToDirection canMoveToDirection}
     */
     ...
     * @public
     * @param {Controls/interface:ISelectionObject} selection
     * @param {Controls/list:IListActionAdditionalConfig} config Конфигурация, необходимая для открытия диалогового окна перемещения. В качестве команды для выполнения действия с RecordSet по умолчанию используется Controls/viewCommands:Move
     */
    moveItemsWithDialog(
        selection: ISelectionObject,
 ...
 * );
 * </pre>
 * @see Controls/list:IListActionAdditionalConfig
