...
export interface IEditableList {
     ...
     * @returns {Controls/_list/interface/IEditableList/TAsyncOperationResult.typedef}
     * @remark
...
export interface IEditingConfig {
    ...
    editOnClick?: boolean;
    /**
     * @name Controls/_list/interface/IEditingConfig#editOnEnter
     ...
     * @deprecated Опция устарела, используйте опцию {@link Controls/_list/interface/IEditingConfig#sequentialEditingMode sequentialEditingMode}
     * @variant true Включен.
     * @variant false Отключен.
     * @default true
     * @see sequentialEditingMode
     * @remark
     * Опция устарела, используйте опцию {@link Controls/_list/interface/IEditingConfig#sequentialEditingMode sequentialEditingMode}
     */
...
/**
 * @typedef {Promise<void | IOperationCanceledResult>} Controls/_list/interface/IEditableList/TAsyncOperationResult
 ...
 * @variant options {@link Controls/_list/interface/IEditableList/IBeforeBeginEditEventResultOptions Параметры редактирования/добавления по месту}.
 */
