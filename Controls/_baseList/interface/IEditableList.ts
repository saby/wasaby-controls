...
export interface IEditingConfig {
    /**
     * Автоматический запуск добавления по месту при инициализации {@link /doc/platform/developmentapl/interface-development/controls/list/list/empty/ пустого списка}.
     * * true Включен.
     * * false Отключен.
     * @cfg
     * @default false
    ...
    /**
     * Запуск редактирования по месту при клике по элементу списка. Является частью {@link /doc/platform/developmentapl/interface-development/controls/list/actions/edit/basic/ базовой конфигурации} функционала редактирования по месту.
     * * true Включен.
     * * false Отключен.
     * @cfg
     * @default false
    ...
    editOnClick?: boolean;
    /**
     * Запуск редактирования по месту отмеченного маркером элемента списка при нажатии клавиши Enter. Является частью {@link /doc/platform/developmentapl/interface-development/controls/list/actions/edit/basic/ базовой конфигурации} функционала редактирования по месту.
     * * true Включен.
     * * false Отключен.
     * @cfg
     * @default false
    ...
    editOnEnter?: boolean;
    /**
     * Автоматический запуск добавления нового элемента, происходящий при завершении редактирования последнего элемента списка.
     * * true Включен.
     * * false Отключен.
     * @cfg
     * @default false
    ...
    autoAdd?: boolean;
    /**
     * Автоматическое добавление нового элемента после добавления текущего элемента нажатием {@link /doc/platform/developmentapl/interface-development/controls/list/actions/edit/item-actions/#visible кнопки "Сохранить"} на {@link /doc/platform/developmentapl/interface-development/controls/list/actions/item-actions/ панели опций записи}.
     * * true Автоматическое добавление включено.
     * * false Автоматическое добавление отключено.
     * @cfg
     * @remark
     * Подробнее читайте {@link /doc/platform/developmentapl/interface-development/controls/list/actions/edit/ways-to-start/auto/#add здесь}.
     * @default true
    ...
    /**
     * Автоматический запуск редактирования по месту для следующего элемента при завершении редактирования любого (кроме последнего) элемента списка.
     * * true Включен.
     * * false Отключен.
     * @cfg
    ...
    /**
     * Автоматический запуск редактирования по месту для следующего элемента, происходящий при завершении редактирования любого (кроме последнего) элемента списка.
     * @cfg
     * @default row
     * @remark
    ...
    /**
     * Видимость кнопок "Сохранить" и "Отмена", отображаемых на {@link /doc/platform/developmentapl/interface-development/controls/list/actions/item-actions/ панели опций записи} в режиме редактирования.
     * * true Кнопки видны.
     * * false Кнопки скрыты.
     * @cfg
     * @default false
    ...
    /**
     * Предназначен для настройки фона редактируемого элемента.
     * @cfg
     * @remark
