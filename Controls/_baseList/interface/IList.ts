 ...
 * @name Controls/_grid/Grid#pixelRatioBugFix
 * @cfg {boolean}
 * @default true
 */
 ...
 * @name Controls/_grid/Grid#subPixelArtifactFix
 * @cfg {boolean}
 * @default false
 */
...
/**
 * @event Происходит при сворачивании и разворачивании скрытого под катом контента.
 * @name Controls/_list/interface/IList#cutClick
 * @param {UI/Events:SyntheticEvent} eventObject Дескриптор события.
