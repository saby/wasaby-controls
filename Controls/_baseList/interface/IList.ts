...
export type TListStyle = 'master' | 'default';
 ...
 * @extends Controls/interface/IItemTemplateListProps
...
export interface IList
    ...
    moreFontColorStyle?: TFontColorStyle;
...
/**
 * Прилипание {@link /doc/platform/developmentapl/interface-development/controls/list/grid/header/ шапки таблицы} и {@link /doc/platform/developmentapl/interface-development/controls/list/grouping/visual/ заголовков групп} при прокрутке {@link /doc/platform/developmentapl/interface-development/controls/list/grid/ таблицы} или {@link /doc/platform/developmentapl/interface-development/controls/list/ списка}.
 ...
 * @cfg {Boolean} Определяет, поддерживает ли метод, который вызывается для получения данных, параметр фильтрации {@link /doc/platform/developmentapl/service-development/service-contract/logic/list/list-iterator/#selection selection}.
 */
 ...
 * @deprecated Если указана опция {@link Controls/_interface/IStoreId#storeId storeId}, то необходимо использовать методы слайса {@link /docs/js/Controls/dataFactory/ListSlice/methods/_dataLoaded _dataLoaded} и {@link /docs/js/Controls/dataFactory/ListSlice/methods/_nodeDataLoaded _nodeDataLoaded}. См подробнее {@link /doc/platform/developmentapl/interface-development/context-data/new-data-store/list-slice/ Слайс для работы со списочными компонентами}.
 * @markdown
 * @remark
 ...
 * @remark
 * В первом и единственным аргументе возвращается стандартный объект ошибки в js.
 * @see itemsReadyCallback
 * @see dataLoadCallback
 */
 ...
 * @default default
 * @remark
 * Поддерживается линейка платформенных цветов, а также строковые значения:
 ...
 * При необходимоти можно указать произвольное строковое значение и самостоятельно определить CSS класс вида controls-background-{value}.
 * @see /doc/platform/developmentapl/interface-development/controls/list/list/background/
 */
