 ...
 * @param {UI/Events:SyntheticEvent<MouseEvent | null>} nativeEvent Объект нативного события браузера.
 ...
 * @param {UI/Events:SyntheticEvent<MouseEvent | null>} nativeEvent Native event object.
 * @remark
