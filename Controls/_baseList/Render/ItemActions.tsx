...
export function ItemActionsTemplateSelector(
    ...
    const [itemActions, setItemActions] = React.useState(
        item.getActions()?.showed || []
    );
...
export function SwipeActionsTemplate(
    props: ISwipeActionsTemplateProps
): JSX.Element {
    ...
    const hoverBackgroundStyle =
        ...
        props.item.getHoverBackgroundStyle() ||
        props.item.getStyle();

    const actionsTemplateConfig = props.item
        .getOwner()
    ...
    return (
        <SwipeActionsTemplateBase
            ...
            {...swipeConfig}
            showedActions={
                props.showedActions || props.item.getActions().showed
            }
...
export function HoverActionsTemplate(
    ...
    const actionsTemplateConfig = props.item
        .getOwner()
        .getActionsTemplateConfig(props);
...
export function getItemActionsTemplate(
    ...
    return React.forwardRef(
        (
            itemActionsProps: TInternalProps &
                Partial<IItemActionsTemplateProps>,
            _
        ) => {
            ...
            return (
                <HoverActionsTemplate
                    ...
                    showedActions={itemActions}
                    itemActionsClass={
                        itemActionsProps.itemActionsClass ||
                    ...
                    itemActionsBackgroundStyle={
                        itemActionsProps.itemActionsBackgroundStyle
                    }
