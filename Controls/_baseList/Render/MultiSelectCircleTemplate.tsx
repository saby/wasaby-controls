...
/**
 * Универсальный компонент круглого чекбокса.
 *
 ...
 * @see Controls/list:MultiSelectCircleTemplate
 */

/**
 * Шаблон круглого чекбокса, используемый в шаблоне записи списка.
 * Рендерит {@link Controls/list:CheckboxCircleMarker} и добавляет стили для выравнивания в шаблоне записи списка.
 * @class Controls/list:MultiSelectCircleTemplate
 *
 * @public
 * @demo Controls-demo/PropertyGridEditor/MultiSelect/MultiSelectTemplate/Circle/Index
 * @see Controls/list:CheckboxCircleMarker
 */
