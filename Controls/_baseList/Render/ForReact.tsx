...
function ItemTemplateWrapper(
    props: IItemTemplateWrapperProps
): React.ReactElement {
...
const ItemTemplateWrapperMemo = React.memo(
    ItemTemplateWrapper,
    itemTemplateWrapperPropsAreEqual
);
...
export default class For extends React.Component<IForProps> {
    protected _getItemProps(item: CollectionItem): IItemTemplateProps {
        return {
            ...
            checkboxVisibility:
                this.props.collection.getMultiSelectVisibility(),
            checkboxValue: item.isSelected(),
            markerVisible: item.isMarked(),
            actions: item.getActions()
                ? (item.getActions().showed as IItemAction[])
                : null,
            ...
            onItemActionSwipeAnimationEnd:
                this.props.onItemActionSwipeAnimationEnd,
            itemActionsTemplateMountedCallback:
                this.props.itemActionsTemplateMountedCallback,
            itemActionsTemplateUnmountedCallback:
                this.props.itemActionsTemplateUnmountedCallback,
