...
import { IViewOptions as IOptionFromSlice } from '../Data/connector/interface/IViewOptions';
import {
...
> extends React.Component<TProps, any> {
    ...
    private _setCollection(collection: Collection, isOnInit?: boolean): boolean {
        ...
        if (this.props.hasSlice) {
            ...
            if (
                isOnInit === false &&
                hasCollection &&
                isEmptyCollectionBeforeSet &&
                isExpandedItemsEmpty
            ) {
    ...
    protected _loadItemsToDirection(
        ...
        if (this.isControlDividedWithSlice) {
            return this.props._loadItemsToDirection(direction, addItemsAfterLoad, useServicePool);
        } else {
