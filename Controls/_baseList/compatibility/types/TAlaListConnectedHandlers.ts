...
export type TAlaListConnectedHandlers = {
    ...
    reload: TGetAlaListConnectedHandler<
        'reload',
        [
            cancelEditPromise: Promise<[boolean, boolean]>,
            control: TBaseTreeControl,
            options: IBaseTreeControlOptions
        ],
        Promise<unknown>
    >;

    _loadItemsToDirection: TGetAlaListConnectedHandler<
        '_loadItemsToDirection',
        [control: TBaseTreeControl],
        Promise<RecordSet | Error>
    >;

    _setPreloadedItems: TGetAlaListConnectedHandler<
        '_setPreloadedItems',
        [control: TBaseTreeControl],
        Promise<void>
    >;
