...
export type TSlicelessBaseControlCompatibility = {
    ...
    slicelessUpdateModel: typeof slicelessUpdateModel;
};
...
function slicelessUpdateModel(
    control: TBaseControl,
    oldOptions: IBaseControlOptions,
    newOptions: IBaseControlOptions
) {
    if (newOptions.order !== oldOptions.order) {
        control._listViewModel.setOrder(newOptions.order);
    }
}
