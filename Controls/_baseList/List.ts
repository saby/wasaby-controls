...
import { BaseControlEmulationCompatibility } from './compatibility/BaseControlEmulationCompatibility';
...
{
    protected _compatibilityWrapper = BaseControlEmulationCompatibility;
 ...
 * @cfg {String} Добавление заглушки после контента, чтобы список мог быть проскроллен последней записью к верхру скроллируемой области.
 */
