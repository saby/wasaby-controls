 ...
 * @implements Controls/interface:IItemTemplateOptions
    ...
    implements IMovableList, IRemovableList
{
    ...
    protected _renderPreloadedItemsRightAway: boolean;
    ...
    getItems(): RecordSet {
        ...
        return this._children.listControl
            ? this._children.listControl.getItems()
            : null;
    }
    ...
    scrollToItem(
        ...
        return this._children.listControl.scrollToItem(
            key,
            position,
            force,
            allowLoad
    ...
    moveItemUp(
        ...
        return this._children.listControl.moveItemUp(
            selectedKey,
            viewCommandName
        );
    }
    ...
    moveItemDown(
        ...
        return this._children.listControl.moveItemDown(
            selectedKey,
            viewCommandName
        );
    }
    ...
    moveItemsWithDialog(
        ...
        return this._children.listControl.moveItemsWithDialog(
            selection,
            viewCommandName
        );
    }
 ...
 * @cfg {Controls/_interface/IItemPadding/IPadding.typedef}
