 ...
 */
import { TKey, IStoreIdOptions } from 'Controls/interface';
...
import * as template from 'wml!Controls/_baseList/List';
 ...
 * @public
 */
export interface IItemsViewOptions
...
export type TItemsViewReceivedState = {
    uniqueId: string;
};
 ...
 * @implements Controls/interface:IStoreIdOptions
...
{
    protected readonly _disableSource: boolean = true;
