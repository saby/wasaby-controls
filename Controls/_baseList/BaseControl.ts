    ...
    implements IMovableList, IEditableList
{
    ...
    constructor(options: IBaseControlOptions, context: object) {
        ...
        this._itemHandlers = {
            ...
            onTouchEndCallback: (event, item) => {
                return callWithCollectionItem(item, this._listViewModel, (collectionItem) => {
                    return this._onItemTouchEnd(event, collectionItem, event);
                });
            },
        };
        ...
        switch (action) {
            case IObservable.ACTION_RESET:
                ...
                const backwardTriggerVisible =
                    ...
                    (this._options.task88221034859483 && !this._hasMoreData('down')) ||
                    (!this._listViewModel.getCount() && !_private.isPortionedLoad(this)) ||
                    !this._options.attachLoadTopTriggerToNull;
    ...
    _onItemTouchEnd(e: SyntheticEvent): void {
        // TODO Убрать мой стоп после аыпуска
        //  https://online.sbis.ru/opendoc.html?guid=8dd871ed-b509-400f-ba25-e01b65701619&client=3
    ...
    private _getDndProps(hasDragScrolling?: boolean): dndCore.IDragNDropProps {
        return {
            ...this._options,
            viewModelState: {
                ...this._options,
