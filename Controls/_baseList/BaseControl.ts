...
import {
    ...
    BASE_CONTROL_DEFAULT_OPTIONS,
} from './compatibility/BaseControlEmulationCompatibility';
...
const _private = {
    ...
    initializeModel(self: BaseControl, options: IBaseControlOptions, data: RecordSet): void {
        ...
        if (!self._destroyed) {
            ...
            if (!options.useCollection) {
                ...
                options.setCollection(self._listViewModel);
            }
    ...
    keyDownEnd(self: BaseControl): void {
        if (self._options.navigation?.viewConfig?.showEndButton) {
            ...
            self._listVirtualScrollController.scrollToEdge('forward').then((key) => {
                self._options.slicelessSetMarkedKeyAfterPaging(self, self._options, key);
            });
        }
    },
    ...
    enterHandler(self: BaseControl, event: SyntheticEvent<KeyboardEvent>): void {
        ...
        if (self._options.slicelessHasMarkerController(self)) {
            const markerController = self._options.slicelessGetMarkerController(self);
    ...
    keyDownDown(self: BaseControl, event: SyntheticEvent): void {
        self._options.slicelessMoveMarkerToDirection(self, self._options, event, 'Down');
    },

    keyDownUp(self: BaseControl, event: SyntheticEvent): void {
        self._options.slicelessMoveMarkerToDirection(self, self._options, event, 'Up');
    },

    spaceHandler(self: typeof BaseControl, event: SyntheticEvent): void {
        self._options.slicelessSpaceHandler(self, self._options, event, (key) => {
    ...
    keyDownDel(self: BaseControl, event: SyntheticEvent<MouseEvent>): void {
        ...
        const toggledItemId = self._options.slicelessGetMarkerController(self).getMarkedKey();
        ...
        if (self._sourceController) {
            ...
            return self
                ...
                .addCallback((addedItems: RecordSet) => {
                    ...
                    if (
                        self._options.slicelessHasMarkerController(self) &&
                        _private.isPortionedLoad(self)
                    ) {
                        const newMarkedKey = self._options
                            .slicelessGetMarkerController(self)
                            .onCollectionReset();
                        self._options.slicelessChangeMarkedKey(self, self._options, newMarkedKey);
                    }
                    ...
                    if (!self._sourceController?.getLoadError()) {
                        ...
                        if (direction === 'up') {
                            ...
                            self._listVirtualScrollController
                                ...
                                .then((key) => {
                                    self._options.slicelessSetMarkedKeyAfterPaging(
                                        self,
                                        self._options,
                                        key
                                    );
    ...
    implements IMovableList, IEditableList
{
    ...
    protected _keyDownLeft(event: SyntheticEvent<KeyboardEvent>, canMoveMarker: boolean): void {
        ...
        this._options.slicelessOnKeyDownLeft(this, this._options, event, canMoveMarker);
    }
    ...
    protected _keyDownRight(event: SyntheticEvent<KeyboardEvent>, canMoveMarker: boolean): void {
        ...
        this._options.slicelessOnKeyDownRight(this, this._options, event, canMoveMarker);
    }
    ...
    protected _beforeUpdate(
        ...
        const markerCompatibility = this._options.slicelessGetBeforeUpdateSteps(this, newOptions);
        markerCompatibility.stepOne();
        ...
        markerCompatibility.stepThree(this._options, {
            modelRecreated,
    ...
    setMarkedKey(key: CrudEntityKey): void {
        if (this._options.markerVisibility !== 'hidden') {
            this._options.slicelessChangeMarkedKey(this, this._options, key);
        }
    }
    ...
    protected _onItemClick(
        ...
        this._options.slicelessSetMarkerOnItemClick(this, this._options, contents, originalEvent);
    ...
    _afterEndEditCallback(item: IEditableCollectionItem, isAdd: boolean, willSave: boolean): void {
        ...
        this._options.slicelessSetMarkerAfterEndEditCallback(
            this,
            this._options,
            item,
            isAdd,
    ...
    onactivated(
        ...
        if (eventOptions?.isTabPressed && this.__needShowEmptyTemplate(this._options)) {
            ...
            this._options.slicelessOnActivated(this, this._options, eventOptions);
        }
    }
    ...
    private _addCoordinatesToActionMenuEvent(target: EventTarget | null): void {
        ...
        // поэтому мдобавляем свойства, а не подменяем target на координаты.
        if (menuRow) {
        ...
        const endDrag = (): void => {
            ...
            if (
                ...
                if (!moveToCollapsedNode) {
                    ...
                    this._options.slicelessChangeMarkedKey(this, this._options, draggedKey);
                }
            }
