    ...
    implements IMovableList, IEditableList
{
    ...
    protected _reload(
        ...
        return new Promise((resolve, reject) => {
            const loader = (cfg.reloadFromContext && cfg.slice) || this._sourceController;
            if (loader) {
    ...
    protected _onItemClick(
        ...
        this._setMarkerOnItemClick(contents, originalEvent);
    ...
    protected _setMarkerOnItemClick(contents: Model | Model[], originalEvent: MouseEvent): void {
        ...
        const itemContents = this._listViewModel.getItemBySourceKey(key)?.getContents() || contents;
        ...
        if (this._options._needSetMarkerCallback) {
            canBeMarked =
                canBeMarked && this._options._needSetMarkerCallback(itemContents, originalEvent);
        }
        if (canBeMarked) {
    ...
    private _onSelectedTypeChanged(typeName: string, limit: number | undefined): void {
        ...
        switch (typeName) {
            ...
            case 'all':
                ...
                selectionController.setMassSelect(true);
                break;
            case 'selected':
