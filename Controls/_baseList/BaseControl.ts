...
export type TBottomPaddingMode = 'placeholder' | 'basic' | 'actions' | 'additional';
    ...
    handleListScrollSync(self: BaseControl, scrollTop: number): void {
        ...
        if (self._options.trackedProperties && isRealScroll && !self._scrolledToEdge) {
            const trackedValuesVisible =
                self._scrollTop + self._placeholders?.backward > 0 || self._hasMoreData('up');
...
export interface IBaseControlOptions
    extends IControlOptions,
        ...
        IEditableListOptions,
        IStoreIdOptions,
        Partial<INewListSchemeProps>,
        Partial<INewListSchemeHandlers> {
    keyProperty?: string;
    ...
    implements IMovableList, IEditableList
{
    ...
    protected _getBottomPaddingClass(
        ...
        } else if (options._needBottomPadding) {
    ...
    protected _updateTrackedValues(): void {
        const trackedValuesVisible =
            this._scrollTop + this._placeholders?.backward > 0 || this._hasMoreData('up');
    ...
    protected _getItemsContainerClasses(): string {
        ...
        classes.push(this._bottomPaddingClass);
