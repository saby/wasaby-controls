...
function ContentComponent(props: IGroupContentProps) {
    ...
    if (displayText) {
        ...
        const textRender =
            props.children ||
            (typeof props.textRender === 'string'
                ? props.textRender
        ...
        content = (
            <div className={contentTextWrapperClasses}>
                <div className={contentTextClasses} data-qa={`${props.listElementName}-expander`}>
                    {textRender}
                </div>
            </div>
        );
    ...
    return (
        ...
        >
            <ContentComponent
                ...
                rightPaddingClassName={item.getGroupPaddingClasses('right')}
                leftPaddingClassName={item.getGroupPaddingClasses('left')}
            />
        </div>
    );
});
