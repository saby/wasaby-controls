...
// По хорошему от этого нужно избавляться, но если это убрать, то сломается в большом кол-ве мест
const HALIGN_MAPPER = {
    start: 'left',
    end: 'right',
    center: 'center',
...
export default React.memo((props: IGroupTemplateProps) => {
    ...
    if (!item.isExpanded()) {
        className += ' controls-ListView__group_collapsed';
    }
 ...
 * @class Controls/_baseList/GroupTemplate/Content
 * @public
 */
