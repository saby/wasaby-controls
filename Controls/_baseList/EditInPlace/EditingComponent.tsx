...
import { BaseEditingComponent, IBaseEditingEventHandlers } from 'Controls/listVisualAspects';

export interface IEditingComponentProps extends TInternalProps, IBaseEditingEventHandlers {
    item?: CollectionItem;
    itemData?: CollectionItem;
    column?: GridDataCell;

    viewTemplate?: JSX.Element;
