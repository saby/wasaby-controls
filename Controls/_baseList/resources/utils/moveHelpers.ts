 ...
 * @interface Controls/_baseList/resources/utils/MoveHelpers/IMoveToDirection
 * @public
 */
...
export function getSiblingItem(props): Model {
 ...
 * @function Controls/_baseList/resources/utils/MoveHelpers/canMoveToDirection
 * @param {Controls/_baseList/resources/utils/MoveHelpers/IMoveToDirection} props Параметры хелпера.
 * @example
 ...
 * </pre>
 */
export function canMoveToDirection(props: IGetSiblingItem): boolean {
