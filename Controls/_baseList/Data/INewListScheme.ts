...
import type { TTriggerVisibilityChangedCallback } from 'Controls/gridRender';
...
export interface INewListSchemeHandlers {
    setCollection(collection: Collection | null, isOnInitInOldLists?: boolean): boolean;
    ...
    onCheckboxClickNew(e, item): void;

    onItemClickNew(e, item, params?: unknown): void;

    onExpanderClick(e, item, props?: TOnToggleExpansionParams): void;
