    ...
    implements INewListSchemeHandlers
{
    ...
    protected _initSlice(options: IConnectedCompatibleContainerOptions): void {
        ...
        this._contextState = {
            ...
            listStoreId: options.isBrowser ? undefined : options.storeId,
        };
        ...
        this._slice._setState = (newState) => {
            ...
            this._contextState = {
                ...newState,
                listStoreId: this._options.isInsideDataContainer
    ...
    protected _setOptionToSliceAndNotify(
        ...
        // Обязательно останавливаем оригинальное событие, т.к. на момент написания этого
        // кода между прикладником и baseControl'ом нет никакого div.
        // События летят от div, прикладник может подписаться на прямо на списке,
        // тогда он получит два события, первое BaseControl, второе от LCCC.
        // https://online.sbis.ru/opendoc.html?guid=aaccdf83-434b-49ba-899c-384f47606315&client=3
