...
import { INavigationSourceConfig, MarkerDirection, TKey } from 'Controls/interface';
...
import { InvertModes } from 'Controls/interface';
import {
    executeAction,
...
export function getHandlersNew(props: IGetHandlersProps): INewListSchemeHandlers {
    ...
    return {
        ...
        _loadItemsToDirection(
            ...
            const isInverted = slice.state.order && slice.state.order !== 'default';
            ...
            return slice._loadItemsToDirection(
