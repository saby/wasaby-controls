...
export default class ScrollPagingController {
    ...
    protected getPagingCfg(arrowState: IArrowState, hasMoreData: IHasMoreData): IPagingCfg {
        ...
        pagingCfg.showTotalCounter = this._options.showTotalCounter;
        return pagingCfg;
    }
    ...
    updateOptions(
        newOptions: IScrollPagingOptions,
        hasMoreData: IHasMoreData = { up: false, down: false }
    ): void {
        this._options = newOptions;
        this.initializePagingData(newOptions);
        this.updateStateByScrollParams(newOptions.scrollParams, hasMoreData);
    }
