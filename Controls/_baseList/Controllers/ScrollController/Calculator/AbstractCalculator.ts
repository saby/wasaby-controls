 ...
 * @private
 */
export interface IAbstractCalculatorOptions
    extends IAbstractCalculatorBaseOptions {
    itemsSizes: IItemsSizes;
}
    ...
    scrollPositionChange(
        ...
        if (this._scrollPosition !== scrollPosition) {
            if (
                ...
                const maxScrollPosition =
                    this._scrollContainerSize - this._viewportSize;
                this._scrollPosition = Math.min(
                    scrollPosition,
                    maxScrollPosition
                );
            } else {
        ...
        if (updateActiveElement) {
            this._activeElementIndex = getActiveElementIndexByScrollPosition({
                contentSize: this._listContainerSize,
                viewportSize: this._viewportSize,
                itemsSizes: this._itemsSizes,
                currentRange: this._range,
                placeholders: this._getPlaceholders(),
        ...
        return {
            ...
            activeElementIndexChanged:
                oldActiveElementIndex !== this._activeElementIndex,
        };
    }
