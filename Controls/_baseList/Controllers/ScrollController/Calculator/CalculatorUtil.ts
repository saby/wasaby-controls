...
import type { IItemSize, IItemsSizes, IRenderedOutsideItem } from '../ItemsSizeController/AbstractItemsSizeController';
...
export function getEdgeVisibleItem(
    ...
    for (
        ...
        if (
            ...
            const itemIsFirstInRow = prevItem && prevItem.offset < item.offset
               && nextItem && nextItem.offset === item.offset;
            if (itemIsFirstInRow) {
                isValidItem = !validateItem || validateItem(nextItem.key);
