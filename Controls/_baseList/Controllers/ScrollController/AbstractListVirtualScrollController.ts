...
import { TItemKey, VirtualScrollController, VirtualScrollHideController } from 'Controls/display';
...
> {
    ...
    removeItems(
        ...
        this._scrollController.removeItems(
            position,
            typeof removedItems === 'number' ? removedItems : removedItems.length,
            scrollMode
        );
    }
    ...
    hasEnoughContentToScrollToItem(index: number, position?: string, force?: boolean): boolean {
        return this._scrollController.hasEnoughContentToScrollToItem(index, position, force);
    }
