...
export class ScrollController {
    ...
    updateContentSizeBeforeList(): boolean {
        ...
        if (!this._disableVirtualScroll) {
            (this._calculator as Calculator).setContentSizeBeforeList(contentSizeBeforeList);
        }
    ...
    hasEnoughContentToScrollToItem(index: number, position?: string, force?: boolean): boolean {
        return this._calculator.hasEnoughContentToScrollToItem(index, position, force);
    }
