...
/**
 * Варианты размещения маркера в списке
 * @typedef TMarkerPosition
 * @variant default Размещение слева от записи, по умолчанию
 * @variant outside Размещение слева на оступе перед записью
 * @variant custom Размещение задаётся CSS классами, переданными в опцию markerClassName шаблона списка или аналогичный параметр объекта конфигурации строки таблицы, возвращаемого из getRowProps
 */
