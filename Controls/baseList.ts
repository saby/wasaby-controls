...
import { default as EditingComponent } from 'Controls/_baseList/EditInPlace/compatibleLayer/EditingComponentProvider';
...
export {
    default as ContainerNew,
    IListContainerOptions as IContainerNewProps,
} from 'Controls/_baseList/Data/ListContainerConnected';
