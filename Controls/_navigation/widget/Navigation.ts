...
export interface INavigationWidgetOptions extends INavigationControlOptions, IControlOptions {
...
export default class Navigation extends Control<INavigationWidgetOptions> {
    ...
    protected _onActiveElementChanged(event: SyntheticEvent, activeElement: CrudEntityKey): void {
    ...
    private _getListConfig(options: INavigationWidgetOptions = this._options): IListConfigResult {
        const id = options.storeId || Object.keys(options._dataOptionsValue.listsConfigs)[0];
