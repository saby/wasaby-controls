...
const Footer = React.forwardRef(function Index(props, ref): JSX.Element {
    const {
        footerTemplate,
    ...
    if (!isDefaultFooter) {
        ...
        return (
            <ContentTpl
                ...
                tabsSelectedKey={tabsSelectedKey}
...
function ShowMoreButtonTemplate(props): JSX.Element {
    ...
    return (
        <Button
            data-qa="controls-Suggest__more"
...
export { DefaultFooterTemplate as FooterTemplate, Footer as _FooterTemplate };
