...
const _private = {
    getBorderWidth(container?: HTMLElement): number {
        ...
        return container
            ? Number(
                  getComputedStyle(container.querySelector('.controls-Suggest__suggestionsContainer'), null)
...
const PopupContent = Control.extend({
    ...
    _beforeUpdate(newOptions): void {
        ...
        const isPopupOpenedToTop =
            newOptions.stickyPosition && newOptions.stickyPosition.direction.vertical === 'top';
