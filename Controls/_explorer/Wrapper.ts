...
export default class ExplorerWrapper extends Control<IControlOptions> {
    ...
    getMarkedNodeKey(
        ...args: FnParams<'getMarkedNodeKey'>
    ): FnResult<'getMarkedNodeKey'> {
    ...
    moveItemsWithDialog(
        ...args: FnParams<'moveItemsWithDialog'>
    ): FnResult<'moveItemsWithDialog'> {
        return this._children.explorer.moveItemsWithDialog(...args);
    }

    toggleExpanded(
        ...args: FnParams<'toggleExpanded'>
    ): FnResult<'toggleExpanded'> {
    ...
    scrollToRight(
        ...args: FnParams<'scrollToRight'>
    ): FnResult<'scrollToRight'> {
        return this._children.explorer.scrollToRight(...args);
    }

    scrollToColumn(
        ...args: FnParams<'scrollToColumn'>
    ): FnResult<'scrollToColumn'> {
