...
export default class ExplorerWrapper extends Control<IExplorerOptions> {
    ...
    horizontalScrollToElement(
        ...args: Parameters<IAbstractColumnScrollControl['horizontalScrollToElement']>
    ): ReturnType<IAbstractColumnScrollControl['horizontalScrollToElement']> {
        return this._children.explorer.horizontalScrollToElement(...args);
    }
