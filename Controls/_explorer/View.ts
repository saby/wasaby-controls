 ...
 *
 * @ignoreOptions filter navigation sorting selectedKeys excludedKeys multiSelectVisibility markerVisibility expandedItems hasChildrenProperty selectionType displayProperty groupHistoryId searchValue propStorageId parentProperty nodeProperty nodeHistoryType nodeHistoryId root nodeTypeProperty selectionCountMode
 *
 * @public
 */
