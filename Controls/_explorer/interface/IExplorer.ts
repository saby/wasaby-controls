 ...
 * @cfg {Controls/_tile/interface/ITile/TileItemPadding.typedef|Controls/_interface/IItemPadding/IPadding.typedef}
 * @remark
 ...
 * В прочих режимах эта опция повлияет на отступы внутри записи и принимает объект {@link Controls/_interface/IItemPadding/IPadding.typedef ItemPadding}.
 */
