...
import { ITileOptions } from 'Controls/tile';

/**
 * Тип, описывающий допустимые значения опции {@link Controls/_explorer/interface/IExplorer#viewMode viewMode} задающей режим отображения списка
...
/**
 * Тип, описывающий допустимые значения опции {@link Controls/_explorer/interface/IExplorer#breadcrumbsVisibility breadcrumbsVisibility} задающей видимость хлебных крошек
 ...
 * @typedef Controls/_explorer/interface/IExplorer/TBreadcrumbsMode
...
export type IExplorerTileProps = Partial<Pick<ITileOptions, 'imageProperty' | 'tileScalingMode'>>;
...
export interface IExplorerOptions
    extends Partial<ITreeControlOptions>,
        ...
        IFilterOptions,
        ISortingOptions,
        Pick<ISearchBreadcrumbsOptions, 'searchNavigationMode'>,
        IExplorerTileProps {
    /**
    ...
    /**
     * @cfg
     * Видимость хлебных крошек и кнопки "Назад" над реестром.
     ...
     * @cfg {Controls/_explorer/interface/IExplorer/TBreadcrumbsMode.typedef}
     * @default row
     */
    ...
    /**
     * @cfg
     * Отображение хлебных крошек над реестром в одну или несколько строк {@link Controls/breadcrumbs:HeadingPath#displayMode}
     * @default default
     */
     ...
     * @example
     * <pre class="brush: js; highlight: [7-9]">
     * import * as React from 'react';
     * import { useContent } from 'UICore/Jsx';
     * import { View as ExplorerView } from 'Controls/explorer';
     * import { ItemTemplate as TileItemTemplate, ITileItemProps } from 'Controls/tile';
     *
     * function Demo(): React.ReactElement {
     *     const tileItemTemplate = useContent((props: ITileItemProps) => {
     *         return <TileItemTemplate {...props} highlightOnHover={false} />;
     *     });
     *     return (
     *         <ExplorerView storeId="demoStoreId"
     *                       columns={columns}
     *                       tileItemTemplate={tileItemTemplate}/>
     *     );
     * }
     * </pre>
     * @demo Controls-demo/explorerNew/WI/TileItemTemplate/Index
     * @see Controls/_explorer/interface/IExplorer#itemTemplate
     * @see Controls/_explorer/interface/IExplorer#itemTemplateProperty
     */
     ...
     * @cfg {Controls/_heading/Back/TBackButtonStyle/TBackButtonStyle.typedef}
     * @default pale
     */
    ...
    /**
     * @cfg {Boolean} Если значение опции установлено в false, то  иконка "домик" не отображается.
     * @default true
     */
    pathHomeButtonVisible?: boolean;
 ...
 * Если требуется вывести хлебные крошки внутри пользовательского шаблона, то стоит передать в contentTemplate компонент Controls/searchBreadcrumbsGrid:SearchBreadcrumbsPathComponent и прокинуть в нео scope="{{contentTemplate}}"
 * @name Controls/_explorer/interface/IExplorer#searchBreadCrumbsItemTemplate
...
/*
 * @name Controls/_explorer/interface/IExplorer#displayProperty
 ...
 * @cfg {Controls/_tile/interface/ITile/TileItemPadding.typedef|Controls/_interface/IItemPadding/IPadding}
 * @remark
 ...
 * В прочих режимах эта опция повлияет на отступы внутри записи и принимает объект {@link Controls/_interface/IItemPadding/IPadding ItemPadding}.
 */
