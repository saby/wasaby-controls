...
export function getNodeExtraItemCellComponentProps(
    ...
    const padding = isMultiselectCell
        ? null
    ...
    const resultProps: INodeExtraItemCellComponentProps = {
        ...
        // тип ячейки
        cellType: isMultiselectCell ? 'checkbox' : cell.LadderContentCell ? 'ladder' : 'base',
        ...
        expanderSize: getCellPropsResult?.expanderSize || rowProps.expanderSize,
        levelIndentSize: getCellPropsResult?.levelIndentSize || rowProps.levelIndentSize,
        withoutLevelPadding:
            getCellPropsResult?.withoutLevelPadding || rowProps.withoutLevelPadding,
        withoutExpanderPadding:
            getCellPropsResult?.withoutExpanderPadding || rowProps.withoutExpanderPadding,
    };
