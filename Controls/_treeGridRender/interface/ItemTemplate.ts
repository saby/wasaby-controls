 ...
 * @class Controls/_treeGridRender/interface/ItemTemplate
...
/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#withoutLevelPadding
...
/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#expanderIcon
...
/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#expanderSize
...
/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#levelIndentSize
...
/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#withoutExpanderPadding
 * @cfg {Boolean} Принудительно скрывать отступ под иконку экспандера.
 * @default false
 */

/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#fontColorStyle
 ...
 * {@link Controls/treeGridRender:IColumn#fontColorStyle Стиль цвета текста ячейки} имеет больший приоритет, чем стиль цвета текста записи.
 * Стиль цвета текста задается константой из стандартного набора цветов, который определен для текущей темы оформления.
 */
/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#fontSize
 * @cfg {TFontSize} Размер шрифта записи.
 * @remark
 * Размер шрифта применяется ко всем записям дерева с колонками, включая {@link /doc/platform/developmentapl/interface-development/controls/list/tree-column/node/group/ узлы, отображаемые в виде групп}.
 ...
 * {@link Controls/treeGridRender:IColumn#fontSize Размер шрифта ячейки} имеет больший приоритет, чем стиль размер шрифта текста записи, но на базовую линию не влияет.
 * Размер шрифта задается константой из стандартного набора размеров шрифта, который определен для текущей темы оформления.
 * @default l
 */
/**
 * @name Controls/_treeGridRender/interface/ItemTemplate#fontWeight
 ...
 * {@link Controls/_treeGridRender/interface/IColumn#fontWeight Насыщенность шрифта ячейки} имеет больший приоритет, чем Насыщенность шрифта текста записи.
 * @default "default".
 */
