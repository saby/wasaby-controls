...
export interface IGroupNodeConfig extends IBaseGroupTemplate {
    /**
     * @cfg {Controls/IVerticalRowPadding} Вертикальные отступы группы
...
export interface IGroupNodeColumn extends IColumn {
    /**
     * @cfg {Controls/_treeGridRender/interface/IGroupNodeColumn} Конфигурация шаблона группы для текущей колонки
    ...
    /**
     * @name Controls/_treeGridRender/interface/IGroupNodeColumn#template
