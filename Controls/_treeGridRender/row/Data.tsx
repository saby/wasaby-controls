...
import { GridHeaderCell, GridFooterCell, GridResultsCell, GridCell } from 'Controls/gridDisplay';
import {
    ...
    if ((cell as unknown as TreeGridNodeExtraItemCell).$TGNEC) {
        ...
        const renderProps = {
            ...
            beforeContentRender: (
                <LevelPadding
                    cell={cell}
                    withoutExpanderPadding={baseCellProps.withoutExpanderPadding}
                />
            ),
            key: cell.key,
            gridColumn: cell,
...
export function getCleanCellComponent(
    ...
    if ((cell as unknown as TreeGridNodeExtraItemCell).$TGNEC) {
        const renderProps: INodeExtraItemCellComponentProps = {
            ...
            key: cell.key,
            beforeContentRender: <LevelPadding cell={cell} />,
        };
