...
import { IExpanderProps, CustomExpanderConnectedComponent } from 'Controls/treeRender';
...
export interface IItemProps<TContents extends Model = Model>
    extends IGridItemProps<TContents, TreeGridDataRow<TContents>>,
        IExpanderProps {}
...
function getCompatibleTreeGridRowComponentProps(props: IItemProps, rowProps: IRowComponentProps) {
    ...
    const className =
        (compatibleGridRowComponentProps.className ?? '') +
        getGroupChildRowComponentClasses(rowProps);
