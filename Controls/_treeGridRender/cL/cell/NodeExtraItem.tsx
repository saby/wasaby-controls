...
import { validate, IColumnTemplateProps, templateLoader } from 'Controls/gridRender';
...
import type { TreeGridNodeFooterRow, TreeGridNodeHeaderRow } from 'Controls/treeGridDisplay';

export interface INodeExtraItemCellTemplateProps
    extends IColumnTemplateProps<string, TreeGridNodeHeaderRow | TreeGridNodeFooterRow> {}
...
function getCompatibleNodeExtraItemCellComponentProps(
    props: INodeExtraItemCellTemplateProps
): INodeExtraItemCellComponentProps {
...
function getContentRender(
    props: INodeExtraItemCellTemplateProps,
    preparedProps: INodeExtraItemCellComponentProps
) {
