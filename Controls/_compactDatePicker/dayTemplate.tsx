...
function CompactDatePickerDayContentTemplate(props) {
    ...
    return (
        <>
            ...
            {isSelectedStart() ? (
                <div className="controls-CompactDatePicker__month-list__item_selected__container controls-CompactDatePicker__month-list__item_selected__container-start">
            ...
            {isSelectedEnd() ? (
                <div className="controls-CompactDatePicker__month-list__item_selected__container controls-CompactDatePicker__month-list__item_selected__container-end">
