...
export default class CompactDatePicker extends Control<ICompactDatePickerOptions> {
    ...
    private _updateTodayIconVisible(newState: boolean, displayedRanges: Date[][], mockedDate: Date): void {
    ...
    protected _todayIconVisibleChangedHandler(todayIconVisible: boolean): void {
        this._updateTodayIconVisible(todayIconVisible, this._options.displayedRanges, this._options._date);
    }
