 ...
 * @remark В качестве аргумента получит дату и данные дня из сорса, по которому произашел клик
 */
 ...
 * @cfg {String} Название поля, находящегося в extData. При указании отображает счётчик под днём календаря.
 * @see Controls/calendar:IMonthListSource
