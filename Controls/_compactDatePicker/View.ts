 ...
 * @implements Controls/calendar:IEnableWeekends
 ...
 * * {@link https://git.sbis.ru/saby/wasaby-controls/-/blob/rc-24.6100/Controls-default-theme/variables/_compactDatePicker.less переменные тем оформления}
...
/**
 * @name Controls/compactDatePicker:View#isMarked
 * @cfg {Boolean} Имя поля в extData, которое указывает на необходимость пометки даты. extData приходит в качестве ответа при загрузке {@link Controls/calendar:IMonthListSource#source source}.
 * @demo Controls-demo/CompactDatePicker/Mark/Index
 */
...
/**
 * @name Controls/compactDatePicker:View#counterFormatter
 * @cfg {Function} Коллбек-функция для форматирования текста в счетчике.
 * @demo Controls-demo/CompactDatePicker/CounterFormatter/Index
 * @default true
 */
...
interface ICompactDatePickerOptions
    ...
    counterClickCallback?: (event: Event, item: Date) => any;
