...
/**
 * @name Controls/_actions/interface/IActionOptions#emptyViewVisibility
 * @cfg {boolean} Флаг, указывающий на то, будет ли экшен отображаться в пустом представлении.
 * @default false
 */
 ...
 * @cfg {string} Путь до модуля, реализующего класс с интерфейсом ICommand.
