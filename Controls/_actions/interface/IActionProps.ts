...
/**
 * @name Controls/_actions/interface/IActionProps#menuIcon
 * @cfg {string} Иконка, отображаемая в меню
 */
 ...
 * @cfg {Controls/_toolbars/interfaces/IToolbarSource/ShowType.typedef} Определяет, где будет отображаться action.
 */
