...
import { IUsedContextNode } from 'Controls-DataEnv/context';

function isSliceWithSelection(slice: object): slice is ISliceWithSelection {
...
export default class ActionsContainer extends Control<IContainerOptions> {
    ...
    private _contextNode: IUsedContextNode;
    ...
    protected _beforeMount(options: IContainerOptions): void {
        ...
        this._actionsCollection = new ActionsCollection({
            ...
            changeMenuItemsShowType: options.changeMenuItemsShowType,
        });
    ...
    protected _executeAction(
        ...
        const params = {
            ...
            contextNode: this._options.contextNode,
        };
    ...
    protected _afterMount(_options?: IContainerOptions) {
