...
import { IActionExecuteParams, IActionState } from 'Controls/_actions/interface/IAction';
...
> {
    ...
    getToolbarItem(): IActionState {
        return {
            ...this.getState(),
            'parent@': this._items.getCount() === 2 ? undefined : true,
        };
    }
