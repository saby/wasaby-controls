    ...
    implements IAction<T>
{
    ...
    protected set counter(value: number) {
        this._setProperty('_counter', value);
    }

    get counterStyle(): string {
        return this._counterStyle;
    }

    protected set counterStyle(value: string) {
        this._setProperty('_counterStyle', value);
    }
    ...
    protected set displayMode(value: string) {
        this._setProperty('_displayMode', value);
    }
    ...
    protected set showType(value: showType) {
        this._setProperty('_showType', value);
    }
    ...
    protected set group(value: string) {
        this._setProperty('_group', value);
    }
    ...
    constructor(options: T) {
        ...
        this.counterStyle = options.counterStyle || this.counterStyle;
        this.displayMode = options.displayMode || this.displayMode;
    ...
    isRequiresSelection(): boolean {
        return !!this._options.requiresSelection;
    }
