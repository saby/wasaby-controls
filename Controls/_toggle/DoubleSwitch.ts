 ...
 */
class DoubleSwitch
    extends Control<IDoubleSwitchOptions>
    implements ICheckable, ITooltip
{
    ...
    private _checkCaptions(options: IDoubleSwitchOptions): void {
        if (
            typeof options.offCaption === 'undefined' ||
            typeof options.onCaption === 'undefined'
        ) {
            throw new Error('You must set offCaption and onCaption.');
        }
    }

    private _toggleSwitchHoverState(
    ...
    protected _setOffCaptionTemplate(
        offCaption: TemplateFunction | string
    ): void {
        const stringCaption =
            typeof offCaption === 'string' ||
            offCaption instanceof String ||
            !offCaption;
        this._offCaptionTemplate = stringCaption ? textTemplate : offCaption;
    }

    protected _setOnCaptionTemplate(
        onCaption: TemplateFunction | string
    ): void {
        const stringCaption =
            typeof onCaption === 'string' ||
            onCaption instanceof String ||
            !onCaption;
