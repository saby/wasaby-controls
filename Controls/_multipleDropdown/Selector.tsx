...
import { IDropdownConfigArgs } from 'Controls/_multipleDropdown/interface/IDropdownConfigArgs';
...
export interface IMultipleDropdown
     ...
     * @cfg {Object.<string, IDropdownConfigArgs>} Настройки для каждого меню.
     * @example
     * <pre>
     *     menuConfigs = {
     *         traffic: {
...
/**
 * Контрол выбора из объединенного меню.
 * @class Controls/multipleDropdown:Selector
 * @implements Controls/dropdown:IUnderline
...
function MultipleDropdown(props: IMultipleDropdown): JSX.Element {
            ...
            Promise.all(promises).then(() => {
                ...
                popupOpener.current.open({
                    ...
                    templateOptions: {
                        ...
                        menuBorderStyle: props.menuBorderStyle,
                        menuHoverBorderStyle: props.menuHoverBorderStyle,
                        menuBorderSize: props.menuBorderSize,
                        menuPopupOptions: props.menuPopupOptions,
                        menuBorderRadius: props.menuBorderRadius,
    ...
    return (
        <ContentTemplate
            ...
            className={`controls-MultipleDropdown${className ? ` ${className}` : ''}`}
            attrs={props.attrs}
