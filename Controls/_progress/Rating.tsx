...
interface IRatingOptions extends IComponentPropsWithReadonly, TInternalProps {
    value: number;
 ...
 */
export default React.forwardRef(function Rating(
    props: IRatingOptions,
    ...
    const onHoverStar = (_: React.MouseEvent<HTMLSpanElement, MouseEvent>, id: number): void => {
    ...
    const touchStar = (event: React.TouchEvent<HTMLSpanElement>, id: number): void => {
    ...
    const clickStar = (event: React.MouseEvent<HTMLSpanElement, MouseEvent>, id: number): void => {
        if (touchStarted) {
