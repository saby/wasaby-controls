 ...
 * @public
 */
export interface ILegendOptions extends IComponentProps {
    /**
 ...
 * @public
 */
export default React.forwardRef<HTMLDivElement, IReactLegendOptions>(function Legend(
    props,
    ...
    return (
        <div {...attrs} className={props.className || attrs.className} ref={ref}>
            {data.map((val, i) => {
