...
export interface IBarOptions extends IComponentProps {
    value?: number;
    barStyle: 'primary' | 'success' | 'danger' | 'warning' | 'secondary' | 'info' | string;
    blankAreaStyle?:
        | 'default'
        | 'none'
        | 'primary'
...
export default React.forwardRef(function Bar(
    ...
    return (
        <div
            {...attrs}
            ref={ref}
            className={`controls-ProgressBar controls-ProgressBar_size-${size} controls-ProgressBar_style-${blankAreaStyle} controls-ProgressBar_style-${barStyle}__filled ${className}`}
        >
