...
export default React.forwardRef(function Bar(
    ...
    return (
        <div
            {...attrs}
            ref={props.$wasabyRef}
            className={`controls-ProgressBar controls-ProgressBar_size-${size} controls-ProgressBar_style-${blankAreaStyle} ${attrs.className}`}
        >
            <div
                className={`controls-ProgressBar_style__filled controls-ProgressBar_style-${barStyle}__filled`}
                style={{ width }}
            />
        </div>
    );
