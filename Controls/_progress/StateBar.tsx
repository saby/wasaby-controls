 ...
 * @public
 */
export interface IStateBarOptions extends IComponentPropsWithReadonly {
    /**
 ...
 * @implements Controls/progress:IStateBar
 *
 * @public
...
export default React.forwardRef(function StateBar(
    ...
    const stateBarClass =
        ...
        ` ${props.blankAreaStyle ? 'controls-StateBar_style-' + props.blankAreaStyle : ''} ${
            attrs.className
        }`;
    return (
        <div {...attrs} ref={ref} className={stateBarClass}>
