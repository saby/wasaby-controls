...
import { IColumnsItemPadding } from 'Controls/_columns/interface/IColumnsView';
 ...
 * @public
 */
export interface IColumnsViewOptions extends IListViewOptions {
...
export default class Columns<
        ...
        TOptions extends IColumnsViewOptions = IColumnsViewOptions,
    > extends View<TControl, TOptions> {
