...
export interface IColumnsView {
    ...
    /**
     * Включает смещение элементов во всех колонках при изменении коллекции.
     ...
     * В значении false при изменении коллекции запииси смещаются в рамках своей колонки. Рекомендуется, когда записи могут быть разной высоты и перерисовка всего списка приведет к визуальной путанице.
