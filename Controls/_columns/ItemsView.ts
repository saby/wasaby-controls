 ...
 */
import { ItemsView as TreeItemsView, IItemsTreeOptions } from 'Controls/tree';
import { default as Render } from 'Controls/_columns/render/Columns';
import { MultiColumnMarkerStrategy } from 'Controls/marker';
import { IColumnsItemPadding } from './interface/IColumnsView';

/**
 * Интерфейс опций контрола
 * @public
 */
export interface IColumnsViewOptions extends IItemsTreeOptions {
...
export default class ItemsView extends TreeItemsView<IColumnsViewOptions> {
