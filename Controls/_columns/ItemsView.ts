 ...
 *
 * @demo Controls-demo/ItemTemplates/UsingInList/Columns/Index
 *
 * @class Controls/columns:ItemsView
...
export default class ItemsView extends BaseItemsView {
    ...
    protected _markerStrategy: new (
        options: IMarkerStrategyOptions
    ) => MultiColumnStrategy = MultiColumnStrategy;
