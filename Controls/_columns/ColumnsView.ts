...
/**
 * @typedef {String} Controls/_columns/View/ItemPaddingEnum
...
/**
 * @typedef {Object} Controls/_columns/View/ItemPadding
 * @property {Controls/_columns/View/ItemPaddingEnum.typedef} [top=m] Отступ сверху от записи. Если свойство принимает значение null, то отступ отсутствует.
 * @property {Controls/_columns/View/ItemPaddingEnum.typedef} [bottom=m] Отступ снизу от записи. Если свойство принимает значение null, то отступ отсутствует.
 * @property {Controls/_columns/View/ItemPaddingEnum.typedef} [left=m] Отступ слева от записи. Если свойство принимает значение null, то отступ отсутствует.
 * @property {Controls/_columns/View/ItemPaddingEnum.typedef} [right=m] Отступ справа от записи. Если свойство принимает значение null, то отступ отсутствует.
 */

/**
 * @name Controls/columns:View#itemPadding
 * @cfg {Controls/_columns/View/ItemPadding.typedef} Конфигурация отступов между записями.
 * @example
 * <pre class="brush: html">
 * <!-- WML -->
 ...
 * @cfg {Controls/_columns/View/ItemPadding.typedef} Конфигурация отступов между крайними записями и контейнером.
 * @example
 * <pre class="brush: html">
 * <!-- WML -->
 * <Controls.columns:View source="{{_viewSource}}">
