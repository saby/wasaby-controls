...
> extends Tree<S, T> {
    ...
    private _previousColumnPlaceholders: Record<number, number> = {};
    ...
    setColumnPlaceholder(column: number, placeholder: number): void {
        if (this._columnPlaceholders[column] !== placeholder) {
            this._previousColumnPlaceholders[column] = this._columnPlaceholders[column];
    ...
    getPreviousColumnPlaceholder(column: number): number {
        return this._previousColumnPlaceholders[column];
    }
