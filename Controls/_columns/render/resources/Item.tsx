...
import { IItemTemplateProps, getItemEventHandlers, itemPropsAreEqual } from 'Controls/baseList';
...
export default React.memo(React.forwardRef(Item), itemPropsAreEqual);
