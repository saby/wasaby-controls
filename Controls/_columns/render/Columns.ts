...
export default class Columns extends ListView {
    ...
    protected _beforeUpdate(options: IColumnsRenderOptions): void {
        ...
        if (options.columnsMode !== this._options.columnsMode) {
            options.listModel.setColumnsMode(options.columnsMode);
        }
    }
    ...
    protected _getItemsPaddingContainerClasses(): string {
        ...
        if (this._options.itemsContainerPadding) {
            ...
            if (!this._options.isAdaptive) {
                ...
                classes += `${prefix}Left_${itemsContainerPadding.left}_itemPadding_is-adaptive`;
                classes += `${prefix}Right_${itemsContainerPadding.right}_itemPadding_is-adaptive`;
                classes += `${prefix}Top_${itemsContainerPadding.top}_itemPadding_is-adaptive`;
                classes += `${prefix}Bottom_${itemsContainerPadding.bottom}_itemPadding_is-adaptive`;
            }
        } else {
            if (!this._options.isAdaptive) {
                ...
                classes += `${prefix}Left_is-adaptive`;
                classes += `${prefix}Right_is-adaptive`;
            }
    ...
    protected _getItemsContainerClasses(): string {
        let classes = 'controls-ColumnsView__itemsContainer controls-ListViewV__itemsContainer ';
