...
class Panel extends Control<ISimplePanelOptions> {
    ...
    private _prepareItemMenuOptions(curItem, showFooterSeparator: boolean): IMenuControlOptions[] {
        const item = { ...curItem };
    ...
    private _getItemsCount(): number {
        return Object.keys(this._menuConfigs).length + (this._dateMenuItem ? 1 : 0);
    }
