...
/**
 * @name Controls/_filterPopup/interface/IFilterPanel#topRightTemplate
 * @cfg {TemplateFunction|String} Шаблон отображения контента слева от кнопок сброса и применения фильтрации.
 * @default undefined
 * @example
 * Пример настройки параметра topRightTemplate
 * <pre class="brush: html; highlight: [3-5]">
 * <!-- WML -->
 * <Controls.filterPopup:DetailPanel>
 *    <ws:topRightTemplate>
 *       <ws:partial template="MyModule/control:topRightTemplate" />
 *    </ws:topRightTemplate>
 * </Controls.filterPopup:DetailPanel>
 * </pre>
 */
...
/*
 * @name Controls/_filterPopup/interface/IFilterPanel#topRightTemplate
 * @cfg {Function|String} Template for displaying content to the left of the reset and apply buttons.
 */
 ...
 * Для правильного отображения необходимо описать шаблоны для всех элементов.
 * @demo Controls-demo/FilterOld/FilterPopup/DetailPanel/HiddenItem/Index
 * @example
 ...
 * @default undefined
 * @demo Controls-demo/FilterOld/FilterPopup/DetailPanel/HistoryId/Index
...
/**
 * @event Controls/_filterPopup/interface/IFilterPanel#itemsChanged Происходит при изменении опции стукрутуры фильтра.
