...
import { useObservableItemStates } from 'Controls/gridRender';
...
interface IBaseExpanderProps {
     ...
     * @cfg {Controls/_gridRender/group/interface/IGroupProps/TExpanderPosition.typedef}
 ...
 * @class Controls/_baseTree/render/ExpanderConnectedComponent
 * @implements Controls/_baseTree/render/ExpanderComponent/IExpanderProps
 * @public
 */
function ExpanderConnectedComponent(props: IExpanderProps) {
...
export function CustomExpanderConnectedComponent(props: IExpanderProps) {
    const item = React.useContext(CollectionItemContext) as unknown as TreeItem;
