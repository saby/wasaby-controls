 ...
 * @includes IValue Controls/_date/interface/IValue
 * @includes ContextProvider Controls/_date/ContextProvider
 * @includes SelectorConsumer Controls/_date/SelectorConsumer
 * @includes ArrowButtonConsumer Controls/_date/ArrowButtonConsumer
 * @includes WeekdayFormatter Controls/_date/WeekdayFormatter
 */
...
export { IExtendedTimeFormatOptions as IExtendedTimeFormat } from 'Controls/_date/interface/IExtendedTimeFormat';
...
export { default as getPopupClassName } from 'Controls/_date/Utils/getPopupClassName';
...
export { IBaseSelectorOptions } from 'Controls/_date/interface/IBaseSelector';
