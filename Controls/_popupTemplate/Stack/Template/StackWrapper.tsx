...
class ErrorBoundaryStack extends ErrorBoundary {
    render() {
        if (typeof this.state.errorViewConfig !== 'undefined') {
            const errorRender = super.render();
            return <StackTemplate bodyContentTemplate={errorRender} />;
        }
...
/**
 * Базовый шаблон {@link https://n.sbis.ru/article/558ad4e6-866f-43a6-8093-af46125111ca стекового окна}.
 *
 * @remark
 * Полезные ссылки:
 * <ul>
 *     <li>{@link https://n.sbis.ru/article/558ad4e6-866f-43a6-8093-af46125111ca руководство разработчика}</li>
 ...
 * </ul>
 *
 * @class Controls/_popupTemplate/StackWrapper
 *
 * @public
 ...
 */
class StackWrapper extends Component<IStackTemplateOptions> {
    constructor(props: IStackTemplateOptions) {
        super(props);
        this._onClose = this._onClose.bind(this);
