    ...
    implements IPopupTemplateBase, IBackgroundStyle
{
    ...
    protected _getFooterBackgroundColor(): string {
        return this._options.footerBackgroundStyle === 'default'
            ? 'controls-StickyTemplate-backgroundColor'
            : 'controls-background-' + this._options.footerBackgroundStyle;
    }
