...
import { getAdaptiveDesktopMode, IPopupPosition } from 'Controls/popup';
...
import { ResizingLine, IDragObject } from 'Controls/dragnDrop';
import { Controller as ManagerController, IAdaptivePopupOptions } from 'Controls/popup';
