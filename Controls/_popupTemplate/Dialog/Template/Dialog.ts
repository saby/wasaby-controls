 ...
 * @default false
 * @demo Controls-demo/Popup/Dialog/ResizableWithDrag/Index
 * @example
 ...
 *     return (
 *     <EventSubscriber
 *          onPopupDragStart={(...args) => {props.onPopupDragStart(...args)}}
 *          onPopupDragEnd={(...args) => {props.onPopupDragEnd(...args)}}>
 *         <Dialog
 *              ...
 *              draggable={true}
 *         />
...
/**
 * @name Controls/_popupTemplate/Dialog#headerSize
...
/**
 * @name Controls/_popupTemplate/Dialog#footerBorderVisible
...
/**
 * @name CControls/_popupTemplate/Dialog#maximize
...
/**
 * @name Controls/_popupTemplate/Dialog#borderRadius
 * @cfg {BorderRadius}
 * @default s
...
/**
 * @name Controls/_popupTemplate/Dialog#resizable
...
/**
 * @name Controls/_popupTemplate/Dialog#closeButtonSize
