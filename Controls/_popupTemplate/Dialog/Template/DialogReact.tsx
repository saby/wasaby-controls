...
class Dialog extends Component<IDialogTemplateOptions> {
    constructor(props: IDialogTemplateOptions) {
        ...
        this._onPopupDragStart = this._onPopupDragStart.bind(this);
        this._onPopupDragEnd = this._onPopupDragEnd.bind(this);
    }
    ...
    private _onPopupDragStart(offset: number, sizes): void {
        this.context?.popupDragStart(offset, sizes);
    }

    private _onPopupDragEnd(): void {
        this.context?.popupDragEnd();
    }
    ...
    render(): JSX.Element {
        return (
            <DialogTemplate
                ...
                onPopupDragStart={this._onPopupDragStart}
                onPopupDragEnd={this._onPopupDragEnd}
            />
        );
    }
