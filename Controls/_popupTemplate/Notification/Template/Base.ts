...
class Notification extends Control<INotificationBaseOptions> {
    ...
    protected _useOldGradient: boolean;
    ...
    protected _beforeMount(options: INotificationBaseOptions): void {
        ...
        const IOSVersionColorMixSupport = 17;
        this._useOldGradient =
            (detection.chrome && detection.chromeVersion <= oldChromeVersion) ||
            detection.isIE ||
            (detection.IOSVersion && detection.IOSVersion < IOSVersionColorMixSupport);
