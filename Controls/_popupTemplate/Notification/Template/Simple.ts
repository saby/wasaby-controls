...
/**
 * Базовый шаблон {@link https://n.sbis.ru/article/d09d217d-f080-4a81-9790-a4c279d8fa8e#toc_c6ddeb64-6973-49a1-989d-519cae7b6909 простого окна уведомления}.
 *
 * @remark
 * Полезные ссылки:
 * <ul>
...
class NotificationSimple extends Control<INotificationSimpleOptions> {
    ...
    protected _getTextLines() {
        return (this._options?.text as string)?.split('\n') || [];
    }
 ...
 * @remark Данная опция также устанавливает стиль отображения иконки нотификационного окна.
 */
