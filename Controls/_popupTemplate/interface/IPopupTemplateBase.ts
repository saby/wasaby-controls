...
/**
 * @name Controls/_popupTemplate/interface/IPopupTemplateBase#headerBackgroundStyle
 * @cfg {String} Определяет цвет фона заголовка.
 * @variant default
 * @variant unaccented
 * @variant secondary
 * @variant primary
 ...
 * @remark Формат функции обратного вызова (event: Event) => void
 */
 ...
 * @remark Счётчик отображается только при открытии на мобильных устройствах.
 * @demo Controls-demo/PopupTemplate/Stack/Header/Index
 */
