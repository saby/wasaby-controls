...
interface IDraggableTreeCollection
    extends IDraggableFlatCollection<IDraggableTreeItem> {
...
export default class Tree extends Flat<
    IDraggableTreeItem,
    IDraggableTreeCollection
> {
    /**
    ...
    calculatePosition({
        ...
        if (this._draggableItem && this._draggableItem === targetItem) {
            return (
                (this._model.getPrevDragPosition &&
                    this._model.getPrevDragPosition()) ||
                null
            );
        }
        ...
        if (
            ...
            result = this._calculatePositionRelativeNode(
                targetItem,
                mouseOffsetInTargetItem
            );
        } else {
    ...
    private _calculatePositionRelativeNode(
        ...
        if (
            ...
            if (
                firstChild.getContents() === this._draggableItem.getContents()
            ) {
