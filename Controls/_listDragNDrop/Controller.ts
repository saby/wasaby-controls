...
export type StrategyConstructor<TPositionDescription extends IDragPosition<IDraggableItem>> = new (
...
export default class Controller<TPositionDescription extends IDragPosition<IDraggableItem>> {
    ...
    static canStartDragNDrop(
        ...
        const nativeEvent = helpers.events.getNativeMouseEvent(event);
