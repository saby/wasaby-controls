...
import {
    Collection as IBaseCollection,
    CollectionItem as ICollectionItem,
    IDragPosition,
 ...
 * @public
 */
export interface IDraggableItem extends ICollectionItem {
...
export interface IDraggableCollection<
    P extends IDragPosition<IDraggableItem> = IDragPosition<IDraggableItem>,
> extends IBaseCollection<Model, IDraggableItem> {
...
export interface IDragStrategy<P> {
    ...
    getDraggableKeys(selectedKeys: TKeysSelection): TKeysSelection;
    getStartPosition(): P;
}
...
export abstract class BaseDragStrategy<
    P extends IDragPosition<IDraggableItem>,
