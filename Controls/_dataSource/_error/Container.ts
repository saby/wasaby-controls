...
type ContainerViewConfig<OptionsType = object> =
    ErrorViewConfig<OptionsType> & { isShown?: boolean } & (
            | { templateName?: string }
...
> extends Control<TOptions, TState> {
    ...
    protected _beforeMount(
        options: IErrorContainerOptions
    ): Promise<void> | void {
    ...
    private _updateConfig(viewConfig?: ContainerViewConfig): void {
        ...
        this._viewConfig = {
            ...viewConfig,
            isShown:
                viewConfig.isShown || viewConfig.mode !== ErrorViewMode.dialog,
            templateName:
                typeof viewConfig.template === 'string'
                    ? viewConfig.template
                    : undefined,
        };
    }
    ...
    private _updateInlistOptions(options: IErrorContainerOptions): void {
        ...
        (
            this._viewConfig as ContainerViewConfig<IInlistTemplateOptions>
