...
import { ILoadDataConfig, ILoadDataResult } from 'Controls/browser';
...
> {
    ...
    static load(
        ...
        return import('Controls/dataSourceOld')
            .then(({ DataLoader }) => new DataLoader().load(sources, loadDataTimeout))
            .then((results) => {
 ...
 * @property {ICrud} source {@link Controls/listDataOld:DataContainer#source}
 * @property {Array|function|IList} fastFilterSource {@link Controls/_filter/Controller#fastFilterSource}
 * @property {Object} navigation {@link Controls/listDataOld:DataContainer#navigation}
