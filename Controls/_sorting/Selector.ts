 ...
 * @remark Про размещение кнопки в тулбаре читайте в статье {@link /doc/platform/developmentapl/interface-development/application-configuration/create-page/accordion/content/toolbar-config/ Настройка тулбара}
