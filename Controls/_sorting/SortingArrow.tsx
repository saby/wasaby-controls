...
function SortingArrow(props: IProps, ref: React.ForwardedRef<SVGSVGElement>): React.ReactElement {
    let className = `controls-SortingArrow_${props.value === 'DESC' ? 'desc' : 'asc'}`;
 ...
 * @cfg {Controls/_interface/ISorting/TSortingValue.typedef} Направление сортировки: DESC (по убыванию) или ASC (по возрастанию)
 */
