...
class View extends Control<IDateLitePopupOptions> {
    ...
    protected _positionCaption: Date;
    ...
    protected _beforeMount(options: IDateLitePopupOptions): void {
        ...
        if (options.chooseQuarters || options.chooseMonths || options.chooseHalfyears) {
            ...
            this._setPositionCaption(this._position, options.shouldPositionBelow);
        } else {
    ...
    setYear(year: number): void {
        ...
        this._positionCaption = this._position;
    ...
    protected _positionChangedHandler(event: SyntheticEvent, value: Date): void {
        this._position = value;
        this._positionCaption = value;
    }

    private _setPositionCaption(value: Date, shouldPositionBelow: boolean): void {
        let delta = 0;
        if (shouldPositionBelow && value.getFullYear() >= new Date().getFullYear()) {
            delta = 1;
        }
        this._positionCaption = new Date(value.getFullYear() - delta, 0);
    }
