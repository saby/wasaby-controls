...
export default {
    getDefaultOptions(): object {
        return {
             ...
             * @cfg {Boolean} Устанавливает возможность выбирать года
             * @default true
             */
            chooseYears: true,

            /**
             * @name Controls/shortDatePicker/IDateLitePopup#chooseAllYears
             * @cfg {Boolean} Устанавливает возможность выбирать весь период в режиме лет
             * @default false
             */

            chooseAllYears: false,
