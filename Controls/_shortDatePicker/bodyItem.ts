    ...
    implements IDateConstructor
{
    ...
    protected _isSelectedStart(value: Date, periodType: string): boolean {
        ...
        return dateUtils.isDatesEqual(this._options.startValue, value) && mainPeriodType === periodType;
    }

    protected _isSelectedEnd(value: Date, periodType: string): boolean {

        const mainPeriodType = this._getMainPeriodType(periodType);
        const endValue = this._getEndValue(value, periodType);
        return dateUtils.isDatesEqual(this._options.endValue, endValue) && mainPeriodType === periodType;
    }
    ...
    protected _isSelectedPeriod(value: Date, periodType: string): boolean {
        ...
        const isSelected = () => {
            ...
            return dateUtils.hitsDisplayedRanges(periodStartValue, [range]) &&
    ...
    protected _getSelectionClassName(value: Date, periodType: string): string {
        ...
        const mainPeriodType = this._getMainPeriodType(periodType);
        if (dateUtils.isDatesEqual(this._options.startValue, periodStartValue)) {
        ...
        if (dateUtils.isDatesEqual(this._options.endValue, periodEndValue)) {
            if (periodType === mainPeriodType) {
