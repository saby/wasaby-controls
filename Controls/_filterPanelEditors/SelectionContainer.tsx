...
export default React.forwardRef(function SelectionContainer(
    ...
    const getSelectedKeys = ({
        ...
        const propValue = propertyValue instanceof Array ? propertyValue[0] : propertyValue;
        if (
            propValue !== null ||
            (emptyKey && emptyKey.includes?.(propValue)) ||
            (resetValue && !isEqual(propertyValue, resetValue))
        ) {
    ...
    const updateSingleSelectionKey = (
        ...
        const resetValue =
            props.resetValue !== undefined
                ? props.resetValue instanceof Array
                    ? props.resetValue[0]
                    : props.resetValue
                : null;
        if (!added && !deleted) {
            ...
            selectedKey = added.length ? added[0] : resetValue;
        }
