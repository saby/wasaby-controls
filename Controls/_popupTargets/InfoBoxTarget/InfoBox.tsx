...
import { isReactComponentType, isFunctionComponent } from 'UICore/Executor';
...
class InfoBox extends Component<IInfoBoxOptions, IInfoboxState> {
    ...
    open(options?: IInfoBoxOptions): void {
        ...
        if (isNewEnvironment()) {
            ...
            this.context.onOpenInfoBoxFix?.(event, config, false);
    ...
    close(withDelay: boolean = true): void {
        if (isNewEnvironment()) {
            ...
            // TODO: Удалить https://online.sbis.ru/opendoc.html?guid=3e97f57b-f818-4d4e-b441-127c260802b3&client=3
            this.context.onCloseInfoBoxFix?.(event, !!withDelay);
