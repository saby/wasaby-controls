 ...
 * Полезные ссылки:
 * <ul>
 *     <li>{@link /materials/DemoStand/app/Controls-demo/Popup/PreviewerTarget/doc/Index демо-пример}</li>
 *     <li>{@link https://n.sbis.ru/article/cf8b8adb-8959-4532-8738-56a55ef2e199 руководство разработчика}</li>
...
export default class Previewer extends Component<IPreviewerOptions> {
    ...
    private _getConfig(): IPreviewerOptions {
        ...
        const config: IPreviewerOptions = {
            ...
            actionOnScroll: this.props.actionOnScroll,
        };
    ...
    protected _contentMouseleaveHandler(event: SyntheticEvent<MouseEvent>): void {
        if (!this.props.readOnly && this._closeOnMouseLeave) {
            ...
            if (this._isPopupOpened()) {
                ...
                // this._openerRef.current.close(this._openerRef.current.getPopupItem(), 'click');
            }
        }
