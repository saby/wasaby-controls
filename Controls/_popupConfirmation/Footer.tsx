                ...
                return (
                    <div
                        ...
                        className={`controls-ConfirmationDialog__button-${
                            buttons.length >= 3 ? 'mini' : 'standard'
                        }
                            ${
                                index > 0
                                    ? 'controls-ConfirmationDialog__no-cancel-button'
                                    : ''
                            }`}
                    >
