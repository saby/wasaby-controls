...
interface IConfirmationTemplate extends IComponentProps, IPopupWidthOptions {
...
function Template(
    ...
    return (
        <FocusRoot
            as="div"
            className={`controls_popupTemplate_theme-${useTheme(
                props
...
/**
 * Базовый шаблон <a href='https://n.sbis.ru/article/7efd671b-7069-4037-aba4-df9e8248919a#toc_327f8c02-1f08-4948-ab7a-9699bc0a8931'>диалога подтверждения</a>.
 *
 * @remark
 * Полезные ссылки:
 * <ul>
