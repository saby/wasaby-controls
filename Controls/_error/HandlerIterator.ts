 ...
 */
import { ErrorHandler, IErrorHandlerConfig, ErrorViewConfig } from 'ErrorHandling/interface';
...
export class HandlerIterator {
    ...
    getViewConfigAsync(
        ...
        return new Promise((resolve) => {
            ...
            resolve(result && result.promise instanceof Promise ? result.promise : result);
        })
            ...
            .then((viewConfig: ErrorViewConfig | void) => {
                return viewConfig || this.getViewConfigAsync(restHandlers, config);
            });
    }
}
