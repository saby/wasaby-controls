...
export class Controller {
    ...
    onCollectionRemove(
        ...
        let markedKeyAfterRemove = this._getMarkedKeyAfterRemove(removedMarkedItem, removedItemsIndex);
    ...
    private _calculateTreeNearbyItemKey(removedItem: CollectionItem, index: number): CrudEntityKey {
        ...
        if (newMarkedKey === null) {
            ...
            removedItem.getParent() !== this._model.getRoot() &&
            removedItem.getParent() !== this._model.getItemBySourceKey(newMarkedKey, false).getParent()
        ) {
            newMarkedKey = this._markerStrategy.getPrevMarkedKey(index - 1);
        }
    ...
    private _getMarkedKeyAfterRemove(removedItem: CollectionItem, removedIndex: number): CrudEntityKey {
