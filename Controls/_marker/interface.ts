...
import type { MultiColumnMarkerStrategy, SingleColumnMarkerStrategy } from 'Controls/marker';
...
export type IMarkerStrategyCtor =
    | (new (
          ...args: ConstructorParameters<typeof SingleColumnMarkerStrategy>
      ) => SingleColumnMarkerStrategy)
    | (new (
          ...args: ConstructorParameters<typeof MultiColumnMarkerStrategy>
      ) => MultiColumnMarkerStrategy);
