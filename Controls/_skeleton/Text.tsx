...
function Text(props: ITextSkeletonOptions) {
    let elemClassName = 'controls-skeleton-text' + ' controls-skeleton-text-' + props.fontSize;
    ...
    for (let i = 0; i < rows; i++) {
        ...
        delete baseSkeletonProps['data-qa'];
        skeletonsList.push(<Base {...baseSkeletonProps}></Base>);
    }

    return (
        <span className={props.className} data-qa={props['data-qa']}>
            {skeletonsList}
        </span>
    );
}
