...
import type { IHistoryStoreData, IHistoryStore, THistoryLoadConfig } from 'Controls/HistoryStore';
 ...
 *
 * @class Controls/_historyOld/Service
    ...
    implements ICrud
{
    ...
    query(query?: Query): Promise<DataSet> {
        ...
        if (this._$historyId || this._$historyIds?.length) {
            ...
            Logger.error(
                'Controls/historyOld: Не установлен идентификатор истории (опция historyId)',
                this
            );
...
/**
 * @name Controls/_historyOld/Service#historyId
...
/**
 * @name Controls/_historyOld/Service#historyIds
...
/**
 * @name Controls/_historyOld/Service#pinned
...
/**
 * @name Controls/_historyOld/Service#frequent
...
/**
 * @name Controls/_historyOld/Service#recent
...
/**
 * @name Controls/_historyOld/Service#dataLoaded
...
Object.assign(HistoryService.prototype, {
    _moduleName: 'Controls/historyOld:Service',
});
