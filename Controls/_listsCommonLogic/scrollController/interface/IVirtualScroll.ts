/**
 * @kaizen_zone e4f64685-8ec4-4ae9-8d75-657bcd9261ef
 */
 ...
 * @interface Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll/IVirtualScrollConfig
 *
 * @public
 */
...
export interface IVirtualScrollConfig {
    /**
     * @name Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll/IVirtualScrollConfig#pageSize
     * @cfg {Number} Количество отображаемых элементов при инициализации списка.
     */
    pageSize?: number;
    /**
     * @name Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll/IVirtualScrollConfig#segmentSize
    ...
    segmentSize?: number;
    /**
     * @name Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll/IVirtualScrollConfig#itemHeightProperty
     * @cfg {String} Имя поля, которое содержит высоту элемента.
     * @default undefined
     */
    itemHeightProperty?: string;
    /**
     * @name Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll/IVirtualScrollConfig#viewportHeight
     * @cfg {Number} Высота контейнера со списком.
     * @default undefined
     */
    viewportHeight?: number;
    /**
     * @name Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll/IVirtualScrollConfig#mode
    ...
    /**
     * @name Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll/IVirtualScrollConfig#calcByOffset
...
/**
 * @name Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll#virtualScrollConfig
...
/**
 * @event Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll#enableVirtualNavigation Происходит при использовании виртуального скролла, когда список находится в такой позиции, что сверху и снизу списка есть скрытые (или доступные для загрузки) элементы.
...
/**
 * @event Controls/_listsCommonLogic/scrollController/interface/IVirtualScroll#disableVirtualNavigation Происходит при использовании виртуального скролла, когда список находится в такой позиции, что сверху или снизу списка нет скрытых (или доступных для загрузки) элементов.
