...
const ERROR_PATH =
    'Controls/_listsCommonLogic/scrollController/ObserversController/AbstractObserversController';
...
export abstract class AbstractObserversController {
    ...
    protected _observer: EdgeIntersectionObserver | null;
    ...
    private _intersectionObserverHandler(eventName: TIntersectionEvent): void {
        ...
        if (shouldHandleTrigger) {
            this._observersCallback(direction as IDirection);
        }
    }
