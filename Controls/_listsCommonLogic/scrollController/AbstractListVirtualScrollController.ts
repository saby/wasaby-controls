...
export interface IEdgeItemCalculatingParams {
    ...
    // Ключ элемента относительно которого необходимо инвертировать границу
    invertedRelativeToElement?: string | null;
}
...
> {
    ...
    getEdgeVisibleItem(
        direction: IDirection,
        offset?: number,
        invertedRelativeToElement?: CrudEntityKey | null
    ): IEdgeItem {
        return this._scrollController.getEdgeVisibleItem({
            direction,
            offset,
            invertedRelativeToElement:
                invertedRelativeToElement && getValidItemKeyAttribute(invertedRelativeToElement),
        });
    }
