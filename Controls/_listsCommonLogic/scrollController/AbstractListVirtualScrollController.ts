...
import { TVirtualScrollMode } from './interface/IVirtualScroll';
...
} from 'Controls/_listsCommonLogic/scrollController/ItemsSizeController/AbstractItemsSizeController';
import {
    ...
    ITriggersPositions,
    ITriggersVisibility,
} from 'Controls/_listsCommonLogic/scrollController/ObserverController/AbstractObserversController';
import { Logger } from 'UI/Utils';
import { isEqual } from 'Types/object';
import {
    ICalculatorState,
    TInvertedIndexes,
} from 'Controls/_listsCommonLogic/scrollController/Calculator/Calculator';
        ...
        const scrollToElement = () => {
            ...
            if (element) {
                ...
                if (this._feature1184208466 && !this._isItemRendered(key)) {
                    ...
                    this._scheduleScroll({
                        type: 'scrollToElement',
                        params: { key, position, force, selfScroll, subtractingListOffset },
                    });
                } else {
                    Logger.error(
