...
import { IItemsRange } from '../ScrollController';
...
export default class ItemsSizeControllerMultiColumns extends ItemsSizeController {
    protected _updateItemsSizes(itemsRange: IItemsRange, itemsElements: HTMLElement[]): void {
        ...
        const itemsContainerTop = this._itemsContainer?.getBoundingClientRect().top ?? 0;
    ...
    private _getPlaceholderSize(): number {
        const placeholder = this._itemsContainer?.querySelector(
