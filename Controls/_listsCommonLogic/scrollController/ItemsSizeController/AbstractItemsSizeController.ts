...
export abstract class AbstractItemsSizesController {
    ...
    updateItemsSizes(itemsRange: IItemsRange): IItemsSizes {
        ...
        if (this._itemsContainer) {
            let itemsElements: HTMLElement[] = Array.from(
    ...
    getContentSizeBeforeItems(): number | null {
        ...
        return (
            scrollContent &&
            this._getContentSizeBeforeContainer(this._itemsContainer, scrollContent)
        );
    }
     ...
     */
    getContentSizeBeforeList(): number | null {
        if (!this._listContainer) {
            return null;
        }
        const scrollContent = getScrollContentElement(this._listContainer);
        return (
            scrollContent && this._getContentSizeBeforeContainer(this._listContainer, scrollContent)
        );
    }
    ...
    getItemsContainer(): HTMLElement | undefined {
    ...
    getListContainer(): HTMLElement | undefined {
    ...
    protected _updateItemsSizes(itemsRange: IItemsRange, itemsElements: HTMLElement[]): void {
        ...
        itemsElements.forEach((element: HTMLElement) => {
            ...
            this._itemsSizes[position] = {
                ...
                offset,
                key: element.getAttribute('item-key') ?? undefined,
            };
            position++;
        });
