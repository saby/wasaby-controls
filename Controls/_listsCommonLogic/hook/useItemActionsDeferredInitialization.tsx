...
import type { IItemAction } from 'Controls/interface';
...
export const useItemActionsDeferredInitialization = ({
    ...
    useLayoutEffect(() => {
        itemActionsTemplateMountedCallback?.(itemKey as CrudEntityKey, setItemActions);
        return () => {
            itemActionsTemplateUnmountedCallback?.((prevItemKey || itemKey) as CrudEntityKey);
        };
    }, [
        item,
        prevItemKey,
