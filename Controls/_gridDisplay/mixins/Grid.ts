...
> {
    ...
    setColumns(newColumns: TColumns, silent: boolean = true): void {
        ...
        this.getHeader()?.setGridColumnsConfig(this._$header || this._$columns);
        this.getResults()?.setGridColumnsConfig(this._$resultsConfig || this._$columns);
        this.getFooter()?.setGridColumnsConfig(this._$footer || this._$columns);
        this.getEmptyGridRow()?.setGridColumnsConfig(this._$emptyTemplateColumns || this._$columns);
