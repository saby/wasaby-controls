...
export type THeader = (IHeaderCell | IHeaderConfig)[];
 ...
 * @public
 * @deprecated  Следует использовать реакт подход к рендеру таблиц https://n.sbis.ru/wasaby/knowledge?article=efaebc77-0882-46cc-999b-26838fe150f6&published=true&mode=readList
 */
export interface IHeaderCell extends IControlOptions, IRowspanParams, IColspanParams {
    ...
    caption?: string;
    /**
     * @cfg {Controls/_gridDisplay/interface/IColumn/TOverflow.typedef} Поведение текста, если он не умещается в ячейке.
    ...
    /**
     * @cfg {Controls/_gridDisplay/interface/IColumn/TCellHorizontalAlign.typedef} Выравнивание содержимого ячейки по горизонтали.
    ...
    /**
     * @cfg {Controls/_gridDisplay/interface/IColumn/TCellVerticalAlign.typedef} Выравнивание содержимого ячейки по вертикали.
    ...
    baseline?: string;
    /*
     * @cfg Иконка в заголовке ячейки
     * Используется для случая, когда нет текста заголовка ячейки
     * Список доступных иконок: https://wi.sbis.ru/icons/?v=23.5100
     * @demo Controls-demo/gridNew/Sorting/SortingIcon/Index
     */
    sortingIcon?: string;
    /*
     * @cfg Способ переноса строк в тексте
     * @variant nowrap Текст отображается одной строкой
     * @variant normal Текст разбивается на несколько строк
     * @default normal
     */
