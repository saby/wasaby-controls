 ...
 * @typedef Controls/_gridDisplay/interface/IGridControl/TResultsPosition
 ...
 *
 * @interface Controls/_gridDisplay/interface/IGridControl
 * @public
 * @author Авраменко А.С.
 */

/**
 * @name Controls/_gridDisplay/interface/IGridControl#ladderProperties
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#ladderMode
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#header
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#columns
 ...
 * @remark Before rendering, make sure that {@link Controls/display:Collection Collection} contains required data, when the {@link Controls/_gridDisplay/interface/IGridControl#columns columns} option changes. Call asynchronous 'reload' method before changing {@link Controls/_gridDisplay/interface/IGridControl#columns columns} option, if necessary.
 * @example
 * <pre>
 * _columns = [
 * {
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#footer
 * @cfg {Array.<Controls/_gridDisplay/interface/IFooterColumn>} Конфигурация колонок {@link /doc/platform/developmentapl/interface-development/controls/list/grid/footer/ подвала таблицы}.
 */
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#stickyHeader
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#columnScroll
...
/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/ColumnScrollStartPosition
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#columnScrollStartPosition
 * @cfg {Controls/_gridDisplay/interface/IGridControl/ColumnScrollStartPosition.typedef} Начальное положение {@link /doc/platform/developmentapl/interface-development/controls/list/grid/horizontal-scrolling/ горизонтальной прокрутки} колонок.
 * @default start
 * @see columnScroll
...
/*
 * @name Controls/_gridDisplay/interface/IGridControl#columnScrollStartPosition
 * @cfg {Controls/_gridDisplay/interface/IGridControl/ColumnScrollStartPosition.typedef} Determines the starting columns scroll position if it is enabled.
 * @default start
 * @see Controls/_gridDisplay/interface/IGridControl#columnScroll
 */

/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/TColumnScrollViewMode
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#columnScrollViewMode
 * @cfg {Controls/_gridDisplay/interface/IGridControl/TColumnScrollViewMode.typedef} Режим отображения {@link /doc/platform/developmentapl/interface-development/controls/list/grid/horizontal-scrolling/ горизонтальной прокрутки} колонок в таблице.
 * @default scrollBar
 * @see columnScroll
 */

/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/TAutoScrollMode
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#columnScrollAutoScrollMode
 * @cfg {Controls/_gridDisplay/interface/IGridControl/TAutoScrollMode.typedef} Режим автоподскрола при завершении скроллирования.
 * @default closest
 */

/**
 * @name Controls/_gridDisplay/interface/IGridControl#stickyColumnsCount
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#dragScrolling
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#stickyItemActions
 * @cfg {Boolean} Включает прилипание операций над записью к правому краю прокручиваемой области при горизонтальном скролле.
 * @default false
 */

/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/RowSeparatorSize
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#rowSeparatorSize
 * @cfg {Controls/_gridDisplay/interface/IGridControl/RowSeparatorSize.typedef|null} Толщина линии-разделителя строк.
 * @default null
...
/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/ColumnSeparatorSize
 * @variant s Тонкая линия-разделитель.
 */

/**
 * @name Controls/_gridDisplay/interface/IGridControl#columnSeparatorSize
 * @cfg {Controls/_gridDisplay/interface/IGridControl/ColumnSeparatorSize.typedef} Толщина {@link /doc/platform/developmentapl/interface-development/controls/list/grid/separator/#column линии-разделителя колонок}.
 * @remark В значении null линия-разделители не отображается.
 * @default null
 ...
 * @cfg {Object} Объект с опциями для настройки шаблона строки итогов, сконфигурированного через {@link Controls/_gridDisplay/interface/IGridControl#resultsTemplate resultsTemplate}.
 * @description
...
/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/ResultsPosition
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#resultsPosition
 * @cfg {Controls/_gridDisplay/interface/IGridControl/ResultsPosition.typedef|undefined} Позиция отображения {@link /doc/platform/developmentapl/interface-development/controls/list/grid/results/ строки итогов}.
 * @default undefined
...
/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/ResultsVisibility
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#resultsVisibility
 * @cfg {Controls/_gridDisplay/interface/IGridControl/ResultsVisibility.typedef} Отображение {@link /doc/platform/developmentapl/interface-development/controls/list/grid/results/ строки итогов} при наличии или отсутствии элементов.
...
/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/HeaderVisibility
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#headerVisibility
 * @cfg {Controls/_gridDisplay/interface/IGridControl/HeaderVisibility.typedef} Отображение {@link /doc/platform/developmentapl/interface-development/controls/list/grid/header/ шапки} при наличии или отсутствии элементов.
 * @demo Controls-demo/gridNew/Header/HeaderVisibility/Index
 * @default hasdata
 */

/**
 * @name Controls/_gridDisplay/interface/IGridControl#editArrowVisibilityCallback
...
/**
 * @typedef {Function} Controls/_gridDisplay/interface/IGridControl/TColspanCallback
 * @description
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#emptyTemplateColumns
 * @cfg {Array.<Controls/_gridDisplay/mixins/Grid/IEmptyTemplateColumn>} Конфигурация колонок {@link /doc/platform/developmentapl/interface-development/controls/list/grid/empty/#empty-template-columns пустой таблицы}.
 * @demo Controls-demo/gridNew/EmptyGrid/Editing/Index
 */

/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/TEmptyTemplateHeight
...
/**
 * @typedef {String} Controls/_gridDisplay/interface/IGridControl/TEmptyTemplateBackgroundColorStyle
...
/**
 * @typedef {Object} Controls/_gridDisplay/interface/IGridControl/TEmptyTemplateOptions
 * @description Объект с опциями для настройки пустого представления, сконфигурированного через {@link Controls/_gridDisplay/interface/IGridControl#emptyTemplate emptyTemplate}.
 * @property {Controls/_gridDisplay/interface/IGridControl/TEmptyTemplateHeight.typedef} [height=stretch] настройка высоты пустого представления
 * @property {Controls/_gridDisplay/interface/IGridControl/TEmptyTemplateBackgroundColorStyle.typedef} [backgroundColorStyle=editing] Настройка фона строки пустого представления.
 */

/**
 * @name Controls/_gridDisplay/interface/IGridControl#emptyTemplateOptions
 * @cfg {Controls/_gridDisplay/interface/IGridControl/TEmptyTemplateOptions.typedef} Объект с опциями для настройки пустого представления, сконфигурированного через {@link Controls/_gridDisplay/interface/IGridControl#emptyTemplate emptyTemplate}.
 * @description
...
/**
 * @name Controls/_gridDisplay/interface/IGridControl#showEditArrow
 ...
 * Чтобы скрыть стрелку у некоторых записей, используйте {@link Controls/_gridDisplay/interface/IGridControl#editArrowVisibilityCallback}.
