...
/**
 * @typedef {String} Controls/_gridDisplay/interface/IColumn/TTagStyle
...
export interface IColumn extends IColspanParams, ITagStyle {
     ...
     * @see Controls/_gridRender/Grid#resizerVisibility
     * @see maxWidth
     */
    minWidth?: number;
    /**
     ...
     *
     * По умолчанию при видимой {@link Controls/_treeGridRender/TreeGrid#expanderVisibility кнопке разворота узла} в первую ячейку итогов таблицы добавляется отступ, позволяющий отобразить содержимое на одоной вертикаоьной линии.
     ...
     * @remark
     * Стиль цвета текста ячейки имеет больший приоритет, чем {@link Controls/_gridRender/interface/ItemTemplate#fontColorStyle стиль цвета текста записи}.
     */
     ...
     * @remark
     * Размер шрифта ячейки имеет больший приоритет, чем {@link Controls/_gridRender/interface/ItemTemplate#fontSize размер шрифта записи}.
     ...
     * @remark
     * Насыщенность шрифта ячейки имеет больший приоритет, чем {@link Controls/_gridRender/interface/ItemTemplate#fontWeight Насыщенность шрифта записи}.
     */
    fontWeight?: TFontWeight;
    /**
     * @cfg {Boolean} Позволяет пометить ячейку нередактируемой при включенном {@link Controls/_gridRender/interface/IGridEditingConfig#mode редактировании отдельных ячеек}.
     * @default true
     */
    editable?: boolean;
    /*
