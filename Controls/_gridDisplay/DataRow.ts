    ...
    implements IMarkable, ILadderSupport, ISelectableItem, IDisplaySearchValue
{
    ...
    setEditing(
        ...
        this.setRowTemplateOptions(
            editing
                ? // _$isItemEditorTemplate флаг, необходимый для валидации вызова базового шаблона.
                  // itemEditorTemplate преобразуется в columns[...].template из-за чего здесь
                  // Controls/_gridRender/cL/row/resolvers/Cell.tsx:216 не понятно, какой
                  // шаблон валидировать Controls/grid:ColumnTemplate или Controls/grid:ItemEditorTemplate
                  { ...this._$owner.getItemEditorTemplateOptions(), _$isItemEditorTemplate: true }
                : undefined
        );
    ...
    hasStickyGroup(): boolean {
        return (
            ...
            this._$contents.get(this._$owner.getGroupProperty()) !== groupConstants.hiddenGroup
        );
    }
