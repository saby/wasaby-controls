...
import { IColspanParams, IColumn, TColumnSeparatorSize } from './interface/IColumn';
    ...
    implements IInstantiable, IVersionable
{
    ...
    getCellContentRender(): React.FunctionComponent<IGridColumnDataDecoratorProps<unknown>> {
    ...
    protected calculationCellPadding(rowProps: IRowComponentProps): IGridPaddingProps {
        return {
            paddingLeft: rowProps.paddingLeft as TGridHPaddingSize,
            paddingRight: rowProps.paddingRight as TGridHPaddingSize,
    ...
    getCellComponentProps(rowProps: IRowComponentProps): ICellComponentProps {
        ...
        if (
            rowProps.isActive &&
            !editing &&
            (rowProps.highlightOnHover !== false || this.isSwiped())
        ) {
        ...
        return {
            ...
            highlightEditor: cellProps?.highlightEditor ?? 'auto',
