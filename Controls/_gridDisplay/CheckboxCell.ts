    ...
    implements IMarkable
{
    ...
    getCellComponentProps(rowProps: IRowComponentProps): ICellComponentProps {
        ...
        if (!superResult.markerSize || superResult.markerSize === 'content-xs') {
            superResult.markerClassName +=
                ' controls-GridView__itemV_marker_inCheckboxCell tw-items-center controls-GridReact__marker_InCheckboxCell-vertical-adjustment ';
        }
