...
import type EmptyRow from 'Controls/_grid/display/EmptyRow';
import type EmptyCell from 'Controls/_grid/display/EmptyCell';
import type { TContentAlign } from 'Controls/_grid/display/EmptyCell';
...
function EmptyCellContent(
    ...
    const inlineStyle = cellModel.getContentStyles(
