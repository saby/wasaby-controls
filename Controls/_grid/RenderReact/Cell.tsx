...
import { default as EditArrowTemplate } from 'Controls/_grid/RenderReact/EditArrowTemplate';
    ...
    if (props.contentTemplate) {
        return createElement(
            props.contentTemplate,
            {
                ...
                expanderTemplate: props.expanderTemplate,
                editArrowTemplate: (editArrowTemplateProps) => {
                    return column.shouldDisplayEditArrow() ? (
                        <EditArrowTemplate
                            {...props}
                            {...editArrowTemplateProps}
                        />
                    ) : (
                        <span tabIndex={-1} />
                    );
