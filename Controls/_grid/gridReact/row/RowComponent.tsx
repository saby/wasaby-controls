...
import { default as DefaultCellComponent } from 'Controls/_grid/cleanRender/cell/DataCellComponent';
...
import { isGroupCell } from 'Controls/_grid/utils/Type';
import { getDataCellComponentProps } from 'Controls/_grid/cleanRender/cell/utils/DataCell';
...
function getCellComponent(
    ...
    if (cell['[Controls/_display/grid/DataCell]']) {
        cellProps = getDataCellComponentProps({
...
function getCellComponentProps(cell: GridCell, rowProps: IRowComponentProps): ICellComponentProps {
    ...
    if (
        ...
        cell['[Controls/_display/grid/CheckboxCell]']
    ) {
        cellComponentProps = getDataCellComponentProps({
    ...
    if (rowProps.decorationStyle === 'master' && cell['[Controls/_display/grid/CheckboxCell]']) {
        cellComponentProps = {
            ...cellComponentProps,
