...
/**
 * @typedef {String} Controls/_grid/gridReact/group/interface/IGroupProps/TExpanderPosition
 ...
 * @interface Controls/_grid/gridReact/group/interface/IGroupProps
 * @public
 */
export interface IGroupProps
    extends IFontColorStyleOptions,
        ...
        ITextTransformOptions {
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#expanderVisible
    ...
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#rightTemplate
    ...
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#textVisible
    ...
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#separatorVisible
    ...
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#expanderPosition
     * @cfg {Controls/_grid/gridReact/group/interface/IGroupProps/TExpanderPosition.typedef} Размещение {@link /doc/platform/developmentapl/interface-development/controls/list/grouping/ кнопки-экспандера} относительно текста заголовка группы.
     * @default left
     * @see expanderVisible
     * @see iconSize
     */
    ...
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#halign
    ...
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#className
    ...
    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#paddingTop
     * @cfg {Controls/interface/TSize.typedef} Размер верхнего внутреннего отступа
     */
    paddingTop?: TSize;

    /**
     * @name Controls/_grid/gridReact/group/interface/IGroupProps#paddingBottom
...
/**
 * @name Controls/_grid/gridReact/group/interface/IGroupProps#children
 * @cfg {String|TemplateFunction|undefined} Пользовательский шаблон вместо текста заголовка группы.
 * @default undefined
 * @see fontSize
 */
/**
 * @name Controls/_grid/gridReact/group/interface/IGroupProps#fontSize
 ...
 */
/**
 * @name Controls/_grid/gridReact/group/interface/IGroupProps#iconSize
 ...
 */
/**
 * @name Controls/_grid/gridReact/group/interface/IGroupProps#iconStyle
 ...
 */
/**
 * @name Controls/_grid/gridReact/group/interface/IGroupProps#fontWeight
 * @cfg {String} Насыщенность шрифта.
 * @default default
 */

/**
 * @name Controls/_grid/gridReact/group/interface/IGroupProps#textTransform
...
/**
 * @interface Controls/_grid/gridReact/group/interface/IMouseEventHandlers
 * @private
 */
 ...
 * @interface Controls/_grid/gridReact/group/interface/IGroupComponentProps
 * @private
 */
 ...
 * @typedef {Function} Controls/_grid/gridReact/group/interface/TGetGroupPropsCallback
 */
