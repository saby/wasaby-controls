...
import { TGetRowPropsCallback } from 'Controls/_grid/gridReact/row/interface';
import * as React from 'react';
import { IEmptyViewConfig } from 'Controls/_grid/dirtyRender/cell/interface';
import { IEmptyViewProps } from 'Controls/_grid/gridReact/emptyView/interface';
import { TGetGroupPropsCallback } from 'Controls/_grid/gridReact/group/interface';
 ...
 * @typedef {(String|Number)} Controls/_grid/gridReact/CommonInterface/TColumnKey
 */
export type TColumnKey = string | number;

/**
 * Базовый интерфейс колонки таблицы (реакт)
 * @interface Controls/_grid/gridReact/CommonInterface
 * @public
 */
 ...
 * @interface Controls/_grid/gridReact/CommonInterface/IColspanProps
 * @public
 */
 ...
 * @interface Controls/_grid/gridReact/CommonInterface/IRowspanProps
 * @public
 */
 ...
 * @typedef {String} Controls/_grid/gridReact/CommonInterface/TResultsPosition
...
export interface IGridProps
    ...
    /**
     * Размещение строки итогов
     * @cfg {Controls/_grid/gridReact/CommonInterface/TResultsPosition.typedef}
     */
     ...
     * @cfg {Controls/_grid/gridReact/row/interface/TGetRowPropsCallback.typedef}
     */
    getRowProps?: TGetRowPropsCallback;
    /**
     * Видимость множественного выбора строк
     * @cfg {Controls/interface/TVisibility}
     */
