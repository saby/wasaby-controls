...
import { isGroupRow, isNodeFooterRow, isSpaceRow } from 'Controls/_grid/utils/Type';
import getColgroup from 'Controls/_grid/gridReact/IE/getColgroup';
import { detection } from 'Env/Env';
import { getGroupRowComponentProps } from 'Controls/_grid/cleanRender/row/utils/Group';
...
function getRowComponentProps({
    ...
    if (isGroupRow(row)) {
        ...
        rowProps = getRowComponentMasterStyleProps(rowProps, props, isAdaptive);
    }
    return rowProps;
}
...
export function getRowComponent(
    ...
    if (itemTemplate && isValidForItemTemplate) {
        ...
        if (isGroupRow(item)) {
            ...
            currentRowProps._$FunctionalCellComponent = GroupCellComponent;
        }
    ...
    return (
        <ListDataContext.Provider value={listData}>
            ...
            >
                ...
                {getEmptyView(props)}
                {ItemsContainer(props, itemsContainerRef)}
