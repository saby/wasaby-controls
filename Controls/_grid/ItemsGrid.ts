...
interface IItemsGridOptions extends Omit<IItemsViewOptions, 'adaptiveMode'>, IGridOptions {
 ...
 *
 * @ignoremethods scrollToColumn scrollToLeft scrollToRight freezeHoveredItem unfreezeHoveredItems getItems reloadItem
 *
 * @public
 */
