 ...
 *
 * @ignoreOptions filter navigation sorting selectedKeys excludedKeys multiSelectVisibility markerVisibility displayProperty groupHistoryId markedKey itemTemplate groupTemplate footerTemplate emptyTemplate
 *
 * @public
...
export default class Grid<
    ...
    TControlOptions = IGridControlOptions,
...
/**
 * @name Controls/_grid/Grid#groupTemplate
 * @deprecated Следует использовать {@link https://n.sbis.ru/wasaby/knowledge?article=efaebc77-0882-46cc-999b-26838fe150f6&published=true&mode=readList реакт подход к рендеру таблиц}
