...
import { ArrowTemplate, TSortingDirection } from 'Controls/sorting';
...
function Arrow(props: IArrowProps): React.ReactElement {
    ...
    return (
        <div className={className}>
            <ArrowTemplate
                className={'controls-SortingButton_arrow'}
                value={props.value}
            />
        </div>
    );
...
function SortingButtonComponent(
    ...
    const spacingClassName = `controls-SortingButton__arrow-spacing-${
        props.align !== 'left' ? 'right' : 'left'
    }`;
    const captionClassName =
        'controls-SortingButton__caption controls-SortingButton__caption' +
        ...
        >
            ...
            >
                {props.value && props.align !== 'left' ? (
                    <Arrow value={props.value} className={spacingClassName} />
                ) : null}
                <div
