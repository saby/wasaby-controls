...
import { IHeaderCellColumnScrollProps } from 'Controls/_grid/cleanRender/cell/HeaderCellComponent';
...
export interface IResultsCellComponentProps extends IBaseCellComponentProps, IResultsCellConfig {
...
function getMinHeightClasses(
    ...
    return ' controls-Grid__results-cell_min-height';
}

function getColumnScrollClasses(props: IResultsCellComponentProps) {
    return (
        getColumnScrollClassesUtil(props as IHeaderCellColumnScrollProps) +
