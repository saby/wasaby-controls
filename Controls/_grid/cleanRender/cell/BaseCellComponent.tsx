...
import { TColumnSeparatorSize } from 'Controls/_baseGrid/display/interface/IColumn';
...
function BaseCellComponent(
    ...
    if (isSticky) {
        const stickyWrapperRenderProps = {
            ...
            zIndex: null,
            fixedZIndex: props.fixedZIndex || null, //Когда группа - 3 или 4 нужно прокидывать
