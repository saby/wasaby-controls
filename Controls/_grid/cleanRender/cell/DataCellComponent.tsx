...
import getCellMarker from './utils/Renders/GetCellMarker';
import getCellTag from './utils/Renders/GetCellTag';
import { default as BaseCellComponent } from './BaseCellComponent';
...
import { getColspanRowspanStyles } from './utils/Styles/ColspanRowspan';
import { getFontClasses } from './utils/Classes/Font';
import { getBorderClasses, getBorderRadiusClasses } from './utils/Classes/Border';
import { getCellPositionClasses } from 'Controls/_grid/cleanRender/cell/utils/Classes/CellPosition';
import { getDisplayTypeClasses } from 'Controls/_grid/cleanRender/cell/utils/Classes/DisplayType';
import {
...
import { getBaselineClasses } from 'Controls/_grid/cleanRender/cell/utils/Classes/Baseline';
import { getShadowClasses } from 'Controls/_grid/cleanRender/cell/utils/Classes/Shadow';
import { getEditingClasses } from 'Controls/_grid/cleanRender/cell/utils/Classes/Editing';
import { getLadderClasses } from 'Controls/_grid/cleanRender/cell/utils/Classes/Ladder';
...
function DataCellComponent(
    ...
    const markerRender = props.markerVisible ? getCellMarker(props) : null;
    ...
    const tagRender = props.tagStyle ? getCellTag(props) : null;

    const draggingCounterRender = props.draggingItemsCount ? (
...
export default React.forwardRef(DataCellComponent);
