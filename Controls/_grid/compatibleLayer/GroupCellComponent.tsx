...
} from '../cleanRender/cell/GroupCellComponent';
...
export function getCompatibleGridGroupCellComponentProps(
    ...
    // TODO при рефакторинге заменить на getGroupCellComponentProps, и убрать весь лишний код.
    const dataCellProps = getCompatibleGridCellComponentProps(props);
    if (!dataCellProps.stickiedBackgroundStyle) {
        dataCellProps.stickiedBackgroundStyle =
            stickyProps.stickiedBackgroundStyle !== undefined
                ? stickyProps.stickiedBackgroundStyle
                : props.backgroundColorStyle;
    }
    if (!dataCellProps.fixedBackgroundStyle) {
        dataCellProps.fixedBackgroundStyle =
            stickyProps.fixedBackgroundStyle !== undefined
                ? stickyProps.fixedBackgroundStyle
    ...
    return {
        ...
        ...stickyProps,
        backgroundStyle: dataCellProps.backgroundStyle,
        stickiedBackgroundStyle: dataCellProps.stickiedBackgroundStyle,
        fixedBackgroundStyle: dataCellProps.fixedBackgroundStyle,
