...
function getEditArrowTemplate({
    ...
    textOverflow: ICompatibleCellComponentProps['textOverflow'];
...
> | null {
    ...
    return React.forwardRef(function FREditArrowComponent(
        ...
        const backgroundStyle = column.getEditArrowBackgroundStyle(
            customProps.backgroundStyle,
            highlightOnHover,
            hoverBackgroundStyle,
            editable
        );
        const textOverflow = cellTextOverflow || customProps.textOverflow;
        return (
            <EditArrowComponent
                ref={ref}
...
export function getCompatibleGridCellComponentProps(
    ...
    const className = (props.className || '') + column.getRecordTypeClasses();
    ...
    compatibleProps.itemActionsTemplate = React.useMemo(() => {
        return getItemActionsTemplateBase({ ...compatibleProps, ...props.actionHandlers });
    }, [
        props.item,
        props.actionHandlers?.itemActionsTemplateMountedCallback,
        props.actionHandlers?.itemActionsTemplateUnmountedCallback,
