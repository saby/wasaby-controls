...
export default class DataCell<
    ...
    >
    extends mixin<Cell<T, TOwner>, DataCellCompatibility<T>>(
        Cell,
        ...
        IDisplaySearchValue
{
    ...
    shouldDrawLadderContent(
        ...
        return this.getOwner().shouldDrawLadderContent(
            ladderProperty,
            stickyProperty
        );
    }
    ...
    getLadderWrapperClasses(
        ...
        return this.getOwner().getLadderWrapperClasses(
            ladderProperty,
            stickyProperty
        );
    }
    ...
    getContentClasses(
        ...
        if (this._$owner.getEditingConfig()?.mode === 'cell') {
            ...
            if (this.isFirstColumn()) {
                classes +=
                    ' controls-Grid__row-cell_editing-mode-single-cell_first';
            }
    ...
    getCellContentRenderOptions(
        ...
        return {
            ...
            fontColorStyle:
                columnConfig.fontColorStyle || templateFontColorStyle,
    ...
    getTagStyle(tagStyle?: string): string {
        ...
        const contents: Model =
            this._$owner.getContents() as undefined as Model;
        return (
            this._$column?.tagStyleProperty &&
    ...
    getTagClasses(): string {
        let classes = 'controls-Grid__cell_tag';
        let tagPosition = 'content';
        if (
            (this._$rightSeparatorSize &&
                this._$rightSeparatorSize.toLowerCase() !== 'null') ||
    ...
    isEditing(): boolean {
        if (this.getOwner().getEditingConfig()?.mode === 'cell') {
            return (
                ...
                this.getOwner().getEditingColumnIndex() ===
                    this.getColumnIndex()
            );
        } else {
    ...
    getTextOverflowClasses(): string {
        let classes = `controls-Grid__cell_${
            this.config.textOverflow || 'none'
        }`;
    ...
    shouldDisplayDraggingCounter(): boolean {
        return (
            this.isLastColumn() &&
            this.getOwner().shouldDisplayDraggingCounter()
        );
    }
    ...
    getActionsVisibility(
        ...
        return actionsVisibility !== 'hidden' && this.isLastColumn()
            ? actionsVisibility
            : 'hidden';
    }
    ...
    isNeedSubPixelArtifactFix(tmplSubPixelArtifactFixOption: boolean): boolean {
        ...
        return super.isNeedSubPixelArtifactFix(tmplSubPixelArtifactFixOption);
    }
    ...
    getCellComponentProps(
        ...
        const actionsVisibility = this.getActionsVisibility(
            rowProps.actionsVisibility
        );
        ...
        return {
            ...
            actionsVisibility,
            actionHandlers: actionsVisible
                ? rowProps.actionHandlers
                : undefined,
            actionsClassName: actionsVisible
                ? rowProps.actionsClassName
                : undefined,
            draggingItemsCount:
				this.shouldDisplayDraggingCounter() &&
                this.getDraggedItemsCount()
        };
    }

    isEditable(): boolean {
        return !!this.config?.editorRender && !!this.getEditingConfig();
    }
