...
export default class HeaderCell extends Cell<null, HeaderRow> {
    ...
    private _calcContentOrientation(): void {
        ...
        const get = (prop: 'align' | 'valign'): string | undefined => {
            ...
            if (
                ...
                this._$column[`end${gridUnit}`] -
                    this._$column[`start${gridUnit}`] >
                    1
            ) {
                return 'center';
    ...
    _getColspanParams(): IColspanParams {
        ...
        if (this._$column.startColumn && this._$column.endColumn) {
            const multiSelectOffset = this.CheckBoxCell
                ? 0
                : +this._$owner.hasMultiSelectColumn();
            ...
            if (!(this._$isLadderCell && isMultilineHeader)) {
                stickyLadderCellsCount =
                    this._$owner.getStickyLadderCellsCount();
                startLadderOffset =
                    this._$column.startColumn > 1
                        ? stickyLadderCellsCount
                        : +!!stickyLadderCellsCount;
            ...
            return {
                startColumn:
                    this._$column.startColumn +
                    multiSelectOffset +
                    startLadderOffset,
                endColumn:
                    this._$column.endColumn +
                    multiSelectOffset +
                    stickyLadderCellsCount,
            };
        }
    ...
    getZIndex(): number {
        ...
        if (
            ...
            const hasStickyLadder = this._$owner.getStickyLadderCellsCount()
                ? 1
                : 0;
    ...
    getWrapperClasses(backgroundColorStyle: TBackgroundStyle): string {
        ...
        if (
            ...
            if (
                ...
                !(
                    this._$owner.hasResults() &&
                    this._$owner.getResultsPosition() === 'top'
                ) &&
                (!isMultilineHeader ||
                    (isMultilineHeader &&
                        this._$column.endRow ===
                            this._$owner.getBounds().row.end))
            ) {
                wrapperClasses +=
    ...
    getContentClasses(): string {
        ...
        if (isMultiLineHeader) {
            contentClasses +=
                ' controls-Grid__row-multi-header__content_baseline';
        } else {
    ...
    getCellComponentProps(
        ...
        superProps.paddingTop = 'null';
        superProps.paddingBottom = 'null';
    ...
    protected _getHorizontalPaddingClasses(cellPadding: ICellPadding): string {
        ...
        if (this._$column.isBreadCrumbs) {
            ...
            if (this._$owner.hasMultiSelectColumn()) {
                classes +=
                    ' controls-Grid__cell_spacingBackButton_with_multiSelection';
            }
        }
