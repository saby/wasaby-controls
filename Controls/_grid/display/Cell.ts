    ...
    implements IInstantiable, IVersionable
{
    ...
    getMinHeightClasses(): string {
        ...
        if (topPadding === 'null' && bottomPadding === 'null') {
            result += ' controls-Grid__row-cell_small_min_height';
        } else {
            result += ' controls-Grid__row-cell_default_min_height';
        }
        return result;
    }
    ...
    getCellComponentProps(
        ...
        if (this.isEditing()) {
            ...
            backgroundStyle = getInheritableCellProp('backgroundStyle');
