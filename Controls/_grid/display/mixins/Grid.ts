...
import type { TGetRowPropsCallback, IResultConfig, IEmptyViewProps } from 'Controls/gridReact';
import type { ISelectorsProps, TColumnScrollStartPosition } from 'Controls/columnScrollReact';
import type {
