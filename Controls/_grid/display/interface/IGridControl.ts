 ...
 * @typedef Controls/_grid/display/interface/IGridControl/TResultsPosition
...
/**
 * @description Допустимые значения для опции {@link groupViewMode}.
 * @typedef {String} Controls/_grid/display/interface/IGridControl/IGroupViewMode
 ...
 */
type IGroupViewMode = 'default' | 'blocks';
...
export interface IGridControl extends IList {
    ...
    /**
     * @name Controls/_grid/Grid#groupViewMode
     * @cfg {IGroupViewMode} Режим отображения группировки.
     * @default default
     * @demo Controls-demo/gridNew/Grouped/groupViewMode/blocks/Index В следующем примере группировка отображается в виде блоков.
     */
    groupViewMode: IGroupViewMode;
    /**
     * @name Controls/_grid/Grid#canResetSorting
     * @cfg {Boolean} Опция, определяющая возможность сброса сортировки
     * @default true
...
/**
 * @name Controls/_grid/display/interface/IGridControl#ladderMode
...
/**
 * @name Controls/_grid/display/interface/IGridControl#resultsTemplateOptions
 * @cfg {Object} Объект с опциями для настройки шаблона строки итогов, сконфигурированного через {@link Controls/_grid/display/interface/IGridControl#resultsTemplate resultsTemplate}.
 * @description
...
/**
 * @typedef {Function} Controls/_grid/display/interface/IGridControl/TColspanCallback
 * @description
 ...
 * @cfg {Controls/_grid/display/interface/IGridControl/TColspanCallback.typedef} Функция обратного вызова для расчёта объединения колонок строки (колспана).
 ...
 * @cfg {Array.<Controls/_grid/display/mixins/Grid/IEmptyTemplateColumn>} Конфигурация колонок {@link /doc/platform/developmentapl/interface-development/controls/list/grid/empty/#empty-template-columns пустой таблицы}.
...
/**
 * @typedef {String} Controls/_grid/display/interface/IGridControl/TEmptyTemplateBackgroundColorStyle
 ...
 * @property {Controls/_grid/display/interface/IGridControl/TEmptyTemplateBackgroundColorStyle.typedef} [backgroundColorStyle=editing] Настройка фона строки пустого представления.
 */
 ...
 * Чтобы скрыть стрелку у некоторых записей, используйте {@link Controls/_grid/display/interface/IGridControl#editArrowVisibilityCallback}.
...
/**
 * @name Controls/_grid/display/interface/IGridControl#itemEditorTemplateOptions
 * @cfg {any} Объект с опциями для редактируемой строки, сконфигурированной через {@link Controls/_grid/display/interface/IGridControl#itemEditorTemplate itemEditorTemplate}.
 * @remark
...
/**
 * @event Controls/_grid/display/interface/IGridControl#hoveredCellChanged Происходит при наведении курсора мыши на ячейку таблицы.
...
/**
 * @event Controls/_grid/display/interface/IGridControl#editArrowClick Происходит при клике на "шеврон" элемента.
 * @param {UI/Events:SyntheticEvent} event Объект события.
 * @param {Types/entity:Model} item Элемент, по которому произвели клик.
 */

/**
 * @event Controls/_grid/display/interface/IGridControl#tagClick Происходит при клике на {@link /doc/platform/developmentapl/interface-development/controls/list/grid/columns/visual/tag/ тег} внутри ячейки таблицы.
...
/**
 * @event Controls/_grid/display/interface/IGridControl#tagHover Происходит при наведении курсора мыши на {@link /doc/platform/developmentapl/interface-development/controls/list/grid/columns/visual/tag/ тег} внутри ячейки таблицы.
 * @param {UI/Events:SyntheticEvent} eventObject Дескриптор события.
 * @param {Types/entity:Model} item Экземпляр элемента списка, на котором было вызвано событие.
 * @param {number} columnIndex порядковый номер колонки, на которой было вызвано событие.
 * @param {UI/Events:SyntheticEvent} event Дескриптор события мыши. Может быть использовано для получения тега как DOM-элемента для отображения инфобокса.
