...
/**
 * @event hoveredCellChanged Происходит при наведении курсора мыши на ячейку таблицы.
...
/**
 * @event editArrowClick Происходит при клике на "шеврон" элемента.
...
/**
 * @event tagClick Происходит при клике на {@link /doc/platform/developmentapl/interface-development/controls/list/grid/columns/visual/tag/ тег} внутри ячейки таблицы.
...
/**
 * @event tagHover Происходит при наведении курсора мыши на {@link /doc/platform/developmentapl/interface-development/controls/list/grid/columns/visual/tag/ тег} внутри ячейки таблицы.
