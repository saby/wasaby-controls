...
function getBaseClasses({
    ...
    let baseClasses = 'controls-GridReact__cell js-controls-Grid__row-cell tw-flex';
...
function GroupCellComponent(
    ...
    const wrapperRenderClassName =
        ...
        getBackgroundColorStyleClasses(props.backgroundStyle) +
        getHoverBackgroundColorStyleClasses({
    ...
    return (
        <BaseCellComponent
            ...
            fixedZIndex={3} // Нужно для стикающейся группы, чтобы при скролле одна группа не задвигалась под другую
            tooltip={undefined}
