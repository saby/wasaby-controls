...
import { GridEmptyRow, GridEmptyCell } from 'Controls/gridDisplay';
...
function getInnerContentWrapperClasses(
    ...
    return ' controls-GridView__emptyTemplate tw-contents';
}
...
function getContentClasses(
    ...
    if (
        ...
        let classes =
            ' tw-flex tw-h-full tw-box-border tw-items-center ' + cell?._getRoundBorderClasses();
    ...
    return (
        ...
        ' tw-w-full tw-items-baseline tw-min-w-0 tw-shrink tw-box-border tw-h-full tw-flex tw-cursor-pointer' +
