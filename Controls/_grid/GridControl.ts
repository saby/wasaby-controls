...
import { TColumns } from 'Controls/_baseGrid/display/interface/IColumn';
import { THeader } from 'Controls/_baseGrid/display/interface/IHeaderCell';
import type Row from 'Controls/_baseGrid/display/Row';
...
> extends BaseControl<T> {
    ...
    protected _shouldRenderPreloadedDataRightAway(): boolean {
        ...
        return (
            ...
            (this.props.renderPreloadedDataIgnoringViewType || isReactView(this.props))
        );
    }
