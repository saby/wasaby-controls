...
import { GridCollection as Collection } from 'Controls/gridDisplay';
...
export function getCellElementByEventTarget(
    target: HTMLElement,
    cellSelector: string = '.js-controls-Grid__row-cell:not([data-qa="ladder-cell"])'
): HTMLElement {
...
export function getCellIndexByEventTarget(
    ...
    return Math.max(cellIndex - multiSelectOffset, 0);
}
