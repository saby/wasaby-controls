...
export function getCompatibleCellComponent(
    ...
    // Если RowComponent рендерят вне списка, тогда _$checkTemplateValidator будет undefined
    // Передаем пустую функцию, чтобы компонент не упал и нормально отрендерился.
    // О том, что RowComponent используется вне списка стреляем ошибкой в useEffect
    // тут: RowControls/_gridRender/row/Base.tsx:331
