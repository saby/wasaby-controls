 ...
 * @typedef {(String|Number)} Controls/_gridRender/CommonInterface/TColumnKey
 */
export type TColumnKey = string | number;

/**
 * Базовый интерфейс колонки таблицы (реакт)
 * @interface Controls/_gridRender/CommonInterface
 * @public
 */
 ...
 * @interface Controls/_gridRender/CommonInterface/IColspanProps
 * @public
 */
 ...
 * @interface Controls/_gridRender/CommonInterface/IRowspanProps
 * @public
 */
 ...
 * @typedef {String} Controls/_gridRender/CommonInterface/TResultsPosition
...
export interface IGridProps
    ...
    /**
     * Размещение строки итогов
     * @cfg {Controls/_gridRender/CommonInterface/TResultsPosition.typedef}
     */
     ...
     * @cfg {Controls/_gridRender/row/interface/TGetRowPropsCallback.typedef}
     */
