 ...
 *
 * @class Controls/_gridRender/interface/EditingEmptyTemplate
 * @public
 *
...
export default interface IEditingEmptyTemplateOptions {
    /**
     * @typedef {String} Controls/_gridRender/interface/EditingEmptyTemplate/Spacing
    ...
    /**
     * @cfg {Controls/_gridRender/interface/EditingEmptyTemplate/Spacing.typedef|null} Отступ между верхней границей и шаблоном contentTemplate.
     * @remark
    ...
    topSpacing?: string;
    /**
     * @cfg {Controls/_gridRender/interface/EditingEmptyTemplate/Spacing.typedef|null} Отступ между нижней границей и шаблоном contentTemplate.
     * @remark
     * В значении null отступ отсутствует.
     * Каждому значению опции соответствует размер в px. Он зависит от {@link /doc/platform/developmentapl/interface-development/themes/ темы оформления} приложения.
     * @default l
    ...
    /**
     * @cfg {Array.<Controls/_gridRender/interface/EditingEmptyTemplate/IEmptyColumnColumns.typedef>} Конфигурация колонок пустой таблицы.
     */
