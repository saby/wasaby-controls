 ...
 * @interface Controls/_gridRender/group/interface/IGroupProps
 * @public
 */
export interface IGroupProps
    extends IFontColorStyleOptions,
        ...
        ITextTransformOptions {
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#expanderVisible
    ...
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#rightTemplate
    ...
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#textVisible
    ...
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#separatorVisible
    ...
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#expanderPosition
     * @cfg {Controls/_gridRender/group/interface/IGroupProps/TExpanderPosition.typedef} Размещение {@link /doc/platform/developmentapl/interface-development/controls/list/grouping/ кнопки-экспандера} относительно текста заголовка группы.
     * @default left
     * @see expanderVisible
     * @see iconSize
     */
    ...
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#halign
    ...
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#className
    ...
    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#paddingTop
     * @cfg {Controls/interface/TSize.typedef} Размер верхнего внутреннего отступа
     */
    paddingTop?: TSize;

    /**
     * @name Controls/_gridRender/group/interface/IGroupProps#paddingBottom
...
/**
 * @name Controls/_gridRender/group/interface/IGroupProps#children
 * @cfg {String|TemplateFunction|undefined} Пользовательский шаблон вместо текста заголовка группы.
 * @default undefined
 * @see fontSize
 */
/**
 * @name Controls/_gridRender/group/interface/IGroupProps#fontSize
 ...
 */
/**
 * @name Controls/_gridRender/group/interface/IGroupProps#iconSize
 ...
 */
/**
 * @name Controls/_gridRender/group/interface/IGroupProps#iconStyle
 ...
 */
/**
 * @name Controls/_gridRender/group/interface/IGroupProps#fontWeight
 * @cfg {String} Насыщенность шрифта.
 * @default default
 */

/**
 * @name Controls/_gridRender/group/interface/IGroupProps#textTransform
...
/**
 * @interface Controls/_gridRender/group/interface/IMouseEventHandlers
 * @private
 */
 ...
 * @interface Controls/_gridRender/group/interface/IGroupComponentProps
 * @private
 */
 ...
 * @typedef {Function} Controls/_gridRender/group/interface/TGetGroupPropsCallback
 */
