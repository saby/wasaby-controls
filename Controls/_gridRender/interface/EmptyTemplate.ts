...
export default interface IEmptyTemplateOptions {
    /**
     * @typedef {String} Controls/_gridRender/interface/EmptyTemplate/Spacing
    ...
    /**
     * @typedef {String} Controls/_gridRender/interface/EmptyTemplate/Align
    ...
    /**
     * @name Controls/_gridRender/interface/EmptyTemplate#topSpacing
     * @cfg {Controls/_gridRender/interface/EmptyTemplate/Spacing.typedef|null} Отступ между верхней границей  и шаблоном contentTemplate.
     * @remark
    ...
    topSpacing?: string;
    /**
     * @name Controls/_gridRender/interface/EmptyTemplate#bottomSpacing
     * @cfg {Controls/_gridRender/interface/EmptyTemplate/Spacing.typedef|null} Отступ между нижней границей и шаблоном contentTemplate.
     * @remark
     * В значении null отступ отсутствует.
     * Каждому значению опции соответствует размер в px. Он зависит от {@link /doc/platform/developmentapl/interface-development/themes/ темы оформления} приложения.
     * @default l
    ...
    /**
     * @name Controls/_gridRender/interface/EmptyTemplate#align
     * @cfg {Controls/_gridRender/interface/EmptyTemplate/Align.typedef|null} Выравнивание текста в шаблоне пустого представления.
     * @default center
     */
    align?: 'center' | 'start' | 'end';
    /**
     * @name Controls/_gridRender/interface/EmptyTemplate#contentTemplate
