 ...
 *
 * @class Controls/_gridRender/interface/ItemTemplate
...
/**
 * @name Controls/_gridRender/interface/ItemTemplate#fontColorStyle
 ...
 */
/**
 * @name Controls/_gridRender/interface/ItemTemplate#fontSize
 ...
 */
/**
 * @name Controls/_gridRender/interface/ItemTemplate#fontWeight
...
/**
 * @name Controls/_gridRender/interface/ItemTemplate#borderVisibility
...
/**
 * @name Controls/_gridRender/interface/ItemTemplate#borderStyle
 * @cfg {Controls/display/TBorderStyle.typedef} Цвет рамки вокруг записи.
 * @see borderVisibility
 */

/**
 * @name Controls/_gridRender/interface/ItemTemplate#shadowVisibility
