...
export interface IGridEditingConfig {
    ...
    /**
     * @cfg {Controls/_gridRender/interface/IEditableGrid/TSequentialEditingMode.typedef} Автоматический запуск редактирования по месту для следующего элемента, происходящий при завершении редактирования любого (кроме последнего) элемента списка.
     * @default row
     * @remark
    ...
    /**
     * @cfg {Controls/_gridRender/interface/IEditableGrid/TEditingMode.typedef} Режим редактирования таблицы.
     * @default row
...
/**
 * @typedef {Enum} Controls/_gridRender/interface/IEditableGrid/TSequentialEditingMode
...
/**
 * @typedef {Object} Controls/_gridRender/interface/IEditableGrid/IBeforeBeginEditEventResultOptions
