 ...
 *
 * @class Controls/_gridRender/interface/ResultColumnTemplate
 * @example
...
export default interface IResultColumnTemplateOptions {
     ...
     * @typedef {String} Controls/_gridRender/interface/ResultColumnTemplate/TFontWeight
     * @variant bold
     * @variant default
     */

    /**
     * @cfg {Controls/_gridRender/interface/ResultColumnTemplate/TFontWeight.typedef} Насыщенность шрифта.
     * @default bold
     */
    fontWeight?: TFontWeight;

    /**
     * @typedef {String} Controls/_gridRender/interface/ResultColumnTemplate/BackgroundColorStyle
     ...
     */
    /**
     * @cfg {Controls/_gridRender/interface/ResultColumnTemplate/BackgroundColorStyle.typedef} Стиль фона ячейки.
     */
    backgroundColorStyle?: string;

    /**
     * @description Допустимые значения для опции {@link fontColorStyle}.
     * @typedef {String} Controls/_gridRender/interface/ResultColumnTemplate/FontColorStyle
     * @variant secondary
     * @variant success
     * @variant danger
     * @variant readonly
    ...
    /**
     * @cfg {Controls/_gridRender/interface/ResultColumnTemplate/FontColorStyle.typedef} Стиль цвета текста результатов.
     * @default secondary
     * @remark
