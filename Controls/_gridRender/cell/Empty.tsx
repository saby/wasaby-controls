...
function Empty(
    ...
    const wrapperClassName =
        ...
        (props.paddingTop, props.paddingBottom, props.decorationStyle) +
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        getMinHeightClasses(props.isSingleCell, props.paddingTop, props.paddingBottom, props.decorationStyle) +
