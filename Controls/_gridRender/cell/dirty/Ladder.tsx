...
import { getStyleObjectFromString } from 'Controls/_gridRender/utils/cssStringToObject';
...
function StickyLadderCellContentRender(props: IStickyLadderCellContentRenderProps) {
    ...
    const contentRender = props.render
        ...
        : createElement(cell.getTemplate(), {
              ...clearProps,
              'data-qa': 'ladder-cell',
              backgroundStyle: 'transparent',
              backgroundColorStyle: 'transparent',
 ...
 */
function Ladder(props: IStickyLadderCellComponentProps): React.ReactElement {
    const { cell } = props;
