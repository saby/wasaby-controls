...
import { getFixedClassName } from 'Controls/_gridRender/cell/utils/Classes/Sticky';
...
export function getDataCellProps(props: IGetDataCellCellComponentProps): IDataCellComponentProps {
    ...
    const cursor = getCursor(
        ccp.cursor || DEF_PROPS.cursor,
        columnScrollProps.isScrollable,
        'default',
        columnScrollProps.hasDragScrolling
    );
