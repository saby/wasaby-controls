...
/**
 * Утилита, предоставляющая свойства для рендера стики-ячейки (стики-шапка, стики-запись, стки-группа и тд)
 * @private
 */
...
> {
    return {
        ...
        subPixelArtifactFix: cell.isNeedSubPixelArtifactFix(row?.subPixelArtifactFix),
    };
}
