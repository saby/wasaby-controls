 ...
 */
import { IResultsCellComponentProps, IResultsCellConfig } from 'Controls/_gridRender/cell/Results';
import type { GridResultsCell, GridResultsRow } from 'Controls/gridDisplay';
...
/**
 * Возвращает пропсы, необходимые для рендера ячейки итогов
 * @private
 */
export function getResultsCellProps(
    ...
    const resultProps = {
        ...
        // cCountStart и cCountEnd: определён тут Controls/_gridRender/dirtyRender/cell/interface.ts:350
        ...
        // В Controls/_gridRender/cL/ResultsCellComponent.tsx:10 ничего не передается и это неправильно
