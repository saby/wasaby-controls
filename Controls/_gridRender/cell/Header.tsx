...
import { ICellTypeProps, IHorizontalCellPadding } from 'Controls/_gridRender/cell/interface/ICell';
...
function Header(
    ...
    const wrapperRenderClassName =
        ...
        getCheckboxClasses(cellType, decorationStyle, 'js-controls-Grid__header-cell-checkbox') +
