...
function getContentRender(props: IResultsCellComponentProps): React.ReactElement {
    ...
    // Декоратор сам ничего не многоточит из-за display: inline, делаем это за него.
    // https://online.sbis.ru/opendoc.html?guid=8e051bb0-75b1-4e9d-b200-3b5cec670fef
    const className = 'tw-inline-block tw-overflow-hidden ' + getTextOverflowClasses(textOverflow);
