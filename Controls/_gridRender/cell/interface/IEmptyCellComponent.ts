...
import { IBorderRadiusProps, TCellType } from 'Controls/_gridRender/cell/interface/ICell';
...
interface ICellTypeProps {
    // тип ячейки. Позволяет исключить добавление CSS классов выавнивания для checkbox
    cellType?: TCellType;
    // Возвращает true, если ячейа растянута на всю строку
