...
import { getIECellClasses } from 'Controls/_gridRender/cell/utils/Classes/IE';
...
function Data(
    ...
    const wrapperRenderClassName =
        ...
        getVerticalPaddingsClasses(props.padding?.top, props.padding?.bottom) +
        getHorizontalPaddingsClasses(props.padding?.left, props.padding?.right) +
        getHorizontalMarginsClasses(
            props.marginLeft,
            props.marginRight,
            props.isFirstCell,
        ...
        getIECellClasses(props.width, props.cellType);
    ...
    const tagRender = props.tagRender ? props.tagRender : props.tagStyle ? getTag(props) : null;
