...
export default interface IDefaultExtendedTemplateOptions {
    /**
     * @name Controls/filterPanel:DefaultExtendedTemplate#headingCaption
    ...
    /**
     * @name Controls/filterPanel:DefaultExtendedTemplate#headingContentTemplate
    ...
    /**
     * @name Controls/filterPanel:DefaultExtendedTemplate#bodyContentTemplate
