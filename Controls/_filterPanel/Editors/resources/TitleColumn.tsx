...
function getTitleTemplate(
    ...
    if (tplProps.titleTemplate) {
        ...
        return (
            <Async
                templateName={tplProps.titleTemplateName}
...
export default function TitleColumn(props: IColumnTemplateProps): JSX.Element {
    const tplProps =
        props.column.getTemplateOptions() as unknown as ITitleColumnProps;
    return (
        <div
            className={`controls-ListEditor__columns ${
                tplProps.markerStyle !== 'primary'
