...
import { IFilterEditorHistoryProps } from 'Controls/_filterPanel/Editors/interface/IFilterEditorHistoryProps';
...
export interface IListEditorOptions
    ...
    root?: TKey;
    slice?: ListSlice;
    onPropertyValueChanged?: (arg: unknown) => void;
}
