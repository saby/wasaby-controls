 ...
 * @remark В основе редактора лежит интерфейсный контрол {@link Control/grid:View} или {@link Controls/treeGrid:View} (в зависимости от опции {@link parentProperty}.
 *
 * Полезные ссылки:
 *
