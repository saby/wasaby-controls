            ...
            onResult: (action, data) => {
                switch (action) {
                    case 'itemClick':
                        ...
                        break;
                    case 'applyClick':
                        handleMenuItemsActivate(data);
                        controller.handleSelectedItems(data);
                        break;
    ...
    const handleSelectedKeysChanged = (value) => {
        const viewMode =
            ...
            isEqual(value, props.resetValue)
                ? 'extended'
                : 'basic';
        notifySelectedKeysChanged(value, textValue, viewMode);
    };
        ...
        <EditorChooser {...props} ref={ref}>
            <BaseEditor
                ...
                editorTemplateOptions={{
                    ...props,
                    sourceController: hasHistory()
                        ? null
                        : props.sourceController,
