...
import { FILTER_CONTEXT_NODE_NAME } from 'Controls/dataFactory';

function ListWithContext(props: IListEditorOptions): ReactElement | null {
    const slice = useSlice(props.name);
    ...
    }, [props.filter, props.source, props.sorting, props.navigation, isVisible]);
