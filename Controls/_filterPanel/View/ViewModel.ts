    ...
    private _getSource(
        ...
        let result = source
            ...
            .map((item, index) => {
                ...
                const newItem = this._prepareFilterItem({ ...item }, filterItemLocalProperty);
                ...
                if (!newItem.hasOwnProperty('editorCaption')) {
                    ...
                    newItem.editorCaption = typeof caption !== 'undefined' ? caption : item.group;
                }
                newItem.caption = '';
                if (newItem.jumpingLabel && isEqual(item.value, item.resetValue)) {
