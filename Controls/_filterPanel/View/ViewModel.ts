...
export default class FilterViewModel extends mixin<VersionableMixin>(VersionableMixin) {
    ...
    private _getSource(
        source: IFilterItem[],
        { editorsViewMode, filterViewMode, multiSelect, orientation }: IFilterViewModelOptions
    ): IFilterItem[] {
    ...
    private _getFilterItemEditorOptions(
        ...
        const itemEditorOptions = {
            ...
            fontColorStyle: this._getFontColorStyle(viewMode, filterViewMode, orientation),
            sourceController,
