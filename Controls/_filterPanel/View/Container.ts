 ...
 *
 * @deprecated Контол устарел, для связи фильтра с поиском используйте контрол {@link Controls-ListEnv/filterPanelConnected:View}.
 * @public
 */
...
export default class Container extends Control<IFilterViewContainerOptions> {
    ...
    protected _getFilterController(dataOptions: unknown, key: string | number): FilterController {
    ...
    protected _beforeUnmount(): void {
        ...
        this._filterController.unsubscribe('filterSourceChanged', this._filterSourceChanged);
    }
