...
export default class Input extends BaseLookupInput {
    protected _rootContainerClasses: string =
        'controls-Lookup controls-MultipleInput';
    protected _itemTemplateClasses: string =
        'controls-MultipleInput__SelectedCollection_item';
    ...
    _calculateSizes(options: ILookupInputOptions): void {
        ...
        this._availableWidthCollection =
            this._getAvailableWidthCollection(options);
    }
    ...
    private static _getPlaceholderWidth(
