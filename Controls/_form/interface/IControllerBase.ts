...
import { Model, Record as RecordBase } from 'Types/entity';
...
export interface IControllerBase extends IControlOptions {
    ...
    validateController?: ControllerClass;
    onUpdateSuccessed?: (record: RecordBase) => void;
    className?: string;
}
...
export interface IUpdateConfig {
    /**
     * Дополнительные данные, которые будут обрабатываться при синхронизации записи с реестром.
     */
    additionalData?: Record<string, unknown>;
    /**
     * Дополнительные данные, которые будут переданы в метод записи.
     */
 ...
 * @param {Controls/form:IUpdateConfig} config Параметр сохранения.
