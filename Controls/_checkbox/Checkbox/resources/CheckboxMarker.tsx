 ...
 * @public
 */
export interface ICheckboxMarkerOptions extends TInternalProps, IComponentPropsWithReadonly {
    triState?: boolean;
    value?: boolean | null;
...
export default React.forwardRef(function CheckboxMarker(
    ...
    const wrapperClass =
        ...
        `${
            validationStatus === 'valid' ? '' : ' controls-CheckboxMarker_invalidStatus'
        } ${getAttrClass()}`;
    ...
    return (
        ...
        >
            <svg
                ...
                data-qa={`controls-CheckboxMarker_state-${value === null ? 'null' : value}${
            ...
            >
                <path
                    ...
                    className={`controls-CheckboxMarker__icon-border_${
                        ...
                        validationStatus === 'valid' || value !== false
                            ? resetValue === value
                                ? '_resetValue'
                                : ''
                            : '_invalid'
                    ...
                    className={`controls-CheckboxMarker__icon-subtract ${
                        value && resetValue !== value
                            ? 'controls-CheckboxMarker__icon-subtract-checked_' +
                              (readOnly ? 'disabled' : 'enabled')
                            : ''
                    }${readOnly ? ' controls-CheckboxMarker__icon-subtract-readonly' : ''}`}
                />
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
