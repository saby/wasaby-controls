...
import { View as List, TItemsViewReceivedState, IListViewOptions } from 'Controls/baseList';
...
/**
 * Опции для контрола {@link Controls/tree:View}
 *
 * @public
 */
export interface IListTreeOptions extends IListViewOptions, ITreeOptions {}
...
export default class Tree<
        TControl extends TreeControl = TreeControl,
        TControlOptions extends IListTreeOptions = IListTreeOptions,
    >
...
/**
 * @name Controls/_tree/Tree#footerTemplate
 ...
 * @demo Controls-demo/list/FooterTemplate/Index
 */
