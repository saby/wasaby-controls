...
> extends Control<IContainerBaseOptions> {
    ...
    protected _componentDidMount(): void {
        ...
        this._notify('createChildrenScroll', [
            {
              ...
              'on:register': this._registerIt,
              'on:unregister': this._unRegisterIt,
    ...
    protected _scrollHandler(e: SyntheticEvent, isWheel: boolean): void {
        ...
        if (getStore('AdaptiveInitializer').get('isScrollOnBody')) {
            const isWindowScroll = e.currentTarget === window;
            scrollTop = isWindowScroll ? e.currentTarget.pageYOffset : scrollTop;
            scrollLeft = isWindowScroll ? e.currentTarget.pageXOffset : scrollLeft;
        }
