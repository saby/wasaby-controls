 ...
 * @property {Controls/_scroll/ContainerBase/TInitialScrollPosition.typedef} [vertical] Определяет положение скрола в момент инициализации по вертикали.
 * @property {Controls/_scroll/ContainerBase/TInitialScrollPosition.typedef} [horizontal] Определяет положение скрола в момент инициализации по горизонтали.
 * @public
 */
 ...
 * @cfg {Controls/_scroll/ContainerBase/initialScrollPosition.typedef}
