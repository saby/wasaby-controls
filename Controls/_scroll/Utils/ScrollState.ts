...
export default class ScrollState implements IScrollState {
    ...
    protected _updateCalculatedState(): void {
        this._canVerticalScroll = canScrollByState(
            this,
            SCROLL_DIRECTION.VERTICAL
        );
        this._canHorizontalScroll = canScrollByState(
            this,
        ...
        this._horizontalPosition = getScrollPositionTypeByState(
            this,
            SCROLL_DIRECTION.HORIZONTAL
        );
    }
