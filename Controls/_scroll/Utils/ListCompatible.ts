...
export class ListCompatible extends DestroyableMixin {
    ...
    generateCompatibleEvents(
        ...
        if (
            ...
            scrollModel.contentClientHeight !== oldScrollState.contentClientHeight
        ) {
        ...
        if (
            ...
            this.sendByListScrollRegistrar(listScroll, 'horizontalScrollResize', {
        ...
        if (scrollModel.scrollTop !== oldScrollState.scrollTop) {
            ...
            this._sendScrollMoveAsync(listScroll, scrollModel, SCROLL_DIRECTION.VERTICAL);
        }

        if (scrollModel.scrollLeft !== oldScrollState.scrollLeft) {
            this.sendByListScrollRegistrar(listScroll, 'horizontalScrollMoveSync', {
                scrollLeft: scrollModel.scrollLeft,
            ...
            this._sendScrollMoveAsync(listScroll, scrollModel, SCROLL_DIRECTION.HORIZONTAL);
        }

        if (scrollModel.canVerticalScroll !== oldScrollState.canVerticalScroll) {
        ...
        if (scrollModel.canHorizontalScroll !== oldScrollState.canHorizontalScroll) {
            this.sendByListScrollRegistrar(
                listScroll,
                scrollModel.canHorizontalScroll ? 'canHorizontalScroll' : 'cantHorizontalScroll',
                {
                    clientWidth: scrollModel.clientWidth,
                    scrollWidth: scrollModel.scrollWidth,
                    viewPortRect: scrollModel.viewPortRect,
    ...
    onRegisterNewListScrollComponent(
        ...
        this._sendByListScrollRegistrarToComponent(listScroll, component, 'viewportResize', {
            scrollHeight: scrollModel.scrollHeight,
            scrollWidth: scrollModel.scrollWidth,
            scrollTop: scrollModel.scrollTop,
            scrollLeft: scrollModel.scrollLeft,
        ...
        if (scrollModel.scrollTop) {
            this._sendByListScrollRegistrarToComponent(listScroll, component, 'scrollMoveSync', {
                scrollTop: scrollModel.scrollTop,
                position: scrollModel.verticalPosition,
                clientHeight: scrollModel.clientHeight,
                scrollHeight: scrollModel.scrollHeight,
    ...
    sendByListScrollRegistrar(listScroll: RegisterClass, eventType: string, params: object): void {
        ...
        this._scrollMoveTimer[direction] = setTimeout(() => {
            ...
            if (!this.destroyed) {
                if (direction === SCROLL_DIRECTION.VERTICAL) {
                    ...
                    this.sendByListScrollRegistrar(listScroll, 'horizontalScrollMove', {
                        scrollLeft: scrollModel.scrollLeft,
                        position: scrollModel.horizontalPosition,
                        clientWidth: scrollModel.clientWidth,
                        scrollWidth: scrollModel.scrollWidth,
