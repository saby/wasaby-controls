...
import ContainerBase, {
    IContainerBaseOptions,
} from 'Controls/_scroll/ContainerBase';
...
export default class Container
    extends ContainerBase<IContainerOptions>
    implements IScrollMode
{
    ...
    protected _dispatchStickyContextCallback: Function =
        this._dispatchStickyContext.bind(this);
    ...
    _beforeMount(options: IContainerOptions): void {
        ...
        this._setHorizontalScrollMode = this._setHorizontalScrollMode.bind(
            this,
            [options]
        );
        this._setArrowButtonClickCallback =
            this._setArrowButtonClickCallback.bind(this);
        this._removeArrowButtonClickCallback =
            this._removeArrowButtonClickCallback.bind(this);
            ...
            (options.shadowMode === SHADOW_MODE.CSS ||
                (options.shadowMode === SHADOW_MODE.MIXED &&
                    (options.topShadowVisibility === SHADOW_VISIBILITY.AUTO ||
                        options.bottomShadowVisibility ===
                            SHADOW_VISIBILITY.AUTO ||
                        options.topShadowVisibility ===
                            SHADOW_VISIBILITY.GRIDAUTO ||
                        options.bottomShadowVisibility ===
                            SHADOW_VISIBILITY.GRIDAUTO)));
        ...
        this._setStickyContextUpdaterCallback =
            this._setStickyContextUpdater.bind(this);
        this._initialScrollPositionStyle =
            this._getInitialScrollPositionStyle(options);
        ...
        this._positionChangedHandlerCallback =
            this._positionChangedHandler.bind(this);
        this._draggingChangedHandlerCallback =
            this._draggingChangedHandler.bind(this);
    ...
    _afterMount(options: IContainerOptions): void {
        ...
        const wheelHappened =
            LocalStorageNative.getItem('scrollContainerWheelEventHappened') ===
            'true';
        ...
        this._scrollbars.updateOptions({
            ...
            scrollbarVisible:
                ...
                this._resolveScrollbarVisibility(options),
        });
    ...
    protected _beforeUpdate(options: IContainerOptions): void {
        ...
        if (this._isPagingVisible(options)) {
            ...
            this._paging.isVisible =
                ...
                this._options.scrollOrientation !== 'none';
        ...
        if (options.scrollOrientation !== this._options.scrollOrientation) {
            ...
            this._shadows.setStickyFixed(
                ...
                this._stickyController.hasFixed(StickyPosition.Bottom) &&
                    this._stickyController.hasShadowVisible(
        ...
        this._isOptimizeShadowEnabled =
            this._getIsOptimizeShadowEnabled(options);
    ...
    private _updateScrollbarsPadding(): void {
        ...
        if (
            this._verticalScrollbarPadding.end !==
            this._scrollbars.horizontal?.isVisible
        ) {
        ...
        if (
            this._horizontalScrollbarPadding.end !==
            this._scrollbars.vertical?.isVisible
        ) {
    ...
    private _updateShadowMode(options?: IContainerOptions): boolean {
        ...
        const isOptimizeShadowEnabled = this._getIsOptimizeShadowEnabled(
    ...
    private _getShadowsModelOptions(
        options: IContainerOptions
    ): IShadowsOptions {
    ...
    protected _scrollHandler(e: SyntheticEvent): void {
        ...
        if (
            ...
            this._isOptimizeShadowEnabled = this._getIsOptimizeShadowEnabled(
                this._options
            );
            this._optimizeShadowClass = this._getOptimizeShadowClass();
        }
    ...
    _updateState(...args) {
        ...
        if (isUpdated) {
            ...
            if (this._scrollModel && this._isInitializationDelayed()) {
                this._scrollbars.updateScrollState(
                    this._scrollModel,
                    this._container
                );
            }
            ...
            if (
                this._scrollModel.clientHeight !==
                this._oldScrollState.clientHeight
            ) {
    ...
    protected _updateScrollContainerPaigingSccClass(
        options: IContainerOptions
    ) {
    ...
    protected _getScrollContainerCssClass(
    ...
    protected _draggingChangedHandler(
    ...
    protected _updateShadowVisibility(
        ...
        if (this._arrowButtons) {
            const isLeftFixed =
                shadowsVisibility.left === SHADOW_VISIBILITY.VISIBLE;
            const isRightFixed =
                shadowsVisibility.right === SHADOW_VISIBILITY.VISIBLE;
            isChanged =
        ...
        if (this._gridAutoShadows) {
            ...
            this._shadows.updateOptions(
                this._getShadowsModelOptions(this._options)
            );
        }
        const needUpdate =
            this._wasMouseEnter || !this._isOptimizeShadowEnabled;
        this._shadows.updateVisibilityByInnerComponents(
            shadowsVisibility,
            needUpdate
        );
    ...
    protected _getBlurClasses(): string {
        ...
        let resultClasses = '';
        const isLeftBlurVisible =
            this._shadows.left.isEnabled && this._shadows.left.isVisible;
        const isRightBlurVisible =
            this._shadows.right.isEnabled && this._shadows.right.isVisible;
    ...
    private _getInitialScrollPositionStyle(options: IContainerOptions): string {
        ...
        if (typeof options.initialScrollPosition?.vertical === 'number') {
            resultStyle = `margin-top: ${-options.initialScrollPosition
                ?.vertical}px;`;
        } else if (
            typeof options.initialScrollPosition?.horizontal === 'number'
        ) {
            resultStyle = `margin-left: ${-options.initialScrollPosition
                ?.horizontal}px;`;
        }
        return resultStyle;
    }
    ...
    private _switchInitialScrollPosition(options: IContainerOptions): void {
        ...
        if (typeof options.initialScrollPosition?.vertical === 'number') {
            ...
            this.scrollTo(
                options.initialScrollPosition?.horizontal,
    ...
    private _updateScrollButtonsByShadowVisibility(
        ...
        if (shadowsVisibility.left === SHADOW_VISIBILITY.VISIBLE) {
            this._arrowButtons.isLeftVisible = this._arrowButtons.isLeftFixed =
                true;
        } else {
        ...
        if (shadowsVisibility.right === SHADOW_VISIBILITY.VISIBLE) {
            this._arrowButtons.isRightVisible =
                this._arrowButtons.isRightFixed = true;
        } else {
        ...
        if (
            ...
            if (!this._arrowButtons.isLeftFixed) {
                this._arrowButtons.isLeftVisible =
                    ...
                    this._scrollModel.horizontalPosition !==
        ...
        if (
            ...
            if (!this._arrowButtons.isTopFixed) {
                this._arrowButtons.isTopVisible =
                    this._scrollModel.canVerticalScroll &&
                    this._scrollModel.verticalPosition !==
                        SCROLL_POSITION.START;
            }
    ...
    protected _setArrowButtonClickCallback(callback: Function): void {
        this._arrowButtonClickCallback =
            this._arrowButtonClickCallback || callback;
    }
    ...
    protected _arrowButtonHandler(
        ...
        if (result !== false) {
            ...
            const position = getScrollPositionByState(
                this._scrollModel,
                orientation
            );
            this.scrollTo(
    ...
    protected _getHasUnrenderedContentState(): IHasUnrenderedContent {
        return {
            top:
                (this._gridAutoShadows &&
                    this._options.topShadowVisibility === 'gridauto') ||
                this._shadows.top?.getVisibilityByInnerComponents() ===
                    SHADOW_VISIBILITY.VISIBLE,
            bottom:
                (this._gridAutoShadows &&
                    this._options.bottomShadowVisibility === 'gridauto') ||
    ...
    protected _getShadowClasses(
        direction: string,
        orientation: string
    ): string {
        const stylePostfix =
            this._options.shadowMode === 'rounded' ? '-rounded' : '';
        return (
    ...
    protected _keydownHandler(event: SyntheticEvent): void {
        ...
        if (!event.nativeEvent.isTrusted) {
            ...
            if (
                event.nativeEvent.which === constants.key.home &&
                scrollTop !== 0
            ) {
                this.scrollToTop();
                event.preventDefault();
    ...
    protected _onWheelHandler(event: SyntheticEvent): void {
        if (!ScrollbarsModel.wheelEventHappened) {
            LocalStorageNative.setItem(
                'scrollContainerWheelEventHappened',
                'true'
            );
    ...
    private _initIntersectionObserverController(): void {
        if (!this._intersectionObserverController) {
            this._intersectionObserverController = new Observer(
                this._intersectHandler.bind(this)
            );
        }
    }
    ...
    protected _intersectionObserverRegisterHandler(
        ...
        this._intersectionObserverController.register(
            this._container,
    ...
    protected _intersectionObserverUnregisterHandler(
        ...
        if (this._intersectionObserverController) {
            this._intersectionObserverController.unregister(
                instId,
                observerName
            );
        }
    ...
    getHeadersHeight(
        ...
        return this._stickyController.getBlocksHeight(
            position,
            type,
            considerOffsetTop
        );
    ...
    getBlocksHeightByScrollTop(scrollTop: number): number {
        return this._stickyController.getFixedBlocksHeightByScrollTop(
            scrollTop
        );
    }
    ...
    _setHorizontalScrollMode(
        options: IContainerOptions,
        mode: THorizontalScrollMode
    ): void {
        ...
        this._scrollbars?.updateOptions({
            ...options,
            scrollbarVisible:
                this._scrollbarVisible || options.scrollbarVisible,
        });
    }
