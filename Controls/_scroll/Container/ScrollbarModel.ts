    ...
    implements IVersionable
{
    ...
    get isVisible(): boolean {
        return Boolean(
            !this._useNativeScrollbar && this._options.scrollbarVisible && this._canScroll
        );
    }
    ...
    private _updateContentSize(): boolean {
        ...
        this._contentSize =
            originalContentSize - offset + this._placeholders.start + this._placeholders.end;
