    ...
    implements IVersionable
{
    ...
    private _visibilityByInnerComponents: ScrollShadowVisibility = ScrollShadowVisibility.Auto;
    ...
    get isEnabled() {
        if (detection.isPhone && this._direction === 'vertical') {
            return false;
        }
    ...
    _getVisibleByState(scrollState: IScrollState): boolean {
        ...
        return (
            (this._type === SHADOW_TYPE.BEFORE && position !== SCROLL_POSITION.START) ||
    ...
    getStickyHeadersShadowsVisibility(): ScrollShadowVisibility {
        if (detection.isPhone && this._direction === 'vertical') {
            return ScrollShadowVisibility.Hidden;
        }
    ...
    private _getShadowEnable(): boolean {
        ...
        if (
            ...
            this._options.initialScrollPosition.vertical > 0
        ) {
            return true;
        }
        if (
            ...
            this._options.initialScrollPosition.horizontal > 0
        ) {
            return true;
        }
