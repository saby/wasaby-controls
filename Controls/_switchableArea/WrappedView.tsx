...
export interface IWrappedViewOptions extends TInternalProps, IComponentProps {
...
function getDataOptions(
    ...
    return slice?.state.results?.[selectedKey];
}
...
export default React.forwardRef(function WrappedView(
    ...
    const contextValue: AreaSlice = useSlice<AreaSlice>(props.storeId);
    ...
    }, [props.selectedKey, contextValue]);
