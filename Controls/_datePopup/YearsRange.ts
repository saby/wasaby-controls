...
export default class YearsRange extends Control<IYearsRangeOptions> {
    ...
    protected _isSelectedStart(value: Date): boolean {
        ...
        return (this._rangeModel.startValue?.getFullYear() === value.getFullYear()) ||
        (!this._options.selectionProcessing && this._rangeModel.startValue?.getFullYear() === value.getFullYear());
    }
    ...
    protected _isSelectedEnd(value: Date): boolean {
        ...
        return (this._rangeModel.endValue?.getFullYear() === value.getFullYear()) ||
            (!this._options.selectionProcessing && this._rangeModel.endValue?.getFullYear() === value.getFullYear());
    }
