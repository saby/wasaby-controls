...
export default {
    ...
    _getCaptionPaddingClass(captionPosition: string): string {
        if (captionPosition === 'right') return ' controls-SpoilerHeading__caption-padding-left';
        else if (captionPosition === 'left' || captionPosition === 'edgeLeft') {
            return ' controls-SpoilerHeading__caption-padding-right';
        }
