...
function ExpandLight(className: string) {
    return (<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
...
export default React.forwardRef(function Heading(props: IHeadingOptions, ref) {
    ...
    const [fontWeight, setFontWeight] = React.useState<string>(_calcFontWeight(expanded, props.fontWeight));
    ...
    const iconClassName = 'controls-SpoilerHeading__icon' +
        ...
        <div
            ...
            <div className={`controls-SpoilerHeading__wrapper controls-fontsize-${fontSize}`}>
                ...
                <div ref={captionContainer}
                     className={'controls-SpoilerHeading__caption ws-ellipsis' +
