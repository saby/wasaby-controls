...
export default React.forwardRef(function View(props: IViewOptions, ref) {
    ...
    return (
        <div ref={ref} {...attrs} className={`controls_spoiler_theme-${theme} controls-SpoilerView ${props.className}`}>
            <div className="controls-SpoilerView__header ws-flexbox ws-align-items-baseline">
                {
                    captions && (
                        <Heading className="controls-SpoilerView__heading ws-flex-row"
                                 expanded={expanded}
                                 captions={captions}
                ...
                }
                {
                    props.headerContentTemplate ? (
                        props.headerContentTemplate.isWasabyTemplate ?
                            <props.headerContentTemplate onExpandedChanged={expandedHandler}
            ...
            {
                expanded && (props.content.isWasabyTemplate ?
