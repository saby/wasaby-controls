...
class ReactContainer extends React.Component<IReactContainerProps> {
    ...
    private _registerMouseMove(): void {
        this.context.registerMouseMove(
            this._onMouseMove,
            this._onTouchMove,
            this
        );
        ...
        if (this._startEvent) {
            ...
            if (this._documentDragging) {
                ...
                if (this.props.draggingTemplate) {
                    this.context.updateDraggingTemplate(
                        dragObject,
                        this.props.draggingTemplate
                    );
                }
            }
        }
    ...
    private _getDragObject(
        ...
        if (mouseEvent && startEvent) {
            ...
            dragObject.offset = ReactContainer._getDragOffset(
                mouseEvent,
                startEvent
            );
            dragObject.draggingTemplateOffset =
                this.props.draggingTemplateOffset;
        }
        return dragObject;
    }
    ...
    componentDidMount(): void {
        this.context.registerDocumentDrag(
    ...
    private static _isDragStarted(
        ...
        const offset: ICords = ReactContainer._getDragOffset(
            moveEvent,
            startEvent
        );
        return (
