...
import { IPropertyGrid, Constants, PropertyGridCollectionItem } from 'Controls/propertyGrid';
 ...
 *
 * @class Controls/_propertyGrid/PropertyGridEditorCollectionItem
 * @extends Controls/_display/TreeItem
 * @public
 */

export default class PropertyGridEditorCollectionItem<T> extends TreeGridDataRow<T> {
...
Object.assign(PropertyGridEditorCollectionItem.prototype, {
    '[Controls/_propertyGridEditor/PropertyGridEditorCollectionItem]': true,
    _moduleName: 'Controls/propertyGridEditor:PropertyGridEditorCollectionItem',
});
