...
> extends VersionableMixin {
    ...
    protected _convertToValue(displayValue: string): TOptions['value'] {
        return displayValue;
    }
    ...
    /**
     * Возвращает отображаемое в поле ввода значение
     */
    ...
    /**
     * Устанавливает отображаемое в поле ввода значение
     * @param {string} value
     */
