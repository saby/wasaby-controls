    ...
    implements IField
{
    ...
    componentDidMount(): void {
        ...
        if (this._hasAutoFillField()) {
            ...
            // Согласно новости от ядра, засовываем вызов события в setTimeout
            // https://online.sbis.ru/news/bfb6f344-7de8-4106-add2-291757d38075
            setTimeout(() => {
    ...
    private _getContentEditableSelection(): ISelection {
        ...
        if (selection.rangeCount) {
            ...
            if (range.startContainer !== range.endContainer) {
                ...
                const value = range.startContainer.nodeValue as string;
                // Если value равен null, значит выбрано все поле ввода, поэтому говорим модели, что все соержимое выделено
                if (value !== null) {
    ...
    protected _getContentProps(className: string) {
        ...
        if (this._isBrowserPlatform) {
            ...
            if (typeof this.state.inputValue === 'string') {
                contentProps.defaultValue = this.state.inputValue;
            }
