/**
 * @typedef {String} Controls/_input/resources/Tag
...
/**
 * @typedef {String} Controls/_input/resources/InputType
 * @description Тип изменения, которое вносит пользователь в поле ввода.
 * @variant insert Вставка нового значения в текущее.
 * @variant deleteForward Удаление части текущего значения, через нажатие клавиш [ctrl +] {delete}.
 * @variant deleteBackward Удаление части текущего значения, через нажатие клавиш [ctrl +] {backspace}.
 * @variant delete Удаление части текущего значения, через его выделение и нажатие клавиш [ctrl +] {backspace|delete}.
 * @public
 */
export type InputType = 'insert' | 'delete' | 'deleteBackward' | 'deleteForward';
/**
 * @typedef {String} Controls/_input/resources/NativeInputType
 ...
 * @interface Controls/_input/resources/ISelection
 * @public
 */
