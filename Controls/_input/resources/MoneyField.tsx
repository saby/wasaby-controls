...
class MoneyField<ModelOptions> extends Field<string, ModelOptions> {
    ...
    shouldComponentUpdate(
        nextProps: IFieldMoneyOptions<ModelOptions>
    ): boolean {
    ...
    private _setContent(props: IFieldMoneyOptions<ModelOptions>): void {
        ...
        let fractionColorStyle =
            split[1] === '00' || props.readOnly
                ? 'readonly'
                : props.fontColorStyle;
        if (fractionColorStyle !== 'readonly' &&
            !(props.fontSize === '5xl' || props.fontSize === '6xl' ||
                props.fontSize === '7xl' || props.fontSize === '8xl')) {
    ...
    render(): JSX.Element {
        const contentProps = this._getContentProps(`controls-Field js-controls-Field controls-Field_money controls-Field_moneyNew${
