                ...
                for (let i = 0; i < field.childNodes.length; i++) {
                    if (field.childNodes[i].nodeType === 3) {
                        ...
                        result = [
                            ...result,
                            ...this._getTextNode(
                                field.childNodes[i] as HTMLElement
                            ),
                        ];
                    }
                }
        ...
        if (
            ...
            if (field.setSelectionRange) {
                ...
                for (let i = 0; i < nodes.length; i++) {
                    if (
                        nodes[i].parent.innerText.length >= positionStart &&
                        !isSetStart
                    ) {
                    ...
                    if (
                        i === nodes.length - 1 &&
                        nodes[i].parent.innerText.length < positionEnd
                    ) {
            ...
            if (
                field.value?.length === selection.start &&
                field.value?.length === selection.end
            ) {
