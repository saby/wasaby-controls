 ...
 * каретки на момент фокусировки, а затем удалим ассинхронно. Изменять нативную позицию перед обработкой нельзя!
...
export class InsertFromDrop {
    ...
    private _timeoutId: ReturnType<typeof window.setTimeout> | undefined = undefined;
