...
/*
 * Класс для исправления бага не правильной позиции каретки при фокусировке.
 ...
 * браузером. Например, в chrome, firefox, IE10-11 она в начале. Это не соответствует поведению по стандарту.
...
export class CarriagePositionWhenFocus {
    ...
    private readonly _updatePositionCallback: TUpdatePositionCallback;
