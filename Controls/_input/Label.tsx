...
type TFontColorStyle = 'label' | 'unaccented' | 'link' | 'primary' | 'success' | 'info';
...
export default React.forwardRef(function Label(
    ...
    const autoHeight =
        typeof props.autoHeight === 'undefined'
            ? underline === 'none'
                ? false
                : true
            : props.autoHeight; // underline !== none - костыль, так как опция underline
