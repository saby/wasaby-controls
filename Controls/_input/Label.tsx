...
export default React.forwardRef(function Label(props: ILabelOptions, _): React.ReactElement {
    const {
        underline = 'none',
    ...
    return (
        <a
            ...
            ref={props.$wasabyRef}
            className={`controls-Label controls-Label_underline_${underline} ${props.className || attrs.className}`}
            href={props.href}
        >
