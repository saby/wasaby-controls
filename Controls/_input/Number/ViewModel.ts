...
import { toString } from 'Controls/Utils/PhoneUtils';
...
class ViewModel extends BaseViewModel<string | number | null, IViewModelOptions> {
    ...
    protected _convertToValue(displayValue: string): string | number | null {
        /*
