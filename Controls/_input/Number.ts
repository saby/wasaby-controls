...
class NumberInput extends Base<INumberInputOptions> implements IOnlyPositive {
    ...
    protected _focusOutHandler(event: SyntheticEvent<HTMLElement, FocusEvent>): void {
        ...
        if (this.props.minValue && this._viewModel.value < this.props.minValue) {
            this._viewModel.value = this.props.minValue;
            isChanged = true;
        }

        if (this.props.maxValue && this._viewModel.value > this.props.maxValue) {
    ...
    protected _keyDownHandler(event: SyntheticEvent<HTMLElement, KeyboardEvent>): void {
        ...
        if (onlyPositive && newValue < 0) newValue = 0;
