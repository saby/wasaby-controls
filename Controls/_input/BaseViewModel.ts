...
abstract class BaseViewModel<TValue, TOptions extends {} = {}> extends VersionableMixin {
    ...
    protected _newValue: string | null;
    protected _selection: ISelection;
    protected _options: TOptions;
    protected _emptyValue: TValue | null;
    ...
    protected _handleConvertedValue(displayValue: string): TValue {
        ...
        if (this._isEmptyValue(value)) {
            return prepareEmptyValue(
                value as unknown as string,
                this._emptyValue as unknown as string
            ) as unknown as TValue;
        }
        return value;
    }

    private _isEmptyValue(value: TValue | null): boolean {
        // @ts-ignore
    ...
    isValueChanged(displayValue: string, _?: string): boolean {
