...
const ColumnChartConnectedType = WidgetType.id('Controls-Graphs/ColumnChartConnected')
    .title('Колоночный')
    .category('График')
    ...
    .properties({
        ...
        reset: StringType.title('')
            .editor('Controls-Graphs-editors/ColumnChartResetEditor:ColumnChartResetEditor')
            .editorProps({
...
export default ColumnChartConnectedType;
