...
import type { TagEditor, ITagEditorProps } from 'Controls-ListEnv/filterPanelExtEditors';
...
const DETACHED_FILTERS = ['Controls-ListEnv/filterPanelExtEditors:TagEditor'];
...
function FilterSearchConnectedView(
    ...
    return (
        ...
        >
            <FocusRoot ref={ref} autofocus={true} as="div" className="tw-contents">
                <SearchTemplate
...
function CloudTemplate(props: ICloudTemplateProps): ReactElement {
    ...
    return (
        <div
            ...
            onClick={clickHandler}
        >
            <div className="js-controls-FilterView__target tw-w-full tw-flex tw-items-center tw-overflow-hidden">
            ...
            if (viewMode === 'frequent' || isDetachedFilter) {
                if (!isAdaptive) {
                    config.push({
                        ...
                        name,
                        closeButtonVisible: item.hasOwnProperty('resetValue') && isValueChanged,
