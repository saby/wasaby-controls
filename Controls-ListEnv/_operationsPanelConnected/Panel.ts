...
import * as template from 'wml!Controls-ListEnv/_operationsPanelConnected/Panel/Panel';
 ...
 *
 * @class Controls-ListEnv/operationsPanelConnected:View
 * @extends Controls-ListEnv/toolbarConnected:Container
...
export default class OperationsWidget extends Control<IOperationsPanelWidgetOptions> {
    ...
    protected _selectedTypeChanged(e: SyntheticEvent, selectedType: string): void {
        ...
        if (selectedType === 'all' || selectedType === 'selected') {
            this._options.slice.setSelectionViewMode(selectedType);
        }
