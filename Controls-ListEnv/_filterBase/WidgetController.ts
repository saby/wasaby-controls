...
export default class WidgetController {
    ...
    applyFilterDescription(filterDescription: IFilterItem[], additionalState?: Partial<IListState>): void {
        this._filterDescription = null;
        if (this._isSlicesAvailable()) {
            this._applyFilterDescription(filterDescription, additionalState);
        } else {
    ...
    getPropStorageId(): ViewModeType {
        return Object.values(this._getFilterSlices())[0].propStorageId;
    }
    ...
    private _applyFilterDescription(filterDescription: IFilterItem[], additionalState: Partial<IListState>): void {
        Object.values(this._getFilterSlices()).forEach((filterSlice) => {
            filterSlice.applyFilterDescription(filterDescription, additionalState);
        });
    }
