 ...
 * @remark Если опцию filterNames не указывать, то для редактирования будут отображены все элементы, описанные в структуре фильтра.
 * @example
 ...
 * @see /doc/platform/developmentapl/interface-development/controls/list/filter-and-search/new-filter/
 */

/**
 * @name Controls-ListEnv/_filterConnected/IFilterNames#excludedFilterNames
 * @cfg {Array<string>} {@link Controls/filter:IFilterItem#name Имена} параметров фильтра, которые будут не доступны для редактирования в виджете.
 * @remark Опцию следует использовать, если {@see filterNames} не задано и нужно из общего набора фильтров исключить какие то фильтры,
 * чтобы они были не доступны для редактирования.
 * @example
 * <pre class="brush: html; highlight: [2-7]">
 *     <Controls-ListEnv.filterConnected:View>
 *         <ws:excludedFilterNames>
 *             <ws:Array>
 *                 <ws:String>Employees</ws:String>
 *             </ws:Array>
 *         </ws:excludedFilterNames>
