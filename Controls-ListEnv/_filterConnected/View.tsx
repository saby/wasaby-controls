...
/**
 * @name Controls-ListEnv/_filterConnected/View#detailPanelOrientation
...
/**
 * @name Controls-ListEnv/_filterConnected/View#detailPanelWidth
...
/**
 * @name Controls-ListEnv/_filterConnected/View#detailPanelExtendedItemsViewMode
...
/**
 * @name Controls-ListEnv/_filterConnected/View#detailPanelTopTemplateName
 * @cfg {string} Путь до шаблона, в котором выводится пользовательский контент, выводящийся справа от заголовка
 */

/**
 * @name Controls-ListEnv/_filterConnected/View#detailPanelHistorySaveMode
...
/**
 * @name Controls-ListEnv/_filterConnected/View#detailPanelTopTemplateOptions
 * @cfg {Object} Опции для контрола, который передан в {@link detailPanelTopTemplateName}.
 */

/**
 * @name Controls-ListEnv/_filterConnected/View#detailPanelExtendedTemplateName
...
/**
 * @name Controls-ListEnv/_filterConnected/View#emptyText
 * @default Все
