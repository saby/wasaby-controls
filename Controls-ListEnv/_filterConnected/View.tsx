 ...
 */
function FilterConnectedView(
    props: IFilterViewWidgetOptions,
...
/**
 * @name Controls-ListEnv/filterConnected:View#detailPanelEmptyHistoryTemplate
 * @cfg {String} Шаблон, который отображаеться в блоке с историей фильтров, если фильтров, сохранённых в историю, ещё нет.
 * @demo Controls-ListEnv-demo/FilterPanelPopup/Sticky/HistoryId/EmptyHistory/Index
 * @example
 * <pre class="brush: html; highlight: [3]">
 *    <Controls-ListEnv.filterConnected:View
 *       storeId="reports"
 *       detailPanelEmptyHistoryTemplate="MyModule/DetailPanelEmptyHistoryTemplate"/>
 * </pre>
 */
 ...
 *
 * Для реализации блока "Можно отобрать" рекомендуется использовать {@link Controls/filterPanelExtendedItems:DefaultTemplate раскладку},
 ...
 * <pre class="brush: html">
 *     <Controls.filterPanelExtendedItems:DefaultTemplate headingCaption="{{_options.headingCaption}}">
 ...
 * @see Controls/filterPanelExtendedItems:DefaultTemplate
 */
...
/**
 * @typedef {String} Controls-ListEnv/filterConnected:View/Alignment
...
/**
 * @name Controls-ListEnv/filterConnected:View#alignment
 * @cfg {Controls-ListEnv/filterConnected:View/Alignment.typedef} Задаёт выравнивание элементов объединённого фильтра.
 * @default right
 * @example
 * <pre class="brush: html">
 * <Controls-ListEnv.filterConnected:View
