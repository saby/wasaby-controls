...
function updateChangedItems(
    ...
    const filterPanel = updateEditorsOptions(newFilterSource, oldFilterSource);
    filterPanel.forEach((item) => {
 ...
 * @remark Строится по настройкам фильтрации, которые указаны в аргументах списочной фабрики. Подробнее можно прочитать в {@link /doc/platform/developmentapl/interface-development/controls/new-data-store/list-slice/ статье}.
 *
 * Полезные ссылки:
