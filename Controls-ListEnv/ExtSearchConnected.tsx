...
export interface ISearchSuggestWidgetOptions
    ...
    constraint?: ITextOptions['constraint'];
...
const Content = React.forwardRef(
    (
        ...
        return <ExtSearch {...props} ref={ref as React.LegacyRef<ExtSearch>} />;
    }
);
 ...
 */
function SearchSuggestWidgetWidget(
    props: ISearchSuggestWidgetOptions,
