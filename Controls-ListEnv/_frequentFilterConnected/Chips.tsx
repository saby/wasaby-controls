...
const Chips = lazy(() => importer('Controls/Chips:Control'));
...
function FrequentFilterChips(props: IToggleFilterProps, forwardedRef: React.ForwardedRef<unknown>) {
    ...
    const handleSelectionChanged = React.useCallback(
        (_event: Event, value: number[] | string[]) => {
            let filterValue;
    ...
    const selectedKeys = React.useMemo(() => {
        return Array.isArray(toggleItem.value) ? toggleItem.value : [toggleItem.value];
    }, [toggleItem.value]);
