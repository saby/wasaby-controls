...
import template = require('wml!Controls-ListEnv/_operationsPopup/ReportDialog/ReportDialog');
import 'css!Controls-ListEnv/operationsPopup';

/**
 * Шаблон диалога с результатами массовых операций.
 *
 * @class Controls-ListEnv/_operationsPopup/ReportDialog
 ...
 * @name Controls-ListEnv/_operationsPopup/ReportDialog#title
 * @cfg {String}
 */

/**
 * The number of elements on which the operation was performed.
 * @name Controls-ListEnv/_operationsPopup/ReportDialog#operationsCount
 * @cfg {Number}
 */

/**
 * Number of items for which the operation completed successfully.
 * @name Controls-ListEnv/_operationsPopup/ReportDialog#operationsSuccess
 * @cfg {Number}
 */

/**
 * Error list.
 * @name Controls-ListEnv/_operationsPopup/ReportDialog#errors
 * @cfg {Array.<String>}
 * @remark
 ...
 * @name Controls-ListEnv/_operationsPopup/ReportDialog#footerContentTemplate
 * @cfg {Function}
 */
export = ReportDialog;
