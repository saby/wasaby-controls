...
import * as template from 'wml!Controls-ListEnv/_extSearchPopup/SuggestTemplate';
...
): INavigationOptionValue<INavigationSourceConfig> | undefined {
...
export default class SuggestTemplate extends Control<ISuggestTemplate> {
    ...
    protected _breadcrumbsVisibility?: string;
    protected _searchNavigationMode?: string;
    protected _navigation?: INavigationOptionValue<INavigationSourceConfig>;
    protected _suggestItemTemplate: TemplateFunction;
    protected _suggestItemPadding?: IItemPadding;
    protected _groupProperty?: ISuggestListsOptions['groupProperty'];
    protected _groupTemplate?: ISuggestListsOptions['groupTemplate'];
    ...
    private _setProperties(
        ...
        this._breadcrumbsVisibility = currentOptions.breadcrumbsVisibility;
        this._searchNavigationMode = currentOptions.searchNavigationMode;
        ...
        this._groupProperty = currentOptions.groupProperty;
        this._groupTemplate = currentOptions.groupTemplate;
    }
    ...
    protected _tabsSelectedKeyChanged(e: SyntheticEvent, key: Key): void {
        e.stopPropagation();
        this._notify('tabsSelectedKeyChanged', [key], { bubbling: true });
    }
}
