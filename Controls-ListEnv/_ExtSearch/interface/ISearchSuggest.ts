 ...
 * Для множественного выбора настроек рекомендуется использовать редактор 'Controls/filterPanelExtEditors:CheckboxGroupEditor',
 * для единичного - 'Controls/filterPanelExtEditors:RadioGroupEditor'.
