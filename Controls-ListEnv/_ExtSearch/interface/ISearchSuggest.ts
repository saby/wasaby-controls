 ...
 * @interface Controls-ListEnv/ExtSearch:ISearchSuggest
 * @public
 */
...
/**
 * @name Controls-ListEnv/ExtSearch:ISearchSuggest#filterDescription
...
/**
 * @name Controls-ListEnv/ExtSearch:ISearchSuggest#suggestWidth
