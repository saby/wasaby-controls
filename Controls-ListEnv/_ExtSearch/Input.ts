...
class Input extends BaseLookupInput {
    ...
    protected _checkRadioGroup(): boolean {
        return this._suggestSettingsOptions.some((item) => {
            return item.editorTemplateName === 'Controls-ListEnv/filterPanelExtEditors:RadioGroupEditor';
        });
    }
    ...
    protected _notifyFilterSource(filterDescription: IFilterItem[], additionalState): void {
