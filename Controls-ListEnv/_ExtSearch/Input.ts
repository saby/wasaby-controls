...
const RESET_SERACH_STATE = { searchValue: '', searchInputValue: '' };
...
class Input extends Control {
    ...
    protected _beforeMount(options: ISearchSuggestOptions): void {
    ...
    protected _beforeUpdate(options: ISearchSuggestOptions): void {
        if (
        ...
        if (optionsType === 'list') {
            ...
            listOptionsItems.forEach((item, index) => {
                ...
                listOptions[item.name] = {
                    ...
                    viewMode: editorOptions.viewMode,
                    editorTemplateName: item.editorTemplateName,
                    editorViewMode: item.viewMode,
                    category: item.category,
                    searchNavigationMode: editorOptions.searchNavigationMode,
                };
            });
            return listOptions;
        }
    ...
    protected _addItem(item: Model, tabsSelectedKey?: Key): void {
        ...
        this._notifyFilterSource(filterDescription, RESET_SERACH_STATE);
    }
