...
import { getDatesByFilterItem, FilterDescription } from 'Controls/filter';
...
function getSelectedItem(
    ...
    return DEFAULT_PERIODS.concat(props.userPeriods || []).find(({ key }) => {
 ...
 * @mixes Controls/filterDateRangeEditor:IPeriodsConfig
...
export default React.forwardRef(function CountFilter(props: IFilterCounter, ref): JSX.Element {
    ...
    const [value, setValue] = React.useState(() => {
        ...
        if (selectedValue) {
            const item = getSelectedItem(props, selectedValue);
            return {
                selectedKey: selectedValue,
                textValue: getTextValue(props, item, selectedValue),
            };
        }
    });
