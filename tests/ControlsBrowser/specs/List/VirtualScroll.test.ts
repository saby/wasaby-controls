...
describe('Controls/list:View - VirtualScroll', () => {
    ...
    it('контент, расположенный над списком, должен исчезать/появляться при скролле', async () => {
        ...
        await openPage('Controls-demo/list_new/VirtualScroll/VirtualScrollContainer/Index');
        ...
        await expect(virtualScrollContainerPage.listTopBlock()).not.toBeDisplayed();
    ...
    it('При скролле данные удаляются и добавляются в DOM', () => {
        return async () => {
            ...
            await expect(virtualScrollContainerPage.listTopBlock()).not.toBeDisplayed();
            await expect(virtualScrollContainerPage.listBottomBlock()).not.toBeDisplayed();

            await scrollList(listView, 'Запись #', 104, 200, 5);
            await expect(virtualScrollContainerPage.listTopBlock()).not.toBeDisplayed();
            await expect(virtualScrollContainerPage.listBottomBlock()).toBeDisplayed();
    ...
    it('эмуляция скролла контактов', async () => {
        ...
        await openPage('Controls-demo/list_new/VirtualScroll/DifferentHeights/Contacts/Index');
    ...
    it('Эмуляция скролдла в реестре задач', async () => {
        ...
        await openPage('Controls-demo/list_new/VirtualScroll/DifferentHeights/Tasks/Index');
    ...
    it('виртуальный скроллинг работает на записях с одинаковыми высотами', async () => {
        ...
        await openPage('Controls-demo/list_new/VirtualScroll/ConstantHeights/Default/Index');
    ...
    it('виртуальный скроллинг работает на записях малой высоты', async () => {
        ...
        await openPage('Controls-demo/list_new/VirtualScroll/ConstantHeights/SmallDialog/Index');
    ...
    it('работает подскролл к записи при виртуальном скроллинге', async () => {
        ...
        await openPage('Controls-demo/list_new/VirtualScroll/ConstantHeights/ScrollToItem/Index');
