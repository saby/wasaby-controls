...
describe('Controls-DataEnv/abstractList:Initializer', () => {
    ...
    describe('ViewMode.', () => {
        it('Если при наличии поискового запроса передан viewMode не search, падает ошибка и устанавливается viewMode: search', async () => {
            ...
            expect(mockConsole.errors[0]).toBe(
                'ПРИКЛАДНАЯ ОШИБКА использования Controls-DataEnv/abstractList (ListSlice/Фабрика списка)!\n' +
                    'Неверная конфигурация опции viewMode!\n' +
