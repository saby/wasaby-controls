import { checkIsBaseSize } from 'Controls-editors/_sizeEditor/_utils/functions';
import { changeSize, changeAspectRatio } from 'Controls-editors/_sizeEditor/changeSize';
...
describe.skip('Controls-editors/_sizeEditor/changeSize', () => {
    ...
    describe('changeSize', () => {
        ...
        it('change width with not base unit and aspectRatio', () => {
            ...
            expect(changeSize(BaseSizes.width, 'auto', value)).toEqual({
                ...value,
                aspectRatio: 0,
                width: 'auto',
            });
