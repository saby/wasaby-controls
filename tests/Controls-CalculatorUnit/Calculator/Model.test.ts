...
describe('Controls-Calculator/_view/Model/View', () => {
    describe('.handleKey()', () => {
        ...
        const cases = [
            ...
            {
                name: 'Дробное число не переходит в экспоненциальную форму',
                expression: ['439703.40251572', plus, '1', equals],
                result: '439704.40251572',
            },
            {
                name: 'Перевод в экспоненциальную форму дробного числа',
                expression: ['439704.40251572', plus, '1000000', equals],
                result: '1.43970e+6',
            },
        ];
