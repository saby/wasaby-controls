...
define([
   ...
   describe('Controls/_tabs/Buttons', function () {
      ...
      describe('_beforeUpdate', () => {
         ...
         beforeEach(function () {
            tabs = new tabsMod.TabsButtonsForTests();
      ...
      it('prepareItemSelected', function () {
         ...
         const tabs = new tabsMod.TabsButtonsForTests();
      ...
      it('_beforeMount with received state', function () {
         var tabs = new tabsMod.TabsButtonsForTests(),
            receivedState = {
               items: [{ id: '1' }],
               itemsArray: [{ id: '1' }],
