   ...
   describe('Controls/_tabs/Buttons', function () {
      ...
      it('prepareItemSelected', function () {
         var item = {
            ...
            expected =
               'controls-Tabs__item_view_selected controls-text-secondary',
            expected2 =
               'controls-Tabs__item_state_default controls-text-secondary',
      ...
      describe('_prepareItemStyles', () => {
         ...
         it('number width restrictions', () => {
            ...
            expect(styleValue.includes(`max-width: ${item.maxWidth}px`)).toBe(
               true
            );
            expect(styleValue.includes(`min-width: ${item.minWidth}px`)).toBe(
               true
            );
         });
         it('percent width restrictions', () => {
            ...
            expect(styleValue.includes('flex-shrink: 0')).toBe(true);
            expect(styleValue.includes(`max-width: ${item.maxWidth}`)).toBe(
               true
            );
            expect(styleValue.includes(`min-width: ${item.minWidth}`)).toBe(
               true
            );
         });
      });
