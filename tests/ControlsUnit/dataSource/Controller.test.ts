...
function getControllerWithHierarchy(
...
describe('Controls/dataSource:SourceController', () => {
    describe('getState', () => {
        it('getState after create controller', () => {
            ...
            expect(
                controllerState.parentProperty === parentProperty
            ).toBeTruthy();
            ...
            expect(
                controllerState.keyProperty === 'testKeyProperty'
            ).toBeTruthy();
        });
    ...
    describe('load', () => {
        ...
        it('load with prefetchProxy in options', async () => {
            ...
            expect(
                (loadedItems as RecordSet).at(0).get('title') === 'Sasha'
            ).toBeTruthy();

            loadedItems = await controller.load('down');
            expect((loadedItems as RecordSet).getCount() === 2).toBeTruthy();
            expect(
                (loadedItems as RecordSet).at(0).get('title') === 'Aleksey'
            ).toBeTruthy();
        });
        ...
        it('load call with direction update items', async () => {
            ...
            expect(
                controller.getItems().at(0).get('title') === 'Sasha'
            ).toBeTruthy();

            await controller.load('down');
            expect(controller.getItems().getCount() === 4).toBeTruthy();
            expect(
                controller.getItems().at(2).get('title') === 'Aleksey'
            ).toBeTruthy();
        });
        ...
        it('load with multiNavigation', async () => {
            ...
            expect(
                (loadedItems as RecordSet).getCount() === pageSize
            ).toBeTruthy();

            await controller.load('down');
            expect(
                controller.getItems().getCount() === allItemsCount
            ).toBeTruthy();
        ...
        it('load with direction returns error', () => {
            ...
            return controller.reload().then(() => {
                ...
                return controller.load('down').catch(() => {
                    expect(controller.getItems().getCount() === 1).toBeTruthy();
                    expect(
                        controller.getLoadError() instanceof Error
                    ).toBeTruthy();
                    ...
                    return controller.load('down').then(() => {
                        expect(
                            controller.getItems().getCount() === 2
                        ).toBeTruthy();
                    });
                });
            });
        ...
        it('load with selectFields', async () => {
            ...
            await controller.reload();
            expect(
                controller.getItems().at(0).get('key') !== undefined
            ).toBeTruthy();
            expect(
                controller.getItems().at(0).get('title') === undefined
            ).toBeTruthy();
        });
        ...
        it('load with childrenProperty', async () => {
            ...
            expect(items.getRecordById(1).get('children').getCount()).toEqual(
                1
            );
        });
    ...
    describe('getKeyProperty', () => {
        it('keyProperty from source', () => {
            ...
            expect(
                sourceController.getKeyProperty() === 'testKeyProperty'
            ).toBeTruthy();
        });
    ...
    describe('hasMoreData', () => {
        ...
        it('hasMoreData for not loaded folder', () => {
            ...
            expect(
                !controller.hasMoreData('down', 'anyFolderKey')
            ).toBeTruthy();
    ...
    describe('hasLoaded', () => {
        it('hasLoaded without navigation', async () => {
            ...
            await controller.reload();
            expect(controller.hasLoaded('anyTestKey')).toBeTruthy();
        });
    ...
    describe('update', () => {
        it('source reject on update', async () => {
            ...
            const notifyStub = jest
                .spyOn(controller, '_notify')
                .mockClear()
                .mockImplementation();
            await controller
                .update(controller.getItems().at(0))
                .catch((error) => {
                    return error;
                });
