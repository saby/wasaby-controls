...
describe('Controls/dataSource/Controller/NodeHistoryId', () => {
    ...
    it('should consider nodeHistoryType=group', async () => {
        ...
        expect(stubStore).toHaveBeenCalledWith(['group_0'], 'GROUP_NODE_HISTORY_ID');
    });
    ...
    it('should consider nodeHistoryType=node', async () => {
        ...
        expect(stubStore).toHaveBeenCalledWith(['node_3'], 'ONLY_NODE_HISTORY_ID');
    });
    ...
    it('should consider nodeHistoryType=all', async () => {
        ...
        expect(stubStore).toHaveBeenCalledWith(['group_0', 'node_3'], 'ONLY_NODE_HISTORY_ID');
    });
