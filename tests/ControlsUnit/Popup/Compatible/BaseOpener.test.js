...
define(['Controls/compatiblePopup', 'Core/CompoundContainer'], function (
   ...
   describe('Controls/compatiblePopup:BaseOpener', function () {
      ...
      it('prepareNotificationConfig', function () {
         ...
         expect(cfg.template).toEqual('Controls/compatiblePopup:OldNotification');
         expect(cfg.componentOptions.template).toEqual(template);
         expect(cfg.componentOptions.templateOptions).toEqual(cfg.templateOptions);
      ...
      it('_prepareConfigForNewTemplate', function () {
         ...
         expect(newConfig.componentOptions.templateOptions).toEqual(config.templateOptions);
         expect(newConfig.componentOptions.template).toEqual(
            'Controls/Popup/Compatible/CompoundAreaForOldTpl/CompoundArea'
         );
         expect(newConfig.template).toEqual('Controls/compatiblePopup:CompoundAreaNewTpl');
         expect(newConfig.animation).toEqual('off');
         expect(newConfig.componentOptions.onResultHandler).toEqual(newConfig.onResultHandler);
         expect(newConfig.componentOptions.onCloseHandler).toEqual(newConfig.onCloseHandler);
         ...
         expect(newConfig.componentOptions.templateOptions.minWidth).toEqual(newConfig.minWidth);
         expect(newConfig.componentOptions.templateOptions.maxWidth).toEqual(1200);
         expect(newConfig.componentOptions.templateOptions.width).toEqual(newConfig.width);
