define(['Controls/popup', 'i18n!ControlsUnits'], (popup, rk) => {
   ...
   it('getIndicatorConfig', () => {
      ...
      standartCfg.id = '123';
      expect(standartCfg).toEqual(popup.BaseOpener.util.getIndicatorConfig(indicatorId));
      const cfg = {
         indicatorConfig: {
            message: 'Error',
            delay: 0
      ...
      expect(newConfig).toEqual(popup.BaseOpener.util.getIndicatorConfig(indicatorId, cfg));
   });
