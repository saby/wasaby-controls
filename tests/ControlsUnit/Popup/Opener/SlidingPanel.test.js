      ...
      describe('Controller', () => {
         ...
         describe('getDefaultConfig', () => {
            it('postion bottom', () => {
               ...
               expect(
                  item.popupOptions.className.includes(
                     'controls-SlidingPanel__animation'
                  )
               ).toEqual(true);
               expect(item.popupOptions.slidingPanelData).toEqual({
                  minHeight:
                     item.popupOptions.slidingPanelOptions.heightList[0],
               ...
               expect(item.popupOptions.hasOwnProperty('content')).toEqual(
                  true
               );
            });
         ...
         describe('popupDragStart', () => {
            ...
            it('position top', () => {
               ...
               Controller.popupDragEnd(item);
               expect(height).toEqual(
                  item.popupOptions.slidingPanelOptions.heightList[1]
               );
            });
            it('double drag', () => {
               const item = getPopupItem();
            ...
            it('heightList when drag ended height should moved to closer height step', () => {
               ...
               const heightList =
                  item.popupOptions.slidingPanelOptions.heightList;
         ...
         describe('compatibility min/max height and heightList', () => {
            it('minHeight', () => {
               ...
               expect(SlidingPanelStrategy.getMinHeight(item)).toEqual(
                  minHeight
               );
            ...
            it('maxHeight', () => {
               ...
               expect(SlidingPanelStrategy.getMaxHeight(item)).toEqual(
                  maxHeight
               );
