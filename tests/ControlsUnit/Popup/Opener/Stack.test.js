...
define([
   ...
   describe('Controls/_popup/Opener/Stack', () => {
      ...
      it('Should return correct maximized state', () => {
         ...
         let result =
            popupStrategy.StackController.getMaximizedState(innerItem);
      ...
      it('stack shadow', () => {
         let baseGetItemPosition =
            popupStrategy.StackController._getItemPosition;
         ...
         expect(
            popupStrategy.StackController._stack.at(0).position.hidden
         ).toBe(true);
         expect(
            popupStrategy.StackController._stack.at(1).position.hidden
         ).toBe(true);
         expect(
            popupStrategy.StackController._stack.at(2).position.hidden
         ).toBe(true);
         expect(
            popupStrategy.StackController._stack.at(3).position.hidden
         ).toBe(false);
         expect(
            popupStrategy.StackController._stack.at(4).position.hidden
         ).toBe(false);
         expect(
            popupStrategy.StackController._stack.at(5).position.hidden
         ).toBe(true);
         expect(
            popupStrategy.StackController._stack.at(6).position.hidden
         ).toBe(false);
         ...
         expect(
            popupStrategy.StackController._stack.at(8).position.hidden
         ).toBe(false);
         ...
         expect(
            popupStrategy.StackController._stack.at(9).position.hidden
         ).toBe(false);
         expect(
            popupStrategy.StackController._stack.at(10).position.hidden
         ).toBe(true);
         expect(
            popupStrategy.StackController._stack.at(11).position.hidden
         ).toBe(true);
         expect(
            popupStrategy.StackController._stack.at(12).position.hidden
         ).toBe(false);
         expect(
            popupStrategy.StackController._stack.at(13).position.hidden
         ).toBe(true);
         expect(
            popupStrategy.StackController._stack.at(14).position.hidden
         ).toBe(false);
         expect(
            popupStrategy.StackController._stack.at(15).position.hidden
         ).toBe(false);
      });
      ...
      it('validate Configuration', () => {
         ...
         popupStrategy.StackController._validateConfiguration(
            innerItem,
            'width'
         );
      ...
      it('prepareSize', () => {
         ...
         let result = popupStrategy.StackController._prepareSize(
            storages,
            'width'
         );
      ...
      it('stack state', () => {
         ...
         popupStrategy.StackController.elementAfterUpdatedWrapper(
            itemConfig,
            {}
         );
         expect(itemConfig.popupState).toEqual(
      ...
      it('stack need redraw after created', () => {
         ...
         let updateItemPosition =
            popupStrategy.StackController._updateItemPosition(innerItem);
