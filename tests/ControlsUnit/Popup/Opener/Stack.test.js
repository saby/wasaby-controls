...
define([
   ...
   describe('Controls/_popupStrategy/Stack/Opener/StackContent', () => {
      it('canResize', () => {
         ...
         expect(true).toEqual(stackC._canResize('propStorageIdTest', 100));
         expect(false).toEqual(stackC._canResize(null, 100));
         expect(false).toEqual(stackC._canResize(null, undefined));
         stackC.destroy();
      });
   });
   ...
   describe('Controls/_popup/Opener/Stack', () => {
      ...
      it('stack shadow', () => {
         ...
         expect(popupStrategy.StackController._stack.at(3).position.hidden).toBe(undefined);
         expect(popupStrategy.StackController._stack.at(4).position.hidden).toBe(undefined);
         expect(popupStrategy.StackController._stack.at(5).position.hidden).toBe(true);
         expect(popupStrategy.StackController._stack.at(6).position.hidden).toBe(undefined);
         ...
         expect(popupStrategy.StackController._stack.at(8).position.hidden).toBe(undefined);
         ...
         expect(popupStrategy.StackController._stack.at(12).position.hidden).toBe(undefined);
         expect(popupStrategy.StackController._stack.at(13).position.hidden).toBe(true);
         expect(popupStrategy.StackController._stack.at(14).position.hidden).toBe(undefined);
         expect(popupStrategy.StackController._stack.at(15).position.hidden).toBe(undefined);
      });
