   ...
   describe('Controls/_popup/Opener/Notification', () => {
      ...
      describe('_updatePositions', () => {
         it('should calculate correct coords for popups', () => {
            ...
            let right;
            let bottom;
            NotificationController.default.elementCreated(
               item1,
               containers[1]
            );
            NotificationController.default.elementCreated(
            ...
            right =
               NotificationController.default._stack.at(0).position.right;
            bottom =
               NotificationController.default._stack.at(0).position
                  .bottom;
            ...
            right =
               NotificationController.default._stack.at(1).position.right;
            bottom =
               NotificationController.default._stack.at(1).position
                  .bottom;
            const firstItemHeight =
               NotificationController.default._stack.at(0).height;
            expect(right).toEqual(
               NotificationController.default._historyCoords.right
            );
            expect(bottom).toEqual(
      ...
      describe('popupDragStart', () => {
         it('should calculate correct position after dragNDrop', () => {
            ...
            NotificationController.default.popupDragStart(
               popupItem,
               null,
               offset
            );
         ...
         [
            ...
            it('should not let popup go out of window ' + index, () => {
               ...
               const popupItem =
                  NotificationController.default._stack.at(0);
               const offset = {
                  x: 10,
                  y: 10
               };
      ...
      it('elementCreated', function () {
         ...
         expect(NotificationController.default._stack.getCount()).toEqual(
            1
         );
         expect(NotificationController.default._stack.at(0)).toEqual(
            item1
         );
         ...
         expect(NotificationController.default._stack.at(1)).toEqual(
            item1
         );
      ...
      it('elementUpdated', function () {
         ...
         NotificationController.default.elementUpdated(
            item,
            containers[2]
         );
         expect(NotificationController.default._stack.getCount()).toEqual(
