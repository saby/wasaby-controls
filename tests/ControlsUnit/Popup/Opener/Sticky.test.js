define([
   ...
   describe('Controls/_popup/Opener/Sticky', () => {
      ...
      it('Sticky action on scroll', () => {
         ...
         expect(StickyOpener._actionOnScroll).toEqual('none');

         config.actionOnScroll = 'close';
         StickyOpener._getConfig(config);
         expect(StickyOpener._actionOnScroll).toEqual('close');
      });
      ...
      it('Sticky gets target node', () => {
         ...
         expect(cfg.popupOptions.target._container).toEqual(
         ...
         expect(cfg.popupOptions.target).toEqual(
            StickyController._getTargetNode(cfg)
         );
      ...
      it('Sticky fix position', () => {
         ...
         let position = StickyStrategy._calculatePosition(
            cfg,
            targetCoords,
            'vertical'
         );
      ...
      it('checkOverflow', () => {
         ...
         result = StrategyInstance._checkOverflow(
            { direction: {} },
            {},
            position,
            'horizontal'
         ...
         result = StickyStrategy._checkOverflow(
            { direction: {} },
            {},
            position,
            'horizontal'
      ...
      it('revertPosition outsideOfWindow', () => {
         ...
         let result = StickyStrategy._calculatePosition(
            popupCfg,
            { leftScroll: 0 },
            'horizontal'
         );
      ...
      it('calculatePosition with float position(overflow < 1px)', () => {
         ...
         StickyStrategy._calculatePosition(
            popupCfg,
            targetCoordinates,
            'vertical'
         );
      ...
      it('restrictive container', () => {
         ...
         StickyStrategy._calculateRestrictionContainerCoords(
            popupCfg,
            position
         );
