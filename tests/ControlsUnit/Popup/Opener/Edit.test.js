 ...
 */
define(['Controls/popup', 'Types/collection', 'Types/deferred', 'Types/entity'], (
   popup,
   collection,
   defferedLib
) => {
   ...
   describe('Controls/_popup/Opener/Edit', () => {
      ...
      it('get config', () => {
         ...
         expect(config.templateOptions.entityKey).toEqual('123');
      ...
      it('onResult', () => {
         ...
         editOpener._loadSynchronizer = () => {
            return new defferedLib.Deferred().callback();
         };
      ...
      it('synchronize', (done) => {
         ...
         let def = new defferedLib.Deferred();
