define([
   ...
   'Core/core-clone',
   'Application/Env'
], (historyMod, collection, entity, sourceLib, util, clone, Env) => {
   describe('History Source', () => {
      ...
      describe('getSourceByMeta', function () {
         it('$_pinned', function () {
            ...
            hS = hSource._getSourceByMeta(
               meta,
               hSource._$historySource,
               hSource._$originSource
            );
      ...
      describe('checkHistory', function () {
         ...
         it('getItems', async function () {
            ...
            expect(historySource.getItems().getRawData()).toEqual(items);
         });
         ...
         it('_private:getFrequentIds', function () {
            let frequentIds = hSource._getFrequentIds(
               hSource._$history.frequent,
               ['5']
            );
         ...
         it('_private:getRecentIds', function () {
            let recentIds = hSource._getRecentIds(
               hSource._$history.recent,
               ['5'],
               ['6', '4']
            );
      ...
      describe('check source original methods', function () {
         ...
         it('serialization', function () {
            ...
            expect(
               configClone.source instanceof historyMod.Source
            ).toBeTruthy();
         });
