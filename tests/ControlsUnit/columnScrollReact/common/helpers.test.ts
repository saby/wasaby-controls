...
describe('ControlsUnit/columnScrollReact/common/helpers', () => {
    ...
    describe('УТИЛИТЫ ПОЗИЦИИ СКРОЛА.', () => {
        ...
        describe('getPrevPagePosition', () => {
            POSITION_AND_WIDTHS_TEST_CASES.forEach(
                (testCase, testCaseIndex) => {
                    describe(`testCase #${testCaseIndex}`, () => {
                        testCase.currentPositions.forEach(
                            (position, positionIndex) => {
                                it(`position=${position}`, () => {
                                    expect(
                                        ...
                                        testCase.expected.getPrevPagePosition[
                                            positionIndex
                                        ]
                                    );
                                });
                            ...
                            (position, positionIndex) => {
                                it(`position=${position}`, () => {
                                    expect(
                                        ...
                                        testCase.expected.getNextPagePosition[
                                            positionIndex
                                        ]
                                    );
                                });
        ...
        describe('getLimitedPosition', () => {
            POSITION_AND_WIDTHS_TEST_CASES.forEach(
                (testCase, testCaseIndex) => {
                    describe(`testCase #${testCaseIndex}`, () => {
                        testCase.unlimitedPositions.forEach(
                            (position, positionIndex) => {
                                it(`position=${position}`, () => {
                                    expect(
                                        getLimitedPosition(
                                        ...
                                        testCase.expected.getLimitedPosition[
                                            positionIndex
                                        ]
                                    );
                                });
                    ...
                    describe(`testCase #${testCaseIndex}`, () => {
                        testCase.currentPositions.forEach(
                            (position, positionIndex) => {
                                it(`position=${position}`, () => {
                                    expect(
                                        getTransformCSSRule(position)
                                    ).toEqual(
                                        testCase.expected.getTransformCSSRule[
                                            positionIndex
                                        ]
                                    );
                                });
                    ...
                    describe(`testCase #${testCaseIndex}`, () => {
                        testCase.currentPositions.forEach(
                            (position, positionIndex) => {
                                it(`position=${position}`, () => {
                                    expect(
                                        getTransformCSSRuleReact(position)
                                    ).toEqual(
                                        testCase.expected
                                            .getTransformCSSRuleReact[
                                            positionIndex
