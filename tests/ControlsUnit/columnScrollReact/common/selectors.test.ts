import {
    DEFAULT_SELECTORS,
    getSelectorsState,
} from 'Controls/_columnScrollReact/common/selectors';
    ...
    it('DEFAULT_SELECTORS', () => {
        expect(DEFAULT_SELECTORS).toEqual({
            ...
            FIXED_TO_LEFT_EDGE_ELEMENT:
                'js-controls-ColumnScrollReact_offsetForFixed',
            HIDE_ALL_FIXED_ELEMENTS:
                'js-controls-ColumnScrollReact_hideFixedElements',
            NOT_DRAG_SCROLLABLE:
                'js-controls-ColumnScrollReact_notDragScrollable',
            ROOT_TRANSFORMED_ELEMENT:
                'js-controls-ColumnScrollReact_root-scroll-transform',
        });
    });
    ...
    describe('getSelectorsState.', () => {
        ...
        it('with any classes, without GUID.', () => {
            expect(
                ...
                FIXED_ELEMENT:
                    'js-controls-ColumnScrollReact_fixed_1212-134432-2311214',
                ...
                ROOT_TRANSFORMED_ELEMENT:
                    'js-testRootTransformed_1212-134432-2311214',
            });
        });
        ...
        it('with all classes, without GUID.', () => {
            expect(
                ...
                NOT_DRAG_SCROLLABLE:
                    'js-TestNot-drag-scrollable_661-1-1-611-61-155-7',
                ROOT_TRANSFORMED_ELEMENT:
                    'js-testRootTransformed_661-1-1-611-61-155-7',
            });
        });
    });
});
