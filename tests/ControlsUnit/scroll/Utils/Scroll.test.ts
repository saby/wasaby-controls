...
describe('Controls/_scroll/Utils/Scroll', () => {
    ...
    describe('getScrollPositionByState', () => {
        [
            ...
            it(`test ${i}. direction ${test.direction}`, () => {
                const container = {};
                expect(getScrollPositionByState(test.state, test.direction)).toBe(test.position);
            });
        });
    });
    ...
    describe('getViewportSizeByState', () => {
        [
            ...
            it(`test ${i}. direction ${test.direction}`, () => {
                const container = {};
                expect(getViewportSizeByState(test.state, test.direction)).toBe(test.size);
            });
        });
    });
    ...
    describe('getContentSizeByState', () => {
        [
            ...
            it(`test ${i}. direction ${test.direction}`, () => {
                const container = {};
                expect(getContentSizeByState(test.state, test.direction)).toBe(test.size);
            });
        });
    });
    ...
    describe('getScrollPositionTypeByState', () => {
        [
            ...
            it(`test ${i}. direction ${test.direction}`, () => {
                const container = {};
                expect(getScrollPositionTypeByState(test.state, test.direction)).toBe(
                    test.scrollPositionType
                );
            });
        });
    });
