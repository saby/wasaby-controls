...
describe('Controls/scroll:Container', () => {
    ...
    describe('_afterMount', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(component._stickyController, 'init').mockClear().mockImplementation();
            jest.spyOn(component, '_switchInitialScrollPosition').mockClear().mockImplementation();
            component._children = {
                content: {
        ...
        it("should't init sticky header controller on not touch devices", () => {
            jest.spyOn(component, '_updateScrollbarsPadding').mockClear().mockImplementation();
    ...
    describe('shadowMode', () => {
        ...
        [
            ...
            it(`${test.shadowMode}, canScroll ${test.canScroll}`, () => {
                ...
                expect(component._isOptimizeShadowEnabled).toBe(test.isOptimizeShadowEnabled);
                expect(component._optimizeShadowClass).toBe(test.optimizeShadowClass);
    ...
    describe('_updateState', () => {
        ...
        describe('shadows', () => {
            it('should update shadows models if optimized shadows are enabled and there are sticky headers', () => {
                ...
                expect(component._shadows.top.isStickyHeadersShadowsEnabled()).toBe(false);
                component._updateState({
                    ...state,
                    scrollTop: 10,
                });
                expect(component._shadows.top.isStickyHeadersShadowsEnabled()).toBe(true);
            });
        });
    ...
    describe('_updateShadowVisibility', () => {
        ...
        it('should stop event propagation', () => {
            ...
            jest.spyOn(component, '_updateStateAndGenerateEvents').mockClear().mockImplementation();
        ...
        it('should`t update models if shadow visibility does not changed', () => {
            ...
            expect(component._shadows.updateVisibilityByInnerComponents).not.toHaveBeenCalled();
        });
    ...
    describe('_positionChangedHandler', () => {
        it('should update scrollTop, scrollOrientation: "vertical"', () => {
            ...
            jest.spyOn(component, '_updateStateAndGenerateEvents').mockClear().mockImplementation();
            component._positionChangedHandler({}, 10, SCROLL_DIRECTION.VERTICAL);
