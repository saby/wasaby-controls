...
describe('Controls/scroll:ContainerBase', () => {
    ...
    describe('_componentDidMount', () => {
        ...
        it('should restore flex-direction and set scrollTop to end. vertical: end.', () => {
            ...
            expect(
                control._children.content.classList.remove
            ).toHaveBeenCalledWith(
                'controls-Scroll-ContainerBase__scrollPosition-vertical-end'
            );
            expect(
                control._children.content.classList.add
            ).toHaveBeenCalledWith(
                'controls-Scroll-ContainerBase__scrollPosition-regular'
            );
        });
    ...
    describe('_afterMount', () => {
        it('should initialize models', () => {
            ...
            jest.spyOn(control._resizeObserver, 'observe')
                .mockClear()
                .mockImplementation();
    ...
    describe('_afterUpdate', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(control, '_generateEvent')
                .mockClear()
                .mockImplementation();
        ...
        it('should update state from dom if resize observer unavailable', () => {
            ...
            jest.spyOn(control, '_observeContentSize')
                .mockClear()
                .mockImplementation();
            jest.spyOn(control, '_unobserveDeleted')
                .mockClear()
                .mockImplementation();
            ...
            jest.spyOn(control, '_isHorizontalScroll')
                .mockClear()
                .mockImplementation();
            control._afterMount();
            ...
            expect(control._scrollModel.clientHeight).toBe(
                content.clientHeight
            );
            expect(control._scrollModel.scrollHeight).toBe(
        ...
        it('should update observed containers', () => {
            ...
            jest.spyOn(control._resizeObserver, 'observe')
                .mockClear()
                .mockImplementation();
            jest.spyOn(control._resizeObserver, 'unobserve')
                .mockClear()
                .mockImplementation();
    ...
    describe('_beforeUnmount', () => {
        it('should destroy models and controllers', () => {
            ...
            jest.spyOn(control._resizeObserver, 'terminate')
                .mockClear()
                .mockImplementation();
            control._dnDAutoScroll = {
                destroy: () => {
    ...
    describe('_resizeObserverCallback', () => {
        it("should't update state if container is invisible", () => {
            ...
            jest.spyOn(control, '_updateStateAndGenerateEvents')
                .mockClear()
                .mockImplementation();
            ...
            expect(
                control._updateStateAndGenerateEvents
    ...
    describe('_registerIt', () => {
        it('should register on all registrars', () => {
            ...
            jest.spyOn(control._registrars.scrollStateChanged, 'register')
                .mockClear()
                .mockImplementation();
            jest.spyOn(control._registrars.listScroll, 'register')
                .mockClear()
                .mockImplementation();
            jest.spyOn(control._registrars.customscroll, 'register')
                .mockClear()
                .mockImplementation();
            jest.spyOn(control, '_onRegisterNewComponent')
                .mockClear()
                .mockImplementation();
            control._scrollModel = {};
            ...
            expect(
                control._registrars.scrollStateChanged.register
            ).toHaveBeenCalled();
            expect(control._registrars.listScroll.register).toHaveBeenCalled();
            expect(
                control._registrars.customscroll.register
            ).toHaveBeenCalled();
        });
    });
    ...
    describe('_unRegisterIt', () => {
        it('should unregister on all registrars', () => {
            ...
            expect(
                control._registrars.scrollStateChanged.unregister
            ).toHaveBeenCalled();
            expect(
                control._registrars.listScroll.unregister
            ).toHaveBeenCalled();
            expect(
                control._registrars.customscroll.unregister
            ).toHaveBeenCalled();
        });
    });
    ...
    describe('scrollTo edge', () => {
        [
            ...
            it(`should scroll to ${test.position}`, () => {
                ...
                control._scrollModel._scrollTop =
                    control._children.content.scrollTop;
                control._scrollModel._scrollHeight =
                    control._children.content.scrollHeight;
                control._scrollModel._clientHeight =
                    control._children.content.clientHeight;
                control._scrollModel._scrollLeft =
                    control._children.content.scrollLeft;
                control._scrollModel._scrollWidth =
                    control._children.content.scrollWidth;
                control._scrollModel._clientWidth =
                    control._children.content.clientWidth;

                control[`scrollTo${test.position}`]();

                expect(control._children.content[test.checkProperty]).toBe(
                    test.scrollPosition
                );
            });
        });
    ...
    describe('_onRegisterNewComponent', () => {
        it('should propagate event to registered component', () => {
            ...
            jest.spyOn(
                control._registrars.scrollStateChanged,
                'startOnceTarget'
            )
                .mockClear()
                .mockImplementation();
            ...
            expect(
                control._registrars.scrollStateChanged.startOnceTarget
            ).toHaveBeenCalledWith(registeredControl, 0, 0);
        });
    });
    ...
    describe('_updateState', () => {
        ...
        it('should not update state if unchanged state arrives', () => {
            ...
            jest.spyOn(inst, '_observeContentSize')
                .mockClear()
                .mockImplementation();
            jest.spyOn(inst, '_isHorizontalScroll')
                .mockClear()
                .mockImplementation();
            inst._container = {
                closest: jest.fn().mockReturnValue(false),
    ...
    describe('onRegisterNewListScrollComponent', () => {
        it('should propagate event to registered component', () => {
            ...
            expect(
                control._registrars.listScroll.startOnceTarget
            ).toHaveBeenCalledWith(
                registeredControl,
                'cantScroll',
                expect.anything()
    ...
    describe('_lockScrollPositionUntilKeyboardShown', () => {
        ...
        it('should set value from scroll state', () => {
            ...
            control._lockScrollPositionUntilKeyboardShown();
            expect(control._scrollLockedPosition).toBe(
                control._scrollModel.scrollTop
            );
        });
    });
