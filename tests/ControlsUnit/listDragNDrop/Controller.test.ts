...
describe('Controls/_listDragNDrop/Controller', () => {
    ...
    describe('startDrag', () => {
        it('not pass draggedItem', () => {
            const modelSetDraggedItemsSpy = jest
                .spyOn(model, 'setDraggedItems')
                .mockClear();
    ...
    it('setDragPosition', () => {
        ...
        const modelSetDragPositionSpy = jest
            .spyOn(model, 'setDragPosition')
            .mockClear();
    ...
    it('endDrag', () => {
        const modelResetDraggedItemsCalled = jest
            .spyOn(model, 'resetDraggedItems')
            .mockClear();
        const controller = new DndController(model, null, FlatStrategy);
    ...
    it('canStartDragNDrop', () => {
        ...
        expect(DndController.canStartDragNDrop(false, true, false, event)).toBe(
            true
        );
        expect(DndController.canStartDragNDrop(false, true, true, event)).toBe(
            false
        );
