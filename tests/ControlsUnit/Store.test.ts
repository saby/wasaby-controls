...
describe('Controls/Store', () => {
    const runContextTests = () => {
        it('without context', () => {
            ...
            expect(Store.getState().myValue as unknown as string).toEqual(
                'myValue'
            );
        });
        ...
        it('with context', () => {
            ...
            expect(
                Store.getState().myValueWithContext as unknown as string
            ).toEqual('myValue');
        });
        ...
        it('change context', () => {
            ...
            expect(
                Store.getState().myValueChangeContext as unknown as string
            ).toEqual('myFirstValue');
