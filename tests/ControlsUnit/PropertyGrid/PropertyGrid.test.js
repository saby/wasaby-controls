   ...
   describe('Controls/_propertyGrid/PropertyGrid', () => {
      ...
      describe('_updatePropertyValue', () => {
         it('with different propertyValue type', () => {
            ...
            let resultPropertyValue = ViewInstance._updatePropertyValue(
               propertyValue,
               'test',
               2
            );
            ...
            propertyValue = {};
            resultPropertyValue = ViewInstance._updatePropertyValue(
               propertyValue,
               'test',
               2
            );
      ...
      describe('displayFilter', () => {
         ...
         it('filtered groupItem', () => {
            ...
            const resultDisplay = ViewInstance._displayFilter(
               group.getContents()
            );
