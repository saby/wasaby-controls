import { PropertyGridCollection, Constants } from 'Controls/propertyGrid';
import { Model } from 'Types/entity';
import { default as IPropertyGridItem } from 'Controls/_propertyGridBase/IProperty';
...
describe('Controls/propertyGrid:CollectionItem', () => {
    ...
    describe('getItemPaddingClasses', () => {
        it('returns padding classes for editor with jumpingLabel', () => {
            ...
            expect(
                classes.indexOf('controls-PropertyGrid__editor_spacingLeft_default') !== -1
            ).toBeTruthy();
        });
    });
