...
describe('Controls/itemActions/Controller/MenuButton', () => {
    ...
    describe('itemActions', () => {
        ...
        it('+actions with different showTypes, =display menu button', () => {
            ...
            expect(actionsOf1.showed[actionsOf1.showed.length - 1].isMenu).toBe(
                true
            );
        });
        ...
        it('+only toolbar actions, =hide menu button', () => {
            ...
            expect(actionsOf1).not.toBeNull();
            expect(
                actionsOf1.showed[actionsOf1.showed.length - 1].isMenu
            ).not.toBe(true);
        });
        ...
        it('+only one action in menu, =hide menu button', () => {
            ...
            expect(
                actionsOf1.showed[actionsOf1.showed.length - 1].showType
            ).toEqual(TItemActionShowType.MENU);
        });
        ...
        it('+only one menu_toolbar action, =hide menu button', () => {
            ...
            expect(
                actionsOf1.showed[actionsOf1.showed.length - 1].showType
            ).toEqual(TItemActionShowType.MENU_TOOLBAR);
        });
    ...
    describe('SwipeActions', () => {
        ...
        it('+contextMenuConfig.footerTemplate, =display menu button', () => {
            ...
            expect(
                config.itemActions.showed[config.itemActions.showed.length - 1]
                    .isMenu
            ).toBe(true);
        });
