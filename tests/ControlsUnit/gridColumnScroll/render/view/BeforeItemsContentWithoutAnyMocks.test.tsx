...
} from 'Controls/_columnScrollReact/ResizeObserver/ResizeObserverContext';
...
function FakeContextBase(
    ...
    const roContext = React.useMemo<IResizeObserverContext>(
        () => ({
            observe: jest.fn().mockReturnValue(jest.fn()),
        }),
        []
    );

    return (
        <ResizeObserverContext.Provider value={roContext}>
