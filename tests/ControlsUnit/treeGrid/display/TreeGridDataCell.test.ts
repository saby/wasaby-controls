...
describe('Controls/_baseTreeGrid/display/TreeGridDataCell', () => {
    ...
    describe('getWrapperClasses', () => {
        it('master style', () => {
            const expected =
                ' controls-Grid__row-cell controls-Grid__cell_default js-controls-Grid__row-cell js-controls-GridReact__cell controls-Grid__row-cell_default controls-Grid__row-cell_relative ' +
                ...
                'controls-Grid__no-rowSeparator controls-Grid__row-cell_withRowSeparator_size-null ' +
                'controls-ListView__item_contentWrapper controls-Grid__cell_fit ' +
        ...
        it('without multiselect', () => {
            const expected =
                ' controls-Grid__row-cell controls-Grid__cell_default js-controls-Grid__row-cell js-controls-GridReact__cell controls-Grid__row-cell_default controls-Grid__row-cell_relative controls-Grid__row-cell_default_style-default_min_height controls-TreeGrid__row-cell ' +
                'controls-TreeGrid__row-cell_default controls-TreeGrid__row-cell__node controls-Grid__no-rowSeparator' +
                ' controls-Grid__row-cell_withRowSeparator_size-null controls-ListView__item_contentWrapper controls-Grid__cell_fit ' +
        ...
        it('with multiselect && first column', () => {
            ...
            const expected =
                ' controls-Grid__row-cell controls-Grid__cell_default js-controls-Grid__row-cell js-controls-GridReact__cell controls-Grid__row-cell_default controls-Grid__row-cell_relative controls-Grid__row-cell-checkbox controls-Grid__row-cell-checkbox-default controls-Grid__row-cell_default_style-default_min_height controls-Grid__no-rowSeparator ' +
                'controls-Grid__row-cell_withRowSeparator_size-null controls-ListView__item_contentWrapper ' +
                'js-controls-ListView__notEditable js-controls-DragScroll__notDraggable controls-GridView__checkbox controls-GridView__checkbox_position-default ' +
