...
describe('Controls/_treeGridDisplay/TreeGridDataCell', () => {
    ...
    describe('getWrapperClasses', () => {
        it('master style', () => {
            const expected =
                ' controls-Grid__row-cell controls-Grid__cell_default js-controls-Grid__row-cell js-controls-GridReact__cell controls-Grid__row-cell_default ' +
                ...
                'tw-box-border tw-flex tw-h-full tw-max-w-full tw-min-w-0 tw-relative';
        ...
        it('without multiselect', () => {
            const expected =
                ' controls-Grid__row-cell controls-Grid__cell_default js-controls-Grid__row-cell js-controls-GridReact__cell controls-Grid__row-cell_default controls-Grid__row-cell_default_style-default_min_height controls-TreeGrid__row-cell ' +
