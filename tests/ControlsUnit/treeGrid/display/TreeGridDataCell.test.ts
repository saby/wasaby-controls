...
describe('Controls/_treeGrid/display/TreeGridDataCell', () => {
    ...
    describe('getWrapperClasses', () => {
        ...
        it('without multiselect', () => {
            const expected =
                ' controls-Grid__row-cell controls-Grid__cell_default js-controls-Grid__row-cell controls-Grid__row-cell_default controls-Grid__row-cell_relative controls-Grid__row-cell_default_min_height controls-TreeGrid__row-cell ' +
        ...
        it('with multiselect && first column', () => {
            ...
            const expected =
                ' controls-Grid__row-cell controls-Grid__cell_default js-controls-Grid__row-cell controls-Grid__row-cell_default controls-Grid__row-cell_relative controls-Grid__row-cell-checkbox controls-Grid__row-cell-checkbox-default controls-Grid__row-cell_default_min_height controls-Grid__no-rowSeparator ' +
    ...
    describe('getRelativeCellWrapperClasses', () => {
        it('support grid', () => {
            ...
            const cell = treeGridCollection.at(0).getColumns()[1];
            CssClassesAssert.isSame(
                cell.getRelativeCellWrapperClasses('default'),
                expected
            );
        });
