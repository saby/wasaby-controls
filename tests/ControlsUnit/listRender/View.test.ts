...
describe('Controls/_listRender/View', () => {
    ...
    describe('_beforeMount()', () => {
        ...
        it('wraps items recordset into the collection', async () => {
            ...
            expect(view._collection.getSourceCollection()).toBe(defaultCfg.items);
        });
        ...
        it('passes received options to the collection', async () => {
            ...
            expect(view._collection.getDisplayProperty()).toBe(cfg.displayProperty);
        });
    });
    ...
    describe('_itemActionsMenuCloseHandler()', () => {
        ...
        beforeEach(() => {
            ...
            stubClosePopup = jest.spyOn(Sticky, 'closePopup').mockClear().mockImplementation();
        });
    ...
    describe('marker', () => {
        ...
        it('_beforeUpdate', () => {
            ...
            expect(view._collection.getItemBySourceKey(1).isMarked()).toBe(true);
            expect(view._collection.getItemBySourceKey(2).isMarked()).toBe(false);
            expect(view._collection.getItemBySourceKey(3).isMarked()).toBe(false);
        });
        ...
        it('_onItemKeyDown downKey', () => {
            ...
            expect(view._collection.getItemBySourceKey(1).isMarked()).toBe(false);
            expect(view._collection.getItemBySourceKey(2).isMarked()).toBe(false);
            expect(view._collection.getItemBySourceKey(3).isMarked()).toBe(true);
