...
describe('Controls/_listRender/Render', () => {
    ...
    describe('_beforeMount()', () => {
        it('generates unique key prefix', () => {
            ...
            expect(anotherRender._templateKeyPrefix).toBe(
    ...
    it('_canHaveMultiselect()', () => {
        ...
        expect(
            render._canHaveMultiselect({ multiselectVisibility: 'hidden' })
        ).toBe(false);
        expect(
            render._canHaveMultiselect({ multiselectVisibility: 'onhover' })
        ).toBe(true);
        expect(
            render._canHaveMultiselect({ multiselectVisibility: 'visible' })
        ).toBe(true);
    });
