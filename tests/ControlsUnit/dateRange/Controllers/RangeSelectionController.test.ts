        ...
        [
            ...
            it(`should return proper range for options ${JSON.stringify(
                ...
                const component: RangeSelectionController =
                    calendarTestUtils.createComponent(
    ...
    describe('_mouseleaveHandler', () => {
        [
            ...
            it(`should reset hovered item ${JSON.stringify(test)}.`, () => {
                ...
                expect(+component._selectionHoveredValue).toBe(
                    +test.clickedItem
                );
    ...
    describe('_itemKeyDownHandler', () => {
        [
            ...
            it('should choose correct date', () => {
                ...
                expect(date.getFullYear()).toEqual(
                    test.eventOptions.getFullYear()
                );
    ...
    describe('_itemMouseEnter', () => {
        [
            ...
            it('should set hovered value as startValue or endValue if selectionType is quantum or there is rangeSelectedCallback', () => {
                ...
                jest.spyOn(component, '_updateDisplayedRange')
                    .mockClear()
                    .mockReturnValue(true);
                component._itemMouseEnter(test.item);
                if (test.displayedStartValue) {
                    expect(test.displayedStartValue).toEqual(
                        component._selectionHoveredValue
                    );
                } else {
                    expect(test.displayedEndValue).toEqual(
                        component._selectionHoveredValue
                    );
                }
