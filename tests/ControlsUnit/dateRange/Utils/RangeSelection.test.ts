    ...
    describe('prepareSelectionClass', () => {
        ...
        [
            ...
            },
            {
                ...
                css: 'controls-RangeSelection',
            },
            {
                args: {
                    date,
                    startValue: date,
                    endValue: new Date(2019, 4, 3),
                },
                css: 'controls-RangeSelection__selected',
            },
            {
                args: {
                    date,
                    startValue: new Date(2018, 3, 1),
                    endValue: dateUtils.getEndOfMonth(date),
                },
                css: 'controls-RangeSelection__selected',
            },
            {
