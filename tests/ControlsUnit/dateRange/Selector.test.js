define([
   'Core/core-merge',
   'Controls/dateRange',
   'Controls/_date/Utils/getPopupClassName'
], function (cMerge, dateRange, getPopupClassName) {
   'use strict';
      ...
      describe('_getFontSizeClass', function () {
         [
            ...
            it(`should return ${test.result} if fontSize: ${test.fontSize}`, function () {
               const fontSizeResult = getPopupClassName.getFontSizeClass(test.fontSize);
