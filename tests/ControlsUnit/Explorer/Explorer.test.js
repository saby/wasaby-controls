define([
   ...
   describe('Controls.Explorer', function () {
      ...
      it('_private._getTopRoot', function () {
         ...
         expect(explorer._getTopRoot([], cfg.parentProperty, cfg.root)).toEqual(
            'rootFromOptions'
         );
         ...
         expect(
            explorer._getTopRoot(breadcrumbs, cfg.parentProperty, cfg.root)
         ).toEqual('rootFromBreadCrumbs');
      ...
      it('setViewMode', async () => {
         ...
         expect(instance._viewName).toEqual(
            instance._constants.VIEW_NAMES.tree
         );
         ...
         expect(instance._viewName).toEqual(
            instance._constants.VIEW_NAMES.search
         );
         expect(instance._viewModelConstructor).toEqual(
         ...
         expect(instance._viewName).toEqual(
            instance._constants.VIEW_NAMES.tile
         );
         expect(instance._viewModelConstructor).toEqual(
      ...
      describe('DragNDrop', function () {
         ...
         it('_hoveredCrumbChanged', function () {
            ...
            expect(innerExplorer._hoveredBreadCrumb).toEqual(
               hoveredBreadCrumb.get('id')
            );
         });
      ...
      describe('restore position navigation when going back', () => {
         it('step back', () => {
            ...
            // ['Title1', 1]
            expect(explorer._navigation.sourceConfig.position).toEqual([
               'Title1',
               1
            ]);
