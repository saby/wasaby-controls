...
describe('Controls/_multiselection/SelectionStrategy/Flat', () => {
    ...
    describe('isAllSelected', () => {
        it('not empty model', () => {
            let selection = { selected: [null], excluded: [] };
            expect(strategy.isAllSelected(selection, false, 3, null)).toBe(
                true
            );
            ...
            expect(strategy.isAllSelected(selection, true, 3, null)).toBe(
                false
            );
            ...
            expect(
                strategy.isAllSelected(selection, false, 3, null, false)
            ).toBe(false);
