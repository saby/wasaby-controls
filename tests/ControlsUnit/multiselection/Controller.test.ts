    ...
    describe('readonly checkboxes', () => {
        ...
        describe('setSelection', () => {
            it('all are selected', () => {
                ...
                expect(readonlyModel.getItemBySourceKey(1).isSelected()).toBe(
                    true
                );
                expect(readonlyModel.getItemBySourceKey(2).isSelected()).toBe(
                    false
                );
                expect(readonlyModel.getItemBySourceKey(3).isSelected()).toBe(
                    false
                );
            });
