...
describe('Controls/_lookup/SelectedCollection/Utils', () => {
    ...
    it('getItemGridColumnStyles', () => {
        expect(getItemGridColumnStyles(0, 'twoColumns')).toEqual({msGridColumn: 1, gridColumn: 1});
        expect(getItemGridColumnStyles(1, 'twoColumns')).toEqual({msGridColumn: 2, gridColumn: 2});
        expect(getItemGridColumnStyles(2, 'twoColumns')).toEqual({msGridColumn: 1, gridColumn: 1});
        expect(getItemGridColumnStyles(3, 'twoColumns')).toEqual({msGridColumn: 2, gridColumn: 2});
