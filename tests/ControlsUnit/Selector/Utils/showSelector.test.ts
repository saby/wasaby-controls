...
describe('Controls/_lookup/showSelector', () => {
    ...
    it('showSelector without params', () => {
        ...
        expect(lastPopupOptions.templateOptions.selectedTab).toEqual('defaultTab');
    ...
    it('showSelector with templateOptions', () => {
        ...
        expect(isShowSelector).toBeTruthy();
        expect(lastPopupOptions.templateOptions.selectedTab).toEqual('Employees');
    ...
    it('showSelector with handlers on templateOptions', () => {
        ...
        expect(
            typeof lastPopupOptions.templateOptions.handlers.onSelectComplete === 'function'
        ).toBeTruthy();
        expect(
            typeof lastPopupOptions.templateOptions.handlers.onTestAction === 'function'
        ).toBeTruthy();
    });
    ...
    it('showSelector with isCompoundTemplate:false', () => {
        const baseController = getBaseController();
        const stub = jest.spyOn(baseController, '_selectCallback').mockClear().mockImplementation();
