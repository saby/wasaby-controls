define(['Controls/_lookupPopup/List/Container', 'Types/entity'], function (Container, entity) {
   const ListContainer = Container.default;
   ...
   describe('Controls/_lookupPopup/Container', function () {
      it('getItemActivateResult', function () {
         ...
         itemKey = 4;
         expect(ListContainer._private.getItemActivateResult(itemKey, selectedKeys, true)).toEqual([
            [1, 2, 3, 4],
            [4],
            []
         ]);
         ...
         selectedKeys = [];
         itemKey = 1;
         expect(ListContainer._private.getItemActivateResult(itemKey, selectedKeys, false)).toEqual(
            [[1], [1], []]
         );
      ...
      it('getMarkedKeyBySelectedKeys', function () {
         ...
         expect(ListContainer._private.getMarkedKeyBySelectedKeys(selectedKeys)).toEqual(null);

         selectedKeys = [1];
         expect(ListContainer._private.getMarkedKeyBySelectedKeys(selectedKeys)).toEqual(1);
      });
      ...
      it('getSelectedKeysFromOptions', function () {
         ...
         expect(ListContainer._private.getSelectedKeysFromOptions(options)).toEqual([]);
         expect(ListContainer._private.getSelectedKeysFromOptions(optionsMultiSelect)).toEqual([
            1, 2, 3
         ]);
      });
      ...
      it('getItemActions', function () {
         ...
         expect(ListContainer._private.getItemActions({}, options)[0].id).toEqual(
            'selector.action'
         );

         options.itemActions = itemActions;
         expect(ListContainer._private.getItemActions({}, options)[0].id).toEqual('test');
         expect(ListContainer._private.getItemActions({}, options)[1].id).toEqual(
            'selector.action'
         );

         options.selectionType = 'leaf';
         options.itemActions = itemActionsEmpty;
         expect(!!ListContainer._private.getItemActions({}, options)[0]).toBe(false);
         options.itemActions = itemActions;
         expect(ListContainer._private.getItemActions({}, options).length).toEqual(1);
      });
      ...
      it('getItemActionVisibilityCallback', function () {
         ...
         expect(ListContainer._private.getItemActionVisibilityCallback({})({ id: 'test' })).toBe(
            true
         );

         // With user callback
         expect(
            ListContainer._private.getItemActionVisibilityCallback({
      ...
      it('itemActivate', function () {
         ...
         ListContainer._private.itemActivate(self, selectedItem);
