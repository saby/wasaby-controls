define(['Controls/dragnDrop'], function (dragnDrop) {
   ...
   describe('Controls.DragNDrop.Container', function () {
      ...
      container._controllerClass._registers.documentDragStart.start =
         function () {
            startDetected = true;
         };

      container._controllerClass._registers.documentDragEnd.start =
         function () {
            endDetected = true;
         };
      ...
      it('updateDraggingTemplate', function () {
         ...
         container._updateDraggingTemplate(
            null,
            draggingTemplateOptions,
            draggingTemplate
         );
