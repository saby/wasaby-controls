define(['Controls/dragnDrop', 'UI/Events'], function (dragnDrop, Vdom) {
   'use strict';
   ...
   describe('Controls.DragNDrop.Controller', function () {
      ...
      it('isDragStarted', function () {
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 25, 10))
         ).toBe(true);
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 20, 15))
         ).toBe(true);
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 20, 5))
         ).toBe(true);
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 15, 10))
         ).toBe(true);
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 24, 10))
         ).toBe(false);
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 20, 14))
         ).toBe(false);
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 16, 10))
         ).toBe(false);
         expect(
            dragnDrop.Container._isDragStarted(startEvent, createNativeEvent('mousemove', 20, 6))
         ).toBe(false);
         expect(
      ...
      it('class controls-DragNDrop__notDraggable does`t start drag', function () {
         ...
         jest.spyOn(controller, '_registerMouseMove').mockClear().mockImplementation();
      ...
      it('getDragOffset', function () {
         expect(
            dragnDrop.Container._getDragOffset(startEvent, createNativeEvent('mousemove', 40, 20))
         ).toEqual({ x: -20, y: -10 });
         expect(
            dragnDrop.Container._getDragOffset(startEvent, createNativeEvent('mousemove', 0, 0))
         ).toEqual({ x: 20, y: 10 });
         expect(
            dragnDrop.Container._getDragOffset(startEvent, createNativeEvent('mousemove', -10, -10))
         ).toEqual({ x: 30, y: 20 });
      });
      ...
      describe('Controls.DragNDrop.Controller phase', function () {
         ...
         describe('mouse', function () {
            ...
            it('dragMove', function () {
               ...
               expect(events.join(', ')).toEqual('dragMove, _updateDraggingTemplate');
