...
describe('Controls/_tile/display/mixins/TileItem/Footer', () => {
    describe('shouldDisplayFooterTemplate', () => {
        it('not pass footerTemplate', () => {
            ...
            expect(item.shouldDisplayFooterTemplate('small', null, 'wrapper')).toBe(false);
            expect(item.shouldDisplayFooterTemplate('preview', null, 'content')).toBe(false);
        });
    ...
    describe('getFooterClasses', () => {
        ...
        it('rich', () => {
            const item = new TileCollectionItem();
            CssClassesAssert.include(item.getFooterClasses({ itemType: 'rich' }), '');
        });
