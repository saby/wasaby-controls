...
describe('Controls/filter:FilterDescription', () => {
    ...
    it('isEqualItems', () => {
        let filter1 = { id: '1' } as IFilterItem;
        let filter2 = { id: '1' } as IFilterItem;
        expect(FilterDescription.isEqualItems(filter1, filter2)).toBe(true);

        filter1 = { id: '2' } as IFilterItem;
        ...
        filter1 = { id: 'test', name: 'test' } as IFilterItem;
        filter2 = { name: 'test' } as IFilterItem;
        expect(FilterDescription.isEqualItems(filter1, filter2)).toBe(true);

        filter1 = { id: 'test' } as IFilterItem;
        filter2 = { name: 'test' } as IFilterItem;
        expect(FilterDescription.isEqualItems(filter1, filter2)).toBe(true);
    });
