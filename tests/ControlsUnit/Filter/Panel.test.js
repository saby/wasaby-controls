define([
   ...
   describe('FilterPanelVDom', function () {
      ...
      var config = {
            headingCaption:
               FilterPopupDetailPanel.default.getDefaultOptions().headingCaption
         },
         items = [
            {
               name: 'list',
      ...
      it('Init::historyItems isReportPanel', function () {
         ...
         expect(hSource.historySource._$recent).toBe(
            history.Constants.MAX_HISTORY_REPORTS + 1
         );
      });
      ...
      it('Init::historyItems fail loading', function (done) {
         ...
         panel2
            ._loadHistoryItems('TEST_PANEL_HISTORY_ID')
      ...
      it('_applyHistoryFilter', function () {
         ...
         expect({ name: 'test', value: false, visibility: true }).toEqual(
            innerItems[2]
         );
      ...
      it('recordSet', function () {
         ...
         expect(panel2._isChanged).toBe(true);
      ...
      describe('Check history', function () {
         ...
         it('filterHistoryItems', function () {
            ...
            expect(
               panel._filterHistoryItems('historyId', historyItems).getCount()
            ).toEqual(1);
            expect(
               panel
                  ._filterHistoryItems('historyId', wrongHistoryItems)
                  .getCount()
            ).toEqual(0);
         });
         ...
         it('filterHistoryItems with removeOutdatedFiltersFromHistory=false', function () {
            ...
            expect(
               panel
                  ._filterHistoryItems('historyId', wrongHistoryItems, false)
                  .getCount()
            ).toEqual(1);
         });
         ...
         it('_reloadHistoryItems', function () {
            ...
            filter.HistoryUtils.getHistorySource({
               historyId: 'TEST_RELOAD_ITEMS_HISTORY_ID'
            }).getItems = () => {
               return historyItems;
            };
            panel._reloadHistoryItems('TEST_RELOAD_ITEMS_HISTORY_ID');
            expect(panel._historyItems.getCount()).toEqual(1);
         });
      });
