define([
   ...
   describe('FilterHistoryList', function () {
      ...
      it('get text', function () {
         ...
         expect(textArr[0]).toEqual(
            'Past month, Due date, Ivanov K.K., Unread, On department'
         );
      ...
      it('_getStringHistoryFromItems', function () {
         ...
         let historyString = list._getStringHistoryFromItems(
            historyItems,
            resetValues
         );
      ...
      it('_getEditDialogOptions', function () {
         ...
         var editableOptions = list._getEditDialogOptions(
            favoriteItem,
            null,
            'savedText'
         );
