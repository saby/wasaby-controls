define([
   ...
   describe('Filter:View', function () {
      ...
      it('openDetailPanel', async function () {
         let view = getView(defaultConfig),
            popupOptions;
      ...
      it('_openPanel', async function () {
         ...
         expect(popupOptions.className).toBe(
            'controls-FilterView-SimplePanel__buttonTarget-popup controls-FilterView-SimplePanel__buttonTarget-popup-right-withHeader controls_popupTemplate_theme-default controls_filter_theme-default controls_filterPopup_theme-default controls_dropdownPopup_theme-default'
         );
         ...
         expect(popupOptions.className).toBe(
            'controls-FilterView-SimplePanel-popup controls-FilterView-SimplePanel-popup_left controls-FilterView-SimplePanel-popup_top-withHeader controls_popupTemplate_theme-default controls_filter_theme-default controls_filterPopup_theme-default controls_dropdownPopup_theme-default'
         );
      ...
      it('_resolveItems check _hasResetValues', function () {
         ...
         expect(view._needShowResetCross(items)).toBe(true);

         items = [
            { name: '1', value: '' },
            { name: '2', value: '' }
         ];
         expect(view._needShowResetCross(items)).toBe(false);
      });
      ...
      describe('View hierarchyList', function () {
         ...
         it('loadItemsFromSource', async () => {
            ...
            view._configs.document.sourceController = {
               ...
               load: jest.fn().mockRejectedValue(new Error('rejected'))
            };
