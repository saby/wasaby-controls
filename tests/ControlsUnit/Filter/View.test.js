   ...
   describe('Filter:View', function () {
      ...
      it('_openPanel', async function () {
         ...
         expect(popupOptions.className).toBe(
            'controls-FilterView-SimplePanel__buttonTarget-popup controls-FilterView-SimplePanel__buttonTarget-popup-withHeader controls_popupTemplate_theme-default controls_filter_theme-default controls_filterPopup_theme-default controls_dropdownPopup_theme-default'
         );
         ...
         expect(popupOptions.className).toBe(
            'controls-FilterView-SimplePanel-popup controls-FilterView-SimplePanel-popup-withHeader controls_popupTemplate_theme-default controls_filter_theme-default controls_filterPopup_theme-default controls_dropdownPopup_theme-default'
         );
