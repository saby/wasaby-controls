import { ControllerClass } from 'Controls/filterOld';
import { Memory } from 'Types/source';
import { RecordSet } from 'Types/collection';
import { object } from 'Types/util';
import 'Controls-ListEnv/filterPrefetch';
...
describe('Controls/filterOld:ControllerClass', () => {
    ...
    it('updateFilterItems with filterChangedCallback', () => {
        ...
        expect(
            filterController.getFilterButtonItems()[1].textValue === 'filterChangedTextValue'
        ).toBeTruthy();
        expect(
            filterController.getFilterButtonItems()[1].editorOptions.filter.date === 'test'
        ).toBeTruthy();
        expect(filterButtonItems[1].editorOptions.filter.date === null).toBeTruthy();
        expect(filterController.getFilter().testId2 === 'filterChangedValue').toBeTruthy();
    ...
    it('updateFilterItems with filterVisibilityCallback', () => {
        ...
        filterController.updateFilterItems(newFilterItems);
        expect(filterController.getFilterButtonItems()[1].visibility === false).toBeTruthy();
    });
    ...
    describe('setFilterDescription', () => {
        it('setFilterDescription', () => {
            ...
            expect(controller.getFilterButtonItems()).toEqual(newFilterDescription);
        });
    });
