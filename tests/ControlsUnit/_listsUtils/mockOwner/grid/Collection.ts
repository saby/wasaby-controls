...
export interface ICollectionMockParams extends IBaseCollectionMockParams {
    ...
    groupViewMode?: IGridCollectionOptions['groupViewMode'];
...
export function getCollectionMock<TData extends unknown>(
    ...
    return {
        ...
        hasDragScrolling: () => {
            return extractParam(params, 'hasDragScrolling', false);
        },
        isFullGridSupport: () => {
        ...
        getGroupViewMode: () => {
            return extractParam(params, 'groupViewMode', 'default');
        },
        getBackgroundStyle: () => {
            return extractParam(params, 'backgroundStyle', undefined);
        },
