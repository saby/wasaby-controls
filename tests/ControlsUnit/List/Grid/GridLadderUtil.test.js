define([
   ...
   describe('Controls/display:GridLadderUtil', function () {
      ...
      it('getStickyColumn', function () {
         ...
         expect(
            Util.getStickyColumn({
               columns: [{ title: 'title' }, { title: 'photo', stickyProperty: 'photo' }]
            })
      ...
      it('shouldAddStickyLadderCell', function () {
         ...
         expect(Util.shouldAddStickyLadderCell([])).toBe(false);
         expect(Util.shouldAddStickyLadderCell([], { index: 1, property: 'sticky' })).toBe(true);
         expect(
         ...
         expect(Util.shouldAddStickyLadderCell([{ title: 'photo', stickyProperty: 'photo' }])).toBe(
            true
         );
         expect(
      ...
      it('stickyLadderCellsCount', function () {
         ...
         expect(Util.stickyLadderCellsCount([])).toBe(0);
         expect(Util.stickyLadderCellsCount([], { index: 1, property: 'sticky' })).toBe(1);
         expect(
         ...
         expect(Util.stickyLadderCellsCount([{ title: 'photo', stickyProperty: 'photo' }])).toBe(1);
         expect(
            Util.stickyLadderCellsCount([{ title: 'photo', stickyProperty: ['date', 'time'] }])
         ).toBe(2);
         expect(
      ...
      it('should return z-index styles for sticky column', () => {
         ...
         expect(ladder.stickyLadder[0].first.headingStyle).toEqual('grid-row: span 1; z-index: 4;');
      });
