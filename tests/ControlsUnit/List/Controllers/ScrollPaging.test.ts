    ...
    describe('pagingMode numbers', () => {
        describe('other methods', () => {
            ...
            it('getScrollTopByPage numbersState = up', () => {
                ...
                expect(spInstance.getScrollTopByPage(1, scrollParams)).toEqual(
                    0
                );
                expect(spInstance.getScrollTopByPage(2, scrollParams)).toEqual(
                    50
                );
                expect(spInstance.getScrollTopByPage(3, scrollParams)).toEqual(
                    100
                );
            });
            it('getScrollTopByPage numbersState = down', () => {
                ...
                expect(spInstance.getScrollTopByPage(50, scrollParams)).toEqual(
                    200
                );
                expect(spInstance.getScrollTopByPage(49, scrollParams)).toEqual(
                    150
                );
                expect(spInstance.getScrollTopByPage(48, scrollParams)).toEqual(
                    100
                );
            });
        });
