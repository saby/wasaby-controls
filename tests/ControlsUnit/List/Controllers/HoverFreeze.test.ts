...
import HoverFreeze, {
    IHoverFreezeOptions,
} from 'Controls/_baseList/Controllers/HoverFreeze';
...
function mockViewContainer(
    itemActionsHeight: number,
    hoverContainerRect: object
): HTMLElement {
    return {
        querySelector: () => {
            return {
...
describe('Controls/list/HoverFreeze', () => {
    ...
    describe('startFreezeHoverTimeout', () => {
        beforeEach(() => {
            cfg = {
                viewContainer: mockViewContainer(
                    itemActionsHeight,
                    hoverContainerRect
                ),
    ...
    describe('virtualScroll', () => {
        it('should start freeze timer with correct start index', () => {
            const viewContainer = mockViewContainer(
                itemActionsHeight,
                hoverContainerRect
            );
            cfg = {
