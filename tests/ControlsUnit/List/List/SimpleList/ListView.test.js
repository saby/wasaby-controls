...
define(['Controls/list', 'Types/collection', 'Controls/display'], function (
   ...
   describe('Controls.List.ListView', function () {
      ...
      it('should not notify about resize by hoveredItemChanged, activeItemChanged or markedKeyChanged', function () {
         ...
         var stubControlResize = jest
            .spyOn(listView, '_notify')
            .mockClear()
            .mockImplementation();
         ...
         expect(stubControlResize).not.toHaveBeenCalledWith(
            'controlResize',
            [],
            { bubbling: true }
         );
      ...
      it('_onItemMouseEnter', function () {
         ...
         expect(lv._notify).toHaveBeenCalledWith('itemMouseEnter', [
            fakeItemData,
            fakeEvent
         ]);
      ...
      describe('_onItemContextMenu', function () {
         ...
         it('itemContextMenu event should fire if contextMenuVisibility: true and the list has no editing items', function () {
            ...
            expect(notifyStub).toHaveBeenCalledWith('itemContextMenu', [
               {},
               {},
               false
            ]);
      ...
      it('debounced setHoveredItem', function () {
         ...
         expect(lv1._notify).toHaveBeenCalledWith(
            'hoveredItemChanged',
            expect.anything()
         );
         expect(lv1._notify).toHaveBeenCalledWith(
         ...
         expect(lv2._notify).toHaveBeenCalledWith(
            'hoveredItemChanged',
            expect.anything()
         );
         expect(lv2._notify).toHaveBeenCalledWith(
