...
describe('tileImageUtil', () => {
    describe('getImageClasses', () => {
        expect(getImageClasses(IMAGE_FIT.CONTAIN)).toBe(' controls-TileView__image-contain');
        expect(getImageClasses(IMAGE_FIT.COVER)).toBe(' controls-TileView__image-cover');
    });
    ...
    describe('getImageSize', () => {
        ...
        describe('none and contain image fit', () => {
            it('returns image original sizes', () => {
                let imageSizes = getImageSize(200, 300, 'static', 1, 1, 'contain');
