define([
   ...
   describe('Dropdown/Controller', () => {
      ...
      it('handleClose', function () {
         ...
         dropdownController._handleClose({ searchValue: 'searchValue' });
      ...
      it('_private::getSourceController', async function () {
         ...
         dropdownController._sourceController = null;
         ...
         const sourceController = dropdownController._getSourceController(historyConfig);
         expect(
            cInstance.instanceOfModule(
               sourceController.getState().source,
               'Controls/historyOld:Source'
            ) ||
               cInstance.instanceOfModule(sourceController.getState().source, 'Types/source:Local')
         ).toBe(true);
         expect(dropdownController._sourceController).toBeTruthy();
      });
