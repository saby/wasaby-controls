import ViewModel, { IExtendedViewModelOptions } from 'Controls/_filterPanelExtendedItems/ViewModel';
import { IFilterItem } from 'Controls/filter';

function getViewModel(viewModelOptions: Partial<IExtendedViewModelOptions>): ViewModel {
