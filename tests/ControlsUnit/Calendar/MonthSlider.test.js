define([
   ...
   describe('Controls/Calendar/MonthSlider', function () {
      ...
      it('should create correct model when component initialized', function () {
         let self = calendarTestUtils.createComponent(MonthSlider, defaultOptions);
         expect(self._month).toStrictEqual(defaultOptions.month);
      });
      ...
      describe('_setMonth', function () {
         it('should update model when new month is set', function () {
            ...
            self._setMonth(newMonth, true, formatter.Date);
            expect(self._month).toStrictEqual(defaultOptions.month);
         });
         ...
         it('should set "slideLeft" animation if month has increased', function () {
            let component = calendarTestUtils.createComponent(MonthSlider, defaultOptions);
            component._setMonth(
               new Date(defaultOptions.month.getFullYear(), defaultOptions.month.getMonth() + 1),
               true,
               formatter.Date
            );
         ...
         it("shouldn't throw error in _setCurrentMonth", function () {
            ...
            expect(component._month.getMonth()).toEqual(options.month.getMonth());
         });
         it("shouldn't throw error in _slideMonth", function () {
            ...
            expect(component._month.getMonth()).toEqual(
               options.month.getMonth() > 0 ? options.month.getMonth() - 1 : MAX_MONTH_NUMBER
            );
         });
      ...
      describe('_updateArrowButtonVisible', () => {
         [
            ...
            it('should set correctArrowButtonVisible', () => {
               ...
               expect(test.shouldShowPrevArrow).toBe(component._prevArrowButtonVisible);
               expect(test.shouldShowNextArrow).toBe(component._nextArrowButtonVisible);
            });
         });
      });
