...
describe('Controls/_toolbar/View', () => {
    ...
    describe('_isShowToolbar', function () {
        ...
        it('Test1', function () {
            ...
            expect(toolbar._isShowToolbar(item, toolbar._parentProperty)).toBe(true);
        });
        it('Test2', function () {
            const item = new Record({
                rawData: {
            ...
            expect(toolbar._isShowToolbar(item, toolbar._parentProperty)).toBe(false);
        });
        it('Test3', function () {
            const item = new Record({
                rawData: {
    ...
    describe('publicMethod', function () {
        ...
        it('click item with menu', async function () {
            ...
            toolbar = new View({});
            const itemConfig = toolbar._getMenuConfigByItem.call(toolbar, itemWithMenu);
            if (
                standart.caption === itemConfig.templateOptions.headConfig.caption &&
        ...
        it('item popup config generation', () => {
            ...
            toolbar = new View({});
            expect(JSON.stringify(toolbar._getMenuConfigByItem.call(testSelf, testItem))).toEqual(
        ...
        it('get button template options by item', function () {
            ...
            const modifyItem = {
                ...
                _underlineVisible: undefined,
                _viewMode: 'ghost',
                readOnly: true,
            };
            toolbar = new View({});
            expect(toolbar._getSimpleButtonTemplateOptionsByItem(item)).toEqual(modifyItem);
            toolbar = null;
        });
        it('get filled template options by item', function () {
            ...
            toolbar = new View({});
            const modifyItem = toolbar._getSimpleButtonTemplateOptionsByItem(item);
            expect(modifyItem._iconSize).toBe('s');
            expect(modifyItem._height).toBe('default');
            expect(modifyItem._iconOptions.icon).toBe('icon-RoundPlus');
            toolbar = null;
        });
        ...
        it('_setMenuSource', async () => {
            ...
            expect(toolbar._menuSource._$data.query instanceof RecordSet).toBe(true);
            toolbar = null;
        });
