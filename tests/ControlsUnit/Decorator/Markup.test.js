...
define([
   ...
   var simpleNode = ['span', 'text'],
      ...
      decoratedLinkFirstChildNode = [
         ...
         [
            'img',
            {
               ...
               alt: 'https://ya.ru',
               src: '/test/?method=LinkDecorator.DecorateAsSvg&params=eyJTb3VyY2VMaW5rIjoiaHR0cHM6Ly95YS5ydSJ9&id=0&srv=1'
            }
         ]
      ],
      ...
      decoratedLinkHtml =
         '<span class="LinkDecorator__wrap"><a class="LinkDecorator__linkWrap" rel="noreferrer noopener" href="https://ya.ru" target="_blank"><img class="LinkDecorator__image" alt="https://ya.ru" src="/test/?method=LinkDecorator.DecorateAsSvg&amp;params=eyJTb3VyY2VMaW5rIjoiaHR0cHM6Ly95YS5ydSJ9&amp;id=0&amp;srv=1" /></a></span>';
   ...
   describe('Controls.markup.Markup.Converter', function () {
      ...
      describe('htmlToJson', function () {
         it('no first tag', function () {
            var html =
               'some text without tag <span>and some text in tag</span> dot';
            var json = [
               [],
               'some text without tag ',
               ['span', 'and some text in tag'],
               ' dot'
            ];
         ...
         it('version', function () {
            expect(
               decorator.Converter.htmlToJson('<p>No attributes</p>')
            ).toEqual([['p', { version: currentVersion }, 'No attributes']]);
            expect(
               decorator.Converter.htmlToJson(
                  '<p style="text-align: center;">With attributes</p>'
               )
            ).toEqual([
               [
                  'p',
            ...
            expect(decorator.Converter.htmlToJson('just a string')).toEqual([
               [],
               'just a string'
            ]);
         });
         ...
         it('long html', function () {
            ...
            expect(
               decorator.Converter.htmlToJson('<p>' + text + '</p>')
            ).toEqual([['p', { version: currentVersion }, text]]);
         }, 1000);
      });
      ...
      describe('jsonToHtml', function () {
         ...
         beforeEach(function () {
            ...
            jest
               .spyOn(ILogger, 'error')
               .mockClear()
               .mockImplementation(errorFunction);
         });
         afterEach(function () {
         ...
         it('onError attribute', function () {
            ...
            expect(typeof vdomTemplate[0].props.children.props.onError).toBe(
               'function'
            );
         });
         ...
         it('escape', function () {
            ...
            if (UIBase.Control.UNSAFE_isReact !== true) {
               ...
               expect(
                  vdomTemplate[0].children[0].hprops.attributes.title
               ).toEqual('"&lt;<>');
            }
         });
         it('without escape', () => {
            const json = [
               'p',
               { style: 'background: url("source.com/param1=1&param2=2");' }
            ];
            equalsHtml(
               decorator.Converter.jsonToHtml(json),
         ...
         it('no XSS', function () {
            var json = [
                  ...
                  [
                     ...
                     [
                        'a',
                        { href: 'tel:+78142332211', rel: 'nofollow' },
                        '+7(814)-233-22-11'
                     ]
                  ],
                  [
         ...
         it('with linkDecorate resolver', function () {
            ...
            var json = [
               ...
               [
                  ...
                  linkNode,
                  '   ',
                  decorator.Converter.deepCopyJson(linkNode)
               ],
               ['p', linkNode, 'text '],
               ['pre', 'https://ya.ru\ntext'],
               ['p', linkNode, ['br'], 'text'],
            ...
            var htmlArray = [
               ...
               '<p><span class="LinkDecorator__wrap"><a class="LinkDecorator__linkWrap" rel="noreferrer noopener" href="https:\\\\ya.ru\\som&quot;e" target="_blank"><img class="LinkDecorator__image" alt="https:\\\\ya.ru\\som&quot;e" src="/test/?method=LinkDecorator.DecorateAsSvg&amp;params=eyJTb3VyY2VMaW5rIjoiaHR0cHM6XFxcXHlhLnJ1XFxzb21cImUifQ%3D%3D&amp;id=0&amp;srv=1" /></a></span></p>',
            ...
            for (var i = 0; i < json.length; ++i) {
               var checkHtml = decorator.Converter.jsonToHtml(
                  json[i],
         ...
         it('with highlight resolver', function () {
            ...
            var html =
               ...
               '</div>';
            equalsHtml(
               decorator.Converter.jsonToHtml(
                  json,
         ...
         it('with innerText resolver', function () {
            ...
            expect(
               decorator.Converter.jsonToHtml(json, decorator.InnerText)
            ).toEqual(
         ...
         it('with noOuterTag resolver', function () {
            ...
            var html =
               ...
               '</p><p><span>text</span></p>';
            equalsHtml(
               decorator.Converter.jsonToHtml(json, decorator.noOuterTag),
               html
            );
            expect(
               decorator.Converter.jsonToHtml([], decorator.noOuterTag)
            ).toEqual('');
         });
         ...
         describe('emojies', function () {
            it('Простые эмодзи внутри одной текстовой ноды', function () {
               ...
               expect(children[0].props).toEqual({
                  className: 'LinkDecorator__emoji',
                  children: '😀😀'
               });
            ...
            it('Эмодзи, декорированная ссылка и tagResolver', function () {
               ...
               const expectedResult =
                  '<div><div><p><span class="LinkDecorator__emoji">😀</span><span><span class="LinkDecorator__wrap"><a href="https://online.sbis.ru/" class="LinkDecorator__linkWrap" target="_blank" rel="noreferrer noopener">';
   ...
   describe('Controls.markup.Markup.resources.linkDecorateUtils', function () {
      describe('isDecoratedLink', function () {
         it('decorated link node', function () {
            expect(
               linkDecorateUtils.isDecoratedLink(
                  'span',
                  decoratedLinkFirstChildNode
               )
            ).toBe(true);
         ...
         it('decorated link node two classes', function () {
            var decoratedLinkFirstChildNodeCopy =
               decorator.Converter.deepCopyJson(decoratedLinkFirstChildNode);
            decoratedLinkFirstChildNodeCopy[1].class += ' anotherClass';
            expect(
               linkDecorateUtils.isDecoratedLink(
                  'span',
                  decoratedLinkFirstChildNodeCopy
               )
            ).toBeTruthy();
         });
      ...
      describe('getUndecoratedLink', function () {
         it('undecorate a decorated link', function () {
            expect(
               linkDecorateUtils.getUndecoratedLink(decoratedLinkFirstChildNode)
            ).toEqual(linkNode);
         });
      });
      ...
      describe('wrapLinksInString', function () {
         it('correct link on local file - 1', () => {
            ...
            var checkResultNode = linkDecorateUtils.wrapLinksInString(
               parentNode[1],
               parentNode
            );
         ...
         it('multiple links', () => {
            var parentNode = [
               'p',
               'C:\\test.html text C:\\test\\hello.html text'
            ];
            var goodResultNode = [
               [],
               [
         ...
         it('long link', () => {
            ...
            const checkStr = linkDecorateUtils.wrapLinksInString(
               parentNode[1],
               parentNode
            );
         ...
         it('Скобка в конце ссылки является частью ссылки', () => {
            ...
            const result = linkDecorateUtils.wrapLinksInString(
               parentNode[1],
               parentNode
            );
      ...
      describe('removeHrefAfterExtraBracket', () => {
         it('Скобка в конце ссылки является частью ссылки', () => {
            ...
            const result = linkDecorateUtils.removeHrefAfterExtraBracket(
               link,
               true
            );
      ...
      describe('normalizeLink', function () {
         ...
         var protocolLinkPrefixPattern = `(?:${protocolNames.join(
            '|'
         )})`.replace(/[a-z]/g, (m) => {
         ...
         it('correct link with protocol without wrapping in tag a', function () {
            ...
            while (linkParseResult !== null) {
               var [match, , , linkToCheck, linkPrefix, linkDomain, ending] =
                  linkParseResult;
               if (linkToCheck) {
      ...
      describe('needDecorate', function () {
         ...
         it('not a link', function () {
            ...
            expect(
               linkDecorateUtils.needDecorate(parentNode[1], parentNode)
            ).toBe(false);
         });
         ...
         it('need decorate uncoded href', function () {
            var href =
               'https://pre-test-online.sbis.ru/call/user/любитель_взг/';
            var parentNode = [
               'div',
               [
                  'a',
         ...
         it('only good links, separated by space chars', function () {
            ...
            for (i = 1; i < parentNode.length; ++i) {
               checkNeedDecorate = linkDecorateUtils.needDecorate(
                  parentNode[i],
                  parentNode
               );
         ...
         it('clear fake needDecorate attribute - 1', function () {
            ...
            var firstNeedDecorate = linkDecorateUtils.needDecorate(
               parentNode[1],
               parentNode
            );
            var secondNeedDecorate = linkDecorateUtils.needDecorate(
               parentNode[2],
               parentNode
            );
            ...
            expect(
               firstAttributesObject.hasOwnProperty('__needDecorate')
            ).toBeFalsy();
            expect(
               secondAttributesObject.hasOwnProperty('__needDecorate')
            ).toBeFalsy();
         });
