import { HighlightFunctions } from 'Controls/baseDecorator';
const prepareParsedText = HighlightFunctions.prepareParsedText;
...
describe('Controls.baseDecorator.Highlight', function () {
    it('Value of parsedText without highlight', function () {
        ...
        ]).toEqual(prepareParsedText(options));
        ...
        ]).toEqual(prepareParsedText(newOptions));
        ...
        ]).toEqual(prepareParsedText(newOptions2));
    });
    ...
    describe('Parsed of the text.', function () {
        ...
        it('strictSearch is false', () => {
            expect(
                prepareParsedText({
                    value: 'Какой-то набранный, какой-то текст, какой-то длинны',
                    highlightMode: 'word',
                    highlightedValue: ['Какой-то', 'текст'],
                })
            ).toEqual([
                { type: 'highlight', value: 'Какой-то' },
                { type: 'plain', value: ' набранный, ' },
                { type: 'highlight', value: 'какой-то' },
                { type: 'plain', value: ' текст, ' },
                { type: 'highlight', value: 'какой-то' },
                { type: 'plain', value: ' длинны' },
            ]);
        });

        it('strictSearch is true', () => {
            expect(
                prepareParsedText({
                    value: 'Какой-то набранный, какой-то текст, какой-то длинны',
                    highlightMode: 'word',
                ...
                { type: 'highlight', value: 'Какой-то' },
                { type: 'plain', value: ' набранный, какой-то ' },
                { type: 'highlight', value: 'текст' },
                { type: 'plain', value: ', какой-то длинны' },
            ]);
        });

        it('strictSearch is true and search result not null', () => {
            expect(
                prepareParsedText({
                    value: 'Какой-то набранный, длинный, непонятный, бессмысленный текст',
                    highlightMode: 'word',
                    highlightedValue: ['Какой-то', 'текст'],
                    strictSearch: true,
                })
                ...
                { type: 'highlight', value: 'Какой-то' },
                { type: 'plain', value: ' набранный, длинный, непонятный, бессмысленный ' },
                { type: 'highlight', value: 'текст' },
            ]);
        });

        it('strictSearch is true and search result is center not null', () => {
            expect(
                prepareParsedText({
                    value: 'Там какой-то набранный, длинный, непонятный, бессмысленный текст',
                    highlightMode: 'word',
                    highlightedValue: ['какой-то', 'текст'],
                    strictSearch: true,
                })
            ).toEqual([
                { type: 'plain', value: 'Там ' },
                { type: 'highlight', value: 'какой-то' },
                { type: 'plain', value: ' набранный, длинный, непонятный, бессмысленный ' },
                { type: 'highlight', value: 'текст' },
            ]);
        ...
        it('strictSearch is true and search result is null', () => {
            expect(
                prepareParsedText({
                    value: 'Какой-то набранный, длинный, непонятный, бессмысленный текст',
                    highlightMode: 'word',
                    highlightedValue: ['текст', 'Какой-то'],
                    strictSearch: true,
                })
            ).toEqual([
                {
