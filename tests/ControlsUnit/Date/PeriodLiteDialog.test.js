      ...
      describe('_changeYear', function () {
         [
            ...
            },
            {
               year: new Date(2005, 0),
               displayedRanges: [
                  [null, new Date(2002, 12, 0)],
                  [new Date(2004, 12, 0), null]
               ],
               chooseHalfyears: false,
               chooseMonths: false,
               chooseQuarters: false,
            ...
            },
            {
               ...
               displayedRanges: [
                  [null, new Date(2017, 12, 0)],
                  [new Date(2019, 12, 0), new Date(2020, 12, 0)],
                  [new Date(2022, 12, 0), new Date(2033, 12, 0)]
               ],
               chooseHalfyears: false,
               chooseMonths: false,
               chooseQuarters: false,
            ...
            },
            {
               ...
               displayedRanges: [[new Date(2007, 12, 0), null]],
               chooseHalfyears: false,
               chooseMonths: false,
               chooseQuarters: false,
               delta: -1,
            ...
            },
            {
               ...
               displayedRanges: [
                  [null, new Date(2022, 12, 0)],
                  [new Date(2025, 12, 0), new Date(2027, 12, 0)],
                  [new Date(2030, 12, 0), null]
               ],
               chooseHalfyears: false,
               chooseMonths: false,
               chooseQuarters: false,
