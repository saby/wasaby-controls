         ...
         it('should create correct month model', function () {
               ...
               data = [
                  {
                     ...
                     tooltip: formatDate.date(
                        new Date(year, 0, 1),
                        formatDate.date.FULL_HALF_YEAR
                     ),
                     quarters: [
                        {
                           date: new Date(year, 0),
                           name: 'I',
                           fullName: formatDate.date(
                              new Date(year, 0, 1),
                              'QQQQr'
                           ),
                           tooltip: formatDate.date(
            ...
            for (let [halfyearIndex, halfyear] of data.entries()) {
               for (let [
                  quarterIndex,
                  quarter
               ] of halfyear.quarters.entries()) {
                  for (let [monthIndex, month] of quarter.months.entries()) {
                     expect(
                        DateUtils.Base.isDatesEqual(
                           component._getYearModel(year, entity.Date)[
                              halfyearIndex
                           ].quarters[quarterIndex].months[monthIndex].name,
                           month.name
                        )
                     ).toBeTruthy();
                  }
      ...
      describe('_onYearClick', function () {
         it('should generate sendResult event', function () {
            ...
            expect(component._notify).toHaveBeenCalledWith(
               'sendResult',
               [
                  new entity.applied.Date(2000, 0, 1),
                  new entity.applied.Date(2000, 11, 31)
               ],
               { bubbling: true }
            );
         });
      ...
      describe('_expandPopup', function () {
         ...
         describe('_getExpandButtonVisibility', function () {
            it('should not show expand button on mobile', () => {
               ...
               component._isExpandButtonVisible =
                  component._getExpandButtonVisibility(component._options);
      ...
      describe('_onHalfYearClick', function () {
         it('should generate sendResult event', function () {
            ...
            expect(component._notify).toHaveBeenCalledWith(
               ...
               [
                  new entity.applied.Date(2000, 0, 1),
                  new entity.applied.Date(2000, 5, 30)
               ],
               { bubbling: true }
            );
         });
      ...
      describe('_onQuarterClick', function () {
         it('should generate sendResult event', function () {
            ...
            expect(component._notify).toHaveBeenCalledWith(
               ...
               [
                  new entity.applied.Date(2000, 0, 1),
                  new entity.applied.Date(2000, 2, 31)
               ],
               { bubbling: true }
            );
         });
      ...
      describe('_changeYear', function () {
         [
            ...
            it('should update year', function () {
               ...
               expect(component._position.getFullYear()).toEqual(
                  options.result
               );
               expect(component._notify).toHaveBeenCalledWith('yearChanged', [
                  options.result
               ]);
            });
         });
         ...
         [
            ...
            it('should not update year', function () {
               ...
               component._position = options.year;
               component._changeYear('event', options.delta);
               expect(options.year.getFullYear()).toEqual(
                  component._position.getFullYear()
               );
            });
         });
      });
      ...
      describe('_getYearItemCssClasses', function () {
         [
            ...
            it(`should return "${test.css}". options: ${test.options}, year: ${test.year}`, function () {
               ...
               expect(component._getYearItemCssClasses(test.year)).toContain(
                  test.css
               );
            });
         });
      ...
      describe('_updateArrowButtonsState', () => {
         [
            ...
            it(test.name, () => {
               ...
               expect(test.nextArrowResult).toEqual(
                  component._nextArrowButtonReadOnly
               );
               expect(test.prevArrowResult).toEqual(
                  component._prevArrowButtonReadOnly
               );
            });
         });
      });
