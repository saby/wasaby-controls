...
describe('Controls/_calendar/MonthList/MonthsSource', () => {
    ...
    describe('_getDefaultDisplayedRanges', () => {
        it('should return correct default displayedRanges', () => {
            ...
            expect(dateUtils.isDatesEqual(result[0][0], defaultDisplayedRanges[0][0])).toBe(true);
            expect(dateUtils.isDatesEqual(result[0][1], defaultDisplayedRanges[0][1])).toBe(true);
        });
    });
});
