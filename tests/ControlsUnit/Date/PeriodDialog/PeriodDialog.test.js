   ...
   describe('Controls/Date/PeriodDialog', function () {
      describe('Initialisation', function () {
         ...
         it('should create the correct range models when range passed.', function () {
            ...
            expect(
               dateUtils.Base.isDatesEqual(
                  component._headerRangeModel.startValue,
                  start
               )
            ).toBeTruthy();
            expect(
         ...
         [
            {
               selectionType:
                  dateRange.IDateRangeSelectable.SELECTION_TYPES.range
            },
            {
               selectionType:
                  dateRange.IDateRangeSelectable.SELECTION_TYPES.range,
         ...
         [
            {
               selectionType:
                  dateRange.IDateRangeSelectable.SELECTION_TYPES.quantum,
               ranges: { quarters: [1] }
            },
            {
               selectionType:
         ...
         [
            {
               selectionType:
                  dateRange.IDateRangeSelectable.SELECTION_TYPES.single
            },
            {
               selectionType:
                  dateRange.IDateRangeSelectable.SELECTION_TYPES.range,
         ...
         [
            ...
            it(`should set todayCalendarEnabled to ${
               test.todayCalendarEnabled
            } if options are ${JSON.stringify(test.options)}`, function () {
               const component = calendarTestUtils.createComponent(
                  PeriodDialog.default,
                  test.options
               );
               expect(component._todayCalendarEnabled).toBe(
                  test.todayCalendarEnabled
               );
            });
         });
         ...
         describe('validators', function () {
            it('should create validators list.', function () {
               ...
               expect(Array.isArray(component._startValueValidators)).toBe(
                  true
               );
      ...
      describe('_todayCalendarClick', function () {
         it('should update _displayedDate.', function () {
            ...
            expect(
               dateUtils.Base.isDatesEqual(component._displayedDate, oldDate)
            ).toBeTruthy();
            component._todayCalendarClick();
            expect(
               dateUtils.Base.isMonthsEqual(
                  component._displayedDate,
                  new Date()
               )
            ).toBeTruthy();
      ...
      describe('_onYearsSelectionHoveredValueChanged', function () {
         it('should update range models and displayed day.', function () {
            ...
            expect(
               dateUtils.Base.isDatesEqual(component._displayedDate, date)
            ).toBeTruthy();
         });
      ...
      describe('_monthRangeMonthClick', function () {
         it('should toggle state and update _displayedDate.', function () {
            ...
            expect(
               dateUtils.Base.isDatesEqual(component._displayedDate, newDate)
            ).toBeTruthy();
         });
      });
      ...
      describe('rangeChanged', () => {
         [
            ...
            },
            {
               ...
               endValue: null,
               testName: 'should update range model with nulls',
               resultStartValue: undefined,
               resultEndValue: undefined,
            ...
            it(test.testName, () => {
               ...
               if (
                  ...
                  expect(
                     component._headerRangeModel.startValue.getTime()
                  ).toEqual(test.resultStartValue.getTime());
                  expect(
                     component._headerRangeModel.endValue.getTime()
                  ).toEqual(test.resultEndValue.getTime());
               } else {
                  expect(component._rangeModel.startValue).toEqual(
                     test.resultStartValue
                  );
                  expect(component._rangeModel.endValue).toEqual(
                     test.resultEndValue
                  );
                  expect(component._headerRangeModel.startValue).toEqual(
                     test.resultStartValue
                  );
                  expect(component._headerRangeModel.endValue).toEqual(
                     test.resultEndValue
                  );
               }
            });
      ...
      describe('_keyDownHandler', () => {
         [
            ...
            it(`should call ${test.methodName}`, () => {
               ...
               jest
                  .spyOn(component, test.methodName)
                  .mockClear()
                  .mockImplementation();
         ...
         [
            ...
            it(`should set homeButtonVisible to ${test.todayCalendar} if isIntersecting is ${test.isIntersecting}.`, function () {
               const component = calendarTestUtils.createComponent(
                  ...
                  entry = new scroll.IntersectionObserverSyntheticEntry(
                     { isIntersecting: test.isIntersecting },
                     {}
                  );
               component._currentDayIntersectHandler(null, entry);

               if (test.todayCalendar) {
                  expect(component._todayCalendarEnabled).toBe(true);
               } else {
                  expect(component._todayCalendarEnabled).toBe(false);
               }
            });
         });
      });
      ...
      describe('_inputFocusOutHandler', function () {
         ...
         it('should reset header type if the focus is not on the input fields.', function () {
            const component = calendarTestUtils.createComponent(
               ...
               defaultOptions = calendarTestUtils.prepareOptions(
                  PeriodDialog.default
               );
      ...
      describe('_inputControlHandler', function () {
         [
            ...
            it('should activate adjacent input', function () {
               ...
               component._inputControlHandler(
                  'e',
                  'value',
                  displayValue,
                  selection
      ...
      describe('_monthsRangeSelectionEnded', () => {
         it('should send correct range with rangeSelectedCallback', () => {
            ...
            expect(stubSendResult).toHaveBeenCalledWith(
               formattedStartValue,
               formattedEndValue
            );
         });
