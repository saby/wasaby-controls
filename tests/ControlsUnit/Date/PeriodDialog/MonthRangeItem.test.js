      ...
      describe('Initialisation', function () {
         [
            ...
            it(`should set proper model for options ${JSON.stringify(test.options)}.`, function () {
               ...
               expect(component._monthsSelectionEnabled).toEqual(test.eq.months);
               expect(component._quarterSelectionEnabled).toEqual(test.eq.quarters);
               expect(component._halfyearSelectionEnabled).toEqual(test.eq.halfYears);
