...
describe('Controls/_datePopup/Utils', () => {
    ...
    describe('isMonthStateEnabled', () => {
        [
            ...
            it(`should return ${test.isEnabled} if ${test.options} passed.`, () => {
                expect(datePopupUtils.isMonthStateEnabled(test.options)).toEqual(test.isEnabled);
            });
        });
    });
    ...
    describe('isYearStateEnabled', () => {
        [
            ...
            it(`should return ${test.isEnabled} if ${test.options} passed.`, () => {
                expect(datePopupUtils.isYearStateEnabled(test.options)).toEqual(test.isEnabled);
            });
        });
    });
});
