...
describe('Controls/_form/ControllerBase', () => {
    ...
    it('afterMount', () => {
        ...
        const showMethod = jest.spyOn(FC, '_needShowConfirmation').mockClear().mockImplementation();
    ...
    it('showConfirmDialog', () => {
        ...
        const confirmMethod = jest.spyOn(FC, '_confirmDialogResult').mockClear();
    ...
    it('add/remove validators', () => {
        const FC = new ControllerBase({});
        const addValidator = jest.spyOn(FC._validateController, 'addValidator').mockClear();
        const removeValidator = jest.spyOn(FC._validateController, 'removeValidator').mockClear();
    ...
    it('update successed', () => {
        ...
        return FC.update().then(() => {
            expect(notifySpy).toHaveBeenCalledWith('validationSuccessed', expect.anything());
            expect(notifySpy).toHaveBeenCalledWith('updateSuccessed', expect.anything());
            expect(notifySpy).toHaveBeenCalledWith('recordChanged', expect.anything());
