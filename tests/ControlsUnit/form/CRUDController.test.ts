...
describe('Controls/form:CrudController', () => {
    ...
    beforeEach(() => {
        ...
        stubNotify = jest.spyOn(formController, '_notify').mockClear().mockImplementation();
    });

    describe('create', () => {
        it('Success', (done) => {
            const resolvePromise = Promise.resolve<Record>(record);
            jest.spyOn(source, 'create').mockClear().mockReturnValue(resolvePromise);
        ...
        it('Fail', (done) => {
            ...
            jest.spyOn(source, 'create').mockClear().mockReturnValue(rejectPromise);
    ...
    describe('read', () => {
        it('Success', (done) => {
            ...
            jest.spyOn(source, 'read').mockClear().mockReturnValue(resolvePromise);
            ...
            actual
                .then(() => {
                    expect(stubNotify).toHaveBeenCalledWith('readSuccessed', expect.anything());
                    done();
                })
                .catch(() => {
                    done('should not go into the Promise.catch handler');
        ...
        it('Fail', (done) => {
            ...
            jest.spyOn(source, 'read').mockClear().mockReturnValue(rejectPromise);
            const actual = crud.read('1');
            ...
            actual
                ...
                .catch(() => {
                    expect(stubNotify).toHaveBeenCalledWith('readFailed', expect.anything());
                    done();
                });
        });
    });
    ...
    describe('update', () => {
        it('Success', (done) => {
            const resolvePromise = Promise.resolve<void>();
            jest.spyOn(source, 'update').mockClear().mockReturnValue(resolvePromise);
            ...
            actual
                .then(() => {
                    expect(stubNotify).toHaveBeenCalledWith('updateSuccessed', expect.anything());
                    done();
                })
                .catch(() => {
                    done('should not go into the Promise.catch handler');
        ...
        it('Fail', (done) => {
            const rejectPromise = Promise.reject<void>();
            jest.spyOn(source, 'update').mockClear().mockReturnValue(rejectPromise);
            record.set<'title'>('title', 'update test');
            ...
            actual
                ...
                .catch(() => {
                    expect(stubNotify).toHaveBeenCalledWith('updateFailed', expect.anything());
                    done();
                });
    ...
    describe('delete', () => {
        it('Success', (done) => {
            const resolvePromise = Promise.resolve<void>();
            jest.spyOn(source, 'destroy').mockClear().mockReturnValue(resolvePromise);
            ...
            actual
                .then(() => {
                    expect(stubNotify).toHaveBeenCalledWith('deleteSuccessed', expect.anything());
                    done();
                })
                .catch(() => {
                    done('should not go into the Promise.catch handler');
        ...
        it('Fail', (done) => {
            const rejectPromise = Promise.reject<void>();
            jest.spyOn(source, 'destroy').mockClear().mockReturnValue(rejectPromise);
            ...
            actual
                ...
                .catch(() => {
                    expect(stubNotify).toHaveBeenCalledWith('deleteFailed', expect.anything());
                    done();
                });
        });
    });
