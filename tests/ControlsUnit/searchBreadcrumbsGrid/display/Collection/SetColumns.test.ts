...
import { SearchGridCollection, SearchSeparatorRow } from 'Controls/searchBreadcrumbsGrid';
...
describe('Controls/searchBreadcrumbsGrid/display/Collection/SetColumns', () => {
    ...
    it('Should call setColumnsConfig', () => {
        ...
        const spySetColumnsConfig = jest.spyOn(separator, 'setColumnsConfig').mockClear();
