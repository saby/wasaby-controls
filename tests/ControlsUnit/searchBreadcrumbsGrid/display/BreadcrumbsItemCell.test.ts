    ...
    describe('getContentClasses', () => {
        it('getContentClasses', () => {
            const expected =
                ...
                ' controls-Grid__cell_spacingLastCol_default controls-Grid__row-cell_default_rowSpacingTop_default' +
                ' controls-Grid__row-cell_default_rowSpacingBottom_null controls-Grid__cell_spacingFirstCol_default' +
