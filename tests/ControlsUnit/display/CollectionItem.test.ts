...
describe('Controls/_display/CollectionItem', () => {
    ...
    */
    ...
    it('.getMultiSelectClasses()', () => {
        ...
        item.setSelected(true, true);
        const selectedMultiSelectClasses =
            item.getMultiSelectClasses('default');
        CssClassesAssert.isSame(
        ...
        const partSelectedMultiSelectClasses =
            item.getMultiSelectClasses('default');
        CssClassesAssert.isSame(
        ...
        CssClassesAssert.isSame(
            ...
            requiredClasses +
                ' controls-ListView__checkbox_position-custom controls-cursor_pointer'
        );
    });
    ...
    describe('.setEditing()', () => {
        ...
        it('notifies owner when editing contents change', () => {
            ...
            expect(typeof editingContents._propertyChangedHandler).toBe(
                'function'
            );
