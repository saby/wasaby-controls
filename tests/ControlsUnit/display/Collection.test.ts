...
describe('Controls/_display/Collection', () => {
    ...
    describe('.each()', () => {
        ...
        it('should return items in order of sort function', () => {
            ...
            const display = new CollectionDisplay({
                ...
                sort: (a, b) => {
                    return (
                        a.collectionItem.get('title') -
                        b.collectionItem.get('title')
                    );
                },
                keyProperty: 'id',
            });
    ...
    describe('.setCollection()', () => {
        it('Increase version after .setCollection', () => {
            ...
            expect(display.getVersion()).toBe(1);
        });
    });
    describe('.setFilter()', () => {
    ...
    describe('.setSort()', () => {
        ...
        it('should not resort display after change item', () => {
            ...
            display.setSort((a, b) => {
                return (
                    b.collectionItem.get('max') - a.collectionItem.get('max')
                );
            });
    ...
    describe('.setGroup()', () => {
        ...
        it('should remove grouping filter when null was passed', () => {
            ...
            const spyRemoveFilter = jest
                .spyOn(display, 'removeFilter')
                .mockClear();
            display.setGroup((item) => {
                return item.group;
            });
    ...
    describe('shortcuts', () => {
        ...
        describe('.getSourceIndexByIndex()', () => {
            ...
            it('should return inverted indexes', () => {
                ...
                display.each((item, index) => {
                    expect(display.getSourceIndexByIndex(index)).toEqual(
                        max - index
                    );
                });
            });
        ...
        describe('.getSourceIndexByItem()', () => {
            ...
            it('should return inverted indexes', () => {
                ...
                display.each((item, index) => {
                    expect(display.getSourceIndexByItem(item)).toEqual(
                        max - index
                    );
                });
            });
        ...
        describe('.getIndexBySourceIndex()', () => {
            ...
            it('should return inverted indexes', () => {
                ...
                list.each((item, index) => {
                    expect(display.getIndexBySourceIndex(index)).toEqual(
                        max - index
                    );
                });
            });
        ...
        describe('.getIndexBySourceItem()', () => {
            ...
            it('should return inverted indexes', () => {
                ...
                list.each((item, index) => {
                    expect(display.getIndexBySourceItem(item)).toEqual(
                        max - index
                    );
                });
            });
        ...
        describe('.getItemBySourceIndex()', () => {
            it('should return equal indexes', () => {
                list.each((item, index) => {
                    expect(display.getItemBySourceIndex(index)).toBe(
                        display.at(index)
                    );
                });
            });
            ...
            it('should return undefined', () => {
                ...
                expect(
                    display.getItemBySourceIndex(undefined)
                ).not.toBeDefined();
            });
        });
        ...
        describe('.getItemBySourceItem()', () => {
            it('should return equal indexes', () => {
                list.each((item, index) => {
                    expect(display.getItemBySourceItem(item)).toBe(
                        display.at(index)
                    );
                });
            });
            ...
            it('should return undefined', () => {
                expect(
                    display.getItemBySourceItem({} as any)
                ).not.toBeDefined();
                expect(display.getItemBySourceItem(null)).not.toBeDefined();
                expect(
                    display.getItemBySourceItem(undefined)
                ).not.toBeDefined();
            });
        });
    });
                ...
                try {
                    ...
                    switch (action) {
                        case IBindCollection.ACTION_ADD:
                            expect(newItems[0].getContents()).toBe(
                                contents[fireId]
                            );
                            break;
                        case IBindCollection.ACTION_REMOVE:
                        case IBindCollection.ACTION_MOVE:
                            expect(oldItems[0].getContents()).toBe(
                                contents[fireId]
                            );
                            break;
                    }
    ...
    describe('.subscribe()', () => {
        ...
        const checkGivenAndExpected = (given, expected) => {
            ...
            for (let i = 0; i < given.length; i++) {
                ...
                expect(given[i].newItems.length).toBe(
                    expected[i].newItems.length
                );
                expect(given[i].newItemsIndex).toBe(expected[i].newItemsIndex);
                for (let j = 0; j < given[i].newItems.length; j++) {
                    expect(given[i].newItems[j].getContents()).toBe(
                        expected[i].newItems[j]
                    );
                }

                expect(given[i].oldItems.length).toBe(
                    expected[i].oldItems.length
                );
                expect(given[i].oldItemsIndex).toBe(expected[i].oldItemsIndex);
                for (let j = 0; j < given[i].oldItems.length; j++) {
                    expect(given[i].oldItems[j].getContents()).toBe(
                        expected[i].oldItems[j]
                    );
                }
            }
        };
        ...
        it('should fire "onCollectionChange" after filter the display', (done) => {
            ...
            const handler = (
                ...
                try {
                    ...
                    expect(newItemsIndex).toBe(0);
                    expect(
                        outsideItems.indexOf(oldItems[0].getContents())
                    ).not.toEqual(-1);
        ...
        it(
            ...
            () => {
                ...
                display.subscribe(
                    'onCollectionChange',
                    (e, action, newItems, newItemsIndex) => {
        ...
        it(
            ...
            () => {
                ...
                for (let i = 0; i < given.length; i++) {
                    ...
                    expect(given[i].newItemsIndex).toBe(
                        expected[i].newItemsIndex
                    );
                    for (let j = 0; j < given[i].newItems.length; j++) {
                        expect(given[i].newItems[j].getContents()).toBe(
                            expected[i].newItems[j]
                    ...
                    expect(given[i].oldItemsIndex).toBe(
                        expected[i].oldItemsIndex
                    );
                    for (let j = 0; j < given[i].oldItems.length; j++) {
                        expect(given[i].oldItems[j].getContents()).toBe(
                            expected[i].oldItems[j]
        ...
        it('should fire "onCollectionChange" after changed item is not moved as item only changed', () => {
            ...
            const display = new CollectionDisplay({
                ...
                sort: (a, b) => {
                    return (
                        a.collectionItem.get('id') - b.collectionItem.get('id')
                    );
                },
            });
            const given = [];
        ...
        it(
            ...
            () => {
                ...
                const display = new CollectionDisplay({
                    ...
                    sort: (a, b) => {
                        return (
                            a.collectionItem.get('id') -
                            b.collectionItem.get('id')
                        );
                    },
                });
                const given = [];
        ...
        it(
            ...
            () => {
                ...
                expect(display.at(at + 1).getContents()).not.toEqual(
                    nextListItem
                );
            }
        );
    ...
    it('.setMultiSelectVisibility()', () => {
        ...
        expect(collection.getMultiSelectVisibility()).toBe(
            multiSelectVisibility
        );
    ...
    describe('drag', () => {
        ...
        beforeEach(() => {
            ...
            notifyCollectionChangeSpy = jest
                .spyOn(display, '_notifyCollectionChange')
                .mockClear();
        });
        ...
        it('setDraggedItems to empty model', () => {
            ...
            expect(emptyDisplay.getItems()[0].getContents().getKey()).toEqual(
                '123'
            );
        });
    ...
    describe('hiddenGroupPosition', () => {
        ...
        it('first', () => {
            ...
            expect(collection.at(0).getContents()).toEqual(
        ...
        it('byorder', () => {
            ...
            expect(collection.at(3).getContents()).toEqual(
                groupConstants.hiddenGroup
            );
        });
    });
    ...
    describe('footer', () => {
        it('initialize footer', () => {
            ...
            expect(collection.getFooter().getContentTemplate()).toEqual(
                footerTemplate
            );
        });
