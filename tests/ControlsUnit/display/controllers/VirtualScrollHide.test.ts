...
describe('Controls/_display/controllers/VirtualScrollHide', () => {
    ...
    describe('setIndices()', () => {
        it('sets items from start to stop index as rendered', () => {
            ...
            items.forEach((item, index) => {
                expect(item._$rendered).toBe(index >= startIndex && index < stopIndex);
            });
        });
    });
    ...
    describe('isItemAtIndexHidden()', () => {
        it('returns true if item is hidden', () => {
            ...
            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 5)).toBe(true);
            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 30)).toBe(true);
            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 17)).toBe(false);

            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 10)).toBe(false);
            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 25)).toBe(true);
            ...
            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 5)).toBe(false);
            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 30)).toBe(false);

            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 0)).toBe(true);
            expect(VirtualScrollHideController.isItemAtIndexHidden(collection, 35)).toBe(true);
        });
    });
});
