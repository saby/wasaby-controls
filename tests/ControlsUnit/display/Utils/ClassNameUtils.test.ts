...
describe('getEditorViewRenderClassName', () => {
    ...
    describe('hover classes for input', () => {
        const CLASS_NAMES = {
            VISIBLE: 'controls-EditingTemplateText_InputBackgroundVisibility_visible',
            HIDDEN: 'controls-EditingTemplateText_InputBackgroundVisibility_hidden',
            ONHOVER: 'controls-EditingTemplateText_InputBackgroundVisibility_onhover',
        };
        ...
        [
            {
                ...
                include: [],
                notInclude: [CLASS_NAMES.VISIBLE, CLASS_NAMES.ONHOVER, CLASS_NAMES.HIDDEN],
            },
            {
            ...
            },
            {
                ...
                include: [],
                notInclude: [CLASS_NAMES.ONHOVER, CLASS_NAMES.VISIBLE, CLASS_NAMES.HIDDEN],
            },
        ].forEach((testCase) => {
            it(testCase.name, () => {
                const classes = getEditorViewRenderClassName(testCase.methodParams);
