...
import MoneyRender from 'Controls/_grid/dirtyRender/types/MoneyRender';
import NumberRender from 'Controls/_grid/dirtyRender/types/NumberRender';
import DateRender from 'Controls/_grid/dirtyRender/types/DateRender';
    ...
    describe('.hasCellContentRender()', () => {
        ...
        cases.forEach((item) => {
            it(item.caseName, () => {
                ...
                expect(gridCell.hasCellContentRender()).toEqual(item.assertValue);
            });
        });
    });
