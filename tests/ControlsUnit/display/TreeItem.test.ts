    ...
    */
    ...
    describe('.getWrapperClasses()', () => {
        it('should return classes for border if isDragTargetNode', () => {
            ...
            CssClassesAssert.include(classes, 'controls-TreeGridView__dragTargetNode');
            CssClassesAssert.include(classes, 'controls-TreeGridView__dragTargetNode_first');
            CssClassesAssert.include(classes, 'controls-TreeGridView__dragTargetNode_last');
        });
    });
});
