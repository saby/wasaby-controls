                ...
                describe(
                    ...
                    () => {
                        ...
                        it(`the position becomes to #${test.expect.position}`, () => {
                            expect(test.expect.position).toBe(enumerator.getPosition());
                        });
                        ...
                        it(`the current is ${
                            ...
                            if (test.expect.current) {
                                expect(original[test.goto]).toBe(enumerator.getCurrent());
                            } else {
                                expect(enumerator.getCurrent()).not.toBeDefined();
                            }
                        });
                        ...
                        const nextTitle =
                            test.expect.next === -1 ? 'undefined' : `original[${test.expect.next}]`;
                            ...
                            it(`positions to original is ${JSON.stringify(
                                ...
                                for (const position in test.expect.posToOriginal) {
                                    if (test.expect.posToOriginal.hasOwnProperty(position)) {
                                        ...
                                        expect(original[test.expect.posToOriginal[position]]).toBe(
