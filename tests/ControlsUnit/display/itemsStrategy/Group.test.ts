...
describe('Controls/_display/itemsStrategy/Group', () => {
    ...
    describe('.items', () => {
        ...
        it('should place groups before their items', () => {
            ...
            const expected = ['one', items[0], items[2], 'two', items[1], items[3]];
        ...
        it('should return items after group has gone', () => {
            ...
            ['#one', 'one', '#two', 'two', '#three', 'three'].forEach((expected, index) => {
            ...
            ['#one', 'one', '#four', 'four', '#three', 'three'].forEach((expected, index) => {
                expect(strategy.items[index].getContents()).toBe(expected);
            });
        });
    });
        ...
        it('should reset group items', () => {
            ...
            oldItems.forEach((item, index) => {
                if (item['[Controls/_display/GroupItem]']) {
                    ...
                    expect(newItems[index].getContents()).toEqual(oldItems[index].getContents());
                } else {
    ...
    describe('.getDisplayIndex()', () => {
        ...
        it('should return last index', () => {
            ...
            expect(strategy.getDisplayIndex(strategy.count)).toBe(strategy.count);
        });
    ...
    describe('.getCollectionIndex()', () => {
        it('should return valid index', () => {
            ...
            strategy.items.forEach((item, index) => {
                expect(strategy.getCollectionIndex(index)).toBe(index % 2 ? (index - 1) / 2 : -1);
            });
        });
