...
describe('Controls/_display/itemsStrategy/Composer', () => {
    ...
    describe('.append()', () => {
        ...
        it('should append a strategy to the end', () => {
            ...
            expect(
                composer.getInstance<IStrategy>(StrategyA).source
            ).not.toBeDefined();
            expect(
                composer.getInstance<IStrategy>(StrategyB).source
            ).toBeInstanceOf(StrategyA);
        });
        ...
        it('should append a strategy after given', () => {
            ...
            expect(
                composer.getInstance<IStrategy>(StrategyC).source
            ).toBeInstanceOf(StrategyA);
            expect(
                composer.getInstance<IStrategy>(StrategyB).source
            ).toBeInstanceOf(StrategyC);
        });
    });
