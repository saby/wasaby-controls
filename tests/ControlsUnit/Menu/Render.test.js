   ...
   describe('Menu:Render', function () {
      ...
      describe('grouping', function () {
         ...
         describe('check class separator', function () {
            ...
            it('collectionItem', function () {
               ...
               expect(actualClasses.indexOf('controls-Menu__row-separator') !== -1).toBe(true);
            });
            ...
            it('history separator is unvisible', function () {
               ...
               groupListModel.at(1).getContents().set('pinned', true);
               let actualClasses = menuRender._getClassList(groupListModel.at(1));
               expect(actualClasses.indexOf(expectedClasses) === -1).toBe(false);
            });
         });
      });
      ...
      describe('getIconPadding', function () {
         ...
         it('hierarchy collection', () => {
            ...
            let iconPadding = hierarchyMenuRender.getIconPadding(hierarchyRenderOptions);
            expect(iconPadding).toEqual('');
            ...
            iconPadding = hierarchyMenuRender.getIconPadding(hierarchyRenderOptions);
            expect(iconPadding).toEqual('m');
         });
      });
