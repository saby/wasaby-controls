define([
   ...
   describe('Menu:Popup', function () {
      ...
      it('_dataLoadCallback', function () {
         ...
         menuPopup._headingIcon = 'testIcon';
         items.at(0).set('pinned', true);
         items.at(1).set('icon', 'testIcon');
         menuPopup._dataLoadCallback(
            { parentProperty: 'parent', root: null, historyId: 'test' },
            items
         );
         expect(menuPopup._headingIcon).toBeNull();
      });
      ...
      it('_prepareSubMenuConfig', function () {
         ...
         expect(popupOptions.className).toEqual(' controls-Menu__subMenu_marginLeft');
         ...
         expect(popupOptions.direction.horizontal).toEqual('right');
         expect(popupOptions.className).toEqual(' controls-Menu__subMenu_marginLeft-revert');
      });
   });
});
