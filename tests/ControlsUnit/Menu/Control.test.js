define([
   ...
   describe('Menu:Control', function () {
      ...
      let getListModel = function (
         items,
         { parentProperty, nodeProperty, root } = {}
      ) {
         const defaultConfig = {
      ...
      describe('_beforeUpdate', () => {
         ...
         it('source is changed, update markerController', async () => {
            ...
            expect(menuControl._notifyResizeAfterRender).toBe(true);
            expect(isClosed).toBe(true);
            expect(isMarkerControllerUpdated).toBe(true);
         });
         ...
         it('searchValue is changed', async () => {
            ...
            expect(isSelectionControllerUpdated).toBe(true);
         });
      });
      ...
      describe('_beforeMount', () => {
         ...
         it('_loadItems return items', async () => {
            ...
            await menuControl._beforeMount(menuOptions);
            expect(menuControl._markerController).not.toBeNull();
         });
      ...
      describe('getCollection', function () {
         ...
         it('check group', function () {
            ...
            expect(listModel.at(0)).toBeInstanceOf(display.GroupItem);
         });
         ...
         it('check history filter', function () {
            ...
            expect(isFilterApply).toBe(true);
         });
      });
      ...
      describe('_addEmptyItem', function () {
         ...
         it('check items count', function () {
            menuRender._addSingleSelectionItem(
               'Not selected',
               null,
               items,
               menuOptions
            );
            expect(menuRender._emptyItem.contents.get('title')).toEqual(
               'Not selected'
            );
      ...
      describe('_isExpandButtonVisible', function () {
         ...
         it('expandButton visible, history menu', () => {
            ...
            const result = menuControl._isExpandButtonVisible(
               items,
               newMenuOptions
            );
      ...
      describe('_itemClick', function () {
         ...
         describe('check touch devices', function () {
            ...
            it('submenu is not open, item is list', function () {
               jest
                  .spyOn(menuControl, '_handleCurrentItem')
                  .mockClear()
                  .mockImplementation();
               menuControl._itemClick('itemClick', item, {});
               expect(selectedItem.getKey()).toEqual(1);
            ...
            it('submenu is open', function () {
               ...
               menuControl._itemClick(
                  'itemClick',
                  menuControl._listModel.at(1).getContents(),
                  {}
               );
               expect(selectedItem.getKey()).toEqual(1);
            });
      ...
      describe('_itemMouseMove', function () {
         ...
         it('on collectionItem', function () {
            ...
            expect(menuControl._hoveredTarget).toEqual(target);
            menuControl._itemMouseMove('mousemove', collectionItem, {
               target: {
                  closest: () => {
                     return 'container';
      ...
      describe('_updateSwipeItem', function () {
         ...
         it('swipe to the left', () => {
            ...
            expect(item1.isSwiped()).toBe(true);
         });

         it('swipe to the left another item', () => {
            menuControl._updateSwipeItem(item2, true);
            expect(item2.isSwiped()).toBe(true);
            expect(item1.isSwiped()).toBe(false);
         });
      ...
      describe('groupMethod', function () {
         ...
         it('item hasn`t group', function () {
            ...
            expect(groupId).toEqual(
               ControlsConstants.groupConstants.hiddenGroup
            );
         });
      ...
      describe('itemActions', function () {
         ...
         it('_onItemActionsMenuResult', () => {
            ...
            menuControl._onItemActionsMenuResult(
               'itemClick',
               actionModel,
               null
            );
            expect(isItemHandled).toBe(true);
            expect(isClosed).toBe(true);
         });
      });
      ...
      it('getCollection', function () {
         ...
         expect(listModel).toBeInstanceOf(baseTree.Search);
      });
      ...
      describe('_subMenuResult', function () {
         ...
         beforeEach(() => {
            ...
            stubClose = jest
               .spyOn(menuControl, '_closeSubMenu')
               .mockClear()
               .mockImplementation();
         });
      ...
      it('_subMenuDataLoadCallback', function () {
         ...
         expect(
            menuControl._listModel.getSourceCollection().getFormat().getCount()
         ).toEqual(4);
      });
      ...
      describe('multiSelect: true', () => {
         it('_beforeUpdate hook', async () => {
            ...
            expect(menuControl._markerController.getMarkedKey()).toEqual(null);
         });
      });
   });
});
