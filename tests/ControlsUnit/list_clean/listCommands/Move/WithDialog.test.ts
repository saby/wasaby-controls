    ...
    beforeEach(() => {
        ...
        validPopupArgs = {
            ...
            templateOptions: {
                ...
                excludedItems: selection.excluded,
                keyProperty: 'id',
                nodeProperty: 'folder@',
        ...
        config = {
            ...
            popupOptions: {
                ...
                templateOptions: {
                    keyProperty: (validPopupArgs.templateOptions as IMoverDialogTemplateOptions)
                        .keyProperty,
                    nodeProperty: (validPopupArgs.templateOptions as IMoverDialogTemplateOptions)
                        .nodeProperty,
                    parentProperty: (validPopupArgs.templateOptions as IMoverDialogTemplateOptions)
                        .parentProperty,
                },
    ...
    describe('constructor', () => {
        ...
        it('moveWithDialog() + source set within popupOptions.templateOptions object', () => {
            ...
            mockDialogOpener((args) => {
                expect((args.templateOptions as { source: Memory }).source).not.toBe(source);
                expect((args.templateOptions as { source: Memory }).source).toBe(source2);
        ...
        it('moveWithDialog() + necessary and static popupOptions', () => {
            mockDialogOpener((args) => {
                ...
                expect(args.templateOptions).toEqual(validPopupArgs.templateOptions);
                expect(args.closeOnOutsideClick).toEqual(validPopupArgs.closeOnOutsideClick);
