...
describe('Controls/_baseList/Controllers/AbstractListVirtualScrollController', () => {
    ...
    function checkCallOrder(expectedCallOrder: unknown[]) {
        for (let i = 0; i < expectedCallOrder.length - 1; i++) {
            expect(
                expectedCallOrder[i].mock.invocationCallOrder[0]
            ).toBeLessThan(
    ...
    describe('afterMountListControl', () => {
        ...
        it('should scroll to active element', () => {
            ...
            const activeElement =
                itemsContainer.querySelector('div[item-key="3"]');
    ...
    describe('afterRenderListControl', () => {
        ...
        it('should not log error from updateItemsSizes (imitate react)', () => {
            ...
            const recordSet =
                collection.getSourceCollection() as unknown as RecordSet;
    ...
    describe('setCollection', () => {
        it('should set iterator to collection', () => {
            ...
            const setIteratorSpy = jest
                .spyOn(newCollection, 'setViewIterator')
                .mockClear();
    ...
    describe('removeItems', () => {
        it('should set indexes to collection', () => {
            ...
            controller.removeItems(2, Array(2), 'fixed');
    ...
    describe('scrollToItem', () => {
        it('should scroll right away if range is not changed', () => {
            ...
            const activeElement =
                itemsContainer.querySelector('div[item-key="2"]');
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(
                activeElement,
                'top',
                true
        ...
        it('should scroll after render if range is changed', () => {
            ...
            const activeElement =
                itemsContainer.querySelector('div[item-key="6"]');
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(
                activeElement,
                'bottom',
                false
        ...
        it('should not scroll to hidden element', () => {
            ...
            expect(scrollToElementUtilSpy).not.toHaveBeenCalledWith(
                firstElement
            );
        });
    ...
    describe('scrollToEdge', () => {
        it('should scroll to forward edge', () => {
            ...
            const activeElement =
                itemsContainer.querySelector('div[item-key="10"]');
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(
                activeElement,
                'bottom',
                true
        ...
        it('should scroll to backward edge', () => {
            ...
            const activeElement =
                itemsContainer.querySelector('div[item-key="1"]');
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(
                activeElement,
                'top',
                true
