...
import { IListVirtualScrollControllerOptions } from 'Controls/baseList';
import { detection } from 'Env/Env';
import { SCROLL_POSITION } from 'Controls/_scroll/Utils/Scroll';

describe('Controls/baseList:AbstractListVirtualScrollController', () => {
    ...
    describe('afterMountListControl', () => {
        ...
        it('should scroll to active element', () => {
            ...
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(activeElement, 'top', true, 0);
            expect(doScrollUtilSpy).not.toHaveBeenCalled();
        });
    ...
    describe('afterRenderListControl', () => {
        ...
        it('should scroll to top after reset items', () => {
            ...
            const firstElement = itemsContainer.querySelector(
                `div[item-key="${collection.getFirst().key}"]`
            );
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(firstElement, 'top', true, 0);
        });
    ...
    describe('resetItems', () => {
        ...
        it('should scroll to bottom after reset items', () => {
            ...
            const lastItem = itemsContainer.querySelector(
                `div[item-key="${controllerParams.virtualScrollConfig.pageSize}"]`
            );
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(lastItem, 'bottom', true, 0);
        });
    ...
    describe('scrollToItem', () => {
        ...
        it('should scroll after render if range is changed', () => {
            ...
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(activeElement, 'bottom', false, 0);
        });
    ...
    describe('scrollToEdge', () => {
        it('should scroll to forward edge', () => {
            ...
            expect(scrollToElementUtilSpy).toHaveBeenCalledWith(activeElement, 'bottom', true, 0);
        });
