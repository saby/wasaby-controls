    ...
    describe('onCollectionChange', () => {
        ...
        describe('removeItems', () => {
            ...
            it('remove two items from start', () => {
                ...
                expect(itemsSizes).toEqual([{ size: 30, offset: 0, key: '3' }]);
            });
        });
        ...
        describe('resetItems', () => {
            ...
            it('should create an array with given sizes', () => {
                const itemsSizes = controller.resetItems(1, [{ size: 1, offset: 0 }]);
