...
import { IObserversControllerOptions as ControllerOptions } from 'Controls/_baseList/Controllers/ScrollController/ObserverController/ObserversController';
import {
    getCollection,
    getListContainer,
...
describe('Controls/_baseList/Controllers/AbstractObserversController', () => {
    ...
    describe('setListContainer', () => {
        ...
        it('should not update triggers in nested list', () => {
            ...
            const listContainer = getListContainerWithNestedList(
                collection,
                nestedCollection
            );
