...
} from 'Controls/_baseList/Controllers/ScrollController/ListVirtualScrollController';
...
describe('Controls/_baseList/Controllers/ScrollController/ListVirtualScrollController', () => {
    let collection;
    let listContainer;
    let itemsContainer;
    ...
    it('should not throw error if groupKey is number', () => {
        ...
        recordSet.add(
            new Model({ rawData: { key: 0, height: 50, group: 123 } }),
            0
        );
