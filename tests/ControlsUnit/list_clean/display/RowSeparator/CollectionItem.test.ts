...
describe('Controls/list/display/RowSeparator/CollectionItem', () => {
    ...
    describe('onCollectionChange', () => {
        ...
        it('RecordSet + remove', () => {
            ...
            expect(collection.getItemBySourceKey(3).isBottomSeparatorEnabled()).toBe(false);
            recordSet.removeAt(3);
            expect(collection.getItemBySourceKey(3).isBottomSeparatorEnabled()).toBe(true);
        });
        ...
        it('RecordSet + assign', () => {
            ...
            expect(collection.getItemBySourceKey(2)).not.toEqual(initialLastItem);
            expect(collection.getItemBySourceKey(4).isBottomSeparatorEnabled()).toBe(true);
        });
    ...
    it('DnD', () => {
        ...
        expect(collection.getItemBySourceKey(4).isBottomSeparatorEnabled()).toBe(false);
        expect(collection.at(3).isBottomSeparatorEnabled()).toBe(true);
    });
    ...
    it('create in collection', () => {
        ...
        expect(collection.getItemBySourceKey(2).isBottomSeparatorEnabled()).toBe(false);
