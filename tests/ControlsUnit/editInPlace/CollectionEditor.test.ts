...
describe('Controls/_editInPlace/CollectionEditor', () => {
    ...
    describe('updateOptions', () => {
        ...
        it('should throw error and use old collection if new has source not type of Types/collection:RecordSet', () => {
            ...
            newCollection.getSourceCollection()['[Types/_collection/RecordSet]'] = false;
    ...
    describe('edit', () => {
        it('correct', () => {
            ...
            expect(collectionEditor.getEditingItem().contents.getKey()).toEqual(1);
    ...
    describe('add', () => {
        it('correct', () => {
            ...
            // Редактирование успешно запустилось
            expect(collection.isEditing()).toBe(true);
            expect(collectionEditor.getEditingItem().contents.getKey()).toEqual(4);
        });
    ...
    describe('commit', () => {
        ...
        it('correct commit adding', () => {
            ...
            // Редактирование успешно запустилось
            expect(collection.isEditing()).toBe(true);
            expect(collectionEditor.getEditingItem().contents.getKey()).toEqual(newItem.getKey());
