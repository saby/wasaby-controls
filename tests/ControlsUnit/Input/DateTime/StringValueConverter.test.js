define([
   ...
   'Controls/date',
   'Controls/dateUtils'
], function (cMerge, env, typesEntity, formatter, DateControlsUtils, dateLib, dateUtils) {
   'use strict';
   ...
   describe('Controls/_date/StringValueConverter', function () {
      ...
      describe('.getStringByValue', function () {
         ...
         it('should return time based on the timezone', function () {
            ...
            expect(converter.getStringByValue(new typesEntity.DateTime(2020, 0, 1))).toBe('02:00');
      ...
      describe('.getValueByString', function () {
         ...
         [
            {
               mask: 'HH:mm:ss:SSS',
               stringValue: '11.11.11:111',
               value: new Date(year, 0, 1, 11, 11, 11, 111)
            },
            ...
            },
            {
               mask: 'HH.mm',
               stringValue: '10.__',
               value: new Date(now.getFullYear(), 0, 1, 10)
            },
            {
               mask: 'HH.mm.ss',
            ...
            },
            {
               ...
               value: new Date(now.getFullYear(), 0, 1, 10, 5)
            },
            {
               mask: 'HH.mm.ss',
               stringValue: '1_.5_.1_',
               value: new Date(now.getFullYear(), 0, 1, 10, 50, 10)
            },
            {
               mask: 'HH.mm.ss',
               stringValue: '_1._5._1',
               value: new Date(now.getFullYear(), 0, 1, 1, 5, 1)
            },
            {
               mask: 'HH.mm',
               stringValue: '__.10',
               value: new Date(now.getFullYear(), 0, 1, 0, 10)
            },
            ...
            // incorrect time
            {
               ...
               value: new Date(now.getFullYear(), 0, 1, 23, 59, 59)
            },
            {
               mask: 'HH:mm:ss',
               stringValue: '80:10:10',
               value: new Date(now.getFullYear(), 0, 1, 23, 10, 10)
            },
            {
               mask: 'HH:mm:ss',
               stringValue: '10:80:80',
               value: new Date(now.getFullYear(), 0, 1, 10, 59, 59)
            },
            {
               mask: 'HH:mm:ss',
               stringValue: '10:10:80',
               value: new Date(now.getFullYear(), 0, 1, 10, 10, 59)
            },
            {
               mask: 'HH:mm',
               stringValue: '80:80',
               value: new Date(now.getFullYear(), 0, 1, 23, 59, 0)
            },
            {
               mask: 'HH:mm',
               stringValue: '10:80',
               value: new Date(now.getFullYear(), 0, 1, 10, 59, 0)
            },
            {
               mask: 'HH:mm',
               stringValue: '24:60',
            ...
            },
            {
               mask: 'HH:mm',
               stringValue: '80:10',
               value: new Date(now.getFullYear(), 0, 1, 23, 10, 0)
            },
            ...
            it(`should return ${test.value} if "${test.stringValue}" is passed`, function () {
               ...
               expect(dateUtils.Base.isDatesEqual(rDate, test.value)).toBeTruthy();
               jest.useRealTimers();
            });
         });
      ...
      describe('.getCurrentDate', function () {
         ...
         [
            ...
            it(`should return curent date if it icludes "${test.mask}"`, function () {
               ...
               expect(dateUtils.Base.isDatesEqual(tested, test.value)).toBeTruthy();
            });
         });
      ...
      describe('_createDate', () => {
         [
            ...
            it(
               'should create correct date with autocorrect if extendedTimeFormat=true ' + index,
               () => {
                  const converter = new dateLib.StringValueConverter({
                     mask: 'DD.MM.YY',
                     dateConstructor: Date
         ...
         it('should create correct date with 24:00 if extendedTimeFormat=true', () => {
            ...
            const result = new Date(2020, 0, 1, 23, 59, 59);
            converter._extendedTimeFormat = true;
            const value = converter._createDate(2020, 0, 1, 24, 0, 0, 0, true, Date);
            const testResult = dateUtils.Base.isDatesEqual(result, value);
            expect(testResult).toBe(true);
         });
      });
