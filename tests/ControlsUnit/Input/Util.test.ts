...
describe('Controls/input:__Util', () => {
    ...
    describe('.transliterateInput()', () => {
        ...
        const cases = [
            {
                testName: 'Курсор в конце строки (текст не совпадает с транслитерацией)',
                value: 'Hello',
            ...
            {
                testName: 'Курсор в конце строки (текст совпадает с транслитерацией)',
                value: 'Hello',
                selection: { start: 5, end: 5 },
                locale: 'en-En',
                expected: 'Руддщ',
            ...
            {
                testName: 'Выделен текст (текст не совпадает с транслитерацией)',
                value: 'Hello',
                selection: { start: 1, end: 3 },
                locale: 'ru-RU',
                expected: 'Hудlo',
            ...
            {
                testName: 'Выделен весь текст (текст не совпадает с транслитерацией)',
                value: 'Hello',
                selection: { start: 0, end: 5 },
                locale: 'ru-RU',
                expected: 'Руддщ',
            ...
            {
                testName: 'Выделен весь текст (текст совпадает с транслитерацией)',
                value: 'Hello',
                selection: { start: 0, end: 5 },
                locale: 'en-En',
                expected: 'Руддщ',
