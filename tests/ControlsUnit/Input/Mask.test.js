define(['Core/core-merge', 'UI/Utils', 'Controls/input'], function (coreMerge, UIUtils, input) {
   'use strict';
   ...
   let createComponent = function (Component, cfg) {
      ...
      if (Component.defaultProps) {
         ...
         cfg = coreMerge(cfg, Component.defaultProps, {
            preferSource: true
         });
      }
         ...
         [
            ...
            it('should update selection if value changed', function () {
               ...
               component.shouldComponentUpdate(
                  coreMerge(test, input.Mask.defaultProps, {
                     preferSource: true
                  })
               );
