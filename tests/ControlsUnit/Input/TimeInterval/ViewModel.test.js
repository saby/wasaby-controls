define(['Controls/_input/TimeInterval/ViewModel', 'Types/entity'], function (ViewModel, entity) {
   'use strict';
   ...
   describe('Controls/_input/TimeInterval/ViewModel', function () {
      describe('._convertToValue', function () {
         it('should return correct TimeInterval object from String', function () {
            ...
            expect(model._convertToValue('44:10:20')._normIntervalStr).toBe(value._normIntervalStr);
            ...
            expect(model._convertToValue('20:10:20')._normIntervalStr).toBe(value._normIntervalStr);

            value = new entity.TimeInterval({ seconds: 20 });
            expect(model._convertToValue('00:00:20')._normIntervalStr).toBe(value._normIntervalStr);
         });
