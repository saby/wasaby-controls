define(['UI/Base', 'Controls/_input/Number/ViewModel'], function (
   Base,
   NumberViewModel
) {
   'use strict';
   ...
   describe('Controls/_input/Number/ViewModel', function () {
      var testCases = [
         ...
         {
            testName:
               'No dot when input starts if precision is 0 (empty field)',
            controlConfig: {
               useGrouping: true,
               precision: 0
            },
         ...
         {
            testName:
               'No dot when input starts if precision is 0 (field with value)',
            controlConfig: {
               useGrouping: true,
               precision: 0
            },
         ...
         {
            testName:
               "Inserting a dot at the beginning of a line results in '0.0'",
            controlConfig: {
               useGrouping: true
            },
            splitValue: {
         ...
         {
            testName:
               'Delete space operation removes symbol before space and moves cursor left',
            controlConfig: {
               useGrouping: true,
               precision: 0
            },
         ...
         {
            testName:
               'Insert number in field with maxed integers (first in line)',
            controlConfig: {
               useGrouping: true,
               integersLength: 5
            },
         ...
         {
            testName:
               'Insert number in field with maxed integers (before space)',
            controlConfig: {
               useGrouping: true,
               integersLength: 4
            },
         ...
         {
            testName:
               'Insert number in field with maxed integers (first in line, with .0)',
            controlConfig: {
               useGrouping: true,
               integersLength: 5
            },
         ...
         {
            testName:
               'Insert number in field with maxed integers (before space, with .0)',
            controlConfig: {
               useGrouping: true,
               integersLength: 4
            },
         ...
         {
            testName:
               'Insert minus at string start when it contains some value',
            controlConfig: {
               useGrouping: true
            },
            splitValue: {
         ...
         {
            testName:
               'Insert minus in decimals start, when max decimals length is reached',
            controlConfig: {
               useGrouping: true,
               precision: 2
            },
         ...
         {
            testName:
               'Insert long integer number in field with integersLength option',
            controlConfig: {
               useGrouping: true,
               integersLength: 5,
               precision: 0
         ...
         {
            testName:
               'Insert long float number in field with integersLength option',
            controlConfig: {
               useGrouping: true,
               integersLength: 5
            },
         ...
         {
            testName:
               'Insert number with long decimals part in field with precision option',
            controlConfig: {
               useGrouping: true,
               precision: 2
            },
         ...
         {
            testName:
               'Insert value in decimals part with precision (decimals part is full)',
            controlConfig: {
               useGrouping: true,
               precision: 2
            },
         ...
         {
            testName:
               'Insert value in decimals part with precision (decimals part is not full)',
            controlConfig: {
               useGrouping: true,
               precision: 2
            },
      ...
      testCases.forEach(function (item) {
         it(item.testName, function () {
            ...
            numberViewModel._displayValue =
               item.splitValue.before +
               item.splitValue.delete +
               item.splitValue.after;
