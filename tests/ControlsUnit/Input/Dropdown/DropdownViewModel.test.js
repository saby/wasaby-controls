   ...
   describe('DropdownViewModel', () => {
      ...
      describe('Groups and separator', function () {
         ...
         it('groupItems', function () {
            ...
            expect(
               viewModel3._itemsModel._display.at(9).getContents().get('group')
            ).toEqual('group_1');
            expect(
               viewModel3._itemsModel._display.at(10).getContents().get('group')
            ).toEqual('group_1');
         });
         ...
         it('needHideGroup', function () {
            ...
            expect(
               DropdownViewModel._private.needHideGroup(self, 'empty')
            ).toBe(true);
            expect(
               DropdownViewModel._private.needHideGroup(self, 'notEmpty')
            ).toBe(false);
      ...
      it('_private.getSpacingClassList', () => {
         ...
         let classList = DropdownViewModel._private.getClassList(
            options,
            itemData,
            hasHierarchy
         );
         ...
         classList = DropdownViewModel._private.getClassList(
            options,
            itemData,
            hasHierarchy
         );
      ...
      it('_private.isHistoryItem', () => {
         ...
         expect(!!DropdownViewModel._private.isHistoryItem(historyItem)).toBe(
            true
         );
         expect(!!DropdownViewModel._private.isHistoryItem(simpleItem)).toBe(
            false
         );
      });
