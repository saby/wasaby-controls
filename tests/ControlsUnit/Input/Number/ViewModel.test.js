define(['Core/core-clone', 'Core/core-merge', 'Controls/_input/Number/ViewModel'], function (
   cClone,
   cMerge,
   ViewModel
) {
      ...
      describe('_convertToDisplayValue', function () {
         [
            ...
            it(`value: ${
               ...
               expect(model._convertToDisplayValue(test.value)).toEqual(test.displayValue);
            });
         });
      });
