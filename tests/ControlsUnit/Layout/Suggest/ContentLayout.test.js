define(['Controls/_suggestPopup/Layer/__ContentLayer'], function (
   __ContentLayer
) {
   describe('Controls._suggestPopup.Layer.__ContentLayer', function () {
      ...
      it('Suggest::_private.calcHeight', function () {
         ...
         self._height = 'auto';
         expect(
            __ContentLayer.default._private.calcHeight(
               self,
               getDropDownContainer(900)
            )
         ).toEqual('auto');
         expect(
            __ContentLayer.default._private.calcHeight(
               self,
               getDropDownContainer(400)
            )
         ).toEqual('300px');
         self._height = '76px';
         expect(
      ...
      it('Suggest::_private.getSizes', function () {
         ...
         self._height = 'auto';
         var sizes = __ContentLayer.default._private.getSizes(
            self,
            getDropDownContainer(900)
         );
      ...
      it('updateMaxHeight when resized', function () {
         ...
         const updateMaxHeight =
            __ContentLayer.default._private.updateMaxHeight;
         layer._container = getContainer({ top: 0 });
         __ContentLayer.default._private.getDropDownContainerSize = () => {
            return { height: 500 };
         };
