define(['Controls/_suggestPopup/Layer/__PopupContent'], function (PopupContent) {
   describe('Controls._suggestPopup.Layer.__PopupContent', function () {
      ...
      it('_private.getSuggestWidth', function () {
         ...
         expect(PopupContent.default._private.getSuggestWidth(target, container)).toEqual(72);
