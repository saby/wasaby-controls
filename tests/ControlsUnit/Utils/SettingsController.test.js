define(['Controls/Application/SettingsController'], function (SettingsController) {
   'use strict';
   ...
   describe('PropStorageUtil', function () {
      ...
      describe('saving data', function () {
         it('one value', async function () {
            ...
            const loadResult = await SettingsController.loadSavedConfig('2', ['fourthProp']);
            expect(loadResult).toEqual({ fourthProp: 4 });
         });
         it('many values', async function () {
            await SettingsController.saveConfig('2', ['firstProp', 'fourthProp'], {
               firstProp: 10,
               fourthProp: 40
            });
