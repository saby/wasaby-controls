define([
   ...
   describe('history:FilterSource', () => {
      ...
      it('fillRecent', () => {
         ...
         historyMod.FilterSource._private.fillRecent(
            self,
            historyInstance,
            itemsRecent
         );
         ...
         itemsRecent.clear();
         historyInstance.pinned.add(
            getItem('12', '{title: 123}', 'TEST_HISTORY_ID_V1')
         );
         historyMod.FilterSource._private.fillRecent(
            self,
            historyInstance,
      ...
      it('findItem', function () {
         ...
         let result = historyMod.FilterSource._private.findItem(
            {},
            historyItems,
            newItem
         );
         ...
         result = historyMod.FilterSource._private.findItem(
            {},
            historyItems,
            newItem
         );
