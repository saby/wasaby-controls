   ...
   describe('Controls.Container.Suggest.List', function () {
      ...
      describe('_beforeMount', () => {
         it('items from sourceController is saved on beforeMount', () => {
            ...
            expect(suggestList._items.getRawData()).toEqual(
               getSuggestItems().getRawData()
            );
         });
      });
      ...
      it('isTabChanged', function () {
         expect(
            SuggestPopupListContainer._private.isTabChanged(
               { tabsSelectedKey: 1 },
               2
            )
         ).toBe(true);
      ...
      it('getTabKeyFromContext', function () {
         ...
         expect(
            SuggestPopupListContainer._private.getTabKeyFromContext(
               emptyContext
            )
         ).toEqual(null);
         expect(
      ...
      it('_private:checkContext', function () {
         ...
         SuggestPopupListContainer._private.checkContext(
            suggestList,
            optionsObject
         );
      ...
      describe('collectionChange', () => {
         it('maxCount navigation', () => {
            ...
            expect(
               suggestList._suggestListOptions.tabsSelectedKey === 'test'
            ).toBe(true);
            expect(notifyStub).toHaveBeenCalledWith('tabsSelectedKeyChanged', [
               'test'
            ]);
