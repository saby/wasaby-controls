...
describe('Controls/grid/Indicator', () => {
    describe('getTemplate', () => {
        it('is full grid support', () => {
            ...
            expect(indicator.getTemplate('', null)).toEqual('Controls/grid:IndicatorComponent');
        });
        ...
        it('is not full grid support', () => {
            ...
            const indicator = new Indicator();
            expect(indicator.getTemplate('', null)).toEqual('Controls/gridIE:IndicatorComponent');
