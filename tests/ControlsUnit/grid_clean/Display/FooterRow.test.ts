...
describe('Controls/grid_clean/Display/FooterRow', () => {
    it('should not skip columns for colspan. All 3 colspaned columns in footer should be shown.', () => {
        ...
        expect(footerRow.getColumns()[0].getColumnConfig()).toEqual(
            footerColumnsConfig[0]
        );
        expect(footerRow.getColumns()[1].getColumnConfig()).toEqual(
            footerColumnsConfig[1]
        );
        expect(footerRow.getColumns()[2].getColumnConfig()).toEqual(
            footerColumnsConfig[2]
        );
