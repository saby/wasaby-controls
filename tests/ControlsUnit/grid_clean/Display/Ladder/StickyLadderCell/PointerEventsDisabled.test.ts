...
describe('Controls/grid/Display/Ladder/StickyLadderCell/PointerEventsDisabled', () => {
    describe('initialize from DataRow', () => {
        ...
        it('initialize with getStickyContentClasses', () => {
            ...
            cAssert.include(
                ...
                'tw-absolute tw-top-0 tw-bottom-0 tw-pointer-events-none tw-pointer-events-none'
            );
        });
    ...
    describe('contentClasses', () => {
        ...
        it('getOriginalContentClasses, -isPointerEventsDisabled', () => {
            const cell = getStickyLadderCell();
            //"tw-w-full", "tw-inline-flex", "tw-items-baseline", "tw-min-w-0", "tw-shrink", "tw-box-border", "tw-h-full", "tw-cursor-pointer"
            cAssert.notInclude(cell.getOriginalContentClasses(''), 'tw-pointer-events-none');
        });
        ...
        it('getOriginalContentClasses, +isPointerEventsDisabled', () => {
            ...
            cAssert.include(cell.getOriginalContentClasses(''), 'tw-pointer-events-none');
        });
    });
});
