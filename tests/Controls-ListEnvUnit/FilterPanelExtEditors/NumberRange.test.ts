import { NumberRangeEditor } from 'Controls-ListEnv/filterPanelExtEditors';
import { StickyOpener } from 'Controls/popup';

describe('Controls-ListEnv/filterPanelExtEditors:NumberRangeEditor', () => {
    ...
    describe('textValue', () => {
        ...
        it('minValue is null', () => {
            numberRangeEditor._handleMaxValueChanged(event, 5);
            expect(textValue).toEqual('до 5');
            expect(changesNotified).toBe(true);
        });

        it('minValue is 0', () => {
            numberRangeEditor._handleMinValueChanged(event, 0);
    ...
    describe('_notifyPropertyValueChanged', () => {
        ...
        it('extended value updated after input value changed', () => {
            ...
            numberRangeEditor._processPropertyValueChanged(null, [minValue, maxValue]);
