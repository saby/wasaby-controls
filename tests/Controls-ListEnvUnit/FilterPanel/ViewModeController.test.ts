...
import { ViewModeController, ViewModeType } from 'Controls-ListEnv/filterPanel';
...
describe('Controls-ListEnv/_filterPanel:ViewModeController', () => {
    ...
    describe('.getFilterPanelSource()', () => {
        ...
        it('should return items filtered by name for /"default/"', () => {
            ...
            controller = new ViewModeController(filterItems, 'default', [
                filterName,
            ]);
            const innerFilterItems = controller.getFilterPanelSource();
    ...
    describe('.setFilterPanelSource()', () => {
        it('should set correct view mode', () => {
            ...
            modes.forEach((mode) => {
                controller.setFilterPanelSource(
                    newFilterItems,
                    mode as ViewModeType,
                    filterNames
                );
        ...
        it('should return same items from both methods', () => {
            const newFilterItems = getExtendedFilterItems();
            const result1 = controller.setFilterPanelSource(
                newFilterItems,
                'default',
                filterNames
            );
    ...
    describe('.updateFilterPanelSource()', () => {
        ...
        it('should return same items from both methods', () => {
            const newFilterItems = getExtendedFilterItems();
            const result1 = controller.updateFilterPanelSource(
                newFilterItems,
                extendedFilterNames
            );
            const result2 = controller.getFilterPanelSource();
