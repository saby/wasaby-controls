import type { TAbstractDispatch, TAbstractMiddleware } from 'Controls-DataEnv/abstractDispatcher';
import { ListWebActions, IListState } from 'Controls/dataFactory';
import { TListActions } from 'Controls-DataEnv/list';
...
const getMiddleware = (): {
    ...
    const middleware = operationsPanel({
        dispatch,
        scheduleDispatch: jest.fn().mockReturnValue(new Error('Should not be called.')),
