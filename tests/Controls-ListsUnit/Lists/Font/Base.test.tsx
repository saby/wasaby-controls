...
describe('Controls-ListsUnit/Lists/Font/Base', () => {
    ...
    it('should apply fontColorStyle on row and cell', () => {
        ...
        const items = getItems();
        const cellsFontPrimary = items[1].querySelectorAll(
            '.controls-text-primary'
        );
        const cellsFontSecondary = items[1].querySelectorAll(
    ...
    it('should apply fontWeight on row and cell', () => {
        ...
        const items = getItems();
        const cellsFontBold = items[2].querySelectorAll(
            '.controls-fontweight-bold'
        );
        const cellsFontNormal = items[2].querySelectorAll(
