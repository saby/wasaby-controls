...
import { getCell } from '../GridHelpers';
...
describe('Controls-ListsUnit/Lists/Border/BorderStyle', () => {
    ...
    it('should add classes with default value', () => {
        ...
        expect(getCell(item, 0).matches(STYLES_SELECTORS.CELL.DEFAULT)).toBeTruthy();
    });
    ...
    it('should not add classes if border is hidden', () => {
        ...
        const item = getFirstItem();
        expect(getCell(item, 0).matches(STYLES_SELECTORS.CELL.DEFAULT)).toBeFalsy();
    });
    ...
    it('should add classes with "danger" value', () => {
        ...
        const item = getFirstItem();
        expect(getCell(item, 0).matches(STYLES_SELECTORS.CELL.DANGER)).toBeTruthy();
    });
