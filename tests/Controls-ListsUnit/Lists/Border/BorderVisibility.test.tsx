...
describe('Controls-ListsUnit/Lists/Border/BorderVisibility', () => {
    ...
    it('should not add classes if default value', () => {
        ...
        const cell = getCell(getFirstItem(), 0);
        expect(cell.matches(VISIBILITY_SELECTORS.ROW.VISIBLE)).toBeFalsy();
        expect(cell.matches(VISIBILITY_SELECTORS.ROW.ONHOVER)).toBeFalsy();

        expect(cell.matches(VISIBILITY_SELECTORS.CELL.VISIBLE)).toBeFalsy();
        expect(cell.matches(VISIBILITY_SELECTORS.CELL.ONHOVER)).toBeFalsy();
    });
    ...
    it('should add classes if "onhover" value', () => {
        ...
        const cell = getCell(getFirstItem(), 0);
        expect(cell.matches(VISIBILITY_SELECTORS.ROW.ONHOVER)).toBeTruthy();
    });
    ...
    it('should add classes if "visible" value', () => {
        ...
        const cell = getCell(getFirstItem(), 0);
        expect(cell.matches(VISIBILITY_SELECTORS.ROW.VISIBLE)).toBeTruthy();
    });
