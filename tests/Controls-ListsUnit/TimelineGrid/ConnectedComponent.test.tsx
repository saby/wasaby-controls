...
import { AdaptiveInitializer } from 'UICore/Adaptive';
import {
...
describe('Controls-ListsUnit/TimelineGrid/ConnectedComponent', () => {
    ...
    test('prepareDynamicColumn default params for hoverMode="cell"', () => {
        ...
        const cellProps = columnParams.getCellProps({} as Model, new Date());
        expect(cellProps.topLeftBorderRadius).toBe('xs');
        expect(cellProps.topRightBorderRadius).toBe('xs');
        expect(cellProps.bottomRightBorderRadius).toBe('xs');
        expect(cellProps.bottomLeftBorderRadius).toBe('xs');
