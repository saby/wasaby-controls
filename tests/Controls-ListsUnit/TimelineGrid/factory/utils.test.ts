...
describe('Controls-ListsUnit/TimelineGrid/factory/utils', () => {
    describe('prepareDynamicColumnsFilter', () => {
        test('initial', () => {
            ...
            const startPositionToForward = new Date(2023, 5, 21, 0, 0, 0, 0);
    ...
    describe('prepareDynamicColumnsFilterRecord', () => {
        test('prepare record', () => {
            ...
            expect(columnsFilterRecordFormat.at(1)).toBeInstanceOf(EntityFormat.StringField);
            expect(columnsFilterRecordFormat.at(2)).toBeInstanceOf(EntityFormat.IntegerField);
            expect(columnsFilterRecordFormat.at(3)).toBeInstanceOf(EntityFormat.DateTimeField);
            expect(columnsFilterRecordFormat.at(4)).toBeInstanceOf(EntityFormat.StringField);
        });
    });
});
