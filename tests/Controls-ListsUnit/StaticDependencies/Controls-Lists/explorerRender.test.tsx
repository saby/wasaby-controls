...
import { renderWithSlice } from '../testEnv/renderWithSlice';
import { RecordSet } from 'Types/collection';
import { Memory } from 'Types/source';
import { ListSlice } from 'Controls/dataFactory';
import { Component } from 'Controls-Lists/explorer';
import 'Controls-Lists/treeGrid';
import { LibPath } from '../testEnv/constants';
...
describe(LibPath.NewExplorer, () => {
    ...
    dependencyTest(
        async () => {
            ...
            renderWithSlice('storeId', slice, <Component storeId={'storeId'} />);
        },
        [],
        [
            LibPath.MarkerComponent,
            LibPath.Input,
            LibPath.ColumnScrollReact,
            LibPath.ListWebReducers,
            LibPath.MultiSelection,
            LibPath.GridColumnScroll,
            LibPath.Checkbox,
            LibPath.ExtButtons,
            LibPath.DragScroll,
            LibPath.ResizeObserver,
        ],
        'Построение компонента explorer'
    );
});
