...
import * as template from 'wml!Controls-Wizard/_horizontal/WrappedLayout/WrappedLayout';
 ...
 * <Controls-Wizard.horizontal:WrappedLayout
 *      items="{{_items}}"
 ...
 * <pre class="brush: html">
 * <Controls-DataEnv.context:Provider value={_loader}>
 *     ...
 * </Controls-DataEnv.context:Provider>
 * </pre>
 *
 * Загруженные данные придут в **dataOptions** {@link link Controls-Wizard/horizontal:ILayout template} шаблона шага.
...
/**
 * @name Controls-Wizard/horizontal:WrappedLayout#storeId
