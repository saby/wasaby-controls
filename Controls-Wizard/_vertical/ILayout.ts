...
export interface ILayoutOptions extends IStepOptions, IControlOptions {
     ...
     * @cfg {Array.<Wizard/vertical:IVerticalItem>} Массив элементов для отображения.
     * @example
     * В данном примере показано, как задавать элементы для отображения
     * <pre class="brush: html">
     * <!-- WML -->
     * <Wizard.vertical:Layout items="{{_items}}" />
     * </pre>
     *
     * <pre class="brush: js">
     * // TypeScript
     ...
     *                 contentTemplate: 'Engine-demo/Wizard/demoVertical2/VerticalStep2',
     *                 contentTemplateOptions: {
     *                     finishStepHandler: this.finishStepHandler,
     *                     finishWizardHandler: this.finishWizardHandler,
     ...
     * @cfg {Wizard/_vertical/ILayout/MarkerSize.typedef} Размер маркера.
     ...
     * <pre class="brush: html">
     * <!-- WML -->
     * <Wizard.vertical:Layout completedStepsIndexVisible="{{_showCompletedSteps}}"/>
     * </pre>
     */
     ...
     * <pre class="brush: html">
     * <!-- WML -->
     * <Wizard.vertical:Layout markerViewMode="marker"/>
     * </pre>
     */
     ...
     * <pre class="brush: html">
     * <!-- WML -->
     * <Wizard.vertical:Layout blockLayout="{{false}}"/>
     * </pre>
     */
    blockLayout?: boolean;
