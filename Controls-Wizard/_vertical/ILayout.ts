...
export type THideUncompletedStepsMode = 'adaptive' | 'all';
...
export interface ILayoutOptions extends IStepOptions, INextButtonCaption, IControlOptions {
    ...
    /**
     * @name Controls-Wizard/_vertical/ILayout#hideUncompletedSteps
     * @cfg {String|undefined} Определяет скрывать будущие шаги или нет, а также определяет на каких типах устройств они будут скрыты(только в адаптиве, или в адаптиве + десктоп).
     * @variant all Скрывает непройденные шаги на всех типах устройств.
     * @variant adaptive Скрывает непройденные шаги только в адаптиве.
     * @default undefined
     * @demo Controls-Wizard-demo/vertical/HideUncompletedStepsMode/Index
     */
    hideUncompletedStepsMode?: THideUncompletedStepsMode;

    /**
     * @name Controls-Wizard/_vertical/ILayout#currentStepIndex
     * @cfg {Number} Номер последнего пройденного шага.
    ...
    /**
     * @name Controls-Wizard/_vertical/ILayout#stepButtonsRightContentTemplate
     * @cfg {ReactElement|TemplateFunction} Пользовательский шаблон, который встраивается справа от кнопок-действий.
     * @demo Controls-Wizard-demo/vertical/StepButtonsRightContentTemplate/Index
     */
    stepButtonsRightContentTemplate: ReactElement;
}
