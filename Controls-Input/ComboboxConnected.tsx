...
import { IComponentPropsWithReadonly, TSelectedKey } from 'Controls/interface';
...
/**
 * Интерфейс для редактора "Значение из списка"
 * @public
 */
 ...
 * @param {IComboboxProps} props
 * @public
 */
function ComboboxConnected(props: IComboboxProps & IComponentPropsWithReadonly) {
        ...
        >
            {props.multiSelect ? (
                ...
                <ComboboxInput
                    ...
                    emptyText={!props.required ? props.placeholder || rk('Не выбрано') : null}
                    validationStatus={validationStatus}
                    onBlur={onBlurHandler}
                    {...clearProps(props)}
                    {...sizeProps}
