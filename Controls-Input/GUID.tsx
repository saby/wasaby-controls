...
import { IMaskOptions, Mask } from 'Controls/input';

/**
 * Определяет набор опций для компонента "GUID"
 * @public
 */
 ...
 *
 * @class Controls-Input/GUID
 * @extends Controls/input:Mask
 *
 * @public
 * @demo Controls-Input-demo/GUID/Index
 */
function GUID(props: IGUIDInputProps, ref: LegacyRef<Mask>) {
    const { replacer = '0' } = props;
    return (
        <Mask
            ref={ref}
            {...props}
...
export default forwardRef(GUID);
