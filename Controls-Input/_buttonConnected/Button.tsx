 ...
 * @implements Controls/buttons:IButtonOptions
 * @public
 */
...
const clickHandler = (
    ...
    if (action && actionConfig) {
        return getProvider(actionConfig.commandName).then((provider) => {
            return provider.execute(action.actionProps, container, container, context);
        });
    } else {
 ...
 * @param props
 * @constructor
 * @demo Controls-Input-demo/ButtonConnected/ActionButton/Index
 */
