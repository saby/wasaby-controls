...
import { IComponentProps, IItemsOptions, TSelectedKey } from 'Controls/interface';
 ...
 * @param props
 */
function SelectorConnected(props: ISelectorProps & IComponentProps) {
    ...
    const onValueChanged = useCallback(
        ...
        [resetValidation, onChange, setLocalValue]
    );
