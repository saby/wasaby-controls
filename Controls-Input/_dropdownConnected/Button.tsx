...
import { useConnectedButtonProps, IButtonStyle, IStyle } from 'Controls-Input/buttonConnected';
 ...
 * @public
 */
function DropdownButtonConnected(props: IButtonProps & IComponentProps & IButtonStyle & IStyle) {
