...
import controlTemplate = require('wml!Controls-TabsLayout-demo/colored/BaseView/HeaderContentTemplate/Index');
...
export default class ContainerBaseDemo extends Control<IControlOptions> {
    ...
    static _styles: string[] = [
        'Controls-TabsLayout-demo/colored/BaseView/HeaderContentTemplate/Index',
    ];
}
