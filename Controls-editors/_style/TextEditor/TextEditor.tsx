...
import { TextStyleEditor, IStyleTextEditorProps } from './TextStyleEditor';
...
interface ITextEditorProps extends ITextData {
    ...
    StyleEditor?: FC<IStyleTextEditorProps>;
}
...
export function TextEditor({
    ...
    return (
        <div className="tw-w-full">
            ...
            <div
                className="TextEditor__block TextEditor__block_contrast TextEditor__block__preview TextEditor-fade"
                data-qa={'TextEditor__preview'}
            >
                <div className="TextEditor__block__preview__content">
                    <TextStylePreview value={PREVIEW_TEXT} style={stylePreview || style} />
                </div>
            </div>
            <div className="TextEditor__block TextEditor__block_contrast">
                <Title
                    caption={TEXT_BLOCK}
                    fontWeight="bold"
                    fontColorStyle="default"
                    fontSize="m"
                    className="controls-margin_bottom-st"
                />
                <StyleEditor
                    className="TextEditor__inner-block"
                    meta={styleMeta}
                    style={style}
                    onChange={onStyleChange}
                />
            </div>
            <div className="TextEditor__block TextEditor__block__comment TextEditor__block_contrast">
                <TextCommentEditor
                    key={selector}
                    inputClass="TextEditor__inner-block"
                    value={comment}
