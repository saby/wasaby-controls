...
export interface IGoogleFontsContext {
    disable: boolean;
}

export const GoogleFontsContext = createContext<IGoogleFontsContext>({ disable: false });
...
export function GoogleFonts({ disable = false }: IGoogleFontsProps) {
    const fontsContext = useContext(GoogleFontsContext);
    ...
    const skipFonts = disable || fontsContext.disable || !fontsWasAddedRef.current;
