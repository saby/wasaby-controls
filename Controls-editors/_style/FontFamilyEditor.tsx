...
interface IFontFamilyEditorProps extends IPropertyGridPropertyEditorProps<string> {
...
export const FontFamilyEditor = memo((props: IFontFamilyEditorProps) => {
    const { bold = false, fontSize, showDefault = true, onChange, className } = props;
    ...
    return (
        <>
            ...
            <ComboboxEditor
                ...
                fontWeight={bold ? 'bold' : 'normal'}
                className={`FontFamilyEditor_width ${className}`}
            />
        </>
    );
});
