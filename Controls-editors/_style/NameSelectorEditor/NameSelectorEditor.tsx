...
function ViewMode({
    ...
    return (
        <div
            style={style}
            className={`tw-flex tw-items-baseline controls-inlineheight-${inlineHeight} NameSelectorEditor`}
        >
            <Title
                caption={nameValue}
...
function EditMode({
    ...
    return (
        <FocusRoot
            ...
            autofocus={true}
            ref={focusRef}
            className="tw-w-full NameSelectorEditor"
        ...
        >
            ...
            >
                <>
                    ...
                    <div className="NameSelectorEditor__confirmButton" data-qa="NameSelectorEditor__confirmButton">
                        <Button
                            viewMode="link"
                            buttonStyle="success"
                            inlineHeight="xs"
