 ...
 * @public
 */
function EnumComboboxEditorFunc<T extends any>(props: IEnumComboboxEditorProps<T>): JSX.Element {
    const {
        type,
        value,
        onChange,
    ...
    return (
        <LayoutComponent>
            <SelectorControl
                ...
                className={'controls-PropertyGrid__editor_enum tw-w-full'}
                source={source}
...
export const EnumComboboxEditor = memo(EnumComboboxEditorFunc) as typeof EnumComboboxEditorFunc;
