...
import { IPropertyGridEditorLayout, IPropertyGridPropertyEditorProps } from 'Controls-editors/propertyGrid';
...
interface ILimitDateEditorProps extends IPropertyGridPropertyEditorProps<IValue> {
