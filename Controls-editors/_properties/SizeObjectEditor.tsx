...
import { IHeightOptions, IFontSizeOptions, IIconSizeOptions } from 'Controls/interface';
import { SizeEditor } from './SizeEditor';

interface ISizeEditorValue extends IHeightOptions, IFontSizeOptions, IIconSizeOptions {}

interface ISizeEditorProps extends Omit<ComponentProps<typeof SizeEditor>, 'value'> {
