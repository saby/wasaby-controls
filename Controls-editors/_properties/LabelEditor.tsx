import { Fragment, memo, useCallback, ReactElement, useRef, useMemo } from 'react';
...
import IIconEditorPopup from './IconEditor/IIconEditorPopup';
import * as rk from 'i18n!Controls';
import 'css!Controls-editors/_properties/LabelEditor';
...
export const LabelEditor = memo((props: ILabelEditorProps) => {
    ...
    const selectedKey = useMemo(() => {
        ...
        return value.labelPosition || null;
    }, [value]);
                ...
                {selectedKey !== 'hidden' &&
                    (typeof value.icon === 'undefined' ? (
                        ...
                        <PreviewerTarget
                            ...
                            template={() => {
                                return <IIconEditorPopup onSendResult={chooseIconHandler} />;
                            }}
                        />
                    ))}
            </>
