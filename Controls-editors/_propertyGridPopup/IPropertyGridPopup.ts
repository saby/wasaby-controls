...
export interface IPropertyGridPopup<RuntimeInterface extends object>
     ...
     * @remark <b>Не добавляйте</b> свои типы контекстов в опции PropertyGridPopup. Передайте {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/context-data/new-data-store/config/ конфигурацию фабрики} слайсов в опцию dataContext
     */
