...
const PropertyGridPopup = forwardRef(
    <RuntimeInterface extends object>(props: IPropertyGridPopup<RuntimeInterface>, ref) => {
                ...
                }),
                {
                    onPendingFail: async (forceFinishValue?: boolean) => {
                        ...
                        if (
                            ...
                            if (resetAnswer) {
                                const formResult =
                                    validationControllerClass.getFormValidationResult();
        ...
        }, [validationControllerClass, bodyEditorMeta, sort, displayedValue, bodyOnChange]); // Получает данные только при первом рендере (прочти доклет вначале файла)
