...
const PropertyGridPopup = forwardRef(
    <RuntimeInterface extends object>(props: IPropertyGridPopup<RuntimeInterface>, ref) => {
        const { metaType, sort, value, onClose, editorContext, dataContext } = props;
        ...
        }, [resetTrigger, applyHandler, ScrollContentMemoized]); // Получает данные только при первом рендере (прочти доклет вначале файла)
