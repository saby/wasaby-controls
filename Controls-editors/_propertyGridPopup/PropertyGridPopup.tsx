...
const PropertyGridPopup = forwardRef(
    <RuntimeInterface extends object>(props: IPropertyGridPopup<RuntimeInterface>, ref) => {
        ...
        const onCloseCallback = useCallback(() => {
            let resolvePending: Function | undefined;
        ...
        }, [bodyEditorMeta, sort, displayedValue, bodyOnChange]); // Получает данные только при первом рендере (прочти доклет вначале файла)
