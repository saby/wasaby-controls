...
import 'css!Controls-editors/_objectEditorPopup/IconEditorPopup';
import * as data from 'json!Controls-editors/_objectEditorPopup/resources/icons';
                                ...
                                <div className="iconPopup-widget__Icon__ListContainer">
                                    <div className="iconPopup-widget__Icon__container">
                                        {!searchValue.length ? (
                                            ...
                                            <div className="controls-margin_left-2xs controls-fontsize-m controls-text-readonly">
