...
import 'css!Controls-editors/tabs';
    ...
    return (
        <LayoutComponent>
            <Combobox
                ...
                keyProperty="id"
                itemsSpacing="s"
                dropdownClassName="controls-LabelEditor-dropdownContainer controls-LabelEditor-tabsDropdownContainer"
