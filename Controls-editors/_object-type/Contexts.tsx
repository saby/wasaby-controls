...
export interface IObjectTypeEditorRootContext {
    ...
    /**
     * Показать свойство(вынести из чипс)
     * @param attributeName
     */
    showProperty(attributeName: string): void;
 ...
 * @see ObjectTypeEditor
 */
export const ObjectTypeEditorRootContext = createContext<IObjectTypeEditorRootContext | undefined>(
    undefined
);
