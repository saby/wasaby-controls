...
export interface IComplexEditor extends IEditor {
    ...
    /**
     * Значение по умолчанию для комплексного редактора
     */
...
export type IGetEditor = (meta: ObjectMeta) => IEditorComponent;

export function isSingleAttributeEditor(
    attribute: IEditorTypeDescription
): attribute is ISingleAttributeEditor {
    return 'name' in attribute && 'metaType' in attribute;
}
