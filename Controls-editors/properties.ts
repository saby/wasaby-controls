...
export { IconEditor } from './_properties/IconEditor';
export { ActionEditor } from './_properties/ActionEditor';
...
export { NumberMinMaxEditor } from './_properties/NumberMinMaxEditor';
