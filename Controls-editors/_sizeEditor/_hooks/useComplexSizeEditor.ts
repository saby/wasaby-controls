...
import { changeSize, changeAspectRatio, checkIsBaseSize, checkIsBaseUnit } from '../changeSize';
...
export const useComplexSizeEditor = (props: TUseComplexSizeEditorProps): IUseComplexSizeEditor => {
    ...
    const isAspectRatioShown = useMemo(() => {
        ...
        return (
            !!metaProperties?.aspectRatio?.getDefaultValue() &&
            checkIsBaseUnit(parsedWidth.baseUnits) &&
            checkIsBaseUnit(parsedHeight.baseUnits)
        );
    ...
    const toggleAspectRatio = useCallback(() => {
        ...
        const newValue = changeAspectRatio(defaultAspectRatio, editorValue);
