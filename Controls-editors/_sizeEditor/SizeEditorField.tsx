    ...
    ({
        ...
        const onLocalValueChange = useCallback(
            (val) => {
                ...
                const newValue = constrainValue(val, newUnit, constraints);

                setSelectedUnit(newUnit);
                setInputValue(newValue);
            },
            [setInputValue, constraints, selectedUnit, isChangeableUnit]
        );
        ...
        const content = (
            <div
                className={
                    'ws-flexbox controls-PropertyGrid-sizeEditor__input ws-align-items-center'
                }
            >
                {showName && (
                ...
                <div
                    className={clsx('ws-flexbox', 'controls-PropertyGrid-sizeEditor__input_border')}
                >
                    <NumberEditor
                        ...
                        placeholder={Math.trunc(absoluteValue || 0).toString()}
                        onlyPositive={true}
                        changeValueByArrows
                        precision={0}
                        integersLength={5}
