    ...
    ({
        ...
        const onChangeSize = useCallback(
            (newSize) => {
                ...
                if (currentSize !== '' && Number(currentSize) < MIN_VALUE) {
                ...
                onChangeValue(currentSize, currentSize ? currentUnits : '');
            },
        ...
        const onChangeLocal = useCallback(
            (newValue: unknown) => {
                ...
                if (currentValue !== '' && Number(newValue) < MIN_VALUE) {
            ...
            <LayoutComponent>
                <div className="ws-flexbox controls-PropertyGrid-sizeEditor__input ws-align-items-baseline">
                    ...
                    <div className={`${inputClass} ws-flexbox`}>
                        ...
                        {showUnit ? (
                            <UnitSelector
                                caption={baseUnits ?? IKeyUnits.pixel}
                                items={unitItems}
                                units={units}
