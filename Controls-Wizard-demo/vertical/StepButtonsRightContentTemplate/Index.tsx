...
function StepButtonsRightContentTemplate() {
    return (
        <div className="controls-text-danger controls-background-default controls-padding-s">
            Шаблон справа от кнопок действий
        </div>
    );
}

export default forwardRef(function StepButtonsRightContentTemplateDemo(
    _: unknown,
    ...
    return (
        <div ref={ref} className="tw-flex controlsWizardDemo__wrapper">
            <Layout
                ...
                stepButtonsRightContentTemplate={StepButtonsRightContentTemplate}
            />
        </div>
    );
});
