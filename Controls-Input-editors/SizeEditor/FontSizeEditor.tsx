...
export const FontSizeEditor = memo((props: ISizeEditorProps) => {
    ...
    }, [onChange, inputValue, props.minValue, props.maxValue]);
    ...
    // Не всегда редактору могут передать значение по умолчанию, поэтому если в мете не указано значение по умолчанию, то проставляем свое
    const placeholder = props.metaType.getDefaultValue() || '14';
