...
import 'css!Controls-Input-editors/ButtonStyleEditor/StyleEditor';
...
export function StyleEditor(props: IStyleEditorProps) {
    ...
    const editingObjectChangedHandler = useCallback(
        (editingObject: IButtonStyle) => {
            if (
                editingObject &&
                (editingObject.buttonStyle === 'label' || editingObject.buttonStyle === 'link') &&
                editingObject.viewMode !== 'link'
            ) {
