import { forwardRef, useMemo, LegacyRef, useCallback } from 'react';
...
export default forwardRef(function HotKeyEditor(props: IHotKeyEditorProps, ref: LegacyRef<Input>) {
    ...
    const onSelectedKeysChanged = useCallback((selectedKeys, added) => {
        let value = null;
    ...
    }, [props.onPropertyValueChanged, source]);
