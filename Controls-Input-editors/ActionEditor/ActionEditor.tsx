...
import { Selector } from 'FrameEditor/dataContextSelector';
...
const blackList = [
    ...
    // Виджет брони:
    '/page/settings-functionality-reservation-widget',
    '/page/settings-functionality-reservation-widget-sp',
    '/page/settings-functionality-reservation-widget-card',
    '/page/settings-functionality-reservation-widget-card-sp',
    // Виджет доставки:
    '/page/settings-functionality-delivery-widget',
    '/page/settings-functionality-delivery-widget-sp',
    '/page/settings-functionality-delivery-widget-card',
    '/page/settings-functionality-delivery-widget-card-sp',
    // Виджет записи:
    '/page/settings-functionality-appointment-widget',
    '/page/settings-functionality-appointment-widget-sp',
    '/page/settings-functionality-appointment-widget-card',
    '/page/settings-functionality-appointment-widget-card-sp',
    // Виджет сертификатов:
    '/page/composite-sale-page',
];
                ...
                if (editorTemplateName) {
                    properties[item.name] = properties[item.name].editor(
                        'Controls-Input-editors/ActionEditor:BaseEditor',
                        {
                            ...
                            ...item.editorOptions,
                            // новом PG свойство type зарезервировано, и прокидывается в редактор, из-за чего прикладное значение перетирается
                            // Поэтому записываем в кастомное поле, чтобы можно было в прикладной редактор отдать то, что они ожидают.
                            _customType: item.editorOptions?.type,
                            validators: getValidators(item.validators, refValue, item.name),
                        }
                    );
                }
