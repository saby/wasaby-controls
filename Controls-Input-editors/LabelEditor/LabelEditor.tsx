...
export const LabelEditor = memo((props: ILabelEditorProps) => {
    ...
    const source = useMemo(() => {
        const data = props.customData ? props.customData : ([
            {
                        ...
                        return (
                            <ItemTemplate
                                ...
                                contentTemplate={() => {
                                    ...
                                    const isLabelHidden = itemTemplateProps.item.contents.get('isLabelHidden');
                                    ...
                                    const captionText = itemTemplateProps.item.contents.get('menuCaption') ||
