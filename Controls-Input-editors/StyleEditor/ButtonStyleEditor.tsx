...
export default forwardRef(function InlineHeightEditor(props: IProps, ref: LegacyRef<SelectorControl>) {
    ...
    return (
        <SelectorControl
            ...
            contentTemplate={() => {
                return <div
                        className={'tw-cursor-pointer controls-ButtonStyleEditor_bubble'}
                    >
                        <div
                        ...
                        return (
                            <div className='controls-padding-s tw-flex tw-w-full'>
                                <Button
                                    ...
                                    fontColorStyle={getFontColorStyle(props.editorStyle.viewMode, itemValue)}
                                    iconStyle={getIconStyle(props.editorStyle.viewMode, itemValue)}
                                    iconSize='s'
                                />
                            </div>
                        );
