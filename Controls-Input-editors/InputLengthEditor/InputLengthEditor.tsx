            ...
            <div className="tw-flex tw-w-full tw-items-baseline">
                ...
                {showInput && (
                    <>
                        {' ' + rk('от')}
                        <NumberInputControl
                            className="controls-Input__width-4ch tw-self-center controls-margin_left-xs controls-margin_right-xs Controls-Input-editors_InputLengthEditor__value-from"
