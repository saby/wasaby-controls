...
function getImageClassName({
    ...
    let classes =
        ' Controls-Templates-HorizontalItem__image Controls-Templates-TileItem__image';
...
function getCaptionClassName(props: IHorizontalItemProps): string {
    let classes =
        ' Controls-Templates-HorizontalItem__caption ' +
        (props.captionClass || '');
...
function getGradientClassName({
    ...
    const needGradient =
        imageEffect === 'custom' && imageViewMode === 'rectangle';
    let classes = '';
    if (needGradient) {
