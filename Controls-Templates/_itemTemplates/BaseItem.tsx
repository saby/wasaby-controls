...
function getCheckboxClassName({ checkboxValue }: ICheckboxProps): string {
    return `js-controls-ListView__checkbox
     ...
     Controls-Templates-BaseItem__checkbox_${
         checkboxValue ? 'selected' : 'unselected'
     }`;
}

function ItemActionsTemplate(props) {
    let itemActionsClass = props.actionsPosition
        ? `controls-itemActionsV_position_${props.actionsPosition}`
        : '';
...
export function BaseItem(
    props: IBaseItemProps
): React.ReactElement<IBaseItemProps> {
        ...
        >
            {propsWithDefaults.checkboxVisibility !== 'hidden' ? (
                <div className={getCheckboxClassName(props)}>
                    <CheckboxMarker value={props.checkboxValue} />
                </div>
            ) : null}
            ...
            <div className={getContentClasses()}>
                {props.markerVisible ? (
                    <div className={getMarkerClassName(props)}></div>
                ) : null}
