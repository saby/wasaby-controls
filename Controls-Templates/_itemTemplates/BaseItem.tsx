...
export function BaseItem(props: IBaseItemProps): React.ReactElement<IBaseItemProps> {
    ...
    return (
        <div
            ...
            ref={props.$wasabyRef}
            onMouseEnter={handlers?.onMouseEnter || props.onMouseEnter}
            onMouseLeave={handlers?.onMouseLeave || props.onMouseLeave}
            onMouseMove={handlers?.onMouseMove || props.onMouseMove}
            onMouseDown={handlers?.onMouseDown || props.onMouseDown}
            onMouseUp={handlers?.onMouseUp || props.onMouseUp}
            onClick={handlers?.onClick || props.onClick}
            onContextMenu={handlers?.onContextMenu || props.onContextMenu}
            onWheel={handlers?.onWheel || props.onWheel}
            onTouchStart={handlers?.onTouchStart || props.onTouchStart}
            onTouchMove={handlers?.onTouchMove || props.onTouchMove}
            onTouchEnd={handlers?.onTouchEnd || props.onTouchEnd}
        >
