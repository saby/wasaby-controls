...
import { EDITOR_SELECTOR_CAPTION, EDITOR_SELECTOR_DESCRIPTION } from './common/constants';
...
export interface IBackgroundItemProps
    ...
    /**
     * @cfg {Controls/interface/TOverlayDirection} Направление градиентного перекрытия изображения
     */
    overlayDirection?: TOverlayDirection;

    /**
     * @cfg {Controls/interface/TOverlayStyle} Стиль градиентного перекрытия изображения
     */
...
function getItemClassName(
    { dominantColor, brightness = 'light', className = '' }: IBackgroundItemProps,
    noZen: boolean
): string {
...
function getDescriptionClassName({
    ...
    let classes = ' ws-flexbox ws-flex-column ' + descriptionClass;
    if (overlayDirection === 'to-top-content') {
        if (!caption) {
            ...
            <div className={'Controls-Templates-TileItem__content_as_column'}>
                ...
                <div className={getContentClassName(props)}>
                    ...
                    >
                        {props.caption ? (
                            <TextRender
                                className={EDITOR_SELECTOR_CAPTION}
                                value={props.caption}
 ...
 * @implements Controls/interface:IZenProps
 * @implements Controls/interface:ICustomContent
 * @public
 * @demo Controls-Templates-demo/BackgroundItem/WI/Index
 */
