...
export interface IVerticalItemProps
    ...
    /**
     * @cfg {string} Классы, которые применяются к корневой ноде базового элемента.
     */
...
function getCaptionWrapperClassName(props: IVerticalItemProps): string {
            ...
            <div className={getContentClassName()}>
                ...
                {props.imageViewMode !== 'none' ? (
                    <div className={getImageWrapperClassName(props)}>
                        {props.imageSrc || props.imageRender ? (
                            <div>
                                <Image
                ...
                <div
                    className={getCaptionWrapperClassName(propsWithDefaults)}
 ...
 * @public
 * @demo Controls-Templates-demo/VerticalItem/WI/Index
 */
