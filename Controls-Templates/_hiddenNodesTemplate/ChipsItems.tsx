...
export function ChipsItems({
    ...
    return (
        <div
            className={'tw-flex tw-w-full tw-justify-between tw-items-baseLine'}
        >
            <div className={'tw-flex'}>
                <ExpanderComponent
                    onMouseDown={onMouseDown}
            ...
            <div className={'ControlsTemplates-ChipsItems_unExpandedWrapper'}>
                {hiddenPrices.map((price: number, index) => {
                    ...
                    const isFirstThreePrice =
                        currentCount <= MIDDLE_COUNT_PRICE;
                    ...
                    return (
                        <div
                            className={isExpanded && 'tw-w-full'}
                            key={index.toString()}
                        >
                            {numberValue && (
                                <div
                                    className={
                                        !isExpanded &&
                                        'ControlsTemplates-ChipsItems_border'
                                    }
                                    onClick={
                                        isMiddlePrice
                                            ? nominalsOpenHandler
