 ...
 */
import IFilterItemLocal from './IFilterItemLocal';

/**
 * Режимы отображения фильтра.
 */
 ...
 * @public
 */
export interface IFilterItemBase<TValue = unknown> {
    /**
     * Имя фильтра.
     * @example
    ...
    viewMode?: TViewMode;
    /**
     * @cfg {String} Режим отображения быстрого фильтра, при котором быстрый фильтр выводится отдельно от остальных быстрых фильтров.
     * @default false
     */
    primary?: boolean;
    ...
    /**
     * Опеределяет, были ли проинициализированы опции для редкактора
     * @private
     */
    __editorOptionsResolved?: boolean;
}
 ...
 * @public
 */
export default interface IFilterDescriptionItem<
    TValue = unknown,
    TEditorOptions = Record<string, unknown>,
> extends IFilterItemBase<TValue>,
        IFilterItemLocal {
    /**
    ...
    caption?: string;
    /**
     * Выводить заголовок в виде прыгающей метки. При включенной опции поле caption выводится, если выбрано значение в фильтре.
     * @example
     * <pre class="brush: js; highlight: [3]">
     *    this._filterSource = [{
     *        name: 'city',
     ...
     *   }]
     * </pre>
     * @demo Controls-ListEnv-demo/Filter/View/ViewMode/Basic/JumpingLabel/Index
     * @see caption
     */
    ...
    /**
     * Порядковый номер фильтра в блоке "Можно отобрать".
     * Актуально для фильтров с {@link viewMode} extended
     * @example
     * <pre class="brush: js; highlight: [4]">
     *    this._filterSource = [{
    ...
    /**
     * Отображение фильтра в адаптиве в стандартной кнопке фильтров. false - фильтр выключен.
     * @remark Выключить фильтр в адаптиве может быть нужно в случае выноса его в кнопку быстрых фильтров,
     * чтобы избежать его дублирования в интерфейсе.
     * @example
     * <pre class="brush: js; highlight: [4]">
     *   this._filterSource = [{
     *        name: 'city',
