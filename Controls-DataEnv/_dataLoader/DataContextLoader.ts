...
export default class DataContextLoader {
    ...
    >();
    private readonly _$nodes: Map<string, DataNodeLoader> = new Map<string, DataNodeLoader>();
    private readonly _$loadTimeout: IDataContextLoaderProps['loadTimeout'];

    private _$dataContext: DataContextAPI = new DataContextAPI({
        data: {},
    });
