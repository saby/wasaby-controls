...
import type { TListAction, TListMiddlewareContext } from 'Controls/dataFactory';
...
export function withLogger<T extends TListMiddlewareContext>(ctx: T, name: string): T {
