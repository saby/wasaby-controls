...
const COMPLEX_UPDATE_ACTION_TYPE: TAbstractListActions.complexUpdate.TBeforeApplyStateAction['type'] =
    'beforeApplyState';
...
export class Session {
    ...
    private _stateUpdated(
        ...
        Session.showChanges(changes, this._output, style);
    ...
    static showChanges(changes: IChange[], output: IOutput, style: TOutputStyle): void {
        showChanges(output, changes, style);
    }
}
