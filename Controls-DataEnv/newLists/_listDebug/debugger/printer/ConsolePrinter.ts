...
import * as MSG from '../printer/consolePrinter/MSG';
import { printStateMutations } from './consolePrinter/printStateMutations';
...
export class Printer {
    static print(
        ...
        const stateMutations = (changes: TChange[] | undefined, mode?: 'hide' | 'warn') => {
            printStateMutations(output, changes, debugMode, undefined, mode);
        };
