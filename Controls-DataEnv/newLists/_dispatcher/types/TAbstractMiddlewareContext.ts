...
import type { TRegisterPendingPromise } from '../Orchestrator';
...
export type TAbstractMiddlewareContext<TState, TAction extends TAbstractAction> = {
    ...
    /**
     * Метод для регистрации Promise некоторой долгой операции.
     * Требуется для отслеживания состояния простоя.
     * */
    readonly registerPendingPromise: TRegisterPendingPromise;
};
...
> = () => Omit<
    TMiddlewareContext,
    'dispatch' | 'getState' | 'setState' | 'applyState' | 'registerPendingPromise'
>;
