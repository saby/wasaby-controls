...
/**
 * Тип действия для обработки состояния после прикладного beforeApplyState.
 */
export type TEndUpdateAction<TState extends IAbstractListState> = TAbstractAction<
    _interactorCore.TEndUpdateSymbol,
    {
        prevState: TState;
        nextState: TState;
    }
 ...
 * Тип действия для обработки состояния после прикладного beforeApplyState.
 */
export type TOnEndUpdateAction<TState extends IAbstractListState> = TAbstractAction<
    'onEndUpdate',
    {
        prevState: TState;
        nextState: TState;
...
export type TAnyInteractorCoreAction<TState extends IAbstractListState> =
    ...
    | TEndUpdateAction<TState>
    | TOnEndUpdateAction<TState>;
