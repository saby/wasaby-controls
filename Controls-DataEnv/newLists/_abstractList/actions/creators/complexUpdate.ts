 ...
 */
export const publicSetState = (
    nextState: IAbstractListState | ((nextState: IAbstractListState) => IAbstractListState)
): complexUpdate.TPublicSetStateAction => ({
    type: 'publicSetState',
    payload: {
        nextState,
    },
 ...
 * @function
 * @param { TAbstractListActions.TAnyAbstractAction[] | undefined} actions Действия, которые будут выполнены
...
export const startUpdate = (
    actions?: TAbstractListActions.TAnyAbstractAction[]
