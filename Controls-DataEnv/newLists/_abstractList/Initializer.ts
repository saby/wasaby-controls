...
import initCoreState from './initializers/core';
...
export class Initializer {
    ...
    static getState(loadResult: IAbstractListDataFactoryLoadResult,
        config: IAbstractListDataFactoryArguments): IAbstractListState {
