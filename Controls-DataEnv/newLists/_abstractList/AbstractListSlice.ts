...
import type { IAbstractListDataFactoryArguments } from './interface/IAbstractListDataFactoryArguments';
    ...
    implements IAbstractListAPI
{
    ...
    // protected constructor(...args: ConstructorParameters<typeof Slice<TState>>) {
    //     super(...args);
    ...
    protected _initState(_loadResult: unknown, config: IAbstractListDataFactoryArguments): TState {
    ...
    protected abstract _getMiddlewaresContext(): TMiddlewareContext;
    ...
    //# endregion IListEnvViewModel API

    //# region IListViewModel Public API
