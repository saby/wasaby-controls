...
export default function initState(
    ...
    return {
        ...
        operationsPanelVisible:
            config.operationsPanelVisible ||
            needOpenOperationsPanel(
                initializer.getSelectionState().selectedKeys,
                initializer.getActionsState().listActions
            ),
...
export function needOpenOperationsPanel(
    selectedKeys: TKey[],
    listActions?: IAbstractListState['listActions']
): boolean {
    return !!(listActions && selectedKeys.length);
}
