...
import { INIT_VALIDATION_FAILED } from '../../ErrorDescriptors';
 ...
 * </pre>
 */
function resolveValue<T>(value: unknown, validator: (v: unknown) => v is T): T | undefined;
