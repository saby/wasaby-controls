...
export default function initState(
    ...
    const searchValue = initSearchValue(config.searchValue, config.searchParam);
    const state: ISearchState = {
        searchMisspellValue: '',
        searchParam: config.searchParam,
        searchValue,
        searchInputValue: config.searchParam ? config.searchInputValue || searchValue || '' : '',
        minSearchLength:
...
export function initSearchValue(searchValue?: string, searchParam?: string): string {
