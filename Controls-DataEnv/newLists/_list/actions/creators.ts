...
/**
 * Конструктор действия, для применения фильтра по его конфигурации
 */
const applyFilterDescriptionToFiller = ({
    filterDescription,
    newState,
    appliedFrom,
}: {
    ...
    appliedFrom?: string;
}): filter.TApplyFilterDescriptionToFiller =>
    aCreator('applyFilterDescriptionToFiller', {
        filterDescription,
        newState,
        appliedFrom,
    });
 ...
 */
const setExpandedItems = (expandedItems: TKey[]): expandCollapse.TSetExpandedItemsAction =>
 ...
 */
const setCollapsedItems = (collapsedItems: TKey[]): expandCollapse.TSetCollapsedItemsAction =>
