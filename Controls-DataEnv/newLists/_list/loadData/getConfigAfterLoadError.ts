...
export async function getConfigAfterLoadError<
    T extends IListState | IListDataFactoryLoadResult = IListState | IListDataFactoryLoadResult,
    E extends IListState | IListDataFactoryLoadResult = T extends IListState
        ? IListState
