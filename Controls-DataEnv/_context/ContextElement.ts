...
function resolveExtraValues(
    ...
    dependencies: Record<string, ContextElement>
): {
    properties: Record<string, unknown>;
    extraValuesDependencies: Record<string, string>;
} {
    const properties: Record<string, unknown> = {};
    const extraValuesDependencies: Record<string, string> = {};
...
export default class ContextElement {
    ...
    private _$parentNode: ContextNode;
    private _$updater: Slice['setState'];
    private _$extraValuesDependencies: Record<string, string> = {};
    private readonly _$extraValues: IDataConfig['dataFactoryArguments']['sliceExtraValues'];
    ...
    getExtraValues(): IDataConfig['dataFactoryArguments']['sliceExtraValues'] {
    ...
    private _resolveDataFactoryArguments(
        ...
        const dependenciesElements: Record<string, ContextElement> = {};
