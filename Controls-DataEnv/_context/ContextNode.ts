...
function checkCircularDependencies(configs: IContextNodeProps['configs'], name: string): void {
...
export default class ContextNode {
    ...
    constructor(props: IContextNodeProps) {
        checkCircularDependencies(props.configs, props.name);
        this._$props = props;
    ...
    addElement(name: string, loadResult: unknown, config: IDataConfig): void {
        ...
        this._$loadResults[name] = loadResult;
