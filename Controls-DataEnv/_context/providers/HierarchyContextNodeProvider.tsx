...
import { IDataConfigLoader, IDataConfig, IDataContextConfigs } from 'Controls-DataEnv/dataFactory';
...
export interface IDataContextOptions {
    ...
    apiRef?: React.Ref<{ updateContext: (contextConfigs: IDataContextConfigs) => void }>;
    /**
...
function HierarchySliceContextProvider(
    ...
    React.useImperativeHandle(
        ...
        () => {
            return {
                updateContext: (contextConfigs: IDataContextConfigs) => {
                    store.update(contextConfigs);
                },
            };
        },
        [store]
