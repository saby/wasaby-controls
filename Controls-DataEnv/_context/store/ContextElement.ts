...
import { IDataContextAPI } from '../DataContext';
...
export default class ContextElement {
    ...
    getContextConfigs(): IDataContextConfigs | undefined {
        ...
        if (dataFactory.getContextConfig) {
            ...
            if (!elementContextConfigs) {
                return;
            }

            if (DataConfigResolver.isFlatContextConfig(elementContextConfigs)) {
                return {
                    configs: elementContextConfigs.configs,
                    data: elementContextConfigs.loadResults,
                };
            } else if (DataConfigResolver.isIHierarchyContextConfig(elementContextConfigs)) {
    ...
    protected _initSlice(
        ...
        return new sliceCtr({
            ...
            dataContext: this._$props.dataContext,
