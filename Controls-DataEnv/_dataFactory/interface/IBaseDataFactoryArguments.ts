...
export interface IExtraValue {
     ...
     * @param dependencyValue Значение из родительской фабрики
     * @param prevValue Предыдущее значение изменяемого свойства
     * @param dependencyState Состояние родительской фабрики
     * @demo Controls-ListEnv-demo/Filter/Lists/Index
     * @returns Новое значение свойства
     */
    prepare?(dependencyValue: unknown, prevValue?: unknown, dependencyState?: unknown): unknown;
}
