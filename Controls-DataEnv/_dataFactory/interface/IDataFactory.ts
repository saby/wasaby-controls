...
import { IDataConfigLoader, IDataContextConfigs, TDataConfigs } from './IDataConfig';
...
export interface ISliceConstructorProps<T, K> {
     ...
     *
     */
    onNotifySubscribers?: Function;
    /**
     *
     */
    onCompleteBeforeApplyState?: Function;
    /**
