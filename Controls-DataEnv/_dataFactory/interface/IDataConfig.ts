 ...
 * @cfg {Object} Аргументы для фабрики данных. Будут переданы в функцию загрузки и в конструктор слайса.
 */
 ...
 * </pre
 */
import { IBaseDataFactoryArguments } from './IDataFactory';
export type TDataConfigs = Record<TKey, IDataConfig>;
export interface IDataConfig<
    T extends IBaseDataFactoryArguments = IBaseDataFactoryArguments
> {
