...
export default abstract class AbstractSlice<State = unknown> {
    ...
    constructor(props: ISliceConstructorProps<unknown, unknown>) {
        const initialState = this._initState(props.loadResult, props.config);
    ...
    protected _needRejectBeforeApply(partialState: Partial<State>): boolean {
        return false;
    }
    ...
    setState<State>(partialState: Partial<State>): void {
        ...
        if (this._isExecuting) {
            ...
            if (this._beforeApplyReject && this._needRejectBeforeApply(partialState)) {
                newState = {
                    ...this._stateForApply,
                    ...partialState,
                };
